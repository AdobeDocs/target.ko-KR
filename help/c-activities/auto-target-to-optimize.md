...
>[!NOTE]
>
>[!UICONTROL 자동 타겟]은 [!DNL Target Premium] 솔루션의 일부로 사용할 수 있습니다. 이 기능은 [!DNL Target Premium] 라이센스가 없는 [!DNL Target Standard]에서는 사용할 수 없습니다.
...
|--- |--- |--- |
| 개인화 알고리즘 평가(50/50) - 목표는 통제 경험(즉, 무작위로 제공된 경험)과 비교하여 개인화 알고리즘이 얼마나 잘 작동하는지 판별하는 것입니다. 현재 개인화 프로그램 평가의 시작 단계에 있을 수 있습니다. | 50% 통제/50% 개인화 경험 분할 | <ul><li>통제 경험과 개인화된 경험 간 상승도의 정확성을 극대화합니다.</li><li>상대적으로 더 적은 방문자에게 개인화된 경험이 생깁니다.</li></ul> |
| 개인화 트래픽 극대화(90/10) - 목표는 개인화된 트래픽의 크기를 극대화하는 &quot;항시적&quot; 개인화 활동을 만드는 것입니다. 비교할 기준이 되는 통제 벤치마크 상승도를 계속하여 유지하면서 상승도를 극대화하려고 합니다. | 10%~30% 통제/70%~90% 개인화된 경험 분할을 사용하는 것이 좋습니다. | <ul><li>개인화된 경험이 있는 방문자의 수를 극대화합니다.</li><li>상승도를 극대화합니다.</li><li>활동에 대한 상승도 크기와 관련하여 정확도가 낮습니다.</li></ul> |
| 사용자 지정 할당 | 백분율을 원하는 대로 수동으로 분할하십시오. | <ul><li>원하는 결과를 얻지 못할 수 있습니다. 잘 모르는 경우에는 앞의 선택 사항들 중 하나에 대한 제안을 따르십시오.</li></ul> |

통제군의 백분율을 조정하려면 - 또는 + 기호를 클릭하십시오. 통제군은 10% 미만으로 줄일 수 없습니다.
