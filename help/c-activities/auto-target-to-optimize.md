---
description: 자동 타겟은 컨텐츠를 개인화하고 변환을 유도하기 위해 고급 기계 학습을 사용하여 성과가 좋은 마케터가 정의한 여러 경험 중에서 선택하고, 개별 고객 프로필과 이 프로필과 유사한 프로필을 가진 이전 방문자의 행동을 기반으로 각 방문자에게 가장 잘 맞춤 설정된 경험을 제공합니다.
keywords: 자동 타겟;타깃팅;트래픽 할당;자주 묻는 질문;faq;문제 해결;문제해결
seo-description: 자동 타겟은 컨텐츠를 개인화하고 변환을 유도하기 위해 고급 기계 학습을 사용하여 성과가 좋은 마케터가 정의한 여러 경험 중에서 선택하고, 개별 고객 프로필과 이 프로필과 유사한 프로필을 가진 이전 방문자의 행동을 기반으로 각 방문자에게 가장 잘 맞춤 설정된 경험을 제공합니다.
seo-title: 자동 타겟
solution: Target
title: 자동 타겟
...
[!UICONTROL Auto-Target] 는 고급 머신 러닝을 사용하여 여러 개의 높은 성과를 기록하는 마케터 중에서 선택하여 컨텐츠를 개인화하고 전환을 촉진합니다. 자동 타깃팅은 개별 고객 프로파일과 유사한 프로필을 갖는 이전 방문자의 행동을 기반으로 각 방문자에게 가장 적합한 경험을 제공합니다.

>[!NOTE]
>
>[!UICONTROL 자동 타겟]은 [!DNL Target Premium] 솔루션의 일부로 사용할 수 있습니다. 이 기능은 [!DNL Target Premium] 라이센스가 없는 [!DNL Target Standard]에서는 사용할 수 없습니다. 이 라이센스에서 제공하는 고급 기능에 대한 자세한 내용은 [Target Premium](/help/c-intro/intro.md)를 참조하십시오.
...
![개인화된 경험을 위한 자동 타겟팅 옵션](/help/c-activities/assets/auto-target-ui-new.png)
...
|--- |--- |--- |
| **개인화 알고리즘 평가 (50/50)**: 귀하의 목표는 개인화 알고리즘이 제어와 얼마나 잘 작동하는지 (즉, 임의로 제공되는 경험) 결정하는 것입니다. 현재 개인화 프로그램 평가의 시작 단계에 있을 수 있습니다. | 50% 통제/50% 개인화 경험 분할 | <ul><li>통제 경험과 개인화된 경험 간 상승도의 정확성을 극대화합니다.</li><li>상대적으로 더 적은 방문자에게 개인화된 경험이 생깁니다.</li></ul> |
| **개인화 트래픽 최대화 (** 2010 년 9 월 10 일): 목표는 개인화된 트래픽의 양을 극대화하는 &quot;항상&quot; 개인화 활동을 구축하는 것입니다. 비교할 기준이 되는 통제 벤치마크 상승도를 계속하여 유지하면서 상승도를 극대화하려고 합니다. | 10%~30% 통제/70%~90% 개인화된 경험 분할을 사용하는 것이 좋습니다. | <ul><li>개인화된 경험이 있는 방문자의 수를 극대화합니다.</li><li>상승도를 극대화합니다.</li><li>활동에 대한 상승도 크기와 관련하여 정확도가 낮습니다.</li></ul> |
| **사용자 지정 할당** | 백분율을 원하는 대로 수동으로 분할하십시오. | <ul><li>원하는 결과를 얻지 못할 수 있습니다. 잘 모르는 경우에는 앞의 선택 사항들 중 하나에 대한 제안을 따르십시오.</li></ul> |

컨트롤 비율을 조정하려면 할당 열에서 아이콘을 클릭합니다. 통제군은 10% 미만으로 줄일 수 없습니다.

![자동 대상 트래픽 할당 변경](/help/c-activities/assets/auto-target-control.png)
...
**[!UICONTROL ]자동 타겟은 개인화된 모델을 만드는 데 자동화된 개인화보다 적은 트래픽을 필요로 합니다.**

자동 타겟이나 자동화된 개인화 모델을 만드는 데 필요한 *경험당* 트래픽의 양은 동일하지만 자동화된 개인화 활동에는 일반적으로 자동 타겟 활동보다 더 많은 경험이 있습니다. [!UICONTROL ][!UICONTROL ][!UICONTROL ] 예를 들어, 두 개의 위치에 위치당 두 개의 오퍼를 만든 [!UICONTROL 자동화된 개인화] 활동이 있었다면, 활동에 총 4개(2 = 4)의 경험이 포함되어 있을 것입니다. [!UICONTROL 자동 타겟]을 사용하여 경험 1을 위치 1에서 오퍼 1을 포함하고, 위치 2에서 오퍼 2를 포함하도록 설정하고, 경험 2를 위치 1에서 오퍼 1을 포함하고, 위치 2에서 오퍼 2를 포함하도록 설정할 수 있을 것입니다. [!UICONTROL 자동 타겟]을 사용하면 한 경험 내에 여러 가지 변경이 생기도록 선택할 수 있으므로 활동에 있는 총경험 수를 줄일 수 있습니다.
...
**[!UICONTROL ]자동 타겟에는 완전한 설정 기능이 있습니다.**
...
**[!UICONTROL ]자동 타겟에서는 광범위한 온라인 테스트 프레임워크를 제공합니다.**
...
**자동 타겟 활동이 상승도를 생성하지 않는 것 같습니다.[!UICONTROL ]무슨 문제가 있습니까?**
...
가장 좋은 작업 방침은 먼저 단순하고 개인화되지 않은 A/B 테스트를 사용하여 활동 경험을 구성하는 컨텐츠와 위치가 전체 응답률에 정말로 영향을 주는지 확인하는 것입니다. 반드시 미리 샘플 크기를 계산하여, 적당한 상승도를 확인하고 실행을 중단하거나 변경하지 않고도 지정된 시간 동안 A/B 테스트를 실행하기에 충분한 전원이 있는지 확인하십시오.
...
[!UICONTROL 자동 타겟은 항상 최적화되는 &quot;항시적&quot; 개인화로 사용할 수 있습니다. ] 특히 항상 사용되는 컨텐츠의 경우 [!UICONTROL 자동 타겟] 활동을 중지할 필요가 없습니다.

[!UICONTROL 자동 타겟] 활동에서 컨텐츠를 크게 변경하려면, 보고서를 검토하는 다른 사용자들이 과거 결과를 다른 컨텐츠와 혼동하거나 결부 짓지 않도록 새 활동을 시작하는 것이 좋습니다.
...
>[!VIDEO](https://video.tv.adobe.com/v/18558?captions=kor)