...
[!UICONTROL Automated Personalization] 활동에 대해 [!UICONTROL 보고서 데이터 재설정] 옵션을 사용하는 것이 권장되지 않습니다. 보이는 보고 데이터를 제거하지만 이 옵션은 [!UICONTROL Automated Personalization] 모델에서 모든 교육 레코드를 제거하지 않습니다. [!UICONTROL Automated Personalization] 활동에 대해 [!UICONTROL 보고서 데이터 재설정] 옵션을 사용하는 대신 새 활동을 만들고 원래 활동을 비활성화합니다. (참고:이 지침은 [!UICONTROL 자동 할당] 및 [!UICONTROL 자동 Target] 활동에도 적용됩니다.)

### Automated Personalization은 환경과 관련하여 어떻게 모델을 구축합니까?
