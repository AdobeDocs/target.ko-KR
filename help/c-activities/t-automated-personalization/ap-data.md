...
description: Automated Personalization(AP) 및 자동 Target(AT) 활동에서 개인화 알고리즘을 빌드하는 데 수집 및 사용하는 데이터 Adobe [!DNL Target] 에 대해 알아봅니다.
...
# ![](/help/assets/premium.png) 개인화 알고리즘에 대한 PREMIUMData  [!DNL Target] 컬렉션
