...
keywords: 자동화된 트래픽 할당;타깃팅;증가 카운트 및 사용자를 활동에 유지;트래픽 할당
seo-description: 자동 할당은 둘 이상의 경험에서 승자를 식별하고, 테스트가 계속 실행되고 학습되는 동안 변환을 늘리기 위해 더 많은 트래픽을 승자에게 자동으로 재할당합니다.
seo-title: 자동 할당
solution: Target
title: 자동 할당
topic: Standard
...
자동 할당 기능은 두 개 이상의 경험 중에서 우승자를 식별하고 우승자에게 더 많은 트래픽을 자동으로 재할당하여 테스트가 계속 실행되고 학습하는 동안 전환율을 높입니다.
...
**자동 할당을 사용하여 우승자를 식별하는 데 소요되는 시간을 예측할 때 샘플 크기 계산기를 사용할 수 있습니까?**
...
**자동 할당 활동에서 성과가 낮은 경험을 제거하여 우승자를 결정하는 프로세스를 빠르게 해야 합니까?**

성과가 낮은 경험을 제거할 이유가 없습니다. 자동 할당은 자동으로 높은 성능의 경험을 자동으로 제공하고 성과가 낮은 경험을 덜 자주 제공합니다. 활동에서 성과가 낮은 경험은 우승자를 결정하는 속도에 크게 영향을 주지 않습니다.

20%의 방문자가 모든 경험에 무작위로 할당됩니다. 성과가 낮은 경험에 제공되는 트래픽의 양은 최소적입니다 (20%는 경험의 수로 나눔).
