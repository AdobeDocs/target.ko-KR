...
+ 대상 기준 {#audience}
  ...
  + [컨텍스트 속성 만들기](guides/audience/creating-your-context-attributes.md)
  + [규칙 세트 만들기 및 사용](guides/audience/creating-and-using-rule-sets.md)
+ 기능 플래그 가져오기 {#import}
  + [기능 플래그 가져오기](guides/cross-environment/import-feature-flags.md)
+ Integration 안내서 {#sdk-releases}
  ...
  + [웹 확장 통합 안내서](guides/sdk-releases/web/web-extension-integration-guide.md)
