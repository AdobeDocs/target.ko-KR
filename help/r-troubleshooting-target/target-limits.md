---
keywords: 문자 제한;mbox 매개 변수;배치 배달 api;프로필 매개 변수;제한;내장 프로필;최대값;제한;제한;문자;모범 사례;orderid;orderTotal;mbox3rdPartyID;카테고리;categoryID;문제 해결
