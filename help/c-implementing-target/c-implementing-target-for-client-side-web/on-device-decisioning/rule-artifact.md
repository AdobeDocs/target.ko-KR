---
keywords: 구현;javascript 라이브러리;js;atjs;장치 내 의사 결정;장치 의사 결정;규칙 아티팩트
description: 장치 내 의사 결정에 사용되는 JSON 규칙 아티팩트에 대해 알아봅니다.
title: 장치 내 의사 결정에서 JSON 규칙 아티팩트는 무엇입니까?
feature: at.js
role: Developer
...
규칙 아티팩트는 [!DNL Adobe Target] 장치 내 의사 결정 활동의 JSON 표현입니다. 규칙 가공물은 [!DNL Target]에 의해 생성되어 Akamai CDN에 전파되므로 방문자에게 가능한 한 가깝게 사용할 수 있는 규칙 가공물이 있는지 확인합니다. 규칙 가공물에는 활동을 정확하게 실행하고 전달할 수 있는 메타데이터가 포함되어 있으며 이벤트 추적을 통해 실시간 분석을 수행할 수도 있습니다.
