...
description: Adobe [!DNL Target] at.js library to fire requests to get a [!DNL Target] 오퍼에 대해 adobe.target.getOffer() 함수 및 해당 옵션을 사용합니다.
title: adobe.target.getOffer() 함수를 어떻게 사용합니까?
feature: at.js
role: Developer
