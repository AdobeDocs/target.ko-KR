---
description: 'at. js에 대한 targetpageparams () 함수에 대한 정보입니다. '
keywords: adobe.target.notification;요소;선택기;알림;확장 프로그램
seo-description: . js JavaScript 라이브러리의 Adobe Target에 대한 targetpageparams () 함수에 대한 정보입니다.
seo-title: . js JavaScript 라이브러리의 Adobe Target에 대한 targetpageparams () 함수에 대한 정보입니다.
solution: Target
subtopic: 시작하기
