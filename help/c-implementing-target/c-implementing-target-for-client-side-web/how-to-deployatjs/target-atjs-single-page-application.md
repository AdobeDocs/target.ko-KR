...
자세한 [내용은 단일 페이지 애플리케이션(SPA)에서 Adobe Target at.js 2.x 구현을](https://helpx.adobe.com/target/kt/using/atjs2-single-page-application-technical-video-implement.html) 참조하십시오.
