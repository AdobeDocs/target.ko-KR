...
description: 클라우드 기반 인스턴스를 사용하여 Adobe [!DNL Target] 를 테스트하거나 개념 증명을 위해 고객이 직면하는 문제를 살펴보십시오.
...
[!DNL at.js] JavaScript 라이브러리는 쿠키를 사용하여 사용자를 추적하여 [!DNL Target]이 항상 일관된 경험을 제공하도록 합니다. [!DNL Target] JavaScript 라이브러리가 쿠키를 저장할 수 없다면 [!DNL Target] 요청이 비활성화된 것입니다.
