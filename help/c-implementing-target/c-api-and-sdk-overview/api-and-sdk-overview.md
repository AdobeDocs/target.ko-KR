...
description: Adobe [!DNL Target] server-side delivery APIs, SDKs, and [!DNL Target] Recommendations API에 대해 알아보십시오.
title: ' [!DNL Target] 서버측 배달 API 및 SDK에 대해 어디에서 학습할 수 있습니까?'
feature: 서버측 구현
role: Developer
