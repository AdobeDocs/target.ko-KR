...
- [문제 해결 Target](r-troubleshooting-target/troubleshooting-target.md):활동 및 다른 요소에 영향을 주는 문자 제한 및 기타 제한(오퍼 크기, 대상, 프로필, 값, 매개 변수 등)에 대한 정보를 포함하여 이 안내서에 포함된 문제 해결 정보에 대한 링크를 제공합니다 [!DNL Target].
- [모바일 앱용 Target](c-target-mobile-app/target-mobile-app.md): 모바일 앱 최적화 및 개인화에 [!DNL Target]을 사용할 수 있는 방법을 설명합니다.
- [리소스 및 연락처 정보](cmp-resources-and-contact-information.md):도움이 필요한 경우  [!DNL Target] 기능 및 연락 방법에 대한 자세한 내용을 살펴볼 수  [!DNL Adobe] 있는 추가 리소스에 대한 정보를 제공합니다.

## 마케터 {#marketers}

- [활동](c-activities/activities.md): [!DNL Target] 활동을 설정, 관리 및 QA하는 방법을 설명합니다.
- [대상](c-target/target.md):타깃팅된 활동에서 컨텐츠와 경험을 보는 사람을 결정하는 방법을 설명합니다.
