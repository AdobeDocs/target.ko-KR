...
![다른 사람이 새 휴대폰과 함께 구입한 액세서리를 보여 주는 추천.](/help/c-recommendations/assets/intro-1.png)
...
![디지털 중심 브랜드를 보여 주는 추천](/help/c-recommendations/assets/intro-2.png)

마케팅 담당자는 [!DNL Adobe Target] 을 활용하여 다양한 업계, 고객 유형 및 채널에서 개인화된 경험을 제공합니다.

[!DNL Adobe Target] 은 어디에서나 개인화된 콘텐츠를 제공합니다.

![Target 이 다양한 위치에서 추천을 제공하는 방법을 보여 주는 그림](/help/c-recommendations/assets/intro-3.png)
...
![우수한 추천을 만드는 세 가지 요소를 보여 주는 일러스트레이션](/help/c-recommendations/assets/intro-4.png)
...
![추천 전략을 보여 주는 그림](/help/c-recommendations/assets/intro-5.png)
...
![추천 구현을 만드는 단계를 보여 주는 그림](/help/c-recommendations/assets/intro-6.png)
...
![컨텍스트 또는 제품에 대해 Target 교육 방법을 보여 주는 일러스트레이션](/help/c-recommendations/assets/intro-7.png)
...
![카탈로그에 대한 메타데이터 정보를 보여 주는 일러스트레이션](/help/c-recommendations/assets/intro-8.png)
...
![사용자 행동을 파악하는 방법을 보여 주는 일러스트레이션](/help/c-recommendations/assets/intro-9.png)
...
![상황에 맞는 추천을 받는 방법을 보여 주는 그림](/help/c-recommendations/assets/intro-10.png)
...
![우수한 추천을 만드는 요소를 보여 주는 그림](/help/c-recommendations/assets/intro-11.png)
...
![추천 활동을 구성하는 요소(대상, 기준 및 디자인)를 보여 주는 일러스트레이션](/help/c-recommendations/assets/intro-12.png)
...
[권장 사항 소개](https://forums.adobe.com/external-link.jspa?url=https%3A%2F%2Fadobecustomersuccess.adobeconnect.com%2Fp8gt31drhs3e%2F%3FOWASP_CSRFTOKEN%3D4bd6cac5d0806167ee0a5449ba93d6300548d09c922bcb751c38973897a5703a)
