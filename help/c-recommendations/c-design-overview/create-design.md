...
description: 기본 디자인을 사용하거나 페이지 레이아웃에 가장 적합한 사용자 정의 디자인을 만들어 Adobe [!DNL Target] Recommendations 디자인을 만드는 방법에 대해 알아보십시오.
...
# ![PREMIUM](/help/assets/premium.png) 디자인 만들기
