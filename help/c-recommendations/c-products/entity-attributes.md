...
제품이나 컨텐츠 정보를 권장 사항에 전달하려면 엔티티 속성을 사용하십시오.
...
권장 사항은 알고리즘에 사용되는 `productId` 또는 `productPurchasedId`(코드에서 `entity.id`라고 함)를 전송합니다.

>[!NOTE]
>
>`entity.id`는 주문 확인 페이지에 전송된 `productPurchasedId` 및 Adobe Analytics 제품 보고서에 사용된 `productId`와 일치해야 합니다.
...
* [사용자 지정 엔티티 속성](../../c-recommendations/c-products/custom-entity-attributes.md#concept_E5CF39BCAC8140309A73828706288322)
