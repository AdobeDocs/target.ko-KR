...
seo-description: Adobe Target Recommendations에서 기준 및 프로모션을 위한 포함 규칙을 만들고 더 나은 결과를 얻기 위해 동적 또는 정적 필터링 규칙을 추가하는 방법에 대한 정보입니다.
seo-title: Adobe Target Recommendations에서 동적 및 정적 포함 규칙 사용
solution: Target
