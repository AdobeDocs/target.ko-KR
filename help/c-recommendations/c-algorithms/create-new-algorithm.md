...
[!NOTE]최근에 본 항목은 활동에 대한 제외 글로벌 설정과 선택한 컬렉션 설정을 모두 준수합니다. 항목이 전역 제외에 의해 제외되거나 선택한 컬렉션에 포함되지 않은 경우, 표시되지 않습니다. 따라서 최근에 본 항목 기준을 사용할 때는 일반적으로 "모든 컬렉션" 설정을 사용해야 합니다.
