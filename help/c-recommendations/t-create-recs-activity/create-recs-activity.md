...
description: Adobe [!DNL Target] VEC(Visual Experience Composer)를 사용하여 [!DNL Target] 사용 가능한 페이지에서 직접 Recommendations 활동을 만드는 방법을 알아봅니다.
...
# ![PREMIUM](/help/assets/premium.png) 권장 사항 활동 만들기
