...
이메일 서비스 공급자의 역량은 사용하는 방법에 따라 결정됩니다. 계정 관리자 또는 컨설턴트가 사용자의 가장 적합한 옵션 선택을 지원할 수 있습니다.

>[!IMPORTANT]
>
>아래에 기술된 배달 API 및 Rawbox 이메일 템플릿 옵션 (옵션 1 및 2)에는 다음의 용량 가이드라인이 적용됩니다.
>
...
## O옵션 3: 다운로드 전용 템플릿 사용 {#section_518C279AF0094BE780F4EA40A832A164}
