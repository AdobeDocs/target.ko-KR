...
# [!DNL Target]의 [!DNL Adobe Customer Journey Analytics] 보고
...
* [!DNL Target] 보고를 사용하여 [!DNL Customer Journey Analytics] 활동을 만들려면 [!UICONTROL Approver]에 &quot;[!UICONTROL Editor]&quot; 또는 &#39;[!DNL Target]&quot; 역할이 있어야 합니다.
...
* 시기에 대한 질문이 있으면 [ 안내서](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-faq#latency){target=_blank}의 *자주 묻는 질문*&#x200B;에서 *[!DNL Adobe Customer Analytics]지연 고려 사항*&#x200B;을 참조하십시오.
...
>[!TIP]
>
>[!DNL Target]이(가) 계정에서 만든 모든 활동에 대해 [!DNL Customer Journey Analytics]에서 보고를 사용하도록 지정할 수도 있습니다(**[!UICONTROL Administration]** > **[!UICONTROL Reporting]** > **[!UICONTROL Reporting Experience Cloud Solution]**). 자세한 내용은 *보고 구성*&#x200B;에서 [Reporting Cloud 솔루션 [!DNL Target]](/help/main/administrating-target/reporting.md#solution)을 참조하십시오.
...
1. [!DNL Customer Journey Analytics]의 **[!UICONTROL Connections]** 페이지에서 **[!UICONTROL Create a new connection]**&#x200B;을(를) 클릭합니다.
   ...
   ![에서 [!DNL Customer Journey Analytics]](/help/main/c-integrating-target-with-mac/cja/assets/create-connection.png)새 연결 링크 만들기
...
1. 이벤트 데이터 세트를 구성하십시오.
   ...
   자세한 내용은 [ 안내서](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-connections/create-connection#add-dataset){target=_blank}의 *연결 만들기*&#x200B;에서 *[!DNL Adobe Customer Journey Analytics]데이터 세트 추가 및 구성*&#x200B;을 참조하십시오.
...
1. 데이터 보기를 설정하고 위에서 만든 연결을 가리키는지 확인합니다.
   ...
   자세한 내용은 [ 가이드의 ](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-dataviews/create-dataview){target=_blank}데이터 보기 만들기 또는 편집&#x200B;*[!DNL Adobe Customer Journey Analytics]*&#x200B;을 참조하세요.
...
1. [!DNL Target] 패널에서 [!UICONTROL Experimentation] 차원을 사용하려면 다음 컨텍스트 레이블을 설정하십시오.
...
설정을 완료한 후 [!DNL Customer Journey Analytics]은(는) [!DNL Adobe Experience Cloud] 또는 [!UICONTROL Reports]의 활동의 [!DNL Target] 탭을 통해 설정합니다.
...
>
>* 활동의 목표 지표로 [!UICONTROL Use a CJA Metric]을(를) 선택한 경우 이 옵션은 특정 성공 지표를 정의해야 하는 시기를 유연하게 지정합니다. [!UICONTROL Experimentation] 패널을 구성할 때 성공 지표가 선택됩니다. 상승도 및 신뢰도는 선택한 CJA 지표에서 계산됩니다.

1. [!DNL Customer Journey Analytics]에서 실험 패널을 만든 다음 **[!UICONTROL Experiment]** 드롭다운 메뉴에서 활동을 선택합니다.

   자세한 내용은 [ 안내서의 ](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/panels/experimentation?lang=en#use){target=_blank}실험 패널&#x200B;*에서*&#x200B;실험 패널&#x200B;*[!DNL Customer Journey Analytics]*&#x200B;을 참조하세요.
...
1. **[!UICONTROL Build]** 아이콘을 클릭합니다.
   ...
   [!UICONTROL Experimentation] 패널은 실험의 성과를 더 잘 이해할 수 있도록 풍부한 데이터 및 시각화를 반환합니다. 자세한 내용은 [[!UICONTROL Panel output] 안내서의 ](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/panels/experimentation#panel-output){target=_blank}실험 패널&#x200B;*에서**[!DNL Customer Journey Analytics]*&#x200B;을(를) 참조하십시오.
