...
* 이 통합을 사용하려면 기본 구현 방법이 다음과 같습니다 [[!DNL Adobe Experience Platform]](https://experienceleague.adobe.com/en/docs/experience-platform){target=_blank} and [!DNL Target] implemented through the [[!DNL Adobe Experience Platform Web SDK]](https://experienceleague.adobe.com/en/docs/target-dev/developer/client-side/aep-web-sdk){target=_blank}.
  ...
  현재 이 없는 경우 [!DNL Adobe Experience Platform Web SDK] 을 구현한 다음 [[!DNL Adobe Analytics] 소스 연결](https://experienceleague.adobe.com/en/docs/experience-platform/sources/ui-tutorials/create/adobe-applications/analytics) 데이터를 로 가져오기 [!DNL Adobe Experience Platform]. 이 메서드를 사용하려면 다음을 선택해야 합니다. [!DNL Analytics] 보고서 세트 [!DNL Adobe Experience Platform] 와 함께 사용하는 샌드박스 [!DNL Customer Journey Analytics].
...
1. 위치 [!DNL Customer Journey Analytics], **[!UICONTROL Connections]** 페이지, 클릭 **[!UICONTROL Create a new connection]**.
   ...
   ![에서 새 연결 링크 만들기 [!DNL Customer Journey Analytics]](/help/main/c-integrating-target-with-mac/cja/assets/create-connection.png)
