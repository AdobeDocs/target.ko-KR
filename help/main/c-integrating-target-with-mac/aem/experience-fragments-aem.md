...
description: ' [!DNL Adobe Experience Manager] [!UICONTROL Experience Fragments]활동에서  [!DNL Adobe Target] 을(를) 사용하는 방법에 대해 알아봅니다.'
...
최적화 및 개인화를 지원하기 위해 [!UICONTROL Experience Fragments] 활동의 [!DNL Adobe Experience Manager]&#x200B;(AEM)에서 만든 [!DNL Target]&#x200B;(XF)을(를) 사용합니다.

## 고려 사항

[!UICONTROL Experience Fragments]에서 AEM [!DNL Target]을(를) 사용하여 작업할 때 다음 사항을 고려하십시오.
...
[!UICONTROL Experience Fragments] 내에서 [!DNL Target] 기능을 사용하여 프로비전해야 합니다. 또한 [!DNL AEM] as a Cloud Service 또는 [!DNL AEM] 6.4 이상을 사용하고 있어야 합니다. 계정 담당자는 사용자가 이 기능을 사용하기 위한 요구 사항을 충족하는지 확인할 수 있습니다.
...
## [!UICONTROL Experience Fragments]에서 [!DNL AEM] 만들기 및 구성 {#section_745C8EFE29F547A2958FDBF61A5ADF7B}

[!DNL AEM]에서 [!UICONTROL Experience Fragments] [!DNL Target]을(를) 사용하려면 다음 단계를 수행해야 합니다.
...
* **AEM as a Cloud Service as a Cloud Service** 안내서의 [[!UICONTROL Experience Fragments]Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/sites/authoring/fundamentals/experience-fragments.html?lang=ko){target=_blank}: **.
* **[!DNL AEM]Adobe Experience Manager 6.5** 설명서의 [[!UICONTROL Experience Fragments] 6.5](https://experienceleague.adobe.com/docs/experience-manager-65/authoring/authoring/experience-fragments.html?lang=ko){target=_blank}: **
* **[!DNL AEM]Adobe Experience Manager 6.4** 설명서의 [[!UICONTROL Experience Fragments] 6.4](https://experienceleague.adobe.com/docs/experience-manager-64/authoring/authoring/experience-fragments.html?lang=ko){target=_blank}: **

### 3단계: [!DNL AEM]과(와) [!UICONTROL Experience Fragment]을(를) 공유하도록 [!DNL Target] 구성
...
이전 작업을 수행하면 [!UICONTROL Experience Fragment]이(가) [!UICONTROL Offers]의 [!DNL Target] 페이지에 표시됩니다.
...
[!UICONTROL Experience Fragment]을(를) HTML 또는 JSON 오퍼로 [!DNL Target]에 가져왔습니다. [!UICONTROL Experience Fragment] &quot;기본&quot; 버전이 [!DNL AEM]에 남아 있습니다. [!UICONTROL Experience Fragment]에서 [!DNL Target]을(를) 편집할 수 없습니다.

[!UICONTROL HTML XFs]&#x200B;(으)로 내보내는 [!UICONTROL JSON XFs] 형식을 구분할 수 있도록 [!UICONTROL Experience Fragment] 및 [!DNL Target]&#x200B;(으)로 필터링하고 검색할 수 있습니다.

![경험 조각 유형별 필터링: Target UI의 HTML 또는 JSON](/help/main/c-integrating-target-with-mac/aem/assets/fragment-types.png)

마우스로 목록의 [!UICONTROL Experience Fragment]을(를) 가리킨 다음 [!UICONTROL View] 아이콘 ![정보 아이콘](/help/main/assets/icons/InfoOutline.svg)을(를) 클릭하여 [!UICONTROL Experience Fragment], [!UICONTROL Name], [!UICONTROL Type], [!UICONTROL Offer ID] 및 마지막 수정 정보를 포함한 [!UICONTROL Offer path]에 대한 추가 정보를 볼 수 있습니다. 이 오퍼를 참조하는 활동을 보려면 [!UICONTROL [!UICONTROL View Full Details]]을(를) 클릭하십시오.
...
1. [!DNL Target]에서 [시각적 경험 작성기](/help/main/c-experiences/experiences.md#concept_A2E10F6AFB3D4AEAB6951EE14688848D)에서 경험을 만들거나 편집하는 동안 페이지에서 [!DNL AEM] 콘텐츠를 삽입할 위치를 클릭한 다음 **[!UICONTROL Replace Content]** > **[!UICONTROL Experience Fragment]**&#x200B;을(를) 클릭하여 [!UICONTROL Experience Fragment] 대화 상자를 표시합니다.
   ...
   [!UICONTROL Experience Fragment] 대화 상자에는 이제 [!DNL AEM] 내에서 기본적으로 사용할 수 있는 [!DNL Target]에서 만들어진 콘텐츠가 표시됩니다.
...
1. 활동 구성을 완료합니다.
   ...
   * **A/B 테스트 또는 XT 활동의 추천:** [오퍼로서의 추천](/help/main/c-recommendations/recommendations-as-an-offer.md)
   ...
   [!UICONTROL Experience Fragments]에서 JSON으로 내보낸 [!DNL Target]은(는) VEC를 사용하여 만든 활동에서 사용할 수 없습니다. HTML [!UICONTROL Experience Fragments]만 VEC 기반 활동에서 지원됩니다. JSON [!UICONTROL Experience Fragments]을(를) 사용하려면 [양식 기반 경험 작성기](/help/main/c-experiences/form-experience-composer.md)를 사용하여 만든 활동에서 사용하십시오.

**[!UICONTROL Experience Fragments]을(를) 사용하여 [!UICONTROL Form-based Experience Composer]을(를) 사용하려면:**
...
* [!DNL Target]은(는) 현재 10분마다 가져올 [!UICONTROL Experience Fragments]을(를) 찾습니다. 가져온 [!UICONTROL Experience Fragment]은(는) 10분 이내에 [!DNL Target]에서 사용할 수 있어야 하지만, 이 기간은 앞으로 더 짧아질 것입니다.
* [!UICONTROL Experience Fragment]을(를) HTML 또는 JSON 오퍼로 [!DNL Target]에 가져왔습니다. [!UICONTROL Experience Fragment] &quot;기본&quot; 버전이 [!DNL AEM]에 남아 있습니다. [!UICONTROL Experience Fragment]에서 [!DNL Target]을(를) 편집할 수 없습니다.
* [!UICONTROL Experience Fragments]을(를) 사용하여 [!DNL Adobe Developer]을(를) 만들 수 없습니다. 위에서 설명한 대로 AEM을 사용하여 [!UICONTROL Experience Fragments]을(를) 만듭니다.
* AEM에서 [!UICONTROL Experience Fragment]을(를) 업데이트하는 경우 [!UICONTROL Experience Fragment]에서 최신 변경 사항을 사용할 수 있도록 [!DNL Target]을(를) 게시하고 [!DNL Target]&#x200B;(으)로 다시 내보내야 합니다.

## [!UICONTROL Experience Fragments]&#x200B;(으)로 내보낸 [!UICONTROL Target]에서 clientlibs 및 관련 없는 HTML 제거

AEM에서 제공한 페이지에서 [!UICONTROL Experience Fragment]과(와) 함께 [!DNL Target] 오퍼를 사용할 때 타깃팅된 페이지에 필요한 클라이언트 라이브러리가 이미 포함되어 있습니다. 오퍼에 불필요한 HTML 요소도 필요하지 않습니다.
