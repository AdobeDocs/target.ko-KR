...
최적화 또는 개인화를 지원하기 위해 [!DNL Target] 활동의 [!DNL Adobe Experience Manager](AEM)에서 작성된 [!UICONTROL 경험 조각](XF)을 사용합니다.
...
### 4단계: 경험 조각을 게시하고 [!DNL Target]으로 내보내기
...
[!DNL Target]은 현재 10분마다 가져올 [!UICONTROL 경험 조각]을 찾습니다. 가져온 경험 조각은 10분 이내에 [!DNL Target]에서 사용할 수 있으며, 이 시간대는 향후 단축될 것입니다.

경험 조각은 HTML 또는 JSON 오퍼로서 [!DNL Target]에 가져왔습니다. 콘텐츠 조각 “기본” 버전은 [!DNL AEM]에 유지됩니다. 경험 조각을 [!DNL Target]에서 편집할 수는 없습니다.
...
목록에서 경험 조각을 마우스로 가리킨 다음 [!UICONTROL 보기] 아이콘 ![정보 아이콘](/help/main/c-integrating-target-with-mac/aem/assets/icon-info.png)을 선택하여 [!UICONTROL 이름], [!UICONTROL 유형], [!UICONTROL 오퍼 ID], [!UICONTROL 오퍼 경로] 및 마지막 수정 정보를 포함한 경험 조각에 대한 추가 정보를 볼 수 있습니다. 이 오퍼를 참조하는 활동을 보려면 [!UICONTROL 오퍼 사용] 탭을 클릭합니다.
...
**양식 기반 경험 작성기를 사용하여 경험 조각을 사용하려면 다음 작업을 수행하십시오.**
...
1. 원하는 경험 조각을 선택한 다음 **[!UICONTROL 저장]**&#x200B;을 클릭합니다.
1. 활동 구성을 완료합니다.

## 고려 사항 {#considerations}

* [!DNL Target]은 현재 10분마다 가져올 [!UICONTROL 경험 조각]을 찾습니다. 가져온 경험 조각은 10분 이내에 [!DNL Target]에서 사용할 수 있으며, 이 시간대는 향후 단축될 것입니다.
* 경험 조각은 HTML 또는 JSON 오퍼로서 [!DNL Target]에 가져왔습니다. 경험 조각 “기본” 버전은 [!DNL AEM]에 유지됩니다. 경험 조각을 [!DNL Target]에서 편집할 수는 없습니다.
* [!DNL Adobe I/O]를 사용하여 [!UICONTROL 경험 조각]을 만들 수 없습니다. 위에서 설명한 대로 AEM을 사용하여 [!UICONTROL 경험 조각]을 만듭니다.
* AEM에서 경험 조각을 업데이트하는 경우, [!DNL Target]에서 최신 변경 내용을 사용할 수 있도록 경험 조각을 [!DNL Target]에 게시하고 내보냅니다.

## [!UICONTROL Target]으로 내보낸 [!UICONTROL 경험 조각]에서 ClientLibs 및 불필요한 HTML 제거

AEM에서 제공하는 페이지에 있는 [!DNL Target]에 경험 조각을 사용하는 경우, 지정된 페이지에는 이미 모든 필수 클라이언트 라이브러리가 포함되어 있습니다. 오퍼에 불필요한 HTML 요소도 필요하지 않습니다.

전체 HTML 페이지가 경험 조각을 래핑하여 문제를 일으키는 경우가 있습니다. 경험 조각이 HTML, HEAD, BODY 등이 포함된 전체 HTML 페이지가 아니라 특정 HTML 부분인지 확인합니다.
