...
| [!UICONTROL at.js]의 이벤트 | 아니오 | 예 | 해당 사항 없음 |
| [!DNL Target Mobile] SDK 이벤트 | 아니오 | 예 | 해당 사항 없음 |
| 배치 업로드 이벤트 | 아니요 | 아니오 | 예 |
| 오프라인 데이터 이벤트 (스트림) | 아니오 | 예 | 예 |
...
[[!DNL Adobe]이(가)  [!DNL Adobe Target] 및 [!DNL Real-time Customer Data Platform]과(와) 함께 동일한 페이지로 향상된 Personalization을 발표합니다.](https://blog.adobe.com/en/publish/2021/10/05/adobe-announces-same-page-enhanced-personalization-with-adobe-target-real-time-customer-data-platform){target=_blank}
