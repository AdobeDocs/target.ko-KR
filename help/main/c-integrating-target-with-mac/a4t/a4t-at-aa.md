...
자세한 내용은 [Analytics 도구 안내서](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/attribution/models.html)에서 *속성 모델 및 전환 확인 기간*&#x200B;을 참조하십시오.
