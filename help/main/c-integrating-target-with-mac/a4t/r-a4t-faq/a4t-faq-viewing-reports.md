...
[!DNL Target]에 보내진 [!DNL Analytics] 변수에는 기본 90일 만료 기간이 있습니다. (참고: 필요한 경우 고객 지원 센터에서 이 만료 기간을 조정할 수 있습니다.) 방문자가 이 만료 기간 동안 사이트를 탐색할 때 많은 수의 항목에 포함됩니다 [!DNL Target] 모든 활동이 차원에서 수집됩니다.
...
가상 보고서 세트는 [!UICONTROL 보고서 세트] 목록, 의 가상 보고서 세트에 연결된 보고서 세트와 공유되는 모든 A4T 데이터 [!DNL Analytics] 는 해당 데이터에 액세스할 수 있습니다. 가상 보고서 세트에서 만든 모든 대상은 다시 공유할 수 없습니다 [!DNL Target].

## 활동이 활성화된 후 A4T를 사용하는 활동에서 트래픽 할당 비율을 변경할 수 있습니까?

활성화 이후에 활동에서 트래픽 할당 비율을 변경하면 의 보고가 일관되지 않을 수 있습니다 [!DNL Analytics] 변경 사항은 새 방문자에게만 영향을 주므로. 재방문자는 영향을 받지 않습니다.
