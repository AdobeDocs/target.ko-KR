...
자세한 내용은 [Analytics 관리 안내서](https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/conversion-variables/conversion-var-admin.html?lang=ko)의 *전환 변수(eVar*)를 참조하십시오.
