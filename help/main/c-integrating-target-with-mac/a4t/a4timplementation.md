...
를 사용하여 Edge 구성 만들기 [!DNL Adobe Experience Platform] edge 구성 도구를 사용합니다. 구성 [[!DNL Analytics] and [!DNL Target] edge 구성 설정](https://experienceleague.adobe.com/docs/experience-platform/edge/fundamentals/datastreams.html).
...
다음에서 [!DNL Target] UI, 클릭 **[!UICONTROL 관리]** > **[!UICONTROL 시각적 경험 작성기]**&#x200B;를 선택한 다음 중 하나를 선택합니다. **[!UICONTROL 활동당 선택]** 또는 **[!UICONTROL Adobe Analytics]**.

* **[!UICONTROL 활동당 선택]** 다음 중에서 선택할 수 있습니다. [!DNL Target] 및 [!DNL Analytics] 각 활동을 만들 때.
...
구현 후 [!DNL Analytics] 을(를) 위한 보고 소스로 사용 [!DNL Target], 다음에 대해 프로비저닝되어야 합니다. [!DNL Analytics] 및 [!DNL Target]. [이 양식을 사용하여 제공을 요청합니다](https://survey.adobe.com/jfe/form/SV_ekBHTLSoP5Zki2y){target=_blank}.
...
방문자 ID 서비스를 통해 [!DNL Adobe Experience Cloud] 솔루션에서 사용자를 식별할 수 있습니다. 필요한 Experience Cloud 방문자 ID 버전을 구현하거나 이 버전으로 마이그레이션합니다. 자세한 내용은 [구현하기 전에](/help/main/c-integrating-target-with-mac/a4t/before-implement.md)의 &quot;구현 요구 사항&quot;을 참조하십시오.

다음을 참조하십시오 [Target을 위한 Experience Cloud ID 서비스 구현](https://experienceleague.adobe.com/docs/id-service/using/implementation/setup-target.html) 다음에서 *Experience Cloud 방문자 ID 서비스* 설명서를 참조하십시오.
...
마이그레이션의 경우 다음을 참조하십시오. [JavaScript용 AppMeasurement로의 마이그레이션](https://experienceleague.adobe.com/docs/analytics/implementation/js/migrate-from-hcode.html) 다음에서 *Analytics 구현 안내서*.
...
위치 [!DNL Target], 클릭 **[!UICONTROL 관리 > 보고]** 다음 중 하나를 선택합니다 **[!UICONTROL 활동당 선택]** 또는 **[!UICONTROL Adobe Analytics]** 을 클릭하여 옵션을 활성화합니다.
