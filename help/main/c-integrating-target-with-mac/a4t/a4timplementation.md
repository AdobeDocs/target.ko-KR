...
*Experience Cloud 방문자 ID 서비스* 설명서의 [Target용 Experience Cloud ID 서비스 구현](https://experienceleague.adobe.com/docs/id-service/using/implementation/setup-target.html?lang=ko)을 참조하십시오.
...
마이그레이션은 *Analytics 구현 안내서*&#x200B;에서 [JavaScript용 AppMeasurement으로 마이그레이션](https://experienceleague.adobe.com/docs/analytics/implementation/js/migrate-from-hcode.html?lang=ko)을 참조하십시오.
...
그런 다음 [데이터 삽입 API](https://helpx.adobe.com/kr/analytics/kb/data-insertion-api-post-method-adobe-analytics.html)를 통해 페이로드를 Analytics에 전달할 수 있습니다. 자동 할당 및 자동 타겟 활동의 경우 sessionId도 전달해야 합니다. 자세한 내용은 *Adobe Target SDK* 안내서의 [Analytics for Target(A4T) 보고](https://experienceleague.adobe.com/docs/target-dev/developer/server-side/integration/a4t-reporting.html?lang=ko){target=_blank}를 참조하십시오.
