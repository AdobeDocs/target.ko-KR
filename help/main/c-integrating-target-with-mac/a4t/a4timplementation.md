...
[Experience Cloud 방문자 ID 서비스](https://experienceleague.adobe.com/docs/id-service/using/implementation/setup-target.html) 설명서의 *Target용 Experience Cloud ID 서비스 구현*&#x200B;을 참조하십시오.
...
새로운 구현의 경우 [Analytics 구현 안내서](https://experienceleague.adobe.com/docs/analytics/implementation/js/overview.html)에서 *JavaScript 구현 개요*&#x200B;를 참조하십시오.

마이그레이션은 [Analytics 구현 안내서](https://experienceleague.adobe.com/docs/analytics/implementation/js/migrate-from-hcode.html)에서 *JavaScript용 AppMeasurement으로 마이그레이션*&#x200B;을 참조하십시오.
...
그런 다음 [데이터 삽입 API](https://helpx.adobe.com/analytics/kb/data-insertion-api-post-method-adobe-analytics.html)를 통해 페이로드를 Analytics에 전달할 수 있습니다. 자동 할당 및 자동 타겟 활동의 경우 sessionId도 전달해야 합니다. 자세한 내용은 [Adobe Target SDK](https://experienceleague.adobe.com/docs/target-dev/developer/server-side/integration/a4t-reporting.html){target=_blank} 안내서의 *Analytics for Target(A4T) 보고*&#x200B;를 참조하십시오.
...
[!DNL Analytics]데이터 삽입 API[를 통해 페이로드를 ](https://helpx.adobe.com/analytics/kb/data-insertion-api-post-method-adobe-analytics.html)에 전달할 수 있습니다.
