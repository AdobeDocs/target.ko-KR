...
## Adobe Experience Platform Web SDK 구현을 위한 ![Adobe Experience Platform Web SDK 배지](/help/main/assets/platform.png) 구현 단계 {#platform}
...
[!DNL Target] 경험 전달을 시작하고 추적 및 분석 목적으로 [!DNL Analytics]을(를) 적용하려면 사이트 페이지에서 Platform Web SDK를 [설치](https://experienceleague.adobe.com/docs/experience-platform/edge/fundamentals/installing-the-sdk.html)하고 [구성](https://experienceleague.adobe.com/docs/experience-platform/edge/fundamentals/configuring-the-sdk.html)하십시오.
...
*Experience Cloud ID 서비스* 설명서의 [Target용 Experience Cloud ID 서비스 구현](https://experienceleague.adobe.com/docs/id-service/using/implementation/setup-target.html)을 참조하십시오.
...
마이그레이션은 *Analytics AppMeasurement 가이드*&#x200B;에서 [JavaScript 구현으로 마이그레이션](https://experienceleague.adobe.com/docs/analytics/implementation/js/migrate-from-hcode.html)을 참조하십시오.
...
그런 다음 [데이터 삽입 API](https://helpx.adobe.com/analytics/kb/data-insertion-api-post-method-adobe-analytics.html)를 통해 페이로드를 Analytics에 전달할 수 있습니다. 자동 할당 및 자동 타겟 활동의 경우 sessionId도 전달해야 합니다. 자세한 내용은 *Adobe Target SDK* 안내서에서 [Analytics for Target(A4T) 보고](https://experienceleague.adobe.com/docs/target-dev/developer/server-side/integration/a4t-reporting.html){target=_blank}를 참조하십시오.
...
Adobe은 구현을 단순화하고 시스템 간의 불일치를 처리할 필요가 없도록 이전 통합을 제거할 것을 권장합니다. `mboxLoadSCPlugin`을(를) 포함하여 이전 SC에 배포한 모든 코드를 T&amp;T 통합으로 제거할 수 있습니다.
