...
>[!NOTE]
>
>이 문서는 at.js 구현에만 적용됩니다. [!DNL Adobe Experience Platform Web SDK]을(를) 사용하여 [!UICONTROL Analytics for Target]&#x200B;(A4T)을(를) 구현하는 방법에 대한 자세한 내용은 Experience Platform Web SDK의 [Target용 Adobe Analytics(A4T) 로깅](https://experienceleague.adobe.com/docs/target-dev/developer/a4t/overview-a4t.html){target=_blank}을 참조하십시오.
