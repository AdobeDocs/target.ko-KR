...
계산된 지표를 포함한 모든 [!DNL Analytics] 지표는 한 가지 예외를 제외하고 [!DNL Target] 및 [!DNL Analytics]의 [!UICONTROL Target 활동] 보고서에서 사용할 수 있습니다. [!UICONTROL 상승도 및 신뢰도]에 대한 계산된 지표는 지원되지 않습니다. 마찬가지로 [!DNL Analytics]에서 사용할 수 있는 모든 세그먼트를 각 솔루션에 적용할 수 있습니다. 활동이 시작된 후 또는 활동이 완료된 후 [!DNL Target]의 보고서에 지표 또는 대상자를 적용할 수 있습니다.
...
* [!DNL Target] UI에서 A4T 활동의 보고를 보면 [!DNL Analytics] 데이터가 표시됩니다. 예를 들어 [!DNL Target]에서 [!UICONTROL 방문자] 지표를 사용하는 경우 [!DNL Target] [!UICONTROL 방문자] 지표가 아닌 [!DNL Analytics] [!UICONTROL 방문자] 지표를 사용합니다(이제 [!UICONTROL 참여자]). 이 차이는 기본 트래픽 지표([!UICONTROL 방문자], [!UICONTROL 방문 횟수], [!UICONTROL 페이지 보기 수]) 및 전환 지표에 특히 중요합니다.
...
| [다변량 테스트(MVT)](/help/main/c-activities/c-multivariate-testing/multivariate-testing.md) | 예 | [!UICONTROL 요소 기여도] 보고서를 가져오려면 mbox 기반 목표 지표 목표가 필요합니다. [!UICONTROL 요소 기여도] 보고서는 현재 [!DNL Analytics] 지표를 지원하지 않습니다. |
...
[!DNL Target]에서 A4T 보고서를 보려면 **[!UICONTROL 활동]**&#x200B;을 클릭하고 [!DNL Analytics]을(를) 보고 소스로 사용하는 목록에서 원하는 활동을 클릭한 다음 **[!UICONTROL 보고서]** 탭을 클릭하십시오.

>[!NOTE]
>
>[!UICONTROL 활동] 페이지 상단의 [!UICONTROL 보고 Source] 드롭다운 목록을 사용하여 A4T를 사용하는 활동만 표시할 수 있습니다.

보고서의 오른쪽 상단에 있는 적절한 아이콘을 클릭하여 보고서의 [!UICONTROL 표 보기]와 [!UICONTROL 그래프 보기] 사이를 전환할 수 있습니다.

다음 그림은 사용 가능한 [!DNL Analytics]개의 목표 지표를 표시하는 [!UICONTROL 보고서 지표] 드롭다운 목록과 함께 A4T 보고서의 [!UICONTROL 그래프 보기]를 보여 줍니다.

![a4t_report_graph1 이미지](assets/a4t_report_graph1.png)

다음 그림은 사용 가능한 [!DNL Analytics]개의 대상을 표시하는 [!UICONTROL 대상] 드롭다운 목록과 함께 A4T 보고서의 [!UICONTROL 그래프 보기]를 보여 줍니다.
...
[!DNL Target]이(가) 아닌 [!DNL Analytics]에서 보고서를 보려면 보고서 상단의 **[!UICONTROL Analytics에서 보기]**&#x200B;를 클릭하십시오.
