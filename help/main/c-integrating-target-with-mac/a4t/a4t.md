...
* 를 사용하려면 [!DNL Analytics] 를 [!DNL Target], 회사와 회사 모두 [!DNL Analytics] 및 [!DNL Target]. [솔루션이 필요할 경우 계정 담당자에게 문의하십시오.](/help/main/cmp-resources-and-contact-information.md#concept_34A1CA16F2244D42930BB77846A5ABBB)
...
* 에서 서버 간 호출 [!DNL Target] to [!DNL Analytics] 에 활동 및 경험 정보를 보냅니다. [!DNL Analytics]. 이 통합은 다음 중 하나에 대한 추가 서버 호출을 발생시키지 않습니다 [!DNL Target] 또는 [!DNL Analytics].
   ...
   경우에 따라 분류는 [!DNL Target] to [!DNL Analytics] 실패 및 활동에 데이터가 표시되지 않음 [!DNL Analytics]. 자세한 내용은 [Analytics 및 Target 통합 문제 해결(A4T)](/help/main/c-integrating-target-with-mac/a4t/c-a4t-troubleshooting/a4t-troubleshooting.md). 다음을 수행할 수도 있습니다 [Client Care에 문의하십시오](/help/main/cmp-resources-and-contact-information.md#concept_34A1CA16F2244D42930BB77846A5ABBB) 추가 지원

## A4T 구현

at.js 및 [!DNL Adobe Experience Platform Web SDK]를 참조하십시오. [Analytics for [!DNL Target] 구현](/help/main/c-integrating-target-with-mac/a4t/a4timplementation.md).
...
| [자동 할당을 사용하는 A/B 활동](/help/main/c-activities/automated-traffic-allocation/automated-traffic-allocation.md) | 예 | 자세한 내용은 [A4T에서 자동 할당 및 자동 Target 활동을 지원합니다](/help/main/c-integrating-target-with-mac/a4t/a4t-at-aa.md) |
| [자동 타겟을 사용하는 A/B 활동](/help/main/c-activities/auto-target/auto-target-to-optimize.md) | 예 | 자세한 내용은 [A4T에서 자동 할당 및 자동 Target 활동을 지원합니다](/help/main/c-integrating-target-with-mac/a4t/a4t-at-aa.md). |
| [경험 타기팅 (XT)](/help/main/c-activities/t-experience-target/experience-target.md) | 예 |  |
| [다변량 테스트(MVT)](/help/main/c-activities/c-multivariate-testing/multivariate-testing.md) | 예 | 다음을 얻기 위해 mbox 기반 목표 지표 목표를 필요로 합니다. [!UICONTROL 요소 기여도] 보고서 세트에 대해 설명합니다. 다음 [!UICONTROL 요소 기여도] 보고서가 현재 지원되지 않음 [!DNL Analytics] 지표 를 참조하십시오. |
| [자동화된 개인화(AP) 활동](/help/main/c-activities/t-automated-personalization/automated-personalization.md) | 아니오 |  |
...
>[!MORELIKETHIS]
>
>* [Analytics for [!DNL Target] 구현](/help/main/c-integrating-target-with-mac/a4t/a4timplementation.md): at.js 및 Platform Web SDK에 대한 구현 정보를 포함합니다.
>* [리디렉션 오퍼 - A4T FAQ](/help/main/c-integrating-target-with-mac/a4t/r-a4t-faq/a4t-faq-redirect-offers.md)를 참조하십시오
