...
1. VEC의 **[!UICONTROL 경험]** 페이지에서 **[!UICONTROL 경험 추가]**&#x200B;를 클릭합니다.
...
1. [!UICONTROL A/B 테스트] 또는 [!UICONTROL 경험 타깃팅]&#x200B;(XT) 활동에서 경험에 대한 **[!UICONTROL 경험 이름 바꾸기]** 아이콘을 클릭하여 경험에 새 이름을 지정합니다.
...
1. [!UICONTROL A/B 테스트] 또는 [!UICONTROL 경험 타깃팅]&#x200B;(XT) 활동에서 경험에 대한 **[!UICONTROL 자세히]** 아이콘(세로 줄임표) 아이콘을 클릭한 다음 **[!UICONTROL URL로 리디렉션]**&#x200B;을 클릭합니다.
...
[!UICONTROL A/B 테스트]에서 환경을 복사할 수 있으므로 처음부터 환경을 다시 작성하지 않고도 간단한 콘텐츠를 변경할 수 있습니다.

1. **[!UICONTROL 경험]** 페이지(3단계 안내식 워크플로우의 첫 번째 단계)에서 세로 줄임표 아이콘 > **[!UICONTROL 복제]**&#x200B;를 클릭합니다.
...
## 교육 비디오: [!UICONTROL 시각적 경험 작성기 사용]

아래 비디오에서는 [!UICONTROL 시각적 경험 작성기] 옵션 사용에 대한 정보를 제공합니다. (7:17)
