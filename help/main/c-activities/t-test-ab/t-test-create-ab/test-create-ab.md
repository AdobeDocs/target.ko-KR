...
description: '[!UICONTROL VEC(시각적 경험 작성기])를 사용하여  [!DNL Target]이 활성화된 페이지에서 직접 A/B 테스트 활동을 만듭니다.'
...
[!DNL Adobe Target]의 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)를 활용하여 [!DNL Target]이(가) 활성화된 페이지에서 직접 [!UICONTROL A/B 테스트] 활동을 만들고 [!DNL Target] 내의 페이지 섹션을 수정합니다.

>[!NOTE]
>
>[!DNL Target]은(는) [!UICONTROL 수동]&#x200B;(기본값) [!UICONTROL A/B 테스트] 활동(이 문서에서 설명됨) 외에도 두 가지 유형의 [!UICONTROL A/B 테스트] 활동을 추가로 제공합니다. [!UICONTROL 자동 할당] 및 [!UICONTROL 자동 타겟].
>
...
1. 페이지의 요소를 변경하여 새 경험을 만듭니다.
   ...
   새 활동을 만든 후에 [!UICONTROL 시각적 경험 작성기] 왼쪽에 두 개의 탭(경험 A 및 경험 B)이 표시됩니다. 경험 A는 제어 경험입니다. 포커스는 원하는 대로 수정할 수 있는 경험 B 탭에 있습니다. 경험 B는 테스트에 추가할 수 있는 대체 경험입니다. [!UICONTROL 경험] 창 상단의 [!UICONTROL 추가] 아이콘(![추가 아이콘](/help/main/assets/icons/Add.svg))을 클릭하여 테스트에 여러 경험을 추가할 수 있습니다. 기본 사이트 경험을 옵션으로 포함하지 않으려면 활동에서 경험 A를 삭제할 수도 있습니다.
...
1. **[!UICONTROL 트래픽 할당]** 컨트롤을 클릭한 다음 아래와 같이 오른쪽 창에서 원하는 트래픽 할당 방법을 선택합니다.
