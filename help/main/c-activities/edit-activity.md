...
description: 활동을 초안 양식으로 저장하는 작업을 포함하여 Adobe Target에서 기존 활동을 편집할 수 있는 다양한 방법에 대해 알아봅니다.
...
에서 기존 활동을 편집할 수 있는 다양한 방법에 대한 정보입니다 [!DNL Adobe Target]( 활동을 초안 양식으로 저장 포함).
...
작업 공간 및 엔터프라이즈 사용자 권한 기능에 대한 자세한 내용은 [Enterprise 사용자 권한](/help/main/administrating-target/c-user-management/property-channel/property-channel.md#concept_E396B16FA2024ADBA27BC056138F9838).
