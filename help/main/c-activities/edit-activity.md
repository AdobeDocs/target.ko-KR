...
## 활동 페이지에서 마우스로 가리키면 [!UICONTROL 추가 작업] 아이콘이 표시됩니다. {#section_29EE2ECA6B88473A8F9AC5600FFBB174}

1. **[!UICONTROL 활동]** 페이지에서 편집할 활동 옆에 있는 **[!UICONTROL 추가 작업]** 아이콘(![추가 작업 아이콘](/help/main/assets/icons/MoreSmall.svg))을 클릭한 다음 [!UICONTROL **편집**]&#x200B;을 클릭합니다.

   [!DNL Target]이(가) [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)에서 활동을 열면 [!UICONTROL 경험] 페이지가 표시됩니다(3단계 안내 워크플로의 첫 번째 단계).

1. [VEC 옵션](/help/main/c-experiences/c-visual-experience-composer/viztarget-options.md)을 사용하여 원하는 대로 활동을 편집합니다.

1. **[!UICONTROL 다음]**&#x200B;을 클릭하여 다음 단계로 이동한 다음 필요한 편집을 수행합니다.

1. **목표 및 설정** 페이지로 이동하면 다음과 같은 옵션이 제공됩니다.

   * **[!UICONTROL 저장 및 닫기]:** **[!UICONTROL 저장 및 닫기]**&#x200B;를 클릭하여 변경 내용을 저장하고 활동의 [!UICONTROL 개요] 페이지를 표시합니다.
   * **저장:** **[!UICONTROL 추가 작업]** 아이콘(![추가 작업 아이콘](/help/main/assets/icons/MoreSmallListVert.svg))을 클릭한 다음 **[!UICONTROL 저장]**&#x200B;을 선택하여 변경 사항을 저장하고 계속 변경 작업을 수행할 수 있는 VEC에 남습니다. 추가적인 변경 작업을 수행하려면 먼저 저장이 완료될 때까지 기다리십시오. 저장이 완료된 후 변경 사항이 적용된 채 VEC가 다시 로드됩니다.

## [!UICONTROL 활동] 페이지에서 해당 이름을 클릭하여 활동 편집 {#section_176180DAD17E40CEA441903F39E0AA1C}

1. 워크플로우를 차례차례 이동하지 않으려면 [!UICONTROL 활동] 페이지에서 원하는 활동을 클릭하여 연 다음, **[!UICONTROL 활동 편집]** 드롭다운 목록에서 옵션을 선택한 다음, 원하는 옵션을 선택하십시오.

   * **경험 편집:**: [!UICONTROL 경험] 페이지(안내가 있는 3단계 워크플로의 첫 번째 단계)로 바로 이동합니다.
   * **타깃팅 편집**: [!UICONTROL 타깃팅] 페이지(3단계 안내가 있는 워크플로우에서 두 번째 단계)로 바로 이동합니다.
   * **[!UICONTROL 목표 및 설정]**: [!UICONTROL 목표 및 설정] 페이지(안내가 있는 3단계 워크플로우에서 세 번째 단계)로 바로 이동합니다.
...
>[!NOTE]
>
>작업 영역은 [!DNL Target Premium] 솔루션의 일부로 사용할 수 있는 [!UICONTROL 속성 및 권한] 기능의 일부입니다. 이 기능은 [!DNL Target Premium] 라이센스가 없는 [!DNL Target Standard]에서는 사용할 수 없습니다.
...
사용자 환경에서 [!UICONTROL Enterprise 사용자 권한]을 사용하도록 설정한 경우 활동을 동일한 작업 영역이나 다른 작업 영역에 복사할 수 있습니다. 현재 활동을 한 작업 공간에서 다른 작업 공간으로 이동할 수는 없습니다. 다른 작업 영역에 활동을 복사하려면 [!UICONTROL 활동] 페이지에서 복사할 활동 옆에 있는 **[!UICONTROL 추가 작업]** 아이콘(![추가 작업 아이콘](/help/main/assets/icons/MoreSmall.svg))을 클릭한 다음 [!UICONTROL **복사**]&#x200B;를 클릭합니다.
...
>[!NOTE]
>
>환경에 [!UICONTROL Enterprise 사용자 권한] 기능이 활성화되어 있지 않으면 복사하기 전에 모든 활동이 편집 모드로 열립니다.

## 활동을 초안 양식으로 저장 {#section_968CD7A63027432EBD8FAE3A0F7404C3}

[!UICONTROL 초안으로 저장] 기능을 더 이상 사용할 수 없습니다. 자세한 내용은 [활동 목록에 필터 적용](/help/main/c-activities/activities.md#filters)에서 *[!UICONTROL 상태]*&#x200B;를 참조하십시오.

## [!DNL Recommendations Classic]에서 생성한 이전 활동으로 작업 {#classic}

[!UICONTROL 활동] 목록에는 [!DNL Recommendations Classic]을(를) 포함하여 다양한 소스에서 만들어진 활동이 표시됩니다. 다음 작업은 [!DNL Recommendations Classic]에서 생성한 이전 활동으로 작업할 때 사용할 수 있습니다.
