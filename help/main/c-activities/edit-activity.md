...
>[!NOTE]
>
>작업 영역은 [!DNL Target Premium] 솔루션의 일부로 사용할 수 있는 [!UICONTROL Properties and Permissions] 기능의 일부입니다. 이 기능은 [!DNL Target Premium] 라이센스가 없는 [!DNL Target Standard]에서는 사용할 수 없습니다.
...
[!UICONTROL Save as Draft] 기능을 더 이상 사용할 수 없습니다. 자세한 내용은 [활동 목록에 필터 적용](/help/main/c-activities/activities.md#filters)의 *[!UICONTROL Status]*&#x200B;을(를) 참조하십시오.
