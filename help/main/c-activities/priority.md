---
keywords: 설정;우선순위
description: Adobe 방법 알아보기 [!DNL Target] 페이지에 전달할 활동을 결정하는 기준에 따라 다르게 결정됩니다 [!DNL Target] 인터페이스 및 사용 중인 활동 만들기 기능입니다.
title: 방법 [!DNL Target] 다른 활동에 우선 순위를 할당하시겠습니까?
feature: Activities
...
## Target Standard/Premium 시각적 경험 작성기 전용 또는 Global을 사용하는 양식 기반 작성기 [!DNL Target] 요청만 {#section_4A0A317DFED345649B58B0CB5B410C8B}
...
## Target Standard/Premium 양식 기반 작성기 및 [!DNL Target] Standard/Premium 시각적 경험 작성기 {#section_4620253E1CE942DD830724C7822B175F}
...
1. Target 서버 호출은 Target에 대한 정보를 제공합니다 [!DNL Target] 요청 및 URL입니다.
1. Target Classic 및 Standard에서는 해당 위치에서 실행 중인 모든 활동을 가져옵니다 [!DNL Target] 요청.
1. Target이 방문자를 활동에 대응시키려고 시도합니다.
...
## 비전역 Target을 사용하는 Standard/Premium 양식 기반 작성기 [!DNL Target] 요청 {#section_C3F5F09B0B2D4EF795C5929D5C426A8C}

>[!NOTE]
>
>이 정보는 Target Classic에서 생성된 실행 중인 모든 캠페인에도 적용됩니다.

회사에서 [!DNL Target] 글로벌 이외의 요청 [!DNL Target] 양식 기반 작성기에서 요청을 만들 때, 한 활동의 콘텐츠만 호출에 대해 반환될 수 있습니다. 활동 전달은 다음 결정 플로우를 사용하여 결정됩니다.

1. 다음 [!DNL Target] 서버 호출이 [!DNL Target] 다음 정보 포함 [!DNL Target] 요청 및 URL입니다.
1. [!DNL Target] 에서 실행되는 모든 활동을 가져옵니다. [!DNL Target] 요청.
1. [!DNL Target] 방문자를 우선순위가 가장 높은 활동에 일치시키려고 합니다.
...
>[!NOTE]
>
>설정에 따라 우선순위 값은 달라집니다. 낮음, 중간 또는 높음의 레거시 설정을 사용하거나 0에서 999까지 세분화된 우선순위를 사용할 수 있습니다. 자세한 내용은 [활동 설정](/help/main/c-activities/activity-settings.md#task_C6B2FF8374724933BE79A83549B9CD02)을 참조하십시오.

**두 Target Classic 캠페인이 비글로벌 Target 요청을 사용합니다**
