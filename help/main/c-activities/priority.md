---
keywords: 설정;우선순위
description: Adobe 방법 알아보기 [!DNL Target] 에 따라 페이지에 전달할 활동을 다르게 결정합니다. [!DNL Target] 사용 중인 활동 만들기 기능과 인터페이스입니다.
...
## Target Standard/Premium 시각적 경험 작성기 전용 또는 전역을 사용하는 양식 기반 작성기 [!DNL Target] 요청만 {#section_4A0A317DFED345649B58B0CB5B410C8B}
...
1. Target 서버 호출은 다음에 대한 정보가 있는 Target으로 이동합니다. [!DNL Target] 요청 및 URL입니다.
1. Target Classic 및 Standard는 해당 위치에서 실행되는 모든 활동을 가져옵니다. [!DNL Target] 요청.
1. Target이 방문자를 활동에 대응시키려고 시도합니다.
...
## 비전역 Target Standard/Premium 양식 기반 작성기 [!DNL Target] 요청 {#section_C3F5F09B0B2D4EF795C5929D5C426A8C}
...
1. [!DNL Target] 는 방문자를 가장 높은 우선 순위 활동에 일치시키려고 시도합니다.
...
**두 개의 Target Classic 캠페인이 비글로벌 Target 요청을 사용함**
