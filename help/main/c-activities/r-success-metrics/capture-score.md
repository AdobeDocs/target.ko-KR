...
첫 번째 페이지는 점수에 1을 더하고, 두 번째 페이지는 0.25, 세 번째 페이지는 0.10, 네 번째 페이지는 0.10을 더해서 총 1.45이다. 이는 통화 또는 포인트로 해석될 수 있을 것이다. 다른 방문에서는 방문자가 개 경험을 하며, 더 적은 페이지를 보지만 방문자가 더 귀중한 페이지를 봤기 때문에 다른 방문보다 높은 점수인 2.10을 받습니다.
