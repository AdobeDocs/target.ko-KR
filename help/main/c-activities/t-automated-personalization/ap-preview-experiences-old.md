...
description: '[!UICONTROL 시각적 경험 작성기]​(VEC)를 사용하여 [!DNL Adobe Target] 의 [!UICONTROL Automated Personalization]​(AP) 활동에서 각 경험을 미리 보는 방법에 대해 알아봅니다.'
...
1. 추가 변경을 수행할 수 있도록 **[!UICONTROL 작성]**&#x200B;을 클릭하여 [!UICONTROL 시각적 경험 작성기]&#x200B;(으)로 돌아가거나 **[!UICONTROL 다음]**&#x200B;을 클릭하여 [!UICONTROL 타깃팅] 단계로 이동합니다.
