...
미리 보기 및 QA 목적으로 활동이 라이브 상태가 되기 전에 사이트에서 직접 경험 콘텐츠를 볼 수 있도록 [!DNL Target] [!UICONTROL Automated Personalization] 활동에 대한 경험 미리 보기 URL을 생성할 수 있습니다. 경험 미리보기 URL은 타깃팅을 우회하여 특정 경험을 강제로 볼 수 있습니다.
...
1. URL을 검토 및/또는 지정합니다.
   ...
   * [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)를 사용하는 경우 활동에 지정한 기본 URL이 자동으로 입력되며 활동의 각 경험에 대한 링크가 생성됩니다. 원할 경우 이 URL을 변경하고 다른 URL을 추가할 수 있습니다.
...
1. 활동 요약으로 돌아가려면 **[!UICONTROL 완료]**&#x200B;를 클릭하십시오.
...
* [!UICONTROL 초안] 상태의 경험은 미리 볼 수 없습니다.
