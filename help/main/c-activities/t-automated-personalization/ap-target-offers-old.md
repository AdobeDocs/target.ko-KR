...
1. [!UICONTROL 시각적 경험 작성기]에서 활동에 대한 오퍼를 설정한 후 **[!UICONTROL 콘텐츠 관리]**&#x200B;를 클릭합니다.
...
1. 원하는 오퍼를 선택한 다음, 해당 오퍼를 볼 수 있는 대상을 선택합니다.
   ...
   단일 오퍼에 대한 타깃팅을 설정하려면 원하는 오퍼 위로 마우스를 가져간 다음 **[!UICONTROL 타깃팅]** 아이콘을 클릭하십시오.

   여러 오퍼에 대한 타깃팅을 설정하려면 원하는 오퍼에 대한 확인란을 선택한 다음 목록의 오른쪽 상단에 표시되는 **[!UICONTROL 타깃팅]** 아이콘을 클릭합니다.

1. [!UICONTROL 대상 선택] 대화 상자에서 오퍼에 대해 원하는 대상을 선택한 다음 **[!UICONTROL 완료]**&#x200B;를 클릭하여 [!UICONTROL 콘텐츠 관리] 대화 상자로 돌아갑니다.
