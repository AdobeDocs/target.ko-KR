...
* 트래픽이 낮은 페이지를 개인화하거나 개인화하는 경험의 구조를 변경하려는 경우, 자동화된 개인화 대신 자동 타겟 사용을 고려해 보십시오. 자세한 내용은 [자동 타기팅](/help/main/c-activities/auto-target/auto-target-to-optimize.md).
