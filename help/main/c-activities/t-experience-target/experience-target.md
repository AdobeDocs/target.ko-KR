...
description: Adobe에서 XT(경험 타깃팅) 활동을 사용하는 방법을 알아봅니다 [!DNL Target] 마케터가 정의한 규칙 및 기준 세트를 기반으로 특정 대상에게 컨텐츠를 전달하는 데 사용됩니다.
...
방문자가 사이트를 볼 때 XT (경험 타기팅)는 방문자를 평가하여 설정된 기준을 총족하는지 여부를 판단합니다. 기준을 충족하면 적격 대상을 위해 디자인된 활동 및 경험을 시작하게 됩니다. 단일 활동 내에서 여러 대상에 대한 경험을 만들 수 있습니다.
