...
description: 사용 방법 알아보기 [!UICONTROL Goals & Settings] 페이지 위치 [!DNL Adobe Target] 의 목표에 대한 정보를 지정하려면 [!UICONTROL Experience Targeting] (XT) 활동.
title: 지정 방법 [!UICONTROL Goals & Settings] 다음에서 [!UICONTROL Experience Targeting] 활동?
...
# 의 목표 및 설정 [!UICONTROL Experience Targeting] (XT) 활동

다음 [!UICONTROL Goals & Settings] 페이지에서 테스트 목표에 대한 정보를 입력할 수 있습니다.
...
이 옵션이에서 활성화되지 않은 경우 [!UICONTROL Administration] (기본값), 우선 순위를 지정합니다. [!UICONTROL Low], [!UICONTROL Medium], 또는 [!UICONTROL High].
...
이전 버전에서 만든 활동의 경우 [!DNL Target], [!UICONTROL Low] 우선 순위가 0으로 전환됩니다. [!UICONTROL Medium] 5로 변환되고, [!UICONTROL High] 는 10으로 변환됩니다. 필요에 따라 이러한 값을 조정할 수 있습니다.
...
고급 설정은 다음에 사용할 수 있습니다. [!UICONTROL Experience Targeting] 목표 지표.

![고급 설정](/help/main/c-activities/t-experience-target/t-xt-create/assets/Menu_AdvancedSettings-new.png)

>[!NOTE]
>
>[!DNL Analytics]를 보고 소스로 사용하는 경우 설정은 [!DNL Analytics] 서버에서 관리됩니다. 다음 [!UICONTROL Advanced Settings] 옵션을 사용할 수 없습니다.
...
2. 클릭 **[!UICONTROL Add Dependency]**:

   ![종속성 추가 링크](/help/main/c-activities/t-experience-target/t-xt-create/assets/add_dependency-new.png)

3. 왼쪽 창에서 오른쪽 창으로 원하는 지표를 드래그해 놓은 다음 를 클릭합니다 **[!UICONTROL Reached]** 설정 전환 [!UICONTROL Reached] 및 [!UICONTROL Not Reached].
...
* 선택 [!UICONTROL Increment Count & Keep User in Activity] 카운트가 증분되는 방식을 지정합니다.
* 선택 [!UICONTROL Increment Count, Release User & Allow Reentry] 활동을 다시 입력할 때 사용자에게 표시되는 경험을 지정합니다.
* 선택 [!UICONTROL Increment Count, Release User & Bar from Reentry] 활동 콘텐츠 대신 사용자에게 표시되는 콘텐츠를 지정합니다.
