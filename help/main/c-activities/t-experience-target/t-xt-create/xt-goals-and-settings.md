...
description: Adobe에서 목표 및 설정 페이지를 사용하는 방법을 알아봅니다 [!DNL Target] 경험 타깃팅(XT) 활동의 목표에 대한 정보를 지정합니다.
...
관리(기본값)에서 이 옵션이 활성화되지 않으면 우선순위를 지정합니다. 낮음, 중간 또는 높음.

세분화된 우선순위를 활성화하려면 **[!UICONTROL 관리]** > **[!UICONTROL 보고]**&#x200B;그런 다음 세분화된 우선순위 활성화 옵션을 &quot;켜기&quot; 위치로 전환하십시오.
