...
[지리 기반의 타깃팅](/help/main/c-target/c-audiences/c-target-rules/geo.md)을 포함한 [!UICONTROL 경험 타깃팅]은(는) 특정 경험이나 콘텐츠를 특정 대상으로 타깃팅하는 규칙을 정의할 때 유용합니다. 활동에서 여러 규칙을 정의하여 다른 대상자에 다양한 콘텐츠 변형을 전달할 수 있습니다.

[!UICONTROL 경험 타깃팅], 사용 사례 시나리오 및 교육 비디오에 대한 자세한 내용은 [경험 타깃팅](/help/main/c-activities/t-experience-target/experience-target.md)을 참조하십시오.

**[!UICONTROL 경험 타깃팅] 활동을 만들려면:**
...
1. 필요한 경우 **[!UICONTROL 시각적(기본값)]**&#x200B;을(를) 선택합니다.
   ...
   [양식 기반 경험 작성기](/help/main/c-experiences/form-experience-composer.md)를 사용하려면 [!UICONTROL 양식]을 선택하세요.
...
1. (조건부) [!DNL Target Premium] 고객인 경우 [작업 영역을 선택](/help/main/administrating-target/c-user-management/property-channel/property-channel.md)합니다.
   ...
   [!UICONTROL 작업 공간 선택] 옵션은 [Target Premium](/help/main/c-intro/intro.md) 기능입니다. 이 옵션이 표시되지 않는 경우 조직에 [!DNL Target Standard] 라이선스가 있는 경우.
