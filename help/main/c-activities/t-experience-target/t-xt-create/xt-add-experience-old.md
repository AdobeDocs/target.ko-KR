...
1. 추가 경험을 만들려면 **[!UICONTROL 경험 타깃팅 추가]**&#x200B;를 클릭하세요.
...
1. 경험을 타깃팅할 대상을 한 명 이상 선택한 다음 **[!UICONTROL 완료]**&#x200B;를 클릭합니다.
...
[!UICONTROL 경험 타깃팅] 활동에서 경험에 대한 [!UICONTROL 편집] 아이콘(수직 줄임표)을 클릭하고 필요에 따라 다음 옵션 중에서 선택할 수 있습니다.
...
**[!UICONTROL 경험]** 페이지(3단계 안내 워크플로의 첫 번째 단계)에서 세로 줄임표 > **[!UICONTROL 삭제]**&#x200B;를 클릭합니다.

![경험 삭제](/help/main/c-activities/t-experience-target/t-xt-create/assets/delete-experience.png)

## 경험 복제

[!UICONTROL 경험 타깃팅] 활동에서 경험을 복사할 수 있으므로 전체 경험을 다시 작성하지 않고도 약간의 콘텐츠를 변경할 수 있습니다.

**[!UICONTROL 경험]** 페이지(3단계 안내식 워크플로우의 첫 번째 단계)에서 세로 줄임표 > **[!UICONTROL 복제]**&#x200B;를 클릭합니다.
