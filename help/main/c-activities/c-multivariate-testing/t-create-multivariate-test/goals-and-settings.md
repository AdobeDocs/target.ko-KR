...
이 옵션이 [!UICONTROL 관리] > [!UICONTROL 보고]&#x200B;(기본값)에서 활성화되지 않으면 우선 순위를 [!UICONTROL 낮음], [!UICONTROL Medium] 또는 [!UICONTROL 높음]으로 지정하십시오.
...
이전 버전의 [!DNL Target]에서 만든 활동의 경우 [!UICONTROL 낮음] 우선순위는 0으로, [!UICONTROL Medium] 우선순위는 5로, [!UICONTROL 높음] 우선순위는 10으로 전환됩니다. 필요에 따라 이러한 값을 조정할 수 있습니다.
...
고급 설정은 [!UICONTROL 다변량 테스트] 목표 지표에서 사용할 수 있습니다.
...
* [!UICONTROL 카운트가 증가하는 방식을 지정하려면 증분 카운트 및 사용자를 활동에 유지]를 선택하십시오.
* [!UICONTROL 사용자가 활동을 다시 입력할 경우 표시되는 경험을 지정하려면 증분 카운트, 사용자 해제 및 재입력 허용을 선택하십시오].
