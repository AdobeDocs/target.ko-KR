...
description: '[!UICONTROL Goals & Settings]의  [!DNL Adobe Target]  페이지를 사용하여 [!UICONTROL Multivariate Test]​(MVT) 활동의 목표에 대한 정보를 지정하는 방법을 알아봅니다.'
...
[!UICONTROL Goals & Settings]의 [!DNL Adobe Target] 페이지에서 [!UICONTROL Multivariate Test]&#x200B;(MVT) 활동의 목표에 대한 정보를 입력합니다.
