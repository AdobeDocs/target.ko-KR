...
description: Adobe의 목표 및 설정 페이지를 사용하는 방법에 대해 알아봅니다. [!DNL Target] 다변량 테스트(MVT) 활동의 목표에 대한 정보를 지정합니다.
title: MVT(다변량 테스트) 활동에서 목표와 설정을 지정하려면 어떻게 합니까?
...
Adobe Target의 목표 및 설정 페이지에서 의 목표에 대한 정보를 입력할 수 있습니다 [!UICONTROL 다변량] (MVT) 테스트.
...
이 옵션이 S에서 활성화되지 않은 경우[!UICONTROL 관리] > [!UICONTROL 보고] (기본값), 우선순위를 낮음, 중간 또는 높음으로 지정합니다.
