...
description: 에 대한 트래픽이 충분한지 확인할 수 있는 트래픽 견적 도구 를 사용하는 방법을 알아봅니다. [!DNL Adobe Target] [!UICONTROL 다변량 테스트] 성공할 활동.
title: 다음에 필요한 트래픽 [!UICONTROL 다변량 테스트] (MVT) 활동
...
# 성공에 필요한 트래픽 예측 [!UICONTROL 다변량 테스트] 활동
...
* 확실히 감지 가능한 최소 25% 상승도. [!DNL Target] 는 25% 이상의 실제 상승도를 감지할 확률이 80%에 달하는 데 필요한 트래픽량을 계산합니다.
...
1. 다음에서 [!UICONTROL 시각적 경험 작성기]를 클릭하고 **[!UICONTROL 트래픽]** 아이콘.
