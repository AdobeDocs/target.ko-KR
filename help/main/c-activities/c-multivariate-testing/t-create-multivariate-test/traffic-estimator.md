...
[!UICONTROL 트래픽 견적 도구]는 다음을 확인하는 데 필요한 샘플 크기를 예측합니다.
...
[!UICONTROL 트래픽 견적 도구]에서는 테스트를 성공하기 위한 트래픽이 충분한지 여부를 알 수 있는 피드백도 제공합니다.

1. [!UICONTROL 다변량] 활동에 있는 [!UICONTROL 시각적 경험 작성기]의 [!UICONTROL 경험] 페이지에서 [!UICONTROL 경험] 페이지의 왼쪽 상단 모서리에 있는 **[!UICONTROL 트래픽]** 아이콘(![트래픽 견적 도구 아이콘](/help/main/assets/icons/Gauge2.svg))을 클릭합니다.
...
1. (조건부) 일반적인 전환율, 일별 예상 방문자 수 및 테스트 기간을 제공합니다.
   ...
   * **[!UICONTROL 테스트 기간]**: 활동을 실행할 일수입니다.
   ...
   [!UICONTROL 트래픽 견적 도구]는 이러한 통계를 사용하여 테스트를 성공적으로 실행하기 위해 필요한 조정을 결정합니다.

   숫자를 변경하면 예측값이 변경됩니다. 예를 들어, 많은 경험을 테스트하고 전환율과 노출이 너무 낮은 경우 [!UICONTROL 트래픽 견적 도구]는 테스트가 성공적으로 실행되기 위해 실행해야 하는 시간을 보여 줍니다. 또는 트래픽이 낮은 경우 [!UICONTROL 트래픽 견적 도구]에서 더 적은 수의 경험을 제안하여 원하는 일수로 테스트를 실행할 수 있습니다.
   ...
   * 테스트의 지속 기간을 늘립니다.
   ...
   [!UICONTROL 트래픽 견적 도구]가 트래픽이 충분하다고 나타낼 때까지 숫자를 조정한 다음 그에 따라 테스트를 디자인합니다.
