...
description: 사용 방법 알아보기 [!UICONTROL 시각적 경험 작성기] (VEC) Adobe [!DNL Target] 에 포함할 오퍼를 만들려면 [!UICONTROL 다변량 테스트] (MVT).
title: 에서 조합을 만드는 방법 [!UICONTROL 다변량 테스트] (MVT)
...
사용 [!UICONTROL 시각적 경험 작성기] (VEC) 위치 [!DNL Adobe Target] 에 포함할 오퍼를 만들려면 [!UICONTROL 다변량 테스트] (MVT).
...
1. 테스트에 포함할 모든 이미지를 선택하고 **[!UICONTROL 저장]**.
