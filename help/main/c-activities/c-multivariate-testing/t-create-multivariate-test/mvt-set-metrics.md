...
description: Adobe에서 지표를 지정하는 방법 알아보기 [!DNL Target] 다변량 테스트 활동 을 통해 전환, 매출 및 참여와 같은 방문이 성공적으로 수행된 시기를 확인할 수 있습니다.
title: MVT(다변량 테스트) 활동에서 목표 지표를 설정하려면 어떻게 합니까?
...
Adobe Target 다변량 테스트의 지표를 사용하여 방문이 성공적으로 수행된 시기를 확인합니다.
