...
다음 [활동을 만들](/help/main/c-activities/c-multivariate-testing/t-create-multivariate-test/create-multivariate-test.md) 때 메시지가 표시되면 활동 URL을 지정하십시오. 전체 URL(`https://` 포함)을 입력한 다음 **[!UICONTROL 다음]**&#x200B;을 클릭합니다.
...
VEC가 열린 후에 다른 페이지를 표시하려면 **[!UICONTROL 구성]** 아이콘을 클릭한 다음 **[!UICONTROL 페이지 배달]**&#x200B;을 선택하고 URL을 지정하십시오.
