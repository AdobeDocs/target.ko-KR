...
1. **[!UICONTROL 미리 보기]**&#x200B;를 클릭한 다음 **[!UICONTROL 경험 표시]** 아이콘(![경험 표시 아이콘](/help/main/assets/icons/WebPages.svg))을 클릭하여 왼쪽 프레임에 모든 경험 목록을 표시합니다.

1. 목록에서 특정 경험을 클릭하여 해당 경험을 봅니다.

1. (조건부) 활동에서 경험을 한 개 이상 제외하려면 **[!UICONTROL 콘텐츠 관리]** 아이콘(![콘텐츠 관리 아이콘](/help/main/assets/icons/Experience.svg))을 클릭하여 [!UICONTROL 콘텐츠 관리] 대화 상자를 표시합니다.

1. (조건부) [!UICONTROL 콘텐츠 관리] 대화 상자에서 제외하려는 경험 옆에 있는 **[!UICONTROL 추가 작업]** 아이콘(![추가 작업 아이콘](/help/main/assets/icons/MoreSmallList.svg))을 클릭한 다음 **[!UICONTROL 제외]**&#x200B;를 클릭합니다.

   충돌하는 변형을 표시하는 경험이나 미적으로 균형 잡히지 않은 경험을 제외하도록 선택할 수 있습니다.

1. (조건부) 여러 경험을 제외하려면 원하는 경험에 대한 확인란을 선택한 다음 **[!UICONTROL 제외]**&#x200B;를 클릭합니다.

1. (조건부) 제외된 여러 경험을 포함하려면 원하는 경험에 대한 확인란을 선택한 다음 **[!UICONTROL 포함]**&#x200B;을 클릭합니다.
