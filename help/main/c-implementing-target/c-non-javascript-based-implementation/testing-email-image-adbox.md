...
description: Adobe 사용 방법 알아보기 [!DNL Target] 이메일에서 이미지를 동적으로 테스트하고, 누군가 이메일을 열면 해당 이미지를 즉시 변경합니다.
...
| 값 | 설명 |
|--- |--- |
| clientcode | 회사의 클라이언트 코드입니다. 다음과 같이 나열된 at.js에서 찾으십시오 `clientCode='yourclientcode'`. 모두 소문자이고 특수 문자를 포함하지 않습니다. |
