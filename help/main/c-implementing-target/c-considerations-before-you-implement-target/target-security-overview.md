---
keywords: 보안;보안 사례
description: Adobe가 데이터 및 Adobe [!DNL Target] 경험에 대한 보안을 강화하기 위해 사용하는 절차에 대해 알아봅니다. Adobe [!DNL Target] Security 개요 백서를 다운로드하십시오.
title: ' [!DNL Target] 은 내 데이터 보안을 어떻게 처리합니까?'
...
[!DNL Adobe]가 귀하의 데이터 및 [!DNL Adobe Target] 경험에 대한 보안을 강화하기 위해 구현하는 심층적 접근 방식 및 보안 절차에 대한 정보입니다.
