...
1. [Admin Console에서](/help/main/administrating-target/c-user-management/property-channel/properties-overview.md#section_79796E0227D048F59BAE0AB02E544EBE) 페이지 상단에 있는 **[!UICONTROL 사용자]** 탭 > **[!UICONTROL 사용자 추가]**&#x200B;를 클릭하여 새로운 사용자를 생성하거나 기존 사용자를 편집합니다.
...
[Target API](/help/main/c-implementing-target/c-api-and-sdk-overview/api-and-sdk-overview.md)에서 엔터프라이즈 권한을 활용하려면 작업 공간 ID를 전달해야 합니다.
...
1. 업데이트 [!DNL Target] 이전 단계에서 얻은 구현 코드로 구현 을 참조하십시오.
   ...
   * **targetPageParamsAll() 함수를 통해:** 다음 코드를 `<head>` 태그에 다음 코드를 배치하십시오.
      ...
      at.js를 사용하여 이 작업을 수행하는 방법에 대한 자세한 내용은 [targetPageParamsAll](/help/main/c-implementing-target/c-implementing-target-for-client-side-web/targetpageparamsall.md).
