...
허용 목록에추가된 URL을 관리하려면 **[!UICONTROL Administration]** > **[!UICONTROL Allowlisted URLs]**&#x200B;을(를) 클릭합니다.
...
1. **[!UICONTROL Add URL]** 아이콘을 클릭합니다.
...
1. 테이블을 필터링하려면 **[!UICONTROL Search URLs]** 필드를 사용하십시오.
