...
관리하는 데 도움이 되는 정보 [!DNL Adobe Target], VEC(시각적 경험 작성기), 보고, Scene7 구성, 구현, 호스트, 환경, 응답 토큰 및 사용자에 대한 구성 설정을 포함합니다.

에 액세스하려면 [!UICONTROL 관리] 메뉴 항목 **[!UICONTROL 관리]** 상단 메뉴 막대에서 왼쪽에서 원하는 탭을 클릭합니다.
