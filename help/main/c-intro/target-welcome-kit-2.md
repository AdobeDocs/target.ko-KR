...
| 자동 타겟<br>(Premium) | [!DNL Target]의 Adobe AI를 활용하여 각 방문자의 개별 고객 프로필과 유사한 프로필을 가진 이전 방문자의 행동을 토대로 여러 방문자의 최상의 경험을 결정하고 전달합니다. 자동 타겟을 사용하면 규모에 맞게 개인화할 수 있습니다. [자세히 알아보기](/help/main/c-activities/auto-target/auto-target-to-optimize.md) |
...
| 추천<br>(Premium) | Adobe AI를 사용하여 이전 활동과 다른 고객의 활동을 기반으로 고객의 흥미를 끌 수 있는 제품이나 콘텐츠를 자동으로 제안합니다. [자세히 알아보기](/help/main/c-recommendations/recommendations.md) |
