...
[!DNL Target]에서 첫 번째 활동을 시작할 준비가 되셨습니까? 훌륭합니다. 웹 사이트, 모바일 사이트 또는 모바일 앱의 활동이 지나치게 복잡하지는 않지만 ROI를 신속하게 제공하고 [!DNL Target]을(를) 사용하여 테스트 및 개인화할 수 있는 가능성에 대해 알아보겠습니다. 조직과 조직의 포커스에 따라 첫 번째 활동으로 세 가지 경로 중 하나를 이동하는 것을 고려할 수 있습니다.

첫 번째 활동의 핵심은 매출, 클릭스루, 양식 제출, 완료된 등록 등 개선하려는 비즈니스 지표의 기준을 설정하는 것입니다. A/B 테스트에서는 현재 경험 또는 오퍼를 &quot;컨트롤&quot;로 사용하여 해당 경험 또는 오퍼의 변형에 대한 영향을 측정할 수 있습니다. 그러나 대부분의 개인화 활동을 사용하면 개인화된 버전의 현재 경험을 시작하기 전에 현재 경험의 성능을 확인하는 것이 이상적입니다. 이렇게 하면 개인화의 영향을 측정할 수 있습니다.

## 경로 1: 모든 방문자 트래픽에 대한 A/B 테스트

한 가지 제안 또는 경험의 변형을 하나 이상의 다른 변형에 대해 테스트하여 방문자가 선호하는 변형을 확인할 수 있는 기본 [A/B 테스트 활동](/help/main/c-activities/t-test-ab/test-ab.md) 을 설정할 수 있습니다. 우수성이 검증된 모델만 찾고 있는 경우 A/B 테스트 설정 워크플로의 두 번째 단계에서 [자동 할당](/help/main/c-activities/automated-traffic-allocation/automated-traffic-allocation.md)을 선택하여 더 빠른 결과를 얻기 위해 AI를 활용할 수 있습니다.
...
공감할 것으로 알고 있는 오퍼 또는 경험을 통해 귀중하다고 알고 있는 특정 대상자를 타기팅하는 [경험 타기팅](/help/main/c-activities/t-experience-target/experience-target.md) (XT) 활동을 설정할 수 있습니다.
...
* **알고 있는 항목 사용** 여러분은 이미 고객을 잘 알고 있으며 고객에게 어떤 반향을 일으킬지 잘 알고 있을 것입니다. 이를 통해 개인화된 경험을 개발할 수 있습니다.
...
* **경쟁업체 보기** 경쟁업체의 웹 사이트를 빠르게 검토하면 설계, 오퍼, 카피 및 비즈니스 결과를 이끌어내는 데 매우 효과적이라고 생각되는 기타 요소가 드러날 수 있습니다. 사이트에서 이러한 접근 방식을 시도할 수 있는 방법을 생각해 보십시오.
...
예를 들어 제어 경험과 변형을 가진 A/B 테스트에서 전체 방문자를 포함할 수 있습니다. 기본적으로 [!DNL Target] 은 제어에 50%를 제공하고 변형에 50%를 제공합니다. 하지만 여러분이 개인화를 진행하고 있다면, 개인화를 하고 있는 대상자를 설명할 수 있습니다. AI를 사용할 때, 여러분은 단지 개인화를 위해 AI를 사용하고 있다는 것을 알아챌 수 있습니다. 활동의 특정 대상자를 선택하는 경우 특정 대상자를 선택하는 이유를 가설에 명시해야 합니다.
...
활동이 완료된 후, 그 결과를 원래의 가설, 활동에서 사용한 모든 중요한 대상자, 그리고 활동 결과를 평가하기 위해 위에서 언급한 기본 및 보조 성공 지표로 연결시키면서 결과를 문서화합니다. 다음 장에서는 이러한 활동 결과를 전달하는 방법에 대해 설명합니다.

### 활동에서 세분화해야 할 사항/다음 단계는 무엇입니까?

활동 결과는 종종 다음에 수행해야 할 작업에 대한 인사이트를 제공합니다. 경험의 변형이 매우 성공적이었다면 웹 사이트에 하드 코딩하는 것이 좋습니다. 이와 같은 성공을 다른 유사한 페이지에 적용할 수 있는 기회가 나타날 수 있습니다. 결과는 이 페이지의 고객 경험을 개선하기 위해 수행해야 할 더 많은 작업을 가리킬 수 있습니다. 이 영역을 사용하여 활동의 주요 학습을 문서화하고 이러한 학습을 기반으로 수행할 작업을 문서화합니다.
