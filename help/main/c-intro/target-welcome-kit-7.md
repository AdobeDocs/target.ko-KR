...
그럼에서 첫 번째 활동을 시작할 준비가 되었습니다. [!DNL Target]? 훌륭합니다. 웹 사이트, 모바일 사이트 또는 모바일 앱의 활동이 지나치게 복잡하지는 않지만 ROI를 신속하게 제공하고 사용 가능성에 대해 알아보겠습니다 [!DNL Target] 을 입력하여 테스트 및 개인화할 수 있습니다. 조직과 조직의 포커스에 따라 첫 번째 활동으로 세 가지 경로 중 하나를 이동하는 것을 고려할 수 있습니다.
...
한 가지 제안 또는 경험의 변형을 하나 이상의 다른 변형에 대해 테스트하여 방문자가 선호하는 변형을 확인할 수 있는 기본 [A/B 테스트 활동](/help/main/c-activities/t-test-ab/test-ab.md) 을 설정할 수 있습니다. 우수성이 검증된 모델만 찾고 있는 경우 을 선택하여 더 빠른 결과를 얻기 위해 AI를 활용할 수 있습니다. [자동 할당](/help/main/c-activities/automated-traffic-allocation/automated-traffic-allocation.md) A/B 테스트 설정 워크플로의 두 번째 단계에서.
...
A/B 테스트 설정 워크플로의 두 번째 단계에서 [자동 타겟](/help/main/c-activities/auto-target/auto-target-to-optimize.md) 을 선택하면 각 방문자에 대해 최상의 경험을 제공하는 AI 기반 활동을 설정할 수 있습니다. 자동 Target을 첫 번째 활동과 함께 사용하면 다양한 방문자에게 어떤 경험이 반향을 일으킬지 모를 때 매우 유용할 수 있습니다. 자동 타겟을 사용하면 머신 러닝이 예측 속성을 실시간으로 평가하고 점수를 매길 수 있으며, 어떤 경험을 전달할지를 결정하는 데 방문자의 어떤 속성이 가장 중요한지 결정할 수 있습니다.
...
다음을 포함했습니다. [Adobe Target Activity Planner](/help/main/assets/activity-planner.pdf) 를 저장하고 반복해서 사용할 수 있는 독립 실행형 PDF으로, PDF 파일을 보려면 링크를 클릭하십시오. PDF 파일을 다운로드하려면 마우스 오른쪽 버튼을 클릭하십시오.
...
[!DNL Target] 은 통계적 원칙에 의존하여 테스트 결과가 통계적으로 유효하다고 판단합니다. 다음 [!DNL Adobe Target] [샘플 크기 계산기](/help/main/c-activities/t-test-ab/sample-size-determination.md#section_6B8725BD704C4AFE939EF2A6B6E834E6) 은 결과에 필요한 신뢰도를 기반으로 테스트 실행 시간을 결정하는 데 도움이 됩니다. 계산기를 열고 사용하려면 이 상자에서 [!UICONTROL 자세히 알아보기] 링크를 클릭합니다.
