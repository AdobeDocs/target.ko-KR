...
저장하고 반복하여 사용할 수 있는 독립 실행형 PDF로 [Adobe Target Activity Planner](/help/main/assets/activity-planner.pdf) 가 포함되어 있습니다. PDF 파일을 보려면 링크를 클릭하십시오. PDF 파일을 다운로드하려면 마우스 오른쪽 버튼을 클릭하십시오.
