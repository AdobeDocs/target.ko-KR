...
**크기 조정**: [!UICONTROL Resize] 기능은 [!UICONTROL Size] 섹션 아래의 [!UICONTROL Properties] 패널에 있습니다. 사용자는 요소의 너비와 높이를 직접 조정할 수 있습니다. 고급 설정에는 다음이 포함됩니다.
...
**이동**: [!UICONTROL Move] 옵션은 [!UICONTROL Position] 섹션 아래의 [!UICONTROL Properties] 패널에 있습니다. 이 옵션을 사용하면 다음과 같은 작업을 수행할 수 있습니다.
...
## [!UICONTROL Design] 패널을 확대할 수 있도록 [!UICONTROL Components], [!UICONTROL Modifications] 및 [!UICONTROL Properties] 레일을 축소할 수 있습니까? {#collapse}
...
[!UICONTROL Components] 레일이 열려 있는 동안 [!UICONTROL Components] 레일을 축소하고 [!UICONTROL Design] 캔버스를 확대하려면 (![구성 요소 표시 아이콘](/help/main/assets/icons/Add.svg)) 아이콘을 클릭합니다.

**[!UICONTROL Modifications] 레일 축소**

[!UICONTROL Modifications] 레일이 열려 있는 동안 [!UICONTROL Modifications] 레일을 축소하고 [!UICONTROL Design] 캔버스를 확대하려면 [!UICONTROL Show Modifications] 아이콘(![수정 사항 레일 표시](/help/main/assets/icons/History.svg)) 아이콘을 클릭합니다.
...
+++세부 사항
사용자 인터페이스에 대한 최신 업데이트를 통해 [!UICONTROL Save as Draft] 및 [!UICONTROL Syncing] 상태를 더 이상 사용할 수 없습니다. 자세한 내용은 *[!UICONTROL Activities overview]*&#x200B;의 [활동 목록에 필터 적용](/help/main/c-activities/activities.md#filters) 아래의 상태를 참조하십시오.
