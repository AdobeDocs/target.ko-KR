...
자세한 내용은 [Target으로 데이터를 가져오는 방법](https://developer.adobe.com/target/before-implement/methods-to-get-data-into-target/methods-to-get-data-into-target/) 을 참조하십시오.
