...
>
>해결 방법 설정에 대해서는 아래의 [대상자 특성 [!UICONTROL 브라우저]의  [!DNL iPad] 및 [!DNL iPhone] 업데이트(2024년 4월 30일)](#updates)를 참조하십시오.
...
* **사용자 지정된 브라우저 대상 규칙:** 사용자 지정된 대상을 사용하면 여러 브라우저를 대상으로 하거나 특정 브라우저, 브라우저 버전 또는 브라우저 언어에 대한 규칙 또는 제외를 설정할 수 있습니다. 이 기능은 브라우저 속성을 기반으로 활동을 타깃팅할 때 상당한 유연성을 제공합니다.
   ...
   1. **[!UICONTROL 브라우저]**&#x200B;를 대상 빌더로 끌어서 놓습니다.
...
* [!UICONTROL 같음]: 선택한 브라우저 언어를 타깃팅합니다.
...
## [!UICONTROL 브라우저] 대상 특성의 [!DNL iPad] 및 [!DNL iPhone] 업데이트(2024년 4월 30일) {#updates}
...
* **브라우저 일치 항목[!DNL Apple]**: [!UICONTROL 모바일] > [!UICONTROL 장치 공급업체] [!UICONTROL 일치 항목] [!DNL Apple]

  ![Apple](/help/main/r-release-notes/assets/apple.png)

* **브라우저가 태블릿과 일치함**: [!UICONTROL 모바일] > [!UICONTROL 태블릿임] > [!UICONTROL 참]

  ![모바일이 태블릿입니다](/help/main/r-release-notes/assets/is-tablet.png)

* **브라우저가 iPad과 일치함**: [!UICONTROL 모바일] > [!UICONTROL 장치 마케팅 이름] [!UICONTROL 일치] [!DNL iPad] 및 컨테이너가 [!UICONTROL 모바일] > [!UICONTROL 태블릿임]인 [!DNL true]

  ![iPad](/help/main/r-release-notes/assets/ipad.png)

* **브라우저가 iPhone과 일치함**: [!UICONTROL 모바일] > [!UICONTROL 장치 마케팅 이름] [!UICONTROL 일치] [!DNL iPhone] 및 컨테이너는 [!UICONTROL 모바일] > [!UICONTROL 휴대폰임]이 [!DNL true]입니다.

  ![iPhone](/help/main/r-release-notes/assets/iphone.png)

조건이 무효화된 경우 등 사용할 수 있는 다른 가능한 설정이 많이 있습니다. 무효화된 조건의 예는 다음과 같습니다.

* **브라우저가 iPhone과 일치하지 않음**: [!UICONTROL 모바일] > [!UICONTROL 장치 공급업체] [!UICONTROL 이(가) 일치하지 않음] [!UICONTROL Apple] 및 [!UICONTROL 모바일] > [!UICONTROL 휴대폰입니다]이(가) [!UICONTROL false]입니다.

  ![휴대폰이 아님](/help/main/r-release-notes/assets/mobile-phone-false.png)

* **브라우저가 iPad과 일치하지 않음**: [!UICONTROL 모바일] > [!UICONTROL 장치 공급업체] [!UICONTROL 이(가) [!UICONTROL 모바일] > [!UICONTROL 태블릿임]이(가) 포함된 Or 컨테이너와 ] [!UICONTROL Apple]이(가) 일치하지 않습니다[!UICONTROL false].
