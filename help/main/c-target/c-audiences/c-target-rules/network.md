...
description: 에서 대상자를 만드는 방법을 알아봅니다. [!DNL Adobe Target] 네트워크 세부 사항을 기반으로 합니다.
title: 네트워크 옵션에 따라 방문자를 Target 할 수 있습니까?
feature: Audiences
...
에서 대상을 만들 수 있습니다. [!DNL Adobe Target] isp, 도메인 이름 및 연결 속도 등 네트워크 세부 사항을 기반으로 합니다.

1. [!DNL Target] 인터페이스에서 **[!UICONTROL 대상자]** > **[!UICONTROL 대상자 만들기]**&#x200B;를 클릭합니다.
1. 대상자의 이름을 지정하고 선택적 설명을 추가합니다.
1. 드래그 앤 드롭 **[!UICONTROL 네트워크]** 대상 빌더 창으로 이동합니다.
1. **[!UICONTROL 선택]**&#x200B;을 클릭한 후, 다음 선택 사항 중 하나를 선택합니다.
   ...
   * **도메인 이름:** 이 이름은 방문자 IP 주소의 도메인 이름입니다. 이 이름은 사용 중인 웹 사이트의 도메인 이름이 아닙니다. [!DNL Target]. 이 도메인 이름은 방문자의 IP 주소와 관련되며 때로는 호스트 이름이라고도 합니다. ISP 이름과 유사합니다. 호스트 이름이 도메인 이름이 아니라, ISP 이름을 새로이 브랜딩한 회사의 이전 이름을 참조하는 경우도 있습니다.
