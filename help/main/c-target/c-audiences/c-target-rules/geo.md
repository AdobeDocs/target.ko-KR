...
1. **[!UICONTROL 지역]**&#x200B;을(를) 대상 빌더 창으로 끌어다 놓습니다.
...
1. **[!UICONTROL 선택]**&#x200B;을 클릭한 후, 다음 선택 사항 중 하나를 선택합니다.
   ...
   * [!UICONTROL 이동통신사]
   ...
   [!UICONTROL 이동통신사]의 경우 [!DNL Target]은(는) IP 주소 등록 데이터(IP 주소 블록을 소유하는 사용자)를 사용하여 [모바일 국가 코드(MCC) 및 모바일 네트워크 코드(MNC)](https://www.mcc-mnc.com)를 사용하는 적절한 이동통신사를 결정합니다.
...
* **at.js 1.*x***: 다른 위치의 IP 주소로 IP 주소를 재정의하고 `mboxOverride.browserIp url` 매개 변수를 사용할 수 있습니다. 예를 들어 회사가 영국에 있지만 글로벌 캠페인 타겟이 뉴질랜드의 오클랜드에 있는 방문자인 경우, `60.234.0.39`이(가) 오클랜드의 IP 주소라고 가정하고 다음과 같은 스타일의 URL을 사용하십시오.
  ...
  >[!NOTE]
  >
  >`mboxOverride.browserIp`은(는) at.js 1.*x*&#x200B;에서만 지원됩니다. 이 기능은 at.js 2.*x*&#x200B;에서 지원되지 않습니다.

* **at.js 2.*x***: IP 주소를 at.js 2.*x*로 재정의하려면 브라우저 확장/플러그인(예: Chrome 또는 Firefox용 X-Forwarded-For Header)을 설치하십시오. 이 확장을 사용하면 페이지 요청에 x-forwarded-for 헤더를 전달할 수 있습니다.
