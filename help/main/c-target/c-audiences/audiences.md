...
* [!UICONTROL 대상] 목록에서 재사용 가능한 대상 선택
...
[!DNL Target] 및 다른 [!DNL Adobe Experience Cloud] 응용 프로그램에서 실시간 타깃팅 및 개인화에 [!DNL Adobe Analytics]이(가) 수집한 대상 데이터를 사용할 수도 있습니다. *Experience Cloud 중앙 인터페이스 구성 요소* 안내서의 [Experience Cloud 대상](https://experienceleague.adobe.com/docs/core-services/interface/audiences/audience-library.html?lang=ko-KR)을 참조하십시오.
...
&quot;[!UICONTROL 새 방문자]&quot; 및 &quot;[!UICONTROL 재방문자]&quot;과 같이 미리 정의된 대상의 이름을 바꿀 수 없습니다.
...
* 대상자가 [!DNL Experience Cloud] 또는 [!DNL Adobe Experience Platform]에서 삭제된 경우 [!UICONTROL 대상자] 목록과 대상자 선택기에 모두 경고 아이콘이 표시됩니다. [!DNL Target] UI의 도구 설명은 대상자가 [!DNL Experience Cloud] 또는 [!DNL Adobe Experience Platform]에서 삭제되었음을 나타냅니다.
...
[!UICONTROL 필터] 단추를 사용하여 [!UICONTROL 대상] 목록을 소스: [!DNL Adobe Target], [!DNL Adobe Target Classic], [!DNL Experience Cloud] 및 [!DNL Adobe Experience Platform]별로 필터링하십시오.

[!UICONTROL 대상자] 목록의 ![필터 옵션](assets/filters.png)

[!UICONTROL 대상자 검색] 상자를 사용하여 [!UICONTROL 대상자] 목록을 검색합니다. 대상 이름의 일부를 검색하거나 특정 문자열을 따옴표로 묶을 수 있습니다.

대상 이름이나 마지막 수정 날짜별로 [!UICONTROL 대상자] 목록을 정렬할 수 있습니다. 이름이나 날짜별로 정렬하려면 열 헤더를 클릭한 다음, 대상자를 오름차순이나 내림차순으로 표시하도록 선택하십시오.
...
예를 들어 다음 대상 정의 카드는 원하는 대상의 [!UICONTROL 세부 정보 보기] 아이콘을 클릭하여 액세스합니다.
...
대상 정의 카드는 대상의 유형, 소스 및 속성을 보여 줍니다. 해당되는 경우 해당 대상을 참조하는 다른 활동을 보려면 **[!UICONTROL 전체 세부 정보 보기]**&#x200B;를 클릭하십시오. 활동의 [!UICONTROL 개요] 페이지에서 대상 정의 카드를 보는 경우 **[!UICONTROL 대상 사용량]**&#x200B;을 클릭하세요.

대상 사용 정보는 대상을 편집하는 동안 다른 활동에 실수로 영향을 주지 않도록 하는 데 도움이 될 수 있습니다. 정보에는 [!UICONTROL 라이브 활동], [!UICONTROL 비활성 활동], [!UICONTROL 보관된 활동] 및 [!UICONTROL 활동 동기화]가 포함됩니다. 이 기능은 모든 대상(라이브러리 대상 및 [활동 전용 대상](/help/main/c-target/creating-activity-only-audience.md#concept_A6BADCF530ED4AE1852E677FEBE68483))에 사용할 수 있습니다.
