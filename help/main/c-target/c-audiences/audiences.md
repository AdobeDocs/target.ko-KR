...
[!DNL Target] 및 다른 [!DNL Adobe Experience Cloud] 응용 프로그램에서 실시간 타깃팅 및 개인화에 [!DNL Adobe Analytics]이(가) 수집한 대상 데이터를 사용할 수도 있습니다. *Experience Cloud 중앙 인터페이스 구성 요소* 안내서에서 [Experience Cloud 대상](https://experienceleague.adobe.com/docs/core-services/interface/audiences/audience-library.html?lang=ko-KR)을 참조하십시오.
...
* [!DNL Adobe Experience Platform]
  ...
  >
  >AEP/RTCDP([!DNL Real-time Customer Data Platform])에서 [!DNL Target] [!UICONTROL Destinations] 카드를 구성하려면 [!DNL Target]에서 사용자가 [!UICONTROL Approver] 이상 상태여야 합니다.
  >
