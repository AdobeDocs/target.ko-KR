...
description: 에서 대상 필터를 사용하는 방법을 알아봅니다. [!DNL Adobe Target] 특성을 공유하는 방문자의 데이터를 보려면
...
* **방문자는 여러 대상에 있을 수 있습니다.** 설정된 대상(예: &quot;새 방문자&quot; 및 &quot;Google의 방문자&quot;)이 둘 다 있고 한 사람이 두 기준을 모두 충족하면 이 방문자가 계산되고 두 대상에서 추적됩니다. 따라서 대상에 있는 방문자의 합계는 활동에 있는 방문자의 수와 일치하지 않습니다.
