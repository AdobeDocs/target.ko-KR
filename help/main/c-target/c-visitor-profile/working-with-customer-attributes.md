...
다음 각 작업을 완료하기 위한 자세한 지침은 *Experience Cloud 서비스 및 관리 설명서*&#x200B;의 [고객 특성 소스를 만들고 데이터 파일 업로드](https://experienceleague.adobe.com/docs/core-services/interface/services/customer-attributes/t-crs-usecase.html)에서 찾을 수 있습니다.
