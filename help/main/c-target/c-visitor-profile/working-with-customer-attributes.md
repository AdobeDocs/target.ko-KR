...
다음 각 작업을 완료하기 위한 자세한 지침은 *Experience Cloud 인터페이스 및 관리* 안내서의 [고객 특성 소스 만들기 및 데이터 파일 업로드](https://experienceleague.adobe.com/docs/core-services/interface/services/customer-attributes/t-crs-usecase.html?lang=ko)에서 찾을 수 있습니다.
...
Experience Cloud ID 서비스를 사용하는 경우 타깃팅에서 고객 속성을 사용하려면 고객 ID 및 인증 상태를 설정해야 합니다. 자세한 내용은 *Experience Cloud ID 서비스* 안내서의 [고객 ID 및 인증 상태](https://experienceleague.adobe.com/docs/id-service/using/reference/authenticated-state.html?lang=ko)를 참조하십시오.

[!DNL Target]에서 고객 특성을 사용하는 방법에 대한 자세한 내용은 다음 리소스를 참조하십시오.

* *Experience Cloud 인터페이스 및 관리* 안내서에서 [고객 특성 데이터를 만들고 업로드](https://experienceleague.adobe.com/docs/core-services/interface/customer-attributes/t-crs-usecase.html?lang=ko)
