...
description: 각 요소 및 각 오퍼의 성과를 보여 주는 Adobe [!DNL Target] [!UICONTROL 경험 타깃팅] 활동에 대한 위치 기여도 보고서를 사용하는 방법에 대해 알아봅니다.
...
>[!NOTE]
>
>[!UICONTROL 위치 기여도] 보고서를 사용할 때는 다음 정보를 참고하십시오.
>
>* 대상 및 지표 선택기는 [!DNL Analytics]이(가) 보고 소스로 사용(A4T)되는 경우에만 사용할 수 있습니다.
>
>* 활동이 [!UICONTROL Analytics를 보고 소스로 사용]&#x200B;(A4T)하도록 구성된 경우에도 [!UICONTROL 위치 기여도] 보고서에 대한 데이터를 [!DNL Target] 백엔드에서 가져옵니다.
>
>* [!DNL Target] 계정 수준에서 다른 기본 환경이 정의된 경우에도 &quot;프로덕션&quot; 환경에 대해 [!UICONTROL 위치 기여도] 보고서의 데이터를 가져옵니다.

[!UICONTROL 위치 기여도] 보고서에 두 개의 테이블이 포함되어 있습니다.
