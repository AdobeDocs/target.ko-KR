...
1. **[!UICONTROL Target 사전 설정]** 옆에 있는 **[!UICONTROL 추가 옵션]**(![추가 옵션 아이콘](/help/main/assets/icons/MoreSmallListVert.svg) ) 아이콘 > **[!UICONTROL 새 이름으로 저장]**&#x200B;을 클릭합니다.

   [!UICONTROL 사전 설정 만들기] 대화 상자가 표시됩니다.

   ![새 사전 설정 대화 상자](/help/main/c-reports/c-report-settings/assets/report_preset_dialog-new.png)

1. **[!UICONTROL 필터]** 섹션의 정보를 검토하여 보고서가 원하는 대로 구성되었는지 확인한 다음 **[!UICONTROL 사전 설정 이름]**(최대 50자)을 지정하십시오.
1. (조건부) 기본/즐겨 찾는 보고서 보기로 설정하려면 **[!UICONTROL 기본 사전 설정으로 설정]** 토글을 [켜기] 위치로 밉니다.
...
1. 보고서의 구성을 원하는 대로 편집합니다(지표, 날짜 범위, 대상, 고급 설정 등).
   ...
   보고서의 구성을 편집한 후 [!UICONTROL 저장]을 클릭하면 사전 설정 이름 뒤에 별표(&#42;)가 표시되어 사전 설정이 변경되었음을 나타냅니다.

1. 새 사전 설정을 만들려면 **[!UICONTROL 추가 옵션]**( ![추가 옵션 아이콘](/help/main/assets/icons/MoreSmallListVert.svg) ) 아이콘 > **[!UICONTROL 새 이름으로 저장]**&#x200B;을 클릭하십시오.

### 사전 설정 삭제

1. 삭제할 사전 설정을 선택합니다.
1. **[!UICONTROL 추가 옵션]**( ![추가 옵션 아이콘](/help/main/assets/icons/MoreSmallListVert.svg) ) 아이콘 > **[!UICONTROL 삭제]**&#x200B;를 클릭합니다.
...
## [!UICONTROL 보고서 지표] {#section_894ABD7148244806B7CE556EBBA2AD62}

**[!UICONTROL 보고서 지표]** 드롭다운 목록을 클릭하면 다른 [성공 지표](/help/main/c-activities/r-success-metrics/success-metrics.md#reference_D011575C85DA48E989A244593D9B9924) 또는 여러 지표를 선택하여 그래프 및 차트로 표시할 수 있습니다.
...
## [!UICONTROL 대상자] {#section_70926EB4618945D9AFF2B0564FF3717B}

보고서에 대해 표시된 대상을 변경하려면 **[!UICONTROL 대상]** 드롭다운 목록을 클릭하십시오.

자세한 내용은 [대상자](/help/main/c-target/target.md#concept_A782F8481A5041EBA75103CB26376522)를 참조하십시오.

## [!UICONTROL 날짜 범위 미리 설정]

**[!UICONTROL 사전 설정된 날짜 범위]** 드롭다운 목록을 클릭하여 사전 설정된 날짜 범위 중에서 선택합니다.

보고서에 대한 새로운 **[!UICONTROL 시작]** 및 **[!UICONTROL 종료]** 날짜를 선택하십시오. **[!UICONTROL 활동 시작]** 및 **[!UICONTROL 활동 시작 - 활동 종료]** 범위를 사용할 수도 있습니다.
...
[!UICONTROL 날짜 범위] 상자에 보고서의 현재 날짜 범위가 표시됩니다. **[!UICONTROL 달력]**( ![달력 아이콘](/help/main/assets/icons/Calendar.svg)) 아이콘을 클릭하여 보고서의 날짜 범위를 변경할 수 있는 달력을 표시합니다.

## 설정의 지침을 완료하여 이 설정을 변경할 수 있습니다 {#section_D99CE462107D45CABE0960F820E1E972}

보고서 설정을 구성하려면:

1. **[!UICONTROL 보고서 설정]**( ![보고서 설정 아이콘](/help/main/assets/icons/Setting.svg) ) 아이콘을 클릭하고 원하는 대로 변경합니다(아래 설명).
...
[!UICONTROL 보고서 데이터 재설정]을 클릭합니다. 이전 데이터를 제거하려면 보고 데이터를 재설정하십시오. 현재 방문자는 활동에 남아 있습니다.  이 옵션은 [!UICONTROL 승인자] 권한이 있는 사용자만 사용할 수 있습니다.
...
[!UICONTROL 예외적인 값 제외] 토글은 수입 및 거래 지표 유형이 있는 활동에만 적용됩니다. 자세한 내용은 [예외적인 주문 제외](/help/main/c-reports/c-report-settings/excluding-extreme-orders.md#task_2AE7743FFCDD466DAEEB720BE5F33DAA)를 참조하십시오.

## 다운로드 {#section_77E65C50BAAF4AB79242DB3A8778ADEF}

**[!UICONTROL 다운로드]**( ![다운로드 아이콘](/help/main/assets/icons/Download.svg)) 아이콘을 클릭하여 보고서 데이터를 [!DNL .csv] 형식으로 다운로드하면 Excel, Access 또는 기타 데이터 분석 프로그램으로 빠르게 가져올 수 있습니다.
...
전체 페이지, 페이지 구성 또는 날짜 범위를 새로 고치지 않고 보고서의 테이블 및 그래프 보기를 새로 고치려면 **[!UICONTROL 새로 고침]** ( ![새로 고침 아이콘](/help/main/assets/icons/Refresh.svg) ) 아이콘을 클릭하십시오.

## 추가 옵션 {#section_AB1B5C695D7045A0A0AC0E2698D2E7DE}

[!UICONTROL 다른 이름으로 저장] 및 [!UICONTROL 삭제] 옵션에 액세스하려면 **[!UICONTROL 추가 옵션]** 아이콘(![추가 옵션 아이콘](/help/main/assets/icons/MoreSmallListVert.svg))을 클릭하십시오.
...
* [!UICONTROL 테이블 보기]에서 보고서를 볼 때만 사용할 수 있습니다.
...
MVT(다변량 테스트) 활동에 대한 위치별 기여도를 표시하도록 보고서를 전환하려면 [[!UICONTROL 위치 기여도]](/help/main/c-reports/multivariate-test-reports/location-contribution-report.md)( ![위치 기여도 아이콘](/help/main/assets/icons/LocationContribution.svg)) 아이콘을 클릭하십시오.

## 경험 {#section_3A450DE1FA7E43F0AAB73165EC3D1C34}

[!UICONTROL 그래프 보기]에서 보고서를 볼 때만 사용할 수 있습니다.
...
보고서에서 그래프에 대한 계산 방법론을 선택할 수 있습니다. AP([!UICONTROL Automated Personalization]) 활동에는 지원되지 않습니다.

그래프 모드에서 보고서를 보는 동안 [!UICONTROL 계산 방법] 옵션에 액세스하려면 **[!UICONTROL 기본 목표]** 드롭다운을 클릭한 다음 계산 방법을 선택하십시오.
...
[!UICONTROL 자동 타겟] 활동에 대한 네 가지 모드는 [!UICONTROL 일별 제어], [!UICONTROL 일별 타깃팅], [!UICONTROL 누적 제어] 및 [!UICONTROL 누적 타깃팅]입니다.
...
* [[!UICONTROL 자동 타겟] 활동](/help/main/c-activities/auto-target/auto-target-to-optimize.md)의 경우 계산 방법으로 &quot;방문자&quot;를 선택할 수 있는 옵션이 없습니다. [!UICONTROL 자동 타겟]은(는) 방문자가 플롯할 수 없는 유일한 활동 유형입니다.
