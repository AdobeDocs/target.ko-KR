...
이 문서에서는 [!DNL Adobe Target]의 수동 A/Bn 테스트에 사용된 자세한 통계 계산을 문서화합니다. [!UICONTROL 전환율], [!UICONTROL 전환율의 신뢰 구간], [!UICONTROL 상승도], [!UICONTROL 상승도에 대한 신뢰 구간] 및 [!UICONTROL 신뢰도]에 대한 정의가 제공됩니다.
