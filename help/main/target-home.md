...
**마지막 업데이트 일자: 2022년 11월 28일 ([변경 사항 보기](r-release-notes/doc-change.md))**
...
- [Adobe Target 개발자 안내서](https://developer.adobe.com/target/){target=_blank}: 이 포털은 [!DNL Target]을 구현하기 위한 API 및 SDK 설명서를 포함하여 [!DNL Adobe Target] 개발자를 위한 리소스 및 안내서를 제공합니다.
