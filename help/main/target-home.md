...
**마지막 업데이트 날짜: 2025년 11월 14일([변경 사항 보기](r-release-notes/doc-change.md) )**
...
UI는 명확성과 효율성을 위해 설계되어 [!DNL Target]을(를) 최대한 활용할 수 있습니다. 자세한 문서 및 단계별 지침에 대한 직접 링크를 통해 빠르게 시작하는 데 도움이 되는 리소스를 살펴보십시오.
