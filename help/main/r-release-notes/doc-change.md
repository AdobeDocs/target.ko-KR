...
|  | [ 개발자 안내서](https://experienceleague.corp.adobe.com/docs/target-dev/developer/api/delivery-api/overview.html){target=_blank}의 *[!DNL Target]배달 API 개요* | 중요한 참고가 추가되었습니다. |
