...
| 10월 28일 | [허용 목록 [!DNL Target] 에지 노드}](https://experienceleague.adobe.com/en/docs/target-dev/developer/implementation/privacy/allowlist-edges){target=_blank} | 허용 목록에 추가하다 IP 주소를 업데이트 할 수 있습니다. |
