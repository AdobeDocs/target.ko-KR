...
| 날짜 | 주제 | 변경 사항 |
|--- |--- |--- |
| 6월 16일 | [Adobe Target 쿠키](https://experienceleague.adobe.com/en/docs/core-services/interface/data-collection/cookies/target){target=_blank} | `sessionId`에 중괄호({})를 포함할 수 없도록 추가하는 텍스트가 업데이트되었습니다.<P>이제 텍스트 읽기: 세션 ID는 공백, 물음표( ? ), 중괄호( { } ) 또는 슬래시( / )를 사용할 수 있습니다. 길이는 1~128자 사이여야 합니다. |
