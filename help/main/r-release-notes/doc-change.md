...
|  | *[!DNL Target]개발자 안내서*&#x200B;에서 [권장 사항 계획 및 구현](https://experienceleague.adobe.com/en/docs/target-dev/developer/recommendations#set-up-your-recommendations-catalog){target=_blank} | [!DNL Target Delivery API]을(를) 통해 [!DNL Recommendations] [!UICONTROL Catalogs]을(를) 업데이트할 때 주의하는 방법에 대한 메모를 추가했습니다. |
