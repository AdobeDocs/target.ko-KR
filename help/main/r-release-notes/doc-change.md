...
|  | [ 개발자 안내서](https://experienceleague.corp.adobe.com/docs/target-dev/developer/api/delivery-api/overview.html){target=_blank}의 *[!DNL Target]배달 API 개요* | [!DNL Recommendations]을(를) 통해 [!UICONTROL Catalogs] [!DNL Target Delivery API]을(를) 업데이트할 때 주의하는 방법에 대한 정보를 추가했습니다. |
