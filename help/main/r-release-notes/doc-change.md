...
| 날짜 | 주제 | 변경 사항 |
|--- |--- |--- |
| 7월 7일 | [[!DNL Target] 릴리스 정보 (프리릴리스)](/help/main/r-release-notes/target-release-notes.md) | [!DNL Target Standard/Premium] 25.7.1 릴리스에 대한 프리릴리스 정보가 추가되었습니다. |
...
| 6월 17일 | [[!DNL Target] 릴리스 정보 (현재)](/help/main/r-release-notes/release-notes.md) | [!DNL Target] 팀이 UI 버전 전환 사용 중단에 대한 타임라인을 조정했습니다.<P>자세한 내용은 [업데이트됨: [!DNL Target] UI 버전 전환 사용 중단(2025년 6월 17일)](/help/main/r-release-notes/release-notes.md)을 참조하십시오. |
