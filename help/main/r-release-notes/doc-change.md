...
| 날짜 | 주제 | 변경 사항 |
| --- | --- | --- |
| 2월 23일 | [Target이 at.js 2.*x*&#x200B;에서 Platform Web SDK](https://experienceleague.adobe.com/docs/platform-learn/migrate-target-to-websdk/introduction.html){target=_blank}로 마이그레이션되었습니다. | 새 튜토리얼이 추가되었습니다. |
