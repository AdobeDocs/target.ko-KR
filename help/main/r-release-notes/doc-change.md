...
| 날짜 | 주제 | 변경 사항 |
| --- | --- | --- |
| 2월 21일 | [Target Edge 노드를 허용 목록에 추가](https://experienceleague.adobe.com/docs/target-dev/developer/implementation/privacy/allowlist-edges.html?lang=ko-KR){target=_blank} | IP 주소 목록이 [Adobe Target 개발자 안내서](https://experienceleague.adobe.com/docs/target-dev/developer/overview.html?lang=ko-KR)에 있는 모든 지역에 대한 허용 목록으로 업데이트되었습니다{target=_blank}. |
