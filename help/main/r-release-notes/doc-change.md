...
| 날짜 | 주제 | 변경 사항 |
|--- |--- |--- |
| 9월 19일 | [ 대상 가이드의 ](https://experienceleague.adobe.com/ko/docs/experience-platform/destinations/catalog/personalization/adobe-target-connection){target=_blank}Adobe Target 연결[!DNL Adobe Experience]. | 다음 참고 정보를 업데이트했습니다. *조직 전체의 데이터 스트림 고유성*. |
