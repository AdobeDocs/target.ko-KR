...
| 날짜 | 주제 | 변경 사항 |
|--- |--- |--- |
| 8월 4일 | [[!DNL Target] UI 업데이트 FAQ](/help/main/c-intro/updated-ui-faq.md#options) | FAQ: &quot;업데이트된 VEC는 어떻게 재배열, 크기 조정, 이동, 숨기기 및 제거 옵션을 처리하며 이러한 옵션은 이전 VEC와 어떻게 다릅니까?&quot;가 추가되었습니다. |
