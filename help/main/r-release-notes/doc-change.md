...
| 날짜 | 주제 | 변경 사항 |
|--- |--- |--- |
| 8월 27일 | [[!DNL Target] 릴리스 정보 (프리릴리스)](/help/main/r-release-notes/target-release-notes.md) | [!DNL Target] 25.8.4 릴리스(2025년 8월 28일)에 대한 프리릴리스 정보가 업데이트되었습니다. 릴리스 날짜, 기능 및 기타 정보는 예고 없이 변경될 수 있습니다. 이 문서의 정보는 특히 릴리스 전에 자주 업데이트됩니다. |
|  | 시각적 경험 작성기에 사용된 요소 선택기 | &quot;[!UICONTROL Use preferred selectors]&quot; 옵션을 추가했습니다. |
