...
| 10월 28일 | [허용 목록 [!DNL Target] 에지 노드&rbrace;](https://experienceleague.adobe.com/ko/docs/target-dev/developer/implementation/privacy/allowlist-edges){target=_blank} | 허용 목록에 추가하다 IP 주소를 업데이트 할 수 있습니다. |
...
| 9월 19일 | [&#x200B; 대상 가이드의 &#x200B;](https://experienceleague.adobe.com/ko/docs/experience-platform/destinations/catalog/personalization/adobe-target-connection){target=_blank}Adobe Target 연결[!DNL Adobe Experience Platform]. | 다음 참고 정보를 업데이트했습니다. *조직 전체의 데이터 스트림 고유성*. |
...
|  | [&#x200B; 개발자 안내서](https://experienceleague.adobe.com/ko/docs/target-dev/developer/recommendations#set-up-your-recommendations-catalog){target=_blank}에서 *[!DNL Target]권장 사항 계획 및 구현* | [!DNL Recommendations]을(를) 통해 [!UICONTROL Catalogs] [!DNL Target Delivery API]을(를) 업데이트할 때 주의하는 방법에 대한 메모를 추가했습니다. |
...
|  | [&#x200B; 개발자 안내서](https://experienceleague.adobe.com/ko/docs/target-dev/developer/api/profile-apis/profile-bulk-api){target=_blank}의 *[!DNL Target]Adobe Target 벌크 프로필 업데이트 API* | 사용할 API 버전에 대한 메모를 업데이트합니다. |
...
|  | [활동 편집](/help/main/c-activities/edit-activity.md) | 다음과 같이 편집했습니다.<UL><li>임시 오퍼의 경우 올바른 형식이 *임을 나타내기 위해*&#x200B;대상 및 오퍼`<Entity Name>` 섹션을 편집했습니다.</li><li>결합된 대상에 대한 정보를 제거하기 위해 *대상 및 오퍼* 섹션을 편집했습니다.</li></ul> |
...
| 7월 21일 | [[!DNL Target] UI 업데이트 FAQ](/help/main/c-intro/updated-ui-faq.md#collapse) | 새 FAQ 추가: [!UICONTROL Components] 패널을 확대할 수 있도록 [!UICONTROL Modifications], [!UICONTROL Properties] 및 [!UICONTROL Design] 레일을 축소할 수 있습니까? |
...
| 7월 17일 | [성공 지표](/help/main/c-activities/r-success-metrics/success-metrics.md) | 다음과 같이 변경되었습니다.<ul><li>[!UICONTROL Revenue] 아래의 [!UICONTROL Overview] 행을 업데이트했습니다.</li><li>새 섹션 추가: [!UICONTROL Revenue] 성공 지표와 관련된 UI 변경 사항입니다.</li></ul> |
...
| 날짜 | 주제 | 변경 사항 |
|--- |--- |--- |
| 3월 31일 | [at.js 버전 세부 사항](https://experienceleague.adobe.com/ko/docs/target-dev/developer/client-side/at-js-implementation/target-atjs-versions){target=_blank} | at.js 2.11.8 릴리스에 대한 정보가 추가되었습니다. |
...
|  | [at.js 버전 세부 사항](https://experienceleague.adobe.com/ko/docs/target-dev/developer/client-side/at-js-implementation/target-atjs-versions){target=_blank} | at.js 버전 2.11.7(2025년 2월 26일)에 대한 정보가 추가되었습니다. |
