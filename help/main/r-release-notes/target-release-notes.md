...
+++세부 정보 보기
* **Recommendations UI에서 사용자 지정 기준 CSV 다운로드가 404 오류를 반환한 문제가 해결되었습니다[!DNL]: 고객이 활동 만들기 프로세스에서 사용자 지정 기준 CSV를 다운로드할 수 없는 문제가 해결되었습니다.** 이제 다운로드 링크가 제대로 작동하여 고객이 예상대로 사용자 지정 기준을 내보낼 수 있습니다. (TGT-51966)
