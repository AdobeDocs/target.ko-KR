...
이 릴리스는 다음의 서로 다른 일정에 따라 사용할 수 있습니다.
...
* 사용자가 다음을 제거할 수 있도록 UI가 개선되었습니다. [!UICONTROL 기본 URL] 아래에 [!UICONTROL 관리] > [!UICONTROL 시각적 경험 작성기] > [!UICONTROL 기본 URL]. 이 변경을 통해 고객은 기본 URL을 빈 문자열로 다시 변경할 수 있게 되었습니다(이전에는 초기 구성 이후 변경할 수 없었음). (TGT-44577)
...
* POST 요청이 [!DNL Recommendations] 을 사용할 때 피드가 실패합니다 [!UICONTROL Analytics 분류] 이름에 점이 있는 보고서 세트 포함. (TGT-44598)
...
| 리소스 | 세부 사항 |
|--- |--- |
| [Adobe 우선순위 제품 업데이트](https://www.adobe.com/kr/subscription/priority-product-update.html){target=_blank} | 에 예정된 제품 개선 사항에 대한 사전 알림을 받을 수 있습니다. [!DNL Target] 및 기타 [!DNL Adobe Experience Cloud] 솔루션. |
| [Target 릴리스 노트 - 사전 릴리스](/help/main/r-release-notes/target-release-notes.md){target=_blank} | 사전 릴리스 정보를 포함하여 이번 달 Target 릴리스에 대한 정보입니다. |
