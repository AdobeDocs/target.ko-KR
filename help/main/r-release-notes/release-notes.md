...
## [!DNL Target Standard/Premium] 26.4.3 (2026년 4월 9일 금요일)

**활동**

+++세부 정보 보기

* 일부 활동에서 **위치가 누락되었습니다.** 일부 활동에서 **[!UICONTROL Location]**&#x200B;이(가) 누락된 문제를 해결했습니다. (TGT-54951)

* **보고 지표 열 순서.** 업데이트된 [!DNL Target] 인터페이스를 사용하면 전체 선택을 지우고 순차적으로 지표를 다시 추가하지 않고 보고 지표의 순서를 변경할 수 있습니다. 이전에는 사용자가 모든 지표를 선택 취소하고 원하는 순서로 다시 선택해야 했습니다. 이전에는 많은 지표가 활성화되어 있을 때와 열 배치를 조정하여 수평 스크롤을 제한할 때 시간이 오래 걸렸습니다. (TGT-53044)
...
## [!DNL Target Standard/Premium] 26.4.2 (2026년 4월 7일 수요일)

**활동**

+++세부 정보 보기

* **추가 보기에 적용할 때 사용자 지정 코드가 유지됩니다.** 동일한 **[!UICONTROL View]**&#x200B;에서 다른 **[!UICONTROL View]**&#x200B;에 대한 사용자 지정 코드를 추가하거나 저장할 때 하나의 **[!UICONTROL Activity]**&#x200B;에 적용된 사용자 지정 코드가 제거될 수 있는 문제를 해결했습니다. (TGT-53933)
+++
