...
[!DNL Target] 커피 브레이크 세션, [!DNL Target] 웨비나 시리즈, [!DNL Target] 스킬 빌더 세션, 개발자 채팅 등을 포함하여 예정된 [!DNL Adobe Target] 이벤트에 대한 공지 사항 및 정보입니다. 사용 가능한 경우 이전 녹화분에 대한 링크가 포함됩니다.
...
[!DNL Adobe Target]의 수석 제품 관리자인 Cristinel Anastasoaie가 [!DNL Adobe Target] 웨비나 “[AI 기반 개인화 및 권장 사항](#AI)”과 관련된 여러분의 질문에 답해 드릴 예정입니다.

웨비나 녹화본을 검토한 후 후속 질문을 준비하여 여러분 고유의 사용 사례에 대한 포괄적인 통찰력, 심층적인 설명 및 전략적 제안을 확인해 보십시오.

* 실시간 추천 최적화, 원클릭 개인화 활동 및 자동화된 오퍼
* [!UICONTROL 시각적 경험 작성기](VEC)를 사용하여 AI 기반 개인화 활동 만들기 및 실행
* 실시간 세그먼트 및 프로필 속성 공유를 위해 [!DNL Adobe Experience Platform](AEP)와 통합

[!DNL Adobe] 기술 지원 엔지니어인 Simon Chen이 여러분의 질문에 대한 추가적인 통찰력과 답변을 제공할 예정입니다.
...
* [녹화 링크](https://video.tv.adobe.com/v/3410117){target=_blank}
   ...
   * [!UICONTROL 자동화된 개인화] 및 [!UICONTROL 자동 타겟] 활동의 향상된 모델 제어
