...
* [녹화 링크](https://video.tv.adobe.com/v/347360){target=_blank}
   ...
   * [!UICONTROL A/B 테스트], [!UICONTROL Multivariate Testing] (MVT), (XT) 및 자동화된 테스트 및 개인화
   * 활동 설정을 위한 단계별 워크플로우
   * 모바일용 항상 켜짐 개인화를 활성화하는 배치 경험 미리 가져오기
   * 고객 경험에서 테스트 및 타깃팅을 위한 라이프사이클 지표
...
* **[웨비나 녹화를 보기 위해 등록](https://real-time-loyalty-activation.dxfieldmarketing.adobeevents.com/){target=_blank}**
