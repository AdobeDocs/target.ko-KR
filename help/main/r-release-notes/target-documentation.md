...
| [서버측 게재 API](https://experienceleague.corp.adobe.com/docs/target-dev/developer/server-side/server-side-overview.html){target=_blank} | Adobe Target 게재 API를 구성하는 리소스에 대한 정보입니다. |
