...
### [!UICONTROL 자동 타기팅] 활동이 동기화 문제를 일으킬 수 있음
...
### 자동 Target 및 Automated Personalization 모델 가용성 지표 {#at-ap-model}

자동 Target 및 Automated Personalization 활동에 대한 모델 가용성 기능은 2022년 6월 1일부터 2022년 7월 19일까지 간헐적으로 실패했습니다. 즉, Target 보고 UI에서 자동 Target 또는 Automated Personalization 활동에서 경험이나 오퍼가 개인화된 기준으로 제공되었지만 모델이 성공적으로 빌드되었음을 나타내는 녹색 확인 표시를 표시하지 못했을 수 있습니다.

참고 사항 **개인화된 모델 작성 자체** 영향을 받지 않으며 모델이 전체 기간 동안 성공적으로 빌드되었습니다. 이 오류로 인해 모델 가용성 시스템만 영향을 받았습니다. **보고 데이터도 영향을 받지 않았습니다**. 즉, 경험 및 오퍼의 성능(방문, 전환 및 전환율)은 영향을 받지 않았습니다. 개인화된 모델 가용성을 나타내는 녹색 확인 표시만 표시되지 않았을 수 있습니다.
