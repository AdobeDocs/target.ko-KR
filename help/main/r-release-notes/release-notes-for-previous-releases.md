...
릴리스 노트는 릴리스 월 및 연도별로 내림차순으로 나열됩니다.
...
* [!DNL A/B Test (Manual)] 활동에 대한 **베이지안 통계** [!DNL A/B Test (Manual)] 활동은 이제 Welch의 t-테스트에 대한 대안으로 베이지안 통계를 지원합니다. [!UICONTROL 목표 및 설정]에서 통계 방법을 선택하십시오. 베이지안 활동의 보고서에는 [!UICONTROL 통제 이길 확률]과 같은 확률 기반 결정 지표와 빈번한 신뢰 구간 대신 신뢰할 수 있는 구간이 표시됩니다.

* [!DNL Auto-Allocate]개 활동에 대한 **[!DNL Customer Journey Analytics]보고 중.** [!DNL Auto-Allocate] 활동에서는 이제 [!DNL Target] 및 [!DNL Adobe Analytics]&#x200B;(A4T) 외에 [!DNL Customer Journey Analytics]을(를) 보고 소스로 사용할 수 있습니다.
...
* **허용된 URL에 대한 정규식 유효성 검사** 올바른 유효성 검사 없이 **[!UICONTROL 허용된 URL]** 필드에 잘못된 정규식을 입력할 수 있는 문제가 수정되었습니다. (TGT-55095)
...
* [!UICONTROL 대상자 편집] 대화 상자의 **단추.** **[!UICONTROL 대상자 편집]** 대화 상자 내의 단추가 더 이상 올바르게 렌더링되지 않는 문제를 해결했습니다. (TGT-54638)
...
* **[!UICONTROL 그래프 보기]이(가) 테이블 및 다운로드와 동기화되지 않았습니다.** **[!UICONTROL 표 보기]** 및 다운로드한 보고서에 여전히 올바른 값이 표시되더라도 활동 보고서에 일부 날짜 범위에 대해 **[!UICONTROL 그래프 보기]**&#x200B;에서 누락되거나 0인 지표가 표시되는 문제가 수정되었습니다. (TGT-54998)
...
* **대상자 사용 목록이 완전히 렌더링되지 않았습니다.** 추가 활동이 해당 대상과 연결되어 있는 경우에도 대상 세부 정보의 **[!UICONTROL 사용량]** 섹션에 매핑된 활동의 하위 집합만 표시되는 문제가 해결되었습니다. (TGT-55094)
...
* **마지막 옥텟 IP 난독화를 더 명확하게 확인합니다.** **[!UICONTROL 관리]** > **[!UICONTROL 구현]**&#x200B;에서 **[!UICONTROL 방문자 IP 주소 난독화]**&#x200B;을(를) **[!UICONTROL 마지막 옥텟]**(으)로 변경하면 이제 확인 대화 상자에서 [!DNL Target]이(가) 방문자 IP 주소의 마지막 옥텟을 숨긴다고 설명합니다. (TGT-44821)
...
* **EEC(고급 경험 작성기)가 있는 비어 있거나 불완전한 페이지입니다.** **[!UICONTROL 향상된 경험 작성기]**&#x200B;를 사용하도록 설정한 경우 [!UICONTROL 시각적 경험 작성기]가 편집기에서 사이트를 로드하지 못하는 문제를 해결했습니다. (TGT-54576)
...
* **보고서의 대상 필터에 오류가 있습니다.** **[!UICONTROL 목표 및 설정]**&#x200B;에서 대상 필터를 변경하면 [!DNL Target] 사용자 인터페이스의 보고 섹션에서 오류가 발생하는 문제를 해결했습니다. (TGT-55006)

* **우선 순위별로 활동을 정렬합니다.** **[!UICONTROL 우선 순위]** 열 헤더를 사용하여 활동 목록에 우선 순위별 정렬을 추가했습니다. 오름차순과 내림차순은 정렬 가능한 다른 열과 일치합니다. (TGT-54948)

* **저장 후 추가 활동 속성이 유지되지 않습니다.** 활동을 저장하고 다시 연 후 특정 **[!UICONTROL 속성]** 선택이 지속되지 않던 문제를 수정했습니다. (TGT-53889)
...
* **[!UICONTROL 페이지 배달] 규칙 연산자에 대한 일본어 레이블** 일본어 UI에서 페이지 전달 규칙 연산자 레이블에 대한 읽을 수 없거나 손상된 문자열을 수정했습니다. (TGT-53097)
...
* **편집기에서 잘못된 환경에 수정 사항이 표시되었습니다.** [!UICONTROL 시각적 경험 작성기]에서 경험 간을 전환한 후 삭제 또는 기타 수정 사항이 잘못된 경험에 나타날 수 있는 문제를 해결했습니다. (TGT-54955)

* **삽입 HTML을 삭제할 때 수정 사항이 제거되었습니다.** **[!UICONTROL 다음 항목 앞에 삽입]** 또는 **[!UICONTROL 다음 항목 뒤에 삽입]**&#x200B;과 함께 추가된 추가 **[!UICONTROL HTML]** 블록을 삭제하면 CSS 선택기가 없는 연결된 수정도 제거되던 문제를 해결했습니다. (TGT-54530)
...
* **일부 활동에서 위치가 누락되었습니다.** 일부 활동에서 **[!UICONTROL Location]**&#x200B;이(가) 누락되는 문제가 해결되었습니다. (TGT-54951)
...
## [!DNL Target Standard/Premium] 26.4.2(2026년 4월 7일)

**활동**

+++세부 정보 보기

* **추가 보기에 적용할 때 사용자 지정 코드가 유지됩니다.** 동일한 **[!UICONTROL 활동]**&#x200B;에서 다른 **[!UICONTROL 보기]**&#x200B;에 대한 사용자 지정 코드를 추가하거나 저장할 때 하나의 **[!UICONTROL 보기]**&#x200B;에 적용된 사용자 지정 코드를 제거할 수 있는 문제를 해결했습니다. (TGT-53933)
+++

## [!DNL Target Standard/Premium] 26.4.1(2026년 4월 2일)

**활동**

+++세부 정보 보기

* **대상 특성이 활동 보기에 표시됩니다.** **[!UICONTROL 활동]**&#x200B;에서 본 대상 규칙 세부 정보에 **[!UICONTROL 대상]** 섹션에서 동일한 대상을 열 때 나타나는 특정 특성이 표시되지 않던 문제를 수정했습니다. (TGT-54742)

* **활동 목록 페이지에서 CSV를 내보냅니다.** **[!UICONTROL CSV 내보내기]** 작업이 추가되어 일상적인 내보내기를 위해 API에만 의존하지 않고 필터가 적용되는 시기를 포함하여 사용자 인터페이스에서 활동 목록을 내보낼 수 있습니다. (TGT-51466)

* **선택기를 찾을 수 없을 때 플래그가 지정된 경험 수정 사항입니다.** 이제 경험 수정 사항에서 선택기 존재 확인을 실행합니다. 선택기를 페이지에서 찾을 수 없으면 수정 사항에 잘못된 플래그가 지정됩니다. (TGT-54815)

* **[!UICONTROL 자동화된 개인화] 활동.** 사용자가 자동화된 개인화 활동을 안정적으로 작성, 편집 또는 관리하지 못하여 캠페인 설정이 차단되고 개인화 사용 사례가 지연되는 인터페이스 및 활동 로드 문제를 해결했습니다. (TGT-54421)
...
* **활동에서 대상을 만들 때 대상 이름 및 설명이 표시됩니다.** **[!UICONTROL 대상]**&#x200B;에서 직접 대상을 만드는 것과 비교하여 활동 흐름에서 대상을 만들거나 편집할 때 대상 **[!UICONTROL 이름]** 및 **[!UICONTROL 설명]** 필드가 명확하게 표시되지 않는 문제를 해결했습니다. (TGT-54837)
...
* Insights의 **[!UICONTROL 라이브 활동] 개수.** 인사이트 대시보드의 **[!UICONTROL 라이브 활동]** 지표가 **[!UICONTROL 모든 활동]**&#x200B;에 라이브로 표시된 활동 수보다 높은 합계를 보고할 수 있는 문제를 해결했습니다. (TGT-54788)
...
* **[!UICONTROL 전역 제외]의 긴 ID 목록** **[!UICONTROL 전역 제외]**&#x200B;에 긴 ID 목록을 붙여넣거나 입력하면 업데이트된 인터페이스에서 기존 ID와 비교하여 잘려서 불완전한 제외 목록이 발생할 수 있는 문제가 해결되었습니다. (TGT-54422)
...
* [!UICONTROL 시각적 경험 작성기]의 EEC(향상된 경험 작성기) 상태 표시기 **입니다.** EEC 지시자는 향상된 경험 작성기가 활성화되었는지 여부를 나타냅니다. 프레젠테이션이 비대화형 상태 표시로만 제공되므로 더 이상 대화형 토글과 유사하지 않도록 수정되었습니다. (TGT-54828)

* [!UICONTROL 시각적 경험 작성기]에서 **축소 가능한 왼쪽 레일.** 편집을 위해 활동을 여는 동안 왼쪽 레일을 축소할 수 있습니다. 이렇게 하면 작은 디스플레이를 포함하여 여러 대상 및 페이지를 포함하는 활동에 대한 **[!UICONTROL 구성 요소]** 및 **[!UICONTROL 속성]**&#x200B;에 대한 액세스가 향상됩니다. (TGT-54269)
...
* **새 시각적 경험 작성기 UI에서 인증 후 간헐적인 회색 화면** 사용자가 새 시각적 경험 작성기에 로그인한 후 간헐적으로 회색 화면을 볼 수 있어 더 이상 편집할 수 없는 문제가 해결되었습니다. 이 업데이트는 사후 인증 로드 안정성을 향상시킵니다. (TGT-54626)
...
* **디자인/찾아보기 모드 선택 항목이 Visual Experience Composer 웹 편집기에 표시됩니다.** 이 수정 사항은 디자인, 찾아보기 및 미리보기 모드 간 전환이 올바르게 작동하지만 인터페이스에 활성 모드가 명확하게 표시되지 않는 문제를 해결합니다. 이제 선택한 모드가 가시적으로 강조 표시되어 현재 모드 상태를 확인할 수 있습니다. (TGT-54790)

* **시각적 경험 작성기(Chrome)의 개인 네트워크 URL** 로컬 네트워크 액세스가 허용되지 않는 한 Chrome은 개인 네트워크의 페이지를 차단할 수 있습니다. 이제 **[!UICONTROL 시각적 경험 작성기]**&#x200B;에서 프레이밍 Experience Cloud에서 사용하는 권한을 요청하므로 Chrome에서 자동으로 실패하는 대신 허용 프롬프트를 표시할 수 있습니다. 액세스를 허용하면 사용자 환경에서 지원할 때 내부 URL이 VEC에 로드될 수 있습니다. (TGT-54346)
...
* **구현 화면에서 깜박임 관리 추가 토글.** 깜박임 관리 설정의 활성화를 제어하기 위해 [!UICONTROL 구현] 화면에 새로운 토글이 추가되었습니다. 이 토글을 사용하면 관리자가 구현 화면에서 직접 플리커 관리를 구성할 수 있습니다. (TGT-52247)
...
* **개요 페이지에 대상 및 경험의 전체 이름을 표시합니다.** 이 향상된 기능은 [!UICONTROL 개요] 페이지를 업데이트하여 대상 및 경험의 전체 이름을 표시합니다. 이전에는 긴 이름이 잘리고 완전히 표시되지 않았으므로 사용자가 모든 텍스트를 세 번 클릭하여 전체 이름을 볼 수 있도록 선택해야 했습니다. 업데이트에서는 전체 대상 및 경험 이름이 표시되므로 사용자가 활동 구성을 보다 쉽게 식별하고 검토할 수 있습니다. (TGT-53323)
...
* **VEC 변경 내용이 Shadow DOM(Salesforce Lightning Web Components)을 사용하는 사이트에 반영되지 않습니다.** 이 수정 사항은 LWC(Lightning Web Components)를 사용하여 Adobe Target에서 수행한 변경 사항(예: CTA 색상 변경 사항)이 Salesforce 기반 사이트의 라이브 사이트에 저장되거나 반영되지 않는 문제를 해결합니다. CMS이 Target 활동의 업데이트를 수락하지 않으며 이 문제는 A/B 테스트 및 기타 활동 유형에서 일관되게 발생했습니다. (TGT-54059)
...
* **추가 보기에 적용되면 사용자 지정 코드가 손실됩니다.** 이 수정 사항은 사용자 지정 코드를 추가 보기에 추가하고 적용할 때 한 보기에 적용된 사용자 지정 코드가 손실되는 문제를 해결합니다. 이전에는 사용자가 활동의 여러 보기에 사용자 지정 코드를 적용하면 이전에 적용된 사용자 지정 코드가 사라졌습니다. 이 수정 사항을 사용하면 추가 보기에 수정 사항을 적용할 때 사용자 지정 코드가 모든 보기에서 올바르게 보존됩니다. (TGT-54230)
...
* **프로필 매개 변수 &#39;In Between&#39; 규칙이 조건에 저장되지 않습니다.** 이 수정 사항은 프로필 매개 변수에 대해 **In Between** 연산자를 사용하는 기준 규칙이 올바르게 저장되지 않는 문제를 해결합니다. 이전에는 사용자가 **In Between** 연산자로 규칙을 구성하고 범위 값을 입력하면 기준이 성공적으로 저장된 것으로 표시되었지만 기준을 다시 열거나 편집할 때는 규칙이 사라졌습니다. 이 수정 사항을 통해 기준을 다시 열 때 **In Between** 규칙이 올바르게 저장되고 유지됩니다. (TGT-54498)
...
* **모든 활동 이후의 인사이트 페이지 위치를 변경합니다.** **Insights 페이지** 위치가 탐색에서 **모든 활동** 페이지 뒤에 나타나도록 업데이트되었습니다. 이제 모든 활동 페이지가 대상 애플리케이션의 기본 페이지입니다. (TGT-54672)
...
* **왼쪽 탐색을 접을 수 있게 만듭니다.** 이제 왼쪽 탐색을 축소 및 확장할 수 있습니다. 축소하면 아이콘에 도구 설명이 표시됩니다. 확장하면 아이콘과 텍스트가 모두 표시됩니다. 이 향상된 기능을 통해 사용자는 탐색 옵션에 대한 빠른 액세스를 유지하면서 필요할 때 더 많은 화면 공간을 사용할 수 있습니다. (TGT-54608)
...
* 백엔드가 null을 반환하는 경우 **기본 experienceEditorType이 &quot;visual&quot;입니다.** 이 수정 사항은 일부 시나리오에서 `experienceEditorType` 값이 null로 반환되어 편집기 유형이 제대로 초기화되지 않은 UI에서 의도하지 않은 동작이 발생하는 문제를 해결합니다. (TGT-54690)

+++

### [!DNL Target Standard/Premium] 26.2.2(2026년 2월 16일)

**[!UICONTROL 시각적 경험 작성기](VEC)**

+++세부 정보 보기

* **활동에 이미지를 추가할 수 없습니다. 알 수 없는 오류입니다.** 이 수정 사항은 사용자가 활동에서 이미지를 추가하거나 교체하려고 할 때 &quot;알 수 없는 오류&quot;가 발생하는 문제를 해결합니다. 이 문제는 Scene7 URL 동기화 및 인증 실패와 관련되어 있습니다. 이 수정 사항을 통해 시각적 경험 작성기에서 이미지를 올바르게 추가하고 바꿀 수 있습니다. (TGT-54137)

+++

### [!DNL Target Standard/Premium] 26.2.1(2026년 2월 8일)

**속성**

+++세부 정보 보기

* **제거 후 속성 토큰이 자동으로 다시 추가되지 않습니다.** 이 수정 사항은 사용자가 활동을 편집할 때 선택 취소한 속성 토큰이 자동으로 다시 추가되는 문제를 해결합니다. 이전에는 사용자가 자동 감지 속성을 제거하고 여러 단계를 탐색하면 시스템에서 경고나 프롬프트 없이 제거된 속성을 다시 도입하여 예기치 않은 속성에서 활동이 활성화되었습니다. 업데이트는 속성 토큰이 제거되면 이후의 모든 편집 및 탐색 중에 제거된 상태로 유지되도록 합니다. (TGT-54040)

+++

### [!DNL Target Standard/Premium] 26.1.2(2026년 1월 30일)
...
* **허용 목록에추가된 URL 관리 기능.** 허용된 원격 오퍼 URL 패턴을 관리하기 위해 새 &quot;허용 목록에추가된 URL&quot; 관리 기능이 [!UICONTROL 관리] 섹션에 추가되었습니다. 이 기능에는 표에 허용 목록에추가된 URL을 표시하고, URL을 검색 및 필터링하고, 모달 대화 상자를 통해 새 URL을 추가하고, 확인을 통해 URL을 삭제하는 기능이 포함됩니다. 이 기능을 통해 고객이 원격 오퍼에 사용할 수 있는 URL을 제어할 수 있으므로 보안과 규정 준수가 향상됩니다. (TGT-54486)
...
* **GraphQL에서 createdAt 및 modifiedAt에 의한 필터링을 지원합니다.** `createdAt` 및 `modifiedAt` 날짜 필드별로 필터링 활동에 대한 지원이 GraphQL API에 추가되었습니다. 이러한 향상된 기능을 통해 Target UI에서 정확한 필터링을 수행하고, 클라이언트측 데이터 처리를 줄이며, 필터링된 활동 데이터를 검색하기 위해 여러 API 호출이 필요하지 않습니다. (TGT-54499)
...
* **웹 편집기 오퍼의 작업 영역 열을 사용하도록 설정합니다.** 이 업데이트는 웹 편집기의 다른 작업 영역에 나타나는 [!UICONTROL 기본 Workspace]의 오퍼로 인해 고객 혼동을 해결합니다. 이 동작은 설계된 대로 작동하지만 [!UICONTROL 기본 Workspace] 오퍼는 모든 작업 영역에 의도적으로 표시되지만, 특히 &quot;승인자&quot;와 같은 기본이 아닌 작업 영역에서 활동을 만들 때 UI가 작업 영역 원본을 명확하게 하지 않았다고 고객이 보고했습니다. 명확성을 개선하기 위해 웹 편집기의 오퍼 목록에서 [!UICONTROL Workspace] 열을 활성화하여 사용자가 각 오퍼가 속한 작업 영역을 쉽게 구별하고 표시되는 추가 오퍼를 잘못 해석할 수 있습니다. (TGT-54138)
* **target=&quot;_blank&quot;인 링크가 새 탭에서 열립니다.** 이 수정 사항은 [!UICONTROL 찾아보기] 모드를 클릭할 때 ~target=&quot;_blank&quot;~인 링크가 포함된 작성된 웹 사이트가 새 브라우저 탭에서 열려 편집기의 미리 보기 환경을 중단하는 문제를 해결합니다. 이 동작은 앵커 요소가 변형되고 편집기 내에서 탐색을 유지하기 위해 대상이 재정의되는 기존 UI에서와 달리, 작성된 페이지의 기본 링크 속성이 확장의 주입된 JavaScript에 의해 가로채지지 않았기 때문에 발생했습니다. 업데이트를 통해 ~target=&quot;_blank&quot;~을(를) 사용하는 링크가 이제 웹 편집기에서 제대로 처리되므로 작성하는 동안 외부 탭이 더 이상 열리지 않습니다. (TGT-54134)
* **속성 선택 해제 경고.** 이 업데이트에서는 활동 편집기에서 자동 감지된 속성을 선택 해제할 때 사용자에게 명확하게 알리도록 시각적 경고를 도입했습니다. 이전에는 자동 감지된 속성을 제거해도 속성이 영구적으로 삭제된다는 표시가 없으므로 타깃팅 구성이 실수로 손실됩니다. 이 수정 사항은 기존 UI의 비헤이비어와 일치하는 경고 아이콘을 추가하여 속성을 선택 해제하면 활동에서 제거됨을 사용자에게 알립니다. (TGT-54121)
* **[!UICONTROL 작업 공간] 드롭다운은 [!UICONTROL 사용자] 섹션에서 20개로 제한됩니다.** 이 수정 사항은 사용자가 더 많은 항목에 액세스할 수 있는 경우에도 [!UICONTROL 관리] > [!UICONTROL 사용자] 섹션의 [!UICONTROL 작업 공간] 드롭다운에 20개의 작업 공간만 표시되는 문제를 해결합니다. `licenseGroups`에 대한 기본 GraphQL 호출도 20개의 결과로 제한되어 사용자가 조직의 더 많은 작업 영역에 액세스할 수 있더라도 UI에 불완전한 목록이 표시됩니다. 업데이트에서는 이 엄격한 제한이 제거되므로 이제 사용 가능한 작업 영역의 전체 세트가 반환되고 올바르게 표시됩니다. (TGT-53820)
* **오퍼 모달에 작업 영역 열이 표시되지 않는 문제가 해결되었습니다.** 오퍼 모달이 업데이트된 UI에서 작업 영역 열을 표시하지 않는 문제를 해결했습니다. 이로 인해 [!UICONTROL 기본 Workspace]의 오퍼가 출처를 표시하지 않고 선택한 작업 영역의 오퍼와 함께 표시되므로 고객에게 혼동이 발생했습니다. 이제 작업 영역 열이 활성화되어 고객이 각 오퍼가 속한 작업 영역을 명확하게 식별할 수 있습니다. (TGT-52320)
...
* **이미 제거된 경우 활동 편집에서 자동 검색 속성을 추가하지 않아야 합니다.** 이 수정 사항은 활동을 편집하면 사용자가 이전에 제거한 자동 감지 속성이 자동으로 다시 도입되는 문제를 해결합니다. 편집을 위해 활동을 다시 열 때 시스템에서 제거된 속성을 잘못 복원하여 [!UICONTROL 속성 목록]에서 일관되지 않은 동작과 혼동을 초래했습니다. 업데이트는 자동 검색 속성이 제거되면 이후에 편집하는 동안 제거된 상태로 유지되며 사용자가 명시적으로 다시 추가하지 않으면 다시 나타나지 않습니다. (TGT-54182)
* **이미 제거된 경우 자동 검색 속성을 추가하지 마십시오.** 이 수정 사항을 사용하면 사용자가 활동에서 자동 감지 속성을 수동으로 제거한 후 활동 편집기 내에서 후속 탐색 중에 시스템이 더 이상 속성을 다시 도입하지 않습니다. 이전에는 사용자가 자동 검색 속성을 선택 취소하고 [!UICONTROL 타깃팅] 단계로 이동한 다음 [!UICONTROL 경험]&#x200B;(으)로 돌아오면 편집기에서 활동 편집기 상태 슬라이스에 저장된 자동 검색 목록을 기반으로 제거된 속성을 다시 채웁니다. 업데이트된 논리는 이제 자동 감지된 속성을 ~ActivityState~ 슬라이스의 현재 속성과 비교하고, 사용자가 이미 제거한 자동 감지된 속성을 다시 추가하는 것을 방지합니다. 이렇게 하면 여러 단계에서 일관된 동작이 발생하고 사용자 의도를 따릅니다. (TGT-54181)
* **자동으로 검색된 텍스트를 속성 목록에 추가합니다.** 이 향상된 기능은 [!UICONTROL 속성 목록]을 업데이트하여 시스템에서 자동으로 감지한 모든 속성에 레이블을 명확하게 지정합니다. 자동 검색 속성이 사용자가 볼 수 있는 [!UICONTROL 속성 목록]에도 있으면 이제 ~ActivityEditorSlice~ 상태에 저장된 값을 사용하여 이름 옆에 &quot;(자동 검색)&quot; 텍스트가 표시됩니다. 이렇게 하면 기존 UI의 동작이 미러링되며 사용자가 수동으로 선택한 속성과 자동으로 식별된 속성을 쉽게 구분할 수 있습니다. (TGT-54120)
* **자동 검색된 [!UICONTROL 속성]을(를) 상태에 추가합니다.** 이 업데이트에서는 ~ActivityEditorSlice.ExperienceEditor~ 상태가 웹 편집기에서 활동 [!UICONTROL 경험] 탭으로 전달된 모든 자동 검색 속성 ID의 최신 목록을 일관되게 유지합니다. 사용자가 [!UICONTROL 경험] 탭으로 이동할 때마다 중복을 방지하면서 새로 감지된 속성으로 상태가 새로 고쳐져 정확한 추적이 보장되고 안정적인 다운스트림 동작이 보장됩니다. (TGT-54119)
...
* **[!UICONTROL 환경] 드롭다운에는 100개의 결과만 표시됩니다.** 이 수정 사항은 환경이 100개를 초과하는 고객이 [!UICONTROL 권장 사항] 내의 [!UICONTROL 환경] 드롭다운에서 처음 100개의 항목만 볼 수 있는 제한을 해결합니다. 기본 GraphQL 쿼리(~getEnvironmentsV2~)는 100의 하드 코딩된 페이지 크기로 페이지 매김되어 추가 페이지를 사용할 수 있는 경우에도 UI에 부분 목록만 표시됩니다. 환경이 100개를 초과하는 고객의 경우 이 문제로 인해 옵션이 누락되고 선택 경험이 불완전합니다. 업데이트는 제한이 증가하여 모든 환경이 반환되고 표시되므로 환경 수에 관계없이 전체 가시성이 보장됩니다. (TGT-53903)
...
* **[!UICONTROL 보고서] 화살표가 확장 가능한 열을 명확하게 나타내지 않는 문제를 해결했습니다.** 보고 테이블에 업데이트된 UI에서 추가 열을 확장할 수 있다는 것이 명확하게 표시되지 않던 문제를 수정했습니다. 열 헤더 근처에 있는 [!UICONTROL 보고서] 화살표에 사라진 도구 설명이 추가되어 더 많은 열을 사용할 수 있음을 고객이 이해할 수 있습니다. (TGT-53479)
...
* **보기에 적용된 수정 사항을 삭제할 수 없습니다.** 이 수정 사항은 수정 사항을 추가 보기에 처음 다시 적용하지 않는 한 사용자가 활동 내에서 수정 사항을 삭제할 수 없는 문제를 해결합니다. 활동(예: 활동 ID 302467) 편집 시 수정 사항 삭제 시도는 영향을 미치지 않았으므로 사용자가 원치 않는 변경 사항을 제거할 수 없습니다. 그러나 &quot;더 많은 보기에 적용&quot;을 사용하여 수정 사항을 다시 적용하고 `Page Load` 이벤트에 할당하면 예상대로 삭제가 갑자기 작동합니다. (TGT-54088)
...
* **[!UICONTROL 경험 조각] 이름이 새 VEC UI에서 잘렸습니다**(TGT-54312).
* **[!UICONTROL 매출] 지표에 [!UICONTROL 고급 설정]을 사용할 수 없습니다.** 이 수정 사항은 사용자가 [!UICONTROL 목표 및 설정]에서 [!UICONTROL 매출] 지표에 대해 [!UICONTROL 고급 설정]을 구성할 때 403 &quot;액세스 거부&quot; 오류가 발생하는 문제를 해결합니다. 기본 목표에 연결된 종속성 조건을 추가할 때 문제가 발생했습니다. 활동을 만들고 편집할 수 있는 권한이 이미 있는 사용자에게도 백엔드에 편집기 권한이 잘못 필요했습니다. 그 결과, 올바른 구성에도 불구하고 활동을 저장하지 못했습니다. 업데이트는 적절한 액세스 권한이 있는 사용자가 금지된 리소스 오류를 트리거하지 않고 매출 지표 종속성을 성공적으로 추가할 수 있도록 권한 검사를 수정합니다. (TGT-54092)
* **추가 단추가 선택한 이미지에 적용되지 않는 문제를 해결했습니다.** 고객이 활동 만들기 프로세스에서 이미지를 선택하거나 업데이트할 때 특정 이미지를 추가하지 못하던 문제를 수정했습니다. 고객이 특정 자산(예: &quot;ipp&quot;를 검색할 때 반환된 이미지)을 검색할 때 [!UICONTROL 추가] 단추를 클릭해도 선택한 이미지가 적용되지 않고 수정되지 않았습니다. `Homepage-banner-1-moz.jpg`과(와) 같은 다른 이미지를 선택하면 예상대로 계속 작동합니다. 이 업데이트를 통해 모든 유효한 이미지를 업데이트된 UI에서 일관되게 적용할 수 있습니다. (TGT-53610)
* **URL 조건을 삭제하면 목표 지표 구성이 재설정되는 문제가 해결되었습니다.** [!UICONTROL 목표] 지표에서 단일 URL 조건을 제거하면 전체 구성이 업데이트된 UI에서 재설정되는 문제가 해결되었습니다. 고객이 [!UICONTROL 전환] > [!UICONTROL 페이지 확인함]에서 저장된 URL 조건을 삭제하려고 하면 목표 유형이 예기치 않게 [!UICONTROL Mbox 확인함]&#x200B;(으)로 전환되고 이전에 구성된 모든 설정이 제거되었습니다. 이 업데이트에서는 선택한 URL 조건만 삭제되고 나머지 목표 설정은 모두 그대로 유지됩니다. (TGT-53271)
...
* **숨겨진 선택기나 잘못된 선택기가 있는 오퍼 결정은 업데이트된 UI에서 편집할 수 없습니다.** 업데이트된 UI에서 요소가 시각적 경험 작성기(VEC)에 표시되지 않으면 숨겨진 선택기나 잘못된 선택기에 연결된 오퍼 결정을 편집할 수 없는 문제가 해결되었습니다. 이제 패널에서 직접 편집할 수 있으므로 기존 UI에서 사용할 수 있는 기능을 복원하고 선택기 가시성에 관계없이 오퍼 결정을 수정할 수 있습니다. (TGT-53899)
...
* **활동의 기준을 편집하면 페이지가 충돌합니다.** 업데이트된 UI에서 편집 활동 조건으로 인해 `useCrudActionsCtx`과(와) 관련된 콘솔 오류로 페이지가 충돌하는 문제를 해결했습니다. 이제 기준 편집기가 로드되고 올바르게 작동하여 활동을 중단 없이 편집할 수 있습니다. (TGT-53971)
* **[!UICONTROL Message] 열에서 업데이트된 UI에 제품 데이터를 간헐적으로 표시하지 못했습니다.** 피드에 값이 있어도 업데이트된 [!UICONTROL 권장 사항] UI에서 [!UICONTROL 카탈로그 검색]의 [!UICONTROL 메시지] 열에 간헐적으로 제품 데이터를 표시하지 못하는 문제를 해결했습니다. 이제 열에 모든 제품에서 올바른 메시지 값이 일관되게 표시되므로 열을 수동으로 재구성할 필요 없이 안정적인 가시성이 보장됩니다. (TGT-52777)
* 업데이트된 UI에 활동을 저장한 후 **[!UICONTROL 권장 사항 데이터 다운로드] 단추가 표시되지 않습니다.** 다시 저장한 후에도 저장된 특정 활동에 대해 [!UICONTROL 권장 사항 데이터 다운로드] 단추가 표시되지 않는 업데이트된 UI의 문제를 해결했습니다. 이제 버튼이 모든 활동에 일관되게 표시되므로 사용자가 해결 방법 없이 추천 데이터를 안정적으로 내보낼 수 있습니다. (TGT-53802)
* **컬렉션에서 특정 제품을 여는 동안 &quot;요청한 리소스를 찾을 수 없습니다&quot;라는 오류가 반환되었으며 모달에 닫기 옵션이 없습니다.** 업데이트된 Recommendations UI에서 컬렉션에서 특정 제품을 열면 &quot;요청한 리소스를 찾을 수 없음&quot; 오류가 발생하고 닫기 옵션이 없는 빈 모달이 표시되는 문제를 해결했습니다. 이제 모달이 제품 세부 정보를 올바르게 로드하며, 항상 닫기 옵션을 사용하여 정상적으로 종료할 수 있습니다. (TGT-53986)
...
* [!DNL Adobe Analytics]을(를) 업데이트된 UI에서 보고 소스로 사용할 때의 **[!UICONTROL 목표 및 설정] 오류 메시지.** 업데이트된 [!UICONTROL 개요] UI에서 목표 섹션에 &quot;문제가 발생했습니다&quot;라는 오류가 표시되는 문제를 해결했습니다. 요청을 완료할 수 없습니다. 보고 소스로 [!DNL Adobe Analytics]&#x200B;(A4T)을(를) 선택했을 때 문제가 지속되면 [!DNL Adobe Client Care]에 문의하십시오. 이제 목표가 [!UICONTROL Adobe Analytics] 지표에 올바르게 표시되므로 보고 소스 간에 일관적인 가시성이 보장됩니다. (TGT-54021)
...
* **업데이트된 UI에서 여러 보고 대상을 선택할 수 없습니다.** 활동을 편집할 때 사용자가 새로 만든 여러 보고 대상을 동시에 선택할 수 없는 업데이트된 UI의 문제를 해결했습니다. 이제 여러 대상을 한 번에 할당할 수 있으므로 보고 설정의 유연성과 효율성을 높일 수 있습니다. (TGT-53253)
...
* **업데이트된 UI에서 의사 결정 오퍼를 편집하거나 바꿀 수 없습니다.** 업데이트된 UI에서 [!UICONTROL 수정 사항] 패널을 통해 의사 결정 오퍼를 편집하거나 바꿀 수 없고 오퍼 이름이 비어 있는 문제를 해결했습니다. 이제 Decisioning 오퍼에 완전히 액세스하고 편집할 수 있으므로 기존 UI와의 패리티를 복원하고 고객이 활동 내에서 오퍼를 직접 관리할 수 있습니다. (TGT-53884)
...
* **활동 저장 후 엔티티 특성이 일치하는 특성별 승격이 권장 사항 키를 로드하지 못했습니다.** 활동을 저장한 후 편집할 때 규칙 유형이 [!UICONTROL 엔티티 속성 일치]인 [!UICONTROL 속성별 프로모션] 유형의 프로모션이 권장 사항 키를 로드하지 않는 문제를 해결했습니다. `customKeyId`이(가) GraphQL을 통해 요청되지 않아 문제가 발생했습니다. 이제 프로모션을 편집하는 동안 권장 사항 키가 올바르게 로드됩니다. (TGT-53117)
* **권장 사항은 ExpB에서 ExpA로 전환할 때 시각적으로 유지됩니다.** 경험 B에서 추천을 삽입한 다음 경험 A로 전환하면 추천 오퍼 상자가 표시되는 문제를 해결했습니다. 이는 시각적 비일관성으로만 제공되었습니다. 이제 경험 간에 전환할 때 수정 사항이 올바르게 렌더링되어 정확한 UI 동작이 보장됩니다. (TGT-53911)
* **추천 키가 [!UICONTROL 엔티티 특성]이(가) 일치하는 [!UICONTROL 특성별 프로모션]에 대해 로드되지 않습니다.** 활동을 저장한 후 편집할 때 규칙 유형이 [!UICONTROL 엔티티 속성 일치]인 [!UICONTROL 속성별 프로모션] 유형의 프로모션이 권장 사항 키를 로드하지 않는 문제를 해결했습니다. 이제 GraphQL을 통해 권장 사항 키를 올바르게 검색하므로 프로모션이 예상대로 표시되고 작동하도록 할 수 있습니다. (TGT-53917)
* **숨겨진 HTML 요소에 대한 권장 사항이 업데이트된 UI에서 작동하지 않습니다.** [!UICONTROL 새 만들기] 및 VEC UI에서 숨겨진 HTML 요소에 적용된 권장 사항 활동을 편집할 수 없는 문제를 해결했습니다. 이제 이 기능이 예상대로 작동하여 기존 UI와의 패리티를 복원하고 요소 가시성에 관계없이 권장 사항을 수정할 수 있습니다. (TGT-53953)
...
* **업데이트된 UI에서 추천 카탈로그에 특성 값이 간헐적으로 누락되었습니다.** 제품 피드에 있는 경우에도 카탈로그 검색 목록에 특정 특성 값(예: 메시지)이 간헐적으로 표시되지 않는 업데이트된 [!UICONTROL 권장 사항] UI의 문제를 해결했습니다. 이제 속성 값이 열을 재구성하지 않고 검색 결과에 일관되게 로드되므로 카탈로그 관리의 안정성과 효율성이 향상됩니다. (TGT-52769)
* 업데이트된 UI에서 [!DNL Recommendations] 활동에 대한 **[!UICONTROL 권장 사항 다운로드] 단추가 없습니다.** 업데이트된 [!DNL Recommendations] UI에서 권장 사항을 사용하는 A/B 활동에 대해 [!UICONTROL 권장 사항 다운로드] 단추가 표시되지 않는 문제를 해결했습니다. 이제 버튼이 올바르게 표시되어 사용자가 레거시 UI의 기능과 일관되게 권장 사항 데이터를 예상대로 내보낼 수 있습니다. (TGT-53768)
* 업데이트된 개요 UI에 **[!UICONTROL 권장 사항 데이터 다운로드] 단추가 없습니다.** 업데이트된 [!UICONTROL 개요] UI에서 권장 사항이 포함된 활동에 대해 [!UICONTROL 권장 사항 데이터 다운로드] 단추가 표시되지 않는 문제를 해결했습니다. 이제 버튼이 올바르게 표시되어 사용자가 이전 UI로 다시 전환할 필요 없이 권장 사항 데이터를 직접 내보낼 수 있습니다. (TGT-53772)
* **활동 기준을 편집하면 업데이트된 UI에서 빈 화면이 표시되는 경우가 있습니다.** [!UICONTROL 경험의 기준 편집]을 클릭하면 특정 활동에 대한 빈 화면이 표시되는 업데이트된 UI의 문제를 해결했습니다. 이제 기준 편집기가 모든 활동에 안정적으로 로드되어 사용자가 중단 없이 편집할 수 있습니다. (TGT-53961)
* **업데이트된 UI에서 시퀀스 조건을 편집할 수 없습니다.** 업데이트된 UI에서 [!UICONTROL 시퀀스 기준]을 편집하려고 하면 기준 팝업이 로드 시 중단된 상태로 유지되어 빈 화면이 표시되는 문제를 해결했습니다. 이제 기준 편집기가 올바르게 로드되어 사용자가 중단 없이 시퀀스 기준을 편집하고 업데이트할 수 있습니다. (TGT-53985)
...
* **[!UICONTROL 다변량 테스트](MVT) 위치 및 그래프 보고 문제로 인해 보고서를 생성할 수 없습니다.** MVT 활동이 Target UI에서 [!UICONTROL 위치 기여도] 및 그래프 보고서를 생성하지 못하고 &quot;문제가 발생했습니다&quot;라는 오류가 표시되는 문제를 해결했습니다. 요청을 완료할 수 없습니다.&quot; 이제 보고서가 UI 내에서 올바르게 로드되어 전체 가시성이 보장됩니다. (TGT-53654)
* [!UICONTROL 요소] 기여 보고서 오류로 인해 **MVT 보고서가 로드되지 않습니다.** MVT 활동 보고서가 Target UI에 로드되지 않고 &quot;요소 기여도 보고서를 가져올 수 없음&quot; 오류가 표시되는 문제가 해결되었습니다. 이제 보고서가 올바르게 표시되므로 요소 기여도를 완전히 볼 수 있습니다. (TGT-53691)
* **XT(경험 타깃팅) 활동 [!UICONTROL CSV로 주문 세부 사항을 내보냅니다** ]XT 활동에 대해 [!UICONTROL 주문 세부 정보를 CSV로 내보내기] 옵션이 잘못 표시되고 빈 파일이 반환되던 문제가 해결되었습니다. 이제 AP 활동에 대해서만 옵션이 표시되므로 정확한 내보내기 기능을 보장하고 혼동을 방지할 수 있습니다. (TGT-53798)
...
* **[!UICONTROL 수정 삭제] 단추 문제로 인해 활동 수정 사항을 제거할 수 없습니다.** [!DNL Target] UI의 [!UICONTROL 수정 사항 삭제] 단추가 작동하지 않아 사용자가 활동 내에서 수정 사항을 제거할 수 없는 문제가 해결되었습니다. 이제 버튼이 예상대로 작동하므로 수정 사항을 지연 없이 안정적으로 삭제할 수 있습니다. (TGT-53728)
* **업데이트된 UI에서 기본 선택기를 인식할 수 없습니다.** 업데이트된 UI에서 `data-target-component-id`과(와) 같은 기본 설정 선택기가 VEC 내의 CSS 선택기 목록에 표시되지 않는 문제를 해결했습니다. 이제 사용자는 동적으로 생성된 클래스 이름 대신 기본 속성을 안정적으로 선택하여 SPA 페이지 업데이트 전반에 걸쳐 안정적인 타겟팅을 보장할 수 있습니다. (TGT-53908)
* **[!UICONTROL 편집]과(와) [!UICONTROL 개요] 페이지 간에 활동 위치 정렬이 일치하지 않습니다.** [!UICONTROL 개요] 페이지의 활동 위치 번호 매기기가 [!UICONTROL  경험 편집] 페이지에서 수행한 업데이트와 일치하지 않던 문제를 해결했습니다. 이제 위치가 두 보기에서 일관되게 유지되므로 정확한 정렬을 보장하고 위치 누락 또는 번호가 잘못 지정되는 것을 방지할 수 있습니다. (TGT-53960 및 TGT-53954)
* **업데이트된 VEC에서 [!UICONTROL 디자인] 모드로 다시 전환할 수 없습니다.** [!UICONTROL 찾아보기] 모드에서 새 페이지로 이동한 후 사용자가 [!UICONTROL 디자인] 모드로 다시 전환할 수 없는 업데이트된 VEC UI의 문제를 해결했습니다. 이제 [!UICONTROL 디자인] 토글이 올바르게 작동하여 페이지 간에 수정 사항을 매끄럽게 적용할 수 있습니다. (TGT-53988 및 TGT-53993)
* **활동 개요에 쿼리 매개 변수가 표시되지 않습니다.** 활동에 대한 [!UICONTROL 개요] 페이지에 쿼리 매개 변수가 표시되지 않아 [!UICONTROL 개요]와 페이지 배달 URL 간에 불일치가 발생하는 업데이트된 UI의 문제를 해결했습니다. 이제 쿼리 매개 변수가 올바르게 표시되므로 활동 위치가 보기 간에 완전히 표시되고 일관되게 표시됩니다. (TGT-53701)
...
+++ 세부 정보 보기
* **업데이트된 UI에서 유용성 문제를 해결했습니다**. [!UICONTROL 관찰자]는 이제 기존 UI에서와 마찬가지로 [!UICONTROL 활동 보기] 옵션을 사용하여 활동을 미리 볼 수 있습니다. (TGT-51741)
* **[!UICONTROL 관찰자] 사용자는 이제 업데이트된 UI에서 활동 콘텐츠를 볼 수 있습니다.** 업데이트된 활동 UI에서 관찰자 역할 사용자의 가시성이 복원되었습니다. 이전에는 관찰자가 수정 사항, 오퍼 및 콘텐츠 변경 사항(기존 UI에서 사용할 수 있었던 기능)을 볼 수 없었습니다. (TGT-53785)
* **[!UICONTROL 승인자] 사용자는 이제 편집기 권한 오류 없이 활동 목표를 편집할 수 있습니다.** 승인자 수준 사용자가 고급 목표 설정에 대한 변경 사항을 저장하지 못하도록 차단한 활동 만들기 UI의 권한 문제를 해결했습니다. 영향을 받는 사용자가 액세스 권한이 충분함에도 불구하고 편집기 권한이 필요한 `403 Forbidden.Resource` 오류를 받았습니다. (TGT-53819)
...
* **다중 대상 선택이 &quot;이 활동만&quot; 보고에서 복원되었습니다.** 사용자가 [!UICONTROL 목표 및 설정]의 [!UICONTROL 이 활동만] 섹션에서 여러 대상을 선택할 수 없는 활동 만들기 UI의 문제를 해결했습니다. (TGT-53283)
* **대상 기반 보고 그래프는 이제 전환 데이터를 올바르게 표시합니다.** 기본이 아닌 대상을 선택할 때 그래프가 실패하는 [!UICONTROL 보고서] 탭의 문제를 해결했습니다. 데이터와 신뢰도 지표를 사용할 수 있는 반면 시각적 그래프는 실선만 보여 분석이 어려웠다. (TGT-53769)
* **이제 [!UICONTROL 타깃팅] UI는 제외된 대상 규칙을 명확하게 나타냅니다.** 활동 만들기 UI의 [!UICONTROL 타깃팅] 섹션에서 [!UICONTROL 제외]&#x200B;(으)로 설정된 대상 규칙이 명확하게 표시되지 않는 문제를 해결했습니다. 이로 인해 타깃팅 논리, 특히 특정 URL을 제외한 대상에 대해 검토할 때 혼동이 발생했습니다. (TGT-53809)
* **이제 [!UICONTROL 타깃팅] 탭에서 대상 정의 값을 선택하고 복사할 수 있습니다.** 사용자가 [!UICONTROL 타깃팅] 탭에서 대상 규칙 값을 선택하고 복사할 수 없는 Activity Create 인터페이스의 문제를 해결했습니다. 이 기능은 레거시 UI에서 사용할 수 있지만 업데이트된 UI에서는 없습니다. (TGT-53856)
...
* **zh_CN 페이지 편집기 컨텍스트에서 &quot;quote&quot;의 오역을 수정했습니다.** 상업용 가격 견적을 의미하는 &quot;quote&quot;라는 용어가 &quot;报价&quot;로 부정확하게 번역된 zh_CN 로케일에서 문맥 번역 오류를 수정했습니다. 타이포그래피 > 제목 스타일 > 블록 인용 섹션에서 의도된 의미는 가격이 아닌 서식 요소(견적 블록)를 참조합니다. (TGT-53841)
* **zh_CN 페이지 편집기 컨텍스트에서 &quot;따옴표가 제거됨&quot;의 오역을 수정했습니다.** 상업용 가격 견적을 의미하는 &quot;견적이 제거됨&quot;이 &quot;移除了报价&quot;로 잘못 렌더링되는 zh_CN 로케일에서 번역 오류가 수정되었습니다. 타이포그래피 > 제목 스타일 > 블록 견적 섹션에서 이 용어는 가격책정이 아닌 서식 요소(견적 블록)를 참조합니다. (TGT-53843)
* **zh_CN 페이지 편집기 컨텍스트에서 &quot;따옴표가 재배열됨&quot;의 오역을 수정했습니다.** 상업용 가격 견적을 의미하는 &quot;quote restructured&quot;가 &quot;重新排列了报价&quot;로 부정확하게 번역된 zh_CN 로케일의 상황별 번역 오류를 수정했습니다. 타이포그래피 > 제목 스타일 > 블록 견적 섹션에서 이 용어는 가격책정이 아닌 서식 요소(견적 블록)를 참조합니다. (TGT-53844)
* **zh_CN 페이지 편집기 컨텍스트에서 &quot;따옴표가 변경됨&quot;의 오역을 수정했습니다.** &quot;quote changed&quot;가 &quot;更改了报价&quot;로 부정확하게 렌더링된 zh_CN 로케일의 번역 오류를 수정하여 상업용 가격 견적을 제안했습니다. 타이포그래피 > 제목 스타일 > 블록 견적 섹션에서 이 용어는 가격책정이 아닌 서식 요소(견적 블록)를 참조합니다. (TGT-53845)
...
* **이제 권장 사항에 대한 CSS 선택기 변경 사항이 올바르게 저장됩니다.** 사용자가 권장 사항 배치에 대한 CSS 선택기를 업데이트할 수 없는 활동 만들기 UI의 문제를 해결했습니다. 저장 후 변경 사항이 반환되어 타기팅 컨테이너에 대한 업데이트가 차단됩니다. (TGT-53835)
* **페이지 로드 이벤트 선택이 권장 사항 수정 시 유지됩니다.** 권장 사항의 이벤트 유형을 [!UICONTROL 보기]에서 [!UICONTROL 페이지 로드]&#x200B;(으)로 전환할 때 사용자가 변경 사항을 저장하지 못하는 활동 만들기 UI의 문제를 해결했습니다. 선택이 성공한 것처럼 보였지만 다른 곳으로 이동한 후 되돌아가 활동 게시를 차단했습니다. (TGT-53957)
...
* 이제 **&quot;[!UICONTROL 주문 세부 정보를 CSV로 내보내기]&quot;에서 전체 데이터를 다운로드합니다.** 유효한 보고서 데이터가 있더라도 &quot;[!UICONTROL 주문 세부 정보를 CSV로 내보내기]&quot; 옵션이 빈 파일을 다운로드하는 업데이트된 [!UICONTROL 개요] UI의 문제를 해결했습니다. (TGT-53787)
...
* **조직 간 데이터 노출로부터 GQL 끝점을 보호하기 위해 IMS 사전 필터가 추가되었습니다.** licenseGroups 및 targetProperties GraphQL 종단점에 영향을 주는 관리 탭의 보안 취약점이 해결되었습니다. 문제는 교차 조직 제품 데이터에 액세스하는 데 악용될 수 있는 관리 클라이언트 토큰과 함께 JIL API를 사용하는 것에서 비롯되었습니다. (TGT-53837)
...
* **VEC가 더 이상 &quot;[!UICONTROL 초기 수정 적용]&quot;에서 간헐적으로 중지되지 않습니다.** 경험을 로드하지 못하고 &quot;[!UICONTROL 초기 수정 적용]&quot;에서 중단된 VEC의 간헐적인 문제를 해결했습니다. 이 동작은 일관되지 않았으며 경우에 따라 리디렉션 루프 또는 필요한 수동 캐시 지우기가 트리거되기도 했습니다. (TGT-53916)
* **VEC 로드 문제를 재현할 수 없습니다.** 기존 활동을 편집할 때 &quot;[!UICONTROL 초기 수정 적용]&quot;에서 VEC가 중단된 보고된 문제를 조사했습니다. 이 동작은 상위 요소가 없는 HTML 컨텐츠와 관련이 있는 것으로 의심되었습니다. 재발을 계속 모니터링하고 안정성을 보장하기 위해 HTML 오퍼에 대해 구조화된 컨테이너를 사용하는 것이 좋습니다. (TGT-53972)
* VEC의 **[!UICONTROL 디자인] 모드가 더 이상 [!UICONTROL 찾아보기] 모드처럼 간헐적으로 작동하지 않습니다.** [!UICONTROL 디자인] 모드가 간헐적으로 [!UICONTROL 찾아보기] 모드처럼 작동하여 클릭 가능한 `<a>` 링크를 허용하고 요소 선택을 방지하는 UI 문제를 해결했습니다. 이로 인해 마우스로 가리키면 상자가 사라지고 수정 워크플로가 차단되었습니다. (TGT-53136)
* **[!UICONTROL 작성기] 모드에서 단추 클릭이 더 이상 페이지 리디렉션을 트리거하지 않습니다.** 업데이트된 VEC UI에서 [!UICONTROL 작성기] 모드에서 단추를 클릭하면 단추의 대상 URL로 예기치 않은 리디렉션이 발생하는 문제가 해결되었습니다. 이로 인해 사용자가 call-to-action(CTA) 요소를 편집할 수 없고 작성 워크플로우가 중단되었습니다. (TGT-53137)
* **이제 자동화된 개인화 활동의 오퍼 코드 업데이트가 오류 없이 저장됩니다.** [!UICONTROL Automated Personalization] 활동에서 오퍼 코드를 업데이트할 때 &quot;[!UICONTROL 잘못된 사용자 입력]&quot; 오류가 발생하는 새 만들기 UI의 문제를 해결했습니다. 이 오류로 인해 입력이 유효한 경우에도 사용자가 변경 사항을 저장할 수 없습니다. (TGT-53586)
* 이제 VEC의 **[!UICONTROL 디자인] 모드에서 편집 가능한 구성 요소에 대한 링크 탐색을 차단합니다.** [!UICONTROL 디자인] 모드에 있는 동안에도 클릭 가능한 요소(예: 단추 및 링크)가 페이지 리디렉션을 트리거한 업데이트된 VEC의 문제를 해결했습니다. 이 동작은 [!UICONTROL 찾아보기] 모드를 모방했으며 사용자가 주요 구성 요소를 수정할 수 없습니다. (TGT-53696)
* **&quot;[!UICONTROL 요소를 클릭함]&quot; 지표가 이제 리디렉션 또는 오류 없이 작동합니다.** &quot;[!UICONTROL 요소를 클릭함]&quot; 전환 지표를 선택할 때 예기치 않은 리디렉션 및 빈 화면을 발생시킨 새 만들기 UI의 문제를 해결했습니다. 설치 중 단추를 클릭하면 요소를 등록하는 대신 탐색이 트리거되어 &quot;[!UICONTROL 요소를 찾을 수 없음]&quot; 오류가 발생합니다. (TGT-53817)
* **편집하는 동안 기존 활동이 더 이상 무한 로드 루프에 걸리지 않습니다.** 새 만들기 UI에서 VEC에서 기존 활동을 편집하면 페이지가 무한 로드 루프에 갇힌 문제를 해결했습니다. 이 문제는 새로 만든 활동에는 영향을 주지 않았으며 페이지의 기존 수정 사항에 의해 트리거되었습니다. (TGT-53913)
...
* **대상 제외 규칙이 [!DNL Target] UI에 포함된 것으로 잘못 표시되었습니다.** 제외 규칙으로 구성된 대상은 활동 내에서 타깃팅을 편집할 때 포함된 것으로 표시됩니다. 제외 로직이 실행 중에 올바르게 적용되었지만 UI가 규칙을 정확하게 반영하지 못하여 &quot;제외&quot; 레이블이 생략되었습니다. 이제 [!DNL Target] UI에 대상 구성 및 타기팅 워크플로 모두에서 제외 규칙이 올바르게 표시되므로 캠페인 설정을 명확하고 일관되게 유지할 수 있습니다. (TGT-53808)
* **대상 규칙이 제외되도록 설정되어 있음을 [!UICONTROL 타깃팅] 섹션에서 나타내지 않았습니다.** 제외 논리로 구성된 대상이 활동 만들기 UI의 [!UICONTROL 타깃팅] 섹션에 포함된 것으로 잘못 표시되었습니다. 백엔드가 제외 규칙을 올바르게 적용했지만 UI가 이를 시각적으로 나타내지 못하여 &quot;제외&quot; 레이블이 생략되고 캠페인 설정 중에 혼동이 발생했습니다. 이제 [!UICONTROL 타깃팅] 섹션에 제외 규칙이 명확하게 표시되므로 대상 구성과 타깃팅 시각화 간의 일관성이 보장됩니다. (TGT-53809)
...
* **VEC에서 추천 상자를 찾아 선택하기 어려웠습니다.** (VEC)에서 권장 사항 오퍼를 추가한 후 왼쪽 패널에서 수정 사항을 클릭해도 페이지의 해당 권장 사항 상자가 강조 표시되거나 스크롤되지 않습니다. 따라서 오퍼를 찾고 편집하는 것이 어려워졌습니다. 특히 선택기 아래에 숨겨지거나 거의 스타일이 지정되지 않은 경우 더욱 그러합니다. 이제 권장 사항 수정을 클릭하면 연결된 요소가 올바르게 강조 표시되고 스크롤되어 업데이트된 활동 만들기 프로세스에서 유용성과 편집 효율성을 향상시킬 수 있습니다. (TGT-52571)
* **활동을 저장한 후 권장 사항 선택기가 잘못 다시 작성되었습니다.** VEC의 요소에 권장 사항을 추가할 때 선택기는 처음에 정확했지만 활동을 저장하고 다시 연 후 일반 선택기로 변경되었습니다. 원본 선택기를 수동으로 복원하려고 하면 유효성 검사 오류가 발생했습니다. 이제 권장 사항 선택기는 저장 후 정확하게 유지되므로 업데이트된 활동 만들기 프로세스에서 신뢰할 수 있는 타깃팅과 편집이 보장됩니다. (TGT-53709)
* 기존 활동을 수정할 때 **기준 콘텐츠를 편집할 수 없습니다.** 활동을 편집할 때 [!UICONTROL 기준] 콘텐츠 섹션이 비활성화되어 있고 단추가 회색으로 표시되고 응답하지 않습니다. 활동 업데이트 중에 [!UICONTROL 기준] 구성을 완전히 편집할 수 있도록 하여 이 문제를 해결했습니다. 이제 고객은 선택을 전환하거나 해결 방법을 사용하지 않고도 [!UICONTROL 기준] 콘텐츠를 수정할 수 있으므로 업데이트된 활동 만들기 프로세스에서 유연성과 유용성이 향상됩니다. (TGT-53812)
* **활동 내에서 조건을 편집할 수 없습니다.** 활동 내에서 조건에 액세스할 때 [!UICONTROL 기준 편집] 및 [!UICONTROL 기준 제거] 옵션이 비활성화되었습니다. 그러나 [!UICONTROL 권장 사항] 탭을 통해 동일한 기준을 성공적으로 편집할 수 있습니다. 이제 활동 편집 워크플로와 [!UICONTROL 권장 사항] 탭 모두에서 기준을 완전히 편집할 수 있으므로 일관되고 효율적인 편집 환경이 보장됩니다. (TGT-53814)
...
* **스크롤 막대와 상호 작용한 후 보고서가 충돌했습니다.** [!UICONTROL 보고서] 탭에서 스크롤 막대를 클릭하면 페이지가 충돌하고 JavaScript 오류가 발생합니다.
...
* **VEC의 최상위 요소에 대해 컨텍스트 메뉴가 나타나지 않았습니다.** VEC에서 [탐색 표시]를 통해 `<div>` 또는 `<main>` 태그와 같은 최상위 요소를 선택하면 컨텍스트 메뉴가 트리거되지 않으므로 추가 편집 작업을 수행할 수 없습니다. 이제 컨텍스트 메뉴가 최상위 컨테이너를 포함하여 지원되는 모든 요소에 일관되게 표시되므로 활동 만들기 워크플로의 유연성과 유용성이 향상됩니다. (TGT-53770)
* **특정 페이지의 요소를 VEC에서 편집할 수 없습니다.** 업데이트된 VEC에서 페이지의 특정 요소를 선택하거나 편집할 수 없습니다. 이 문제는 해당 페이지로 분리되었으며 동일한 계정 내의 다른 페이지에는 영향을 주지 않았습니다. 이제 페이지의 모든 요소를 예상대로 선택 및 편집할 수 있으므로 활동 만들기 워크플로우에서 전체 기능을 복원할 수 있습니다. (TGT-53353)
* **VEC에서 요소를 선택하는 동안 자식 요소를 볼 때 워크플로를 개선했습니다.** 활동을 만드는 동안 유용성과 정밀도를 개선하기 위해 이제 VEC가 상위 HTML 요소 위로 마우스를 이동하거나 선택할 때 하위 요소를 표시합니다. 이 향상된 기능을 통해 고객은 페이지 구조를 더 잘 이해하고 더 정확하게 수정할 수 있으므로 업데이트된 UI에서 편집 워크플로우를 간소화할 수 있습니다. (TGT-53416)
* **수정 표시줄을 사용하여 기존 활동의 요소를 편집할 수 없습니다.** 이전에 만든 활동을 편집할 때 수정 막대가 페이지의 특정 요소에 대해 활성화되지 않아 업데이트가 수행되지 않습니다. 이 문제는 주로 수정된 활동에서 관찰되었으며 새로 생성된 활동에서는 재현되기 어려웠습니다. 이제 수정 표시줄이 일관되게 표시되고 지원되는 모든 요소를 편집할 수 있으므로 업데이트된 활동 만들기 워크플로우에서 안정성과 유용성이 향상됩니다. (TGT-53013)

+++

+++[!UICONTROL 작업 공간]

* **활동을 다른 작업 영역에 복제하면 &quot;잘못된 사용자 입력&quot; 오류가 트리거되었습니다.** 한 작업 영역에서 다른 작업 영역으로 작업을 복제하려고 하면 &quot;InvalidProperty.Json - 인식할 수 없는 속성 이름 &#39;content&#39;가 발견되었습니다.&quot; 오류가 발생했습니다. 이 문제는 복제 프로세스 중에 활동 메타데이터를 잘못 처리했기 때문에 발생했습니다. 이제 유효성 검사 오류를 트리거하지 않고 작업 공간 간에 활동을 성공적으로 복제하여 더 원활한 활동 배포 워크플로우를 보장할 수 있습니다. (TGT-53731 및 TGT-53736)
...
* **[!UICONTROL 콘텐츠 관리] 모달에서 [!UICONTROL Automated Personalization] 활동의 활동 전용 대상에 대해 잘못된 사용자 입력 오류가 표시되는 문제를 해결했습니다.** 고객이 AP 활동에 대한 [!UICONTROL  콘텐츠 관리] 모달에서 활동 전용 대상을 구성할 때 잘못된 사용자 입력 오류가 발생했습니다. 대상이 이전에 성공적으로 사용되었지만 이 문제가 발생했습니다. 이제 결합된 대상 구성이 유효성 검사 오류를 트리거하지 않고 올바르게 저장됩니다. (TGT-53749)
...
* **이제 초기 활동을 만드는 동안 오퍼 결정 옵션이 일관되게 표시됩니다.** A/B 활동에 대한 첫 번째 만들기 흐름 동안, 특히 오퍼 결정이 활성화된 테넌트에서 시크릿 모드로 액세스할 때 [!UICONTROL 오퍼 결정] 옵션이 표시되지 않던 업데이트된 UI의 문제를 해결했습니다. 옵션은 [!UICONTROL 타깃팅] 단계로 이동한 후 [!UICONTROL 경험]&#x200B;(으)로 돌아간 후에만 나타납니다. 이 수정 사항으로 초기 설정 중에 [!UICONTROL 오퍼 결정] 옵션을 즉시 사용할 수 있으므로 유용성이 향상되고 혼동이 줄어듭니다. (TGT-51888)
...
* **`includeContent=true`일 때 리디렉션 오퍼에 페이로드에 `redirectOptions`이(가) 포함되지 않는 문제가 해결되었습니다.** `includeContent=true `을(를) 사용하여 리디렉션 오퍼를 검색하는 고객에게 응답 페이로드의 `redirectOptions` 필드가 누락되었습니다. 이 불일치는 오퍼 복사 및 활동 생성과 같은 워크플로에 영향을 주었습니다. 콘텐츠를 요청하면 리디렉션 오퍼에 `redirectOptions`이(가) 올바르게 포함됩니다. (TGT-53737)
...
* **업데이트된 UI에서 만들어진 [!UICONTROL 권장 사항] 활동에 대해 클릭 추적이 복원되었습니다.** 업데이트된 UI에서 만들어진 [!UICONTROL 권장 사항] 활동이 클릭 추적을 등록하지 못해 보고된 전환이 0이 되는 문제를 해결했습니다. 레거시 UI에 내장된 활동이 예상대로 클릭을 올바르게 추적하고 전환을 보고했습니다. 이 수정 사항으로 인해 업데이트된 UI에서 생성된 권장 사항 활동에 이제 올바른 추적 속성, 전환 보고 복원 및 A4T 지표와의 정렬이 포함됩니다. (TGT-53287)
* **추천 활동에 대해 클릭 추적이 복원되었습니다.** 업데이트된 UI에서 만들어진 [!UICONTROL 권장 사항] 활동이 클릭 추적을 등록하지 못해 보고된 전환이 0이 되는 문제를 해결했습니다. 기존 UI가 [!UICONTROL 권장 사항] 콘텐츠에 추적 ID(`at-track-click`)를 올바르게 적용한 반면 업데이트된 UI는 실수로 자리 표시자(`__recsClickTrackIdPlaceholder__`)를 삽입하여 백엔드 추적을 방지했습니다. 이 수정 사항으로 인해 [!DNL Recommendations] 콘텐츠에 올바른 추적 ID가 포함되어 전환 보고를 복원하고 A4T 지표와 정렬됩니다. (TGT-53496)
* **업데이트된 UI에서 컬렉션 편집기 충돌이 해결되었습니다.** 업데이트된 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC) UI에서 편집기 패널에서 컬렉션을 열면 페이지가 TypeError로 충돌하는 문제가 해결되었습니다. 정의되지 않은 속성을 읽을 수 없습니다(&#39;customLocale&#39; 읽기). 이 오류는 [!UICONTROL 권장 사항] 및 A/B 테스트를 포함한 여러 활동 유형에서 발생했습니다. (TGT-53703)
* **선택한 컬렉션을 제거하는 옵션이 VEC에서 복원되었습니다.** VEC에서 사용자가 [!UICONTROL 권장 사항] 활동에서 선택한 컬렉션만 바꿀 수 있지만 완전히 제거할 수 없는 문제를 해결했습니다. 이러한 제한은 대체 없이 컬렉션을 깔끔하게 제거해야 하는 사용 사례를 차단했습니다. 이 수정 사항에서는 선택한 컬렉션을 제거하는 명확한 옵션이 도입되어 활동 설정의 융통성을 높이고 이전 UI 동작과 일치할 수 있습니다. (TGT-53652)
* **사용자 지정 기준 컬렉션이 이제 [!UICONTROL 권장 사항] UI에 올바르게 표시됩니다.** Recommendations 인터페이스에서 사용자 지정 기준을 사용하여 빌드한 컬렉션이 제품 결과를 표시하지 못하는 문제를 해결했습니다. 표준 속성 기반 컬렉션이 예상대로 작동하지만 사용자 지정 필터를 사용하는 컬렉션은 유효한 카탈로그 일치에도 불구하고 &quot;검색 결과가 없음&quot;을 반환했습니다. 이 수정 사항을 통해 사용자 지정 특성을 사용하는 컬렉션이 [!UICONTROL 제품] 탭에 올바르게 채워지고 개인화된 권장 사항 워크플로우에 대한 전체 기능이 복원됩니다. (TGT-53653)
* **컬렉션에서 [!UICONTROL 제품] 페이지를 처음 열 때 제품을 표시하지 않는 문제를 해결했습니다.** [!UICONTROL 제품] 페이지를 처음 열 때 [!UICONTROL 권장 사항] 섹션의 컬렉션에 액세스하는 고객에게 빈 제품 결과가 표시되었습니다. 이 문제는 사용자 지정 기준이 있는 컬렉션에 대한 제품 데이터를 로드하지 못한 GraphQL 쿼리의 백엔드 오류로 인해 발생했습니다. 문제가 해결되었으며 이제 환경 전환 없이 제품이 올바르게 표시됩니다. (TGT-53694)
* **양식 기반 [!UICONTROL 권장 사항] 활동에서 컬렉션을 제거할 수 없는 문제가 해결되었습니다.** [!UICONTROL 양식 기반 경험 작성기]를 사용하여 [!UICONTROL 권장 사항] 활동을 만드는 고객은 이전에 선택한 컬렉션을 선택 취소할 수 없습니다. UI를 저장하기 전에 컬렉션을 선택해야 하므로 사용자가 &quot;모든 컬렉션&quot;으로 되돌릴 수 없습니다. 이 동작은 VEC 기능과 일치하도록 업데이트되었으므로 고객은 선택한 컬렉션 없이 저장할 수 있고 예상대로 &quot;모든 컬렉션&quot;으로 기본 설정됩니다. (TGT-53708)
...
* **중복된 경험 이름으로 인해 활동을 저장할 수 없는 문제가 해결되었습니다.** 특정 기준 및 디자인 조합이 포함된 활동을 저장할 때 고객에게 잘못된 사용자 입력 오류가 발생했습니다. 설정이 유효한 것처럼 보이는 경우에도 중복 경험 이름에 의해 오류가 트리거되었습니다. 이제 서로 다른 구성의 활동을 이름 충돌 없이 저장할 수 있습니다. (TGT-53805)
* **특성으로 구성된 프로모션에 대해 유효성 검사가 올바르지 않은 문제가 해결되었습니다.** 모든 필수 필드가 올바르게 채워진 경우에도 활동 만들기 프로세스에서 속성별로 프로모션을 설정할 때 고객이 지속적인 유효성 검사 오류가 발생했습니다. 이 문제는 [!UICONTROL 권장 사항] 워크플로우에서 잘못된 유효성 검사 논리로 인해 발생했습니다. 이제 속성 기반 프로모션이 유효성을 검사하고 예상대로 저장합니다. (TGT-53811)
* **실시간 [!UICONTROL 권장 사항] 활동에 프로모션을 적용하면 오류가 발생하는 문제가 해결되었습니다.** 유효한 구성 세부 정보를 제공한 후에도 실시간 [!UICONTROL 권장 사항] 활동에 전면 프로모션을 적용하려고 하면 고객에게 &quot;프로모션에 컬렉션 ID 또는 필터링 규칙 값이 없습니다.&quot; 오류가 발생했습니다. 이제 프로모션이 유효성 검사 오류를 트리거하지 않고 라이브 활동에 성공적으로 적용되어 업데이트된 활동 만들기 UI에서 더 원활한 경험을 보장할 수 있습니다. (TGT-53738)
* **제품이 [!UICONTROL 권장 사항] UI 내의 컬렉션에 표시되지 않는 문제를 해결했습니다.** 단일 테넌트의 고객이 새 UI의 [!UICONTROL 권장 사항] 섹션에서 특정 컬렉션을 볼 때 제품 목록을 로드하지 못했다고 보고했습니다. 환경을 전환하여 문제가 일시적으로 해결되었지만 이 해결 방법으로 사용자 환경이 나빴습니다. 이제 제품 엔티티는 환경 전환 없이 일관되게 로드됩니다. (TGT-53783)
* **기준 및 디자인이 활동 만들기 UI의 한 줄에 표시되지 않는 문제가 해결되었습니다.** 기존에는 활동 만들기 프로세스의 기준과 디자인이 압축된 형식으로 표시돼 고객이 개별 항목을 보고 관리하기가 어려웠다. 이제 각 기준 및 디자인이 개별 라인에 표시되어 업데이트된 UI에서 가독성과 유용성을 개선합니다. (TGT-53818)
...
* 이제 **[!UICONTROL 총 매출] 지표가 활동 보고서에서 CSV 내보내기에 포함됩니다.** 총 매출액이 활동 보고서 보기에 올바르게 표시되었지만 CSV 내보내기에서 누락되어 $0으로 표시되는 업데이트된 [!UICONTROL 개요] UI의 문제를 해결했습니다. 이 불일치로 인해 사용자가 오프라인 분석 및 보고를 위해 내보낸 데이터에 의존하지 못하도록 했습니다. (TGT-53325)
* 이제 **[!UICONTROL 총 판매] 지표가 활동 보고서에서 CSV 내보내기에 포함됩니다.** 업데이트된 UI에서 [!UICONTROL 총 판매] 지표가 활동 보고서 보기에 올바르게 표시되었지만 CSV 내보내기에서 누락된 문제를 해결했습니다. 이 불일치로 인해 사용자가 다운로드한 보고서의 전체 성능 데이터에 액세스할 수 없었습니다. 이 수정 사항으로 인해 [!UICONTROL 총 판매] 값이 이제 CSV 내보내기에 정확하게 포함되어 인앱 보고와 오프라인 분석 간의 일관성이 복원됩니다. (TGT-53330)
* **지표가 활성화되지 않은 경우 [!UICONTROL 그래프 보기]에 대한 오류 메시지가 개선되었습니다.** 요청된 지표가 연결된 [!DNL Analytics] 보고서 세트에서 활성화되지 않은 경우 [!UICONTROL 그래프 보기]에 일반적인 &quot;문제가 발생했습니다&quot; 메시지가 표시되는 VEC의 문제가 해결되었습니다. 이 문제는 백 엔드 GraphQL 응답의 `not_enabled_metric` 오류로 인해 트리거되었습니다. 이 수정 사항은 모호한 오류를 [!DNL Analytics]에서 구성 문제를 식별하는 데 도움이 되는 보다 유용한 메시지로 대체하여 혼동과 불필요한 지원 에스컬레이션을 줄입니다. (TGT-53577)
* **보고서 기간이 지원되는 제한인 90일을 초과하는 문제를 해결했습니다.** [!UICONTROL 보고서] 섹션에서 &quot;[!UICONTROL 마지막 X일]&quot; 필터를 사용하는 고객은 90일이 넘는 기간을 선택할 수 있으므로 성능 문제와 불완전한 데이터가 발생할 수 있습니다. 필터를 업데이트하여 최대 90일 범위를 적용하므로 일관되고 안정적인 보고가 보장됩니다. (TGT-53795)
...
* **A4T(Analytics for Target) 보고에서 [!UICONTROL 그래프 보기]에 데이터를 표시하지 못하는 문제가 해결되었습니다.** A4T 통합으로 [!DNL Target]을(를) 사용하는 고객이 A/B 테스트 활동의 보고 탭에서 그래프 보기로 전환할 때 &quot;문제가 발생했습니다&quot;라는 오류가 발생했습니다. [!UICONTROL 테이블 보기]가 올바르게 로드되었지만 [!UICONTROL 그래프 보기]에서 선택한 시간 범위에 대한 지표 트렌드를 렌더링하지 못했습니다. 이제 [!UICONTROL 그래프 보기]에 지원되는 모든 지표에 대해 예상대로 성능 데이터가 표시되므로 업데이트된 UI에서 가시성과 보고 정확도가 향상됩니다. (TGT-53573)
...
* **이제 이동 경로 메뉴에 마우스를 가져다 대면 요소 메타데이터가 표시됩니다.** 마우스로 항목을 가리키면 ID, 클래스 및 이름과 같은 추가 요소 세부 정보가 표시되도록 VEC의 이동 경로 메뉴가 개선되었습니다. 이러한 개선된 기능은 사용자가 활동을 설정하는 동안 요소를 보다 쉽게 식별하고 구분할 수 있도록 지원합니다. (TGT-53409)
* **이동 경로 가리키기가 이제 VEC에서 해당 요소를 강조 표시합니다.** 이동 경로 메뉴의 항목을 마우스로 가리키면 편집기에서 해당 요소를 강조 표시하도록 [!UICONTROL 시각적 경험 작성기]가 개선되었습니다. 컨테이너, 굵은 텍스트 또는 버튼과 같은 요소 유형도 표시됩니다. 이 동작은 형제 요소에 적용되며 유효성 검사 목록에 따라 SVG과 같은 지원되지 않는 유형은 제외됩니다. (TGT-53411)
* **VEC 수정 워크플로에서 저장되지 않은 변경 내용 경고가 복원되었습니다.** 사용자 지정 코드 수정에서 저장하지 않은 변경 사항에 대해 더 이상 사용자에게 알리지 않던 VEC의 문제가 수정되었습니다. 기존 UI와 달리 개인화 편집기를 탐색하거나 닫을 때 새 경험에 프롬프트가 부족하기 때문에 진행률이 실수로 손실되었습니다. 이 수정 사항은 사용자 지정 코드를 포함하여 모든 수정 유형에 대한 경고를 복원하며 저장하지 않고 종료하기 전에 사용자에게 경고를 줍니다. (TGT-53435).
* **VEC에서 페이지를 새로 고치는 동안 사용자 지정 코드 변경 내용이 유지됩니다.** 웹 사이트를 새로 고치는 동안 사용자 지정 코드 수정 사항이 손실되는 VEC의 문제를 해결했습니다. 이 문제는 여러 번 다시 로드되는 페이지에서 발생하여 편집기가 재설정되고 저장되지 않은 변경 사항을 되돌립니다. 이 수정 사항을 사용하면 편집하는 동안 페이지가 다시 로드되더라도 사용자 지정 코드 편집이 그대로 유지되므로 진행률이 실수로 손실되는 것을 방지할 수 있습니다. (TTGT-53501)
...
* **VEC Helper 확장에서 쿠키 복제 문제가 해결되었습니다.** [!UICONTROL Adobe Experience Cloud Visual Editing Helper] 확장 프로그램이 미리 보기 링크를 통해 QA를 수행하는 동안 `at_qa_mode` 쿠키를 복제하는 문제를 해결했습니다. 미리 보기 인덱스를 수동으로 전환할 때 도메인 간에 충돌하는 값이 있는 여러 쿠키가 만들어져 테스터가 변형을 안정적으로 전환할 수 없습니다. 이 동작은 Target UI 외부에서도 관찰되었으며 내부 및 클라이언트 계정 모두에 영향을 주었습니다. 이 수정 사항은 중복 항목을 방지하고 도메인 범위를 정렬하여 일관된 쿠키 처리를 보장하므로, 수동으로 쿠키를 정리하지 않고도 원활한 변형 전환을 수행할 수 있습니다. (TGT-53579)
* **특정 홈 페이지의 요소를 클릭하면 메모리 누수가 발생하는 문제가 해결되었습니다.** 이 홈 페이지에서 활동을 만든 고객이 페이지 요소와 상호 작용할 때 메모리 누수가 발생했습니다. 이 문제는 과도한 콘솔 경고와 특히 잘못된 srcset 속성과 관련하여 서브프레임의 메모리 사용량이 증가하는 것과 관련이 있었습니다. 이제 상호 작용 중에 메모리 사용이 안정적으로 유지됩니다. (TGT-53761)
...
* **[!UICONTROL Automated Personalization] 활동의 [!UICONTROL 콘텐츠 관리] 레일에 일치하지 않는 위치 레이블이 표시되는 문제를 해결했습니다.** 고객이 [!UICONTROL 콘텐츠 관리] 레일에서 [!UICONTROL 경험] 및 [!UICONTROL 오퍼] 탭에서 위치 번호가 일치하지 않는다고 보고했습니다. (예: 경험의 위치 2와 위치 4, 오퍼의 위치 1과 위치 2) 두 위치만 구성된 경우에도 마찬가지입니다. 이제 위치 레이블이 일관되고 수정 사항에 정확하게 매핑되어 활동 만들기 프로세스의 명확성과 유용성이 개선되었습니다. (TGT-52934)
* **저장한 후 VEC의 수정 내용이 손실되는 문제를 해결했습니다.** 고객은 VEC에서 수정 사항을 저장한 후 페이지를 새로 고치고 변경 사항을 이전 버전으로 되돌린다고 보고했습니다. 이 문제로 인해 전체 활동이 즉시 저장되지 않는 한 최신 업데이트가 손실되었습니다. 이제 저장 후 수정 사항이 올바르게 지속되며, 편집기에서 더 이상 예기치 않게 변경 사항을 되돌리지 않으므로 활동 만들기 워크플로우에서 안정적인 경험을 보장할 수 있습니다. (TGT-53500)
* **마우스로 가리키고 선택할 때 요소 유형을 표시하여 VEC에서 요소 선택을 개선했습니다.** 활동을 만드는 동안 유용성을 개선하기 위해 이제 VEC는 마우스로 가리거나 선택할 때 HTML 요소를 해당 유형으로 장식합니다. 이러한 향상된 기능을 통해 고객은 올바른 요소를 보다 쉽게 식별하고 선택할 수 있습니다. 선택한 요소는 고유한 색상으로 강조표시되고 가리킨 요소는 파란색으로 윤곽선이 표시됩니다. 요소 유형도 표시되어 편집 중에 더 명확한 컨텍스트를 제공합니다. (TGT-53502)
...
이 업데이트는 일관된 구성을 보장하며 다중 샌드박스 환경 간의 충돌을 방지합니다. 자세한 내용은 *Adobe Target 대상* 안내서의 [Experience Platform 연결](https://experienceleague.adobe.com/en/docs/experience-platform/destinations/catalog/personalization/adobe-target-connection){target=_blank}을 참조하십시오.
...
* **오퍼 결정 오류가 ODE 오퍼에 대해 해결되었습니다.** 형식 메타데이터가 누락되어 [!DNL Target]을(를) 통해 주입된 ODE(오퍼 결정 엔진) 오퍼가 400 오류를 반환하는 문제를 해결했습니다. MIME 유형이 null임을 나타내는 오류 메시지가 표시되어 오퍼 결정을 성공적으로 처리할 수 없습니다. 이 수정 사항을 통해 오퍼 메타데이터를 적절하게 처리하고, 개인화된 콘텐츠 전달을 위한 기능을 복원하며, 마케팅 캠페인을 중단 없이 실행할 수 있습니다. (TGT-53635)
* **ODS 오퍼 렌더링 문제가 해결되었습니다.** 활동이 업데이트된 UI에서 VEC를 사용하여 만들어졌을 때 [!DNL Adobe Journey Optimizer]&#x200B;(AJO)을 통해 만들어진 [!DNL Offer Decision Service]&#x200B;(ODS) 오퍼가 렌더링되지 않는 문제를 해결했습니다. 동일한 구성이 레거시 UI에서 올바르게 작동하여 혼동이 발생하고 캠페인 실행이 차단되었습니다. 이 수정 사항은 두 UI 버전 모두에서 일관된 오퍼 전달을 보장하여 AJO 기반 개인화에 대한 예상 동작을 복원합니다.
...
* **업데이트된 보고서 개요 UI의 보고서 섹션에서 다운로드 옵션이 복원되었습니다.** 보고서 섹션에 [!UICONTROL 다운로드] 단추가 없어서 사용자가 특성 중요도 점수를 내보낼 수 없는 새 개요 UI의 문제를 해결했습니다. 이 업데이트는 전체 내보내기 기능을 복원하여 분석 및 보고를 위한 다운로드 가능한 데이터에 대한 능률적인 액세스를 가능하게 합니다. (TGT-53222)
* **[!UICONTROL 전체 CSV 보고서 다운로드] 단추가 [!UICONTROL 중요 특성] 보기에서 복원되었습니다.** 업데이트된 활동 만들기 UI에서 보고서 보기의 [!UICONTROL 중요 특성] 섹션에 [!UICONTROL 전체 CSV 보고서 다운로드] 단추가 없는 문제를 해결했습니다. 이 수정 사항은 다운로드 가능한 통찰력에 대한 액세스를 복원하여 업데이트된 UI 및 이전 UI 모두에서 일관된 기능을 보장합니다. (TGT-53238)
* **업데이트된 개요 UI에서 [!UICONTROL 자동 타겟] 보고에 영향을 주는 UI 문제가 해결되었습니다.** [!UICONTROL 자동 타겟] 활동 보고에 영향을 주는 업데이트된 개요 인터페이스의 여러 UI 문제를 해결했습니다. 이러한 수정 사항에는 다음이 포함됩니다.

  * 요약 보고서에 상승도 및 신뢰도 지표 누락
  * &quot;모델 작성&quot; 확인란의 잘못된 색상 표시기
  * [!DNL Analytics]의 데이터 분산에도 불구하고 작동하지 않는 그래프 보고서
  * [!UICONTROL 자동화된 세그먼트] 및 [!UICONTROL 중요 특성] 보고서에 대한 다운로드 링크가 없습니다.
  * 손상된 [!UICONTROL 자동화된 세그먼트] 보고서 표시

  이러한 수정 사항은 예상 보고 동작을 복원하고 업데이트된 UI에서 [!UICONTROL 자동 타겟] 성능에 대한 가시성을 향상시킵니다. (TGT-53484)

+++

**[!UICONTROL 시각적 경험 작성기]**

+++세부 정보 보기

* **업데이트된 UI에서 매개 변수 존재 조건에 대한 양식 유효성 검사가 수정되었습니다.** 업데이트된 UI에서 고객이 값을 입력해야 하는 &quot;[!UICONTROL 사용자 지정 mbox 매개 변수 값이 있음]&quot; 또는 &quot;[!UICONTROL 매개 변수가 있음]&quot;을 선택하는 문제가 해결되었습니다. 이 동작은 해당 값에 관계없이 매개 변수가 있는지 확인하는 의도한 논리와 충돌합니다. 이 수정 사항은 양식 유효성 검사를 예상 동작에 맞게 조정하므로 활동을 더욱 원활하게 설정하고 업데이트된 UI를 완전히 적용할 수 있도록 지원합니다. (TGT-53638)
* **페이지 게재에서 매개 변수 존재 규칙에 대한 양식 논리가 수정되었습니다.&quot;** 업데이트된 UI에서 사용자가 추가 매개 변수 값을 입력해야 하는 잘못된 방식으로 &quot;[!UICONTROL 매개 변수가 있음]&quot;, &quot;[!UICONTROL 매개 변수가 없음]&quot;, &quot;[!UICONTROL 매개 변수 값이 있음]&quot; 또는 &quot;[!UICONTROL 매개 변수 값이 없음]&quot;과 같은 페이지 전달 규칙을 선택하는 문제가 해결되었습니다. 이 동작은 기존 UI와 일관되지 않으며 값을 지정하지 않고 매개 변수 존재를 감지하는 의도한 논리와 모순됩니다. 이 수정 사항은 예상되는 규칙 구성 동작을 복원하여 활동 설정을 간소화하고 유용성을 개선합니다. (TGT-53640)
* **업데이트된 UI에서 다중 페이지 규칙 빌더에 대한 유효성 검사 논리가 개선되었습니다.** 업데이트된 UI 내에서 다중 페이지 규칙 빌더에서의 여러 유효성 검사 문제가 해결되었습니다. 이러한 수정 사항에는 다음이 포함됩니다.
...
* **A/B 및 MVT 활동에서 위치 이름 변경 문제가 해결되었습니다.** 위치 목록, 타깃팅 및 뒤로 이동하는 후 [!UICONTROL A/B 테스트] 또는 [!UICONTROL 다변량 테스트]&#x200B;(MVT) 활동에서 위치 이름 변경이 지속되지 않던 업데이트된 UI의 버그를 수정했습니다. 이 업데이트를 통해 위치 이름 변경 사항이 저장되고 활동 워크플로우 전반에 지속적으로 반영됩니다. (TGT-52367)
* **업데이트된 UI에서 MVT 및 AP 활동에 대한 위치 이름 지속성이 수정되었습니다.** 업데이트된 UI에서 [!UICONTROL MVT(다변량 테스트)] 및 [!UICONTROL Automated Personalization]&#x200B;(AP) 활동에서 편집된 위치 이름이 올바르게 저장되지 않는 문제를 해결했습니다. 위치 이름을 바꾼 후 [!UICONTROL 타깃팅] 및 [!UICONTROL 경험]과 같은 탭 사이를 탐색하면 이름이 이전 상태로 되돌아갑니다. 이 수정 사항으로 탭 간 일관된 위치 이름이 지정되며 활동 설정 중에 안정성이 향상됩니다. (TGT-52927)
* **MVT 활동에 대한 경험 관리 패널에서 위치 레이블이 수정되었습니다.** 업데이트된 UI에서 [!UICONTROL 다변량 테스트]&#x200B;(MVT) 활동의 [!UICONTROL 경험 관리] 패널에 일관되지 않은 위치 번호 매기기가 표시되는 문제를 해결했습니다. 이 수정 사항을 통해 위치 레이블이 사용자 정의 수정 사항과 올바르게 정렬되어 경험 설정 중 명확성과 유용성이 향상됩니다. (TGT-52929)
...
* **고객은 [!UICONTROL 활동 개요]**&#x200B;에서 활동 또는 문서 이름을 복사할 수 없습니다. 이전에는 업데이트된 활동 만들기 프로세스에서 [!UICONTROL 활동 개요]에서 직접 활동 또는 관련 오퍼/문서를 복사할 수 없었습니다. 이 제한 사항은 특히 작은 화면에서 유용성에 영향을 주었습니다. 이제 고객은 해결 방법 없이 활동과 문서 이름을 모두 쉽게 복사할 수 있습니다. (TGT-51850)
...
* **AP 활동이 [!UICONTROL 보고서] 섹션**&#x200B;에서 모델 준비 데이터를 가져오지 못했습니다. [!UICONTROL 보고서] 섹션에서 Automated Personalization(AP) 활동을 보는 고객은 보고서 그룹 및 오퍼 수준에서 모델 준비 표시기를 볼 수 없습니다. 이 문제는 모델 준비 데이터를 백엔드에서 올바르게 가져오지 않았기 때문에 발생했습니다. 기능이 복원되었으며 이제 모델 준비 데이터가 예상대로 표시됩니다. (TGT-53600 및 TGT-53601)
* **나중에 예약된 활동이 [!UICONTROL 활동] 개요**&#x200B;에서 &quot;[!UICONTROL 라이브]&quot; 상태를 잘못 표시함: 고객은 나중에 시작하도록 예약된 활동이 [!UICONTROL 활동] 개요에서 &quot;[!UICONTROL 라이브]&quot;(으)로 잘못 표시되었음을 관찰했습니다. 이 상태 불일치가 해결되었으며 예약된 활동이 이제 페이지를 새로 고칠 필요 없이 &quot;[!UICONTROL 예약됨]&quot;(으)로 올바르게 표시됩니다. (TGT-52835)
...
* **제품 목록이 [!UICONTROL 컬렉션 보기] 대화 상자:**&#x200B;에 표시되지 않았습니다. 이전에는 [!UICONTROL 권장 사항] 탭에서 컬렉션을 볼 때 고객이 제품 목록을 볼 수 없었습니다. 이제 [!UICONTROL 컬렉션 보기] 대화 상자에 관련 제품이 올바르게 표시되므로 업데이트된 [!UICONTROL 권장 사항] UI에서 투명도와 유용성이 향상되었습니다. (TGT-50531)
* **[!UICONTROL 제품 카탈로그 검색] 고급 검색**&#x200B;에서 대/소문자를 구분하는 필터링을 일으키는 문제를 해결했습니다. [!UICONTROL 제품 카탈로그 검색] 페이지의 고급 검색 필터링은 이제 백 엔드와 GraphQL 서비스 모두의 동작에 맞게 대/소문자를 구분하는 것을 올바르게 무시합니다. 이 업데이트는 텍스트 대소문자에 관계없이 고객을 위한 일관되고 정확한 제안 결과를 보장합니다. (TGT-53585)
...
* **보고서 페이지에서 대상을 전환하면 Target UI에 오류가 발생했습니다**: 고객이 [!UICONTROL 보고서] 섹션에서 특정 대상을 선택할 때 오류가 발생했습니다. 이 문제는 백엔드 GraphQL 호출에서 잘못된 대상 처리로 인해 예기치 않은 오류가 발생하고 데이터가 누락되어 발생했습니다. 이 문제는 해결되었으며 이제 데이터를 사용할 수 없는 경우에도 데스크탑 대상자가 오류 없이 로드됩니다. (TGT-53370)
* [!UICONTROL 보고서] 섹션의 **[!UICONTROL 그래프 보기]에[!DNL Analytics]**&#x200B;의 값이 표시되지 않음: Re포트 섹션의 [!UICONTROL 그래프 보기]에 액세스하는 고객에게 데이터가 누락되었습니다. 모든 값은 0으로 표시됩니다. 이 문제는 [!UICONTROL Analytics]에서 잘못된 데이터 검색으로 인해 발생했습니다. 이제 [!UICONTROL 그래프 보기]에 예상대로 정확한 값이 표시됩니다. (TGT-52792)
+++
...
* **함수가 누락되어 EEC([!UICONTROL 고급 경험 작성기])를 사용하여 &quot;쿠키 수락&quot;을 클릭하지 못했습니다**: 고객이 EEC를 통해 쿠키를 수락하려고 하면 콘솔 오류가 발생한다고 보고했습니다. `handleclickAcceptAllButton is not defined`. 이제 쿠키 수락 기능이 예상대로 작동하여 업데이트된 UI에서 활동을 만드는 동안 더 원활한 경험을 보장합니다. (TGT-52794)
...
* **백스페이스를 사용하여 모든 날짜 값을 지우면 페이지가 충돌합니다**: [!UICONTROL 목표 및 설정] 섹션에서 활동을 예약하는 고객이 백스페이스를 사용하여 &quot;[!UICONTROL 지정된 날짜 및 시간]&quot; 필드의 모든 값을 지울 때 충돌이 발생했습니다. 이 문제는 날짜 처리 논리의 null 참조 오류로 인해 발생했습니다. 이제 페이지는 충돌하지 않고 빈 날짜 입력을 정상적으로 처리합니다. (TGT-53624)
* **잘못된 페이로드로 인해 [!UICONTROL 제품 카탈로그 검색]에 제품이 표시되지 않음**: [!UICONTROL 제품 카탈로그 검색]의 [!UICONTROL 권장 사항] 섹션에 액세스하는 고객이 잘못된 GraphQL 페이로드로 인해 빈 결과를 발견했습니다. 이 백엔드 오류로 인해 제품 데이터가 올바르게 로드되지 않았습니다. 이제 제품이 업데이트된 UI에서 예상대로 표시됩니다. (TGT-53630)
* **[!DNL Scene7]개의 이미지가 업데이트된 VEC에 낮은 해상도로 저장되었습니다.**: 업데이트된 VEC에서 경험을 편집하는 고객은 [!UICONTROL Scene7] 이미지 URL이 해상도 매개 변수 없이 저장되었으므로 낮은 품질의 이미지가 전달됩니다(의도한 800×800 대신 400×400). 이제 이미지 URL은 올바른 해상도를 위해 올바른 매개 변수를 유지합니다. (TGT-52631)
...
* **업데이트된 VEC에서 [!UICONTROL 실패] 및 [!UICONTROL 초안] 활동 섹션이 해제됨**: [!UICONTROL 실패] 및 [!UICONTROL 초안] 활동 옵션이 업데이트된 VEC에서 제거되었습니다. 새 UI는 더 이상 초안 상태를 지원하지 않으며 실패한 캠페인은 백엔드에 저장되지 않습니다. 이러한 옵션은 더 이상 관련이 없습니다. 활동 관리를 간소화하기 위해 관련 필터 및 백엔드 필드(예: `uiSyncFailed`, `errorMessage`)도 제거되었습니다. (TGT-53150)
...
* **뒤로 단추를 [!UICONTROL 찾아보기] 모드에서 두 번 누르면 VEC가 충돌함**: VEC에서 [!UICONTROL 찾아보기] 모드를 탐색하는 고객은 브라우저의 뒤로 단추를 두 번 누를 때 충돌이 발생했습니다. 이 문제로 인해 편집기가 중지되었으며 페이지를 새로 고쳐야 합니다. 이제 편집기가 충돌하지 않고 뒤로 탐색을 안정적으로 처리합니다. (GT-53568)
...
* **예약된 활동이 페이지를 새로 고칠 때까지 [!UICONTROL Live] 상태를 잘못 표시하는 문제를 해결했습니다**: 고객은 향후 날짜 및 시간에 활동을 시작하도록 예약할 때 상태가 [!UICONTROL 예약됨] 대신 [!UICONTROL Live]&#x200B;(으)로 즉시 표시된다는 점을 확인했습니다. 확인 메시지에서 활동이 예약되었음을 올바르게 표시했지만 이로 인해 혼동이 발생했습니다. 페이지를 새로 고치면 상태 표시가 수정되었습니다. 이제 이 문제가 해결되었으며 새로 고침할 필요 없이 예약된 활동이 예약된 상태를 올바르게 표시합니다. (TGT-52937)
...
* **업데이트된 UI에서 &quot;다음 항목 앞에 삽입&quot; 또는 &quot;다음 항목 뒤에 삽입&quot; 옵션을 사용하여 [!UICONTROL 경험 조각]을(를) 활동에 삽입하려고 할 때 고객이 UI에서 [!UICONTROL 다음 항목 앞에 삽입] 또는 [!UICONTROL 다음 항목 뒤에 삽입]을(를) 사용하여 경험 조각을 삽입할 수 없는 문제를 해결했습니다.** 표시되는 오류 메시지: &quot;오퍼 콘텐츠에는 정확히 하나의 HTML 요소가 포함되어야 합니다.&quot; 이 문제는 업데이트된 UI에만 해당되며 이전 버전에서는 발생하지 않았습니다. 이제 이 문제가 해결되었으며 고객은 이 오류가 발생하지 않고 [!UICONTROL 경험 조각]을 삽입할 수 있습니다. (TGT-53442)
...
* **저장한 후 [!UICONTROL 오퍼 결정] 선택기를 수정할 수 없고 예기치 않게 변경할 수 없는 문제가 해결되었습니다**: 업데이트된 활동 만들기 프로세스에서 고객이 의도한 대로 [!UICONTROL 오퍼 결정] 선택기를 수정할 수 없습니다. 선택기를 변경하려는 시도가 실패하여 저장한 후 선택기가 잘못된 값으로 되돌아갔습니다. 이 동작으로 인해 의사 결정 오퍼가 시각적 경험 작성기 (VEC)에서 사라져 추가 편집이 차단되었습니다. 이제 선택기 변경 사항이 올바르게 보존되고, 저장 후 의사 결정 오퍼가 VEC에 계속 표시되고 편집할 수 있습니다(TGT-53433).
* **저장 후 [!UICONTROL 오퍼 결정]이 활동에서 사라지는 문제가 해결되었습니다.**: 활동 만들기 프로세스 중에 추가된 [!UICONTROL 오퍼 결정]이 활동을 저장하고 다시 연 후 유지되지 않았습니다. 이 문제는 동적 콘텐츠를 편집하고 특정 선택기 및 속성을 사용하여 [!UICONTROL 오퍼 결정]을 삽입할 때 발생했습니다. 이제 저장 후 [!UICONTROL 오퍼 결정]이 올바르게 유지되고 선택기는 그대로 유지되므로 일관된 타깃팅 및 편집 동작이 보장됩니다. (TGT-53434)
...
* **[!UICONTROL 카탈로그 검색]**&#x200B;에서 일관되지 않은 이미지 로드 문제 해결: [!UICONTROL  카탈로그 검색]의 썸네일 및 이미지가 활동 만들기 프로세스에서 일관되게 로드되지 않는 문제가 해결되었습니다. 이미지가 나타나지 않는 한 &quot;썸네일 URL&quot; 열이 표시되고 일부 제품 이미지가 탐색 또는 검색 작업 후 부분적으로 로드되거나 전혀 로드되지 않습니다. 이미지 로드 동작이 안정되었으며 이제 열 가시성 또는 탐색 동작에 관계없이 썸네일이 안정적으로 표시됩니다. (TGT-52778)
...
* **[!UICONTROL 권장 사항 카탈로그]에서 간헐적으로 전체 제품 특성 데이터를 표시하지 못하는 문제가 해결되었습니다.**: 업데이트된 [!DNL Recommendations] UI에서 데이터가 피드에 존재하더라도 고객에게 메시지와 같은 특정 제품 특성이 [!UICONTROL 카탈로그 검색] 결과에 일관되게 표시되지 않는 문제가 발생했습니다. 이 문제는 고객이 누락된 값을 검색하기 위해 열 가시성을 수동으로 다시 구성해야 했습니다. [!UICONTROL 카탈로그 검색]에 구성된 모든 특성이 안정적으로 표시되므로 열을 수동으로 다시 설정할 필요가 없습니다. (TGT-52769)
* **라이브 활동에서 [!UICONTROL 전면 프로모션]을(를) 비활성화할 수 없는 문제를 해결했습니다**: 라이브 활동에서 [!UICONTROL 전면 프로모션]을(를) 비활성화하려는 시도가 저장되지 않았습니다. [!UICONTROL 프로모션 변경]을 선택하고 비활성화한 후 활동을 다시 편집할 때 프로모션이 활성 상태로 유지되어 추천 구성에 대한 업데이트가 수행되지 않았습니다. 이제 프로모션 설정이 올바르게 저장되므로 고객이 예상대로 라이브 활동에서 프로모션을 비활성화하거나 수정할 수 있습니다. (TGT-53231)
* **데이터 없이 [!DNL Recommendations] [!UICONTROL 승격]을(를) 사용하면 명확하지 않은 오류 메시지가 트리거되는 문제가 해결되었습니다**: 필수 값을 지정하지 않고 [!DNL Recommendations] 활동에서 [!UICONTROL 전면] 또는 [!UICONTROL 다시 승격]을(를) 사용하면 일반적인 &quot;잘못된 입력 오류&quot; 메시지가 표시됩니다. 기본 문제는 구성 필드가 누락되었지만 오류 메시지에 원인이 명확하게 표시되지 않아 문제 해결이 어려웠습니다. 이제 활동 만들기 프로세스에서 `collectionId` 또는 규칙과 같은 필수 필드가 누락된 경우 명확하고 실행 가능한 오류 메시지를 제공하므로 고객이 구성 문제를 신속하게 식별하고 해결할 수 있습니다. (TGT-52616)
* **[!UICONTROL 권장 사항] 탭 내의 [!UICONTROL 편집] 모달에 [!UICONTROL 제품] 목록이 표시되지 않는 문제를 해결했습니다**: [!UICONTROL 권장 사항] 탭에서 [!UICONTROL 컬렉션] 또는 [!UICONTROL 제외]를 편집할 때 고객이 필터링된 제품 목록을 볼 수 없습니다. 해당 목록은 적용된 규칙을 기반으로 실시간으로 업데이트될 예정이었으나 의도한 대로 나타나지 않았다. 이 문제는 해결되었으며 이제 규칙이 수정되면 제품 목록이 올바르게 표시되고 동적으로 업데이트됩니다. (TGT-53481)
* **업데이트된 UI에서 [세부 정보 보기] 대화 상자의 레이아웃 문제를 해결했습니다**: 명확성과 유용성을 개선하기 위해 업데이트된 UI에서 [세부 정보 보기] 모달의 레이아웃이 수정되었습니다. 이제 대화 상자에 두 개의 탭이 포함됩니다.
  * [!UICONTROL 세부 정보] 탭: 선택한 항목에 대한 모든 관련 정보를 표시합니다.
  * [!UICONTROL 인벤토리] 탭: 현재 컬렉션 및 제외 규칙으로 필터링된 모든 제품을 표시합니다.

  이 향상된 기능을 통해 고객은 활동 만들기 프로세스 내에서 품목별 데이터 및 재고 컨텍스트를 보다 쉽게 탐색하고 이해할 수 있습니다. (TGT-53503)

  * **저장한 후 권장 사항 활동에서 제거된 프로모션이 다시 표시되는 문제가 해결되었습니다**: 고객이 [!UICONTROL 전면] 또는 [!UICONTROL 후면] 프로모션이 [!DNL Recommendations] 활동에서 제거되고 활동이 저장되었을 때 다시 열면 프로모션이 계속 표시된다고 보고했습니다. 이 문제는 스테이징 환경과 프로덕션 환경 모두에서 발생했으며 업데이트된 활동 만들기 프로세스에 영향을 주었습니다. 문제가 해결되었습니다. 활동에서 제거된 프로모션은 이제 저장 후 올바르게 지속됩니다. (TGT-53490)
...
* **자동화된 세그먼트] 보고서에 null 대상 값이 표시되던 문제를 해결했습니다**: 고객이 활동 보고서의 [!UICONTROL 자동화된 세그먼트]가 대상 데이터에 대해 null을 표시한다고 보고하여 세그먼트 성능을 정확하게 분석할 수 없습니다. [!UICONTROL 이 문제는 올바른 대상 데이터가 필요하지만 [!UICONTROL 보고서] 섹션에 액세스하고 [!UICONTROL 자동화된 세그먼트]를 선택할 때 발생했습니다. [!UICONTROL 자동화된 세그먼트]는 이제 대상 값을 올바르게 표시하므로 안정적인 보고 및 세분화 통찰력을 보장합니다. (TGT-52793)
...
* **[!UICONTROL 찾아보기]와 [!UICONTROL 디자인] 모드 간 전환으로 업데이트된 UI에서 SPA 상태가 재설정되는 문제가 해결되었습니다**: 고객은 업데이트된 UI에서 [!UICONTROL 찾아보기]와 [!UICONTROL 디자인] 모드 간 전환으로 인해 웹 편집기가 다시 로드되어 SPA 상태가 재설정되었다고 보고했습니다. 이 문제로 인해 워크플로우가 중단되었으며 고객이 정보를 다시 입력해야 했습니다. 문제가 해결되었습니다. 이제 모드 간에 전환할 때 SPA 상태가 유지되므로 활동을 만드는 동안 더 유연하고 일관된 경험이 보장됩니다. (TGT-53074)
...
* **AP 활동의 [!UICONTROL 타깃팅] 단계로의 진행을 차단하는 활동 만들기 프로세스의 문제**: 두 위치가 추가되지 않으면 고객이 [!UICONTROL Automated Personalization]&#x200B;(AP) 활동의 [!UICONTROL 타깃팅] 단계로 진행할 수 없는 활동 만들기 프로세스의 문제를 해결했습니다. 이 동작은 오퍼가 여러 개인 단일 위치만으로도 충분했던 이전 경험과 다릅니다. 요구 사항이 수정되어 고객이 단일 위치 설정을 AP 워크플로우의 일부로 계속 사용할 수 있습니다. (TGT-53426)
...
* **고객이 업데이트된 UI에서 보고서 세트를 검색할 수 없는 문제를 해결했습니다**: 업데이트된 UI에서 [!UICONTROL 목표 및 설정] 섹션의 [!UICONTROL 보고서 세트] 드롭다운 목록에서는 고객이 입력하고 검색할 수 없으므로 특정 보고서 세트를 찾는 것이 어렵습니다. 특히 항목 수가 많은 테넌트의 경우 그렇습니다. 기존 UI와 달리 목록이 정렬되지 않아 입력 기반 필터링이 부족했다. 이 문제는 해결되었습니다. 이제 고객이 을 입력하여 보고서 세트를 검색 및 필터링할 수 있으므로, 기존 UI에서 사용할 수 있는 기능이 복원됩니다. (TGT-53514)
...
* **단일 작업 영역으로 제한된 고객이 다른 작업 영역의 활동을 볼 수 있는 문제를 해결했습니다**: 활동 만들기 프로세스에서 [!UICONTROL 모든 작업 영역]을(를) 선택할 때 한 작업 영역으로 제한된 액세스 권한을 가진 고객이 예기치 않게 모든 작업 영역의 활동을 볼 수 있었습니다. 이러한 가시성은 다른 작업 공간의 라이브 활동에 의도하지 않은 변경을 초래할 수 있으며, 웹 사이트 성능에 영향을 줄 수 있습니다. 고객이 할당된 작업 영역 내의 활동만 보고 상호 작용할 수 있도록 Workspace 액세스 제어를 강화했습니다. (TGT-53101)
* **고객이 액세스 권한 없이 [!UICONTROL 기본 Workspace]에서 활동을 볼 수 있는 문제를 해결했습니다.** 스테이징 작업 영역에만 액세스할 수 있는 고객이 활동 만들기 프로세스를 통해 [!UICONTROL 기본 Workspace]에서 활동을 볼 수 있습니다. 이 동작은 올바른 백엔드 구성 및 액세스 권한에도 불구하고 발생했습니다. 고객이 할당된 작업 영역 내에서만 활동을 볼 수 있도록 Workspace 액세스 제어를 강화했습니다.(TGT-53297)
...
* **업데이트된 UI에서 AP 활동에 대한 활동 만들기 프로세스의 경험 요구 사항 문제 해결**: [!UICONTROL Automated Personalization]&#x200B;(AP) 활동에 업데이트된 UI에서 두 개의 경험이 아닌 두 개의 위치가 필요한 활동 만들기 프로세스의 문제를 해결했습니다. 이 동작은 고객이 이전에 지원된 여러 오퍼로 단일 위치를 구성한 사용 사례를 차단했습니다. 원래 기능과 일치하도록 요구 사항이 수정되어 고객이 위치 수에 관계없이 두 개의 경험을 사용하여 AP 활동을 진행할 수 있습니다. (TGT-53429)
* **저장되지 않은 입력을 방지하고 명확성을 개선하기 위해 클릭 추적 모드에서 추적된 요소 필드 동작을 수정했습니다**: [!DNL Click Track] 모드에서 [!UICONTROL 추적된 요소] 필드를 편집할 수 있지만 입력한 이름을 유지하지 않아 고객에게 혼동을 주는 활동 만들기 프로세스의 문제를 수정했습니다. 이제 필드가 비활성화되어 저장되지 않은 입력을 방지할 수 있고, 목표 구성 및 추적 정확도를 개선하기 위해 선택한 요소의 이름이 명확해졌습니다.** (TGT-53458)
* **활동 만들기 프로세스에서 [!UICONTROL 트랙 클릭] 모드에서 추적된 구성 요소의 이름을 차단하는 문제가 해결되었습니다.**: [!UICONTROL 트랙 클릭] 모드에서 고객이 추적된 구성 요소의 이름을 지정할 수 없는 문제가 활동 만들기 프로세스에서 해결되었습니다. 이름을 입력한 후 필드는 편집 가능한 것으로 표시되었지만 입력을 보존하지 않았으므로 편집 모드에서 &quot;MY PRIMARY GOAL 0&quot;과 같은 일반 레이블로 기본 설정됩니다. 이제 추적된 요소 필드가 비활성화되고 목표 설정 및 추적 정확도를 개선하기 위해 이름 지정 동작이 명확해졌습니다. (TGT-51396)
...
* **카탈로그 검색 UI에서 고급 검색이 제안을 제공하지 못하는 문제가 해결되었습니다**: 새 [!UICONTROL 카탈로그 검색] UI에서 [!UICONTROL 고급 검색] 기능이 제안을 제공하지 못하는 문제가 해결되었습니다. 사용자는 정확한 철자로 정확한 값을 입력해야 하므로 검색 경험이 번거롭고 오류가 발생하기 쉽습니다. 이 수정 사항으로 [!UICONTROL 고급 검색]은(는) 이제 사용자가 입력할 때 관련 제안을 제공하여 유용성을 높이고 제품 찾기에서 마찰을 줄입니다. (TGT-52008)
...
* **제품 메시지가 권장 사항 보기에 표시되지 않는 활동 만들기 프로세스의 문제가 해결되었습니다**: 메시지가 있어도 [!DNL Recommendations] 보기의 [!UICONTROL 메시지] 열에 제품 데이터가 표시되지 않는 활동 만들기 프로세스의 문제가 해결되었습니다. 고객은 콘텐츠를 일시적으로 표시하기 위해 열을 수동으로 제거하고 다시 추가해야 했는데, 스크롤하거나 검색할 때 종종 다시 사라집니다. 이 업데이트는 제품 메시지의 일관된 가시성을 복원하여 카탈로그 탐색 및 검토 워크플로우를 개선합니다. (TGT-52777)
...
* **마지막으로 업데이트한 날짜] 열별로 일관되지 않은 정렬 문제를 해결했습니다.** [!UICONTROL 마지막으로 업데이트한 날짜] 열별로 카탈로그를 정렬하면 일관되지 않은 결과가 발생하는 활동 만들기 프로세스의 문제를 해결했습니다. [!UICONTROL 고객이 업데이트 타임스탬프를 기반으로 제품 데이터를 안정적으로 구성할 수 없어 카탈로그 검토 및 관리가 더욱 어려웠습니다. 이제 정렬이 예상대로 작동하여 업데이트된 UI의 정확도와 유용성이 개선됩니다. (TGT-53116)
...
* **활동 만들기 프로세스의 활동 로드 및 [!UICONTROL 취소] 단추 문제가 해결되었습니다**: 특정 활동이 로드되지 않고 고객이 수정 사항에 액세스할 수 없는 활동 만들기 프로세스의 문제가 해결되었습니다. 또한 [!UICONTROL 취소] 단추가 응답하지 않아 고객이 로드 프로세스를 중지하거나 편집 보기를 종료할 수 없습니다. 이 수정 사항으로 인해 활동이 안정적으로 로드되고 [!UICONTROL 취소] 단추가 예상대로 작동하여 시각적 경험 작성기의 전반적인 안정성과 사용자 경험이 향상됩니다. (VEC)(TGT-53218)
* **편집을 차단하고 [!UICONTROL 취소] 단추를 사용하지 않도록 설정한 업데이트된 VEC UI의 경험 전환 문제**: XT(경험 타깃팅) 활동에서 경험 간을 전환할 때 수정 사항을 로드하지 못하는 업데이트된 VEC UI의 문제를 해결했습니다. 고객이 처음에 입력한 경험 이외의 경험을 편집할 수 없으며 [!UICONTROL 취소] 단추가 없거나 응답하지 않습니다. 이 수정 사항을 통해 이제 모든 경험에서 수정 사항이 올바르게 로드되고 Helper 확장이 없어도 [!UICONTROL 취소] 단추가 안정적으로 작동하여 편집 워크플로가 개선되고 문제가 줄어듭니다. (TGT-53256)
...
* **사용자 지정 코드 변경 내용이 편집 세션 간에 안정적으로 저장되지 않는 VEC의 문제를 해결했습니다**: VEC(시각적 경험 작성기)에서 수정한 사용자 지정 코드가 한 번의 시도에서 안정적으로 저장되지 않는 문제를 해결했습니다. 고객은 [!UICONTROL 콘텐츠 편집] 및 최종 [!UICONTROL 저장] 버튼을 모두 사용해도 웹 사이트 및 QA URL에서 스타일 업데이트 또는 HTML 편집과 같은 변경 사항이 간헐적으로 누락되었다고 보고했습니다. 모든 사용자 지정 코드 변경 사항이 편집 세션 간에 예상대로 유지되도록 이 회귀 문제를 해결했습니다.** (TGT-53418)
...
* 업데이트된 [!DNL Target] UI에서 [!UICONTROL 편집기] 역할을 가진 사용자가 라이브 활동에 액세스하여 편집을 시도할 수 있는 문제를 해결했습니다. 이를 제한해야 합니다. 활동 목록 및 개요 화면에 라이브 활동에 대한 편집 옵션이 잘못 표시되어 의도하지 않은 변경이 발생할 수 있습니다. (TGT-53055)
* [!UICONTROL 고급 검색] UI에서 &quot;값이 있음&quot; 또는 &quot;값이 없음&quot; 연산자를 선택하면 피연산자를 입력하라는 메시지가 표시되는 문제가 해결되었습니다. 이러한 조건에는 피연산자가 필요하지 않습니다. (TGT-51961)
...
* 컨텐츠 전달에서 올바르게 작동하지만 XF(경험 조각) 컨텐츠가 [!UICONTROL VEC(시각적 경험 작성기) 미리 보기에서 렌더링되지 않는 문제를 해결했습니다. ]&#x200B;(TGT-53318)
...
* [!UICONTROL 타깃팅] 탭에서 다시 [!UICONTROL 경험]&#x200B;(으)로 이동한 후 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)에서 수정된 HTML 오퍼가 지속되지 않는 업데이트된 [!DNL Target] UI의 문제를 해결했습니다. (TGT-52874)
* 업데이트된 [!DNL Target] UI에서 동일한 선택기의 앞에 한 개의 HTML 오퍼를 삽입하고 그 뒤에 다른 오퍼를 삽입하면 잘못된 위치가 생성되는 문제를 해결했습니다. 고객이 [!UICONTROL 타깃팅] 탭에서 [!UICONTROL 경험] 탭으로 돌아왔을 때 하나의 선택기만 유지되어 수정 내용이 손실되고 콘텐츠 전달이 중단되었습니다. 이 동작은 고유한 위치 식별자를 사용하여 두 수정 사항을 모두 올바르게 보존한 레거시 UI와 다릅니다. (TGT-52891)
* 업데이트된 [!DNL Target] UI에서 [!UICONTROL 수정 사항] 레일 내에서 추가된 오퍼를 클릭하면 오른쪽의 [!UICONTROL 구성] 패널이 간헐적으로 나타났다가 사라져 오퍼 설정과 상호 작용하기 어려운 문제가 해결되었습니다. (TGT-53288)
...
* 업데이트된 VEC에서 고객이 [!UICONTROL 단일 페이지 애플리케이션]&#x200B;(SPA) 보기에 수정 사항을 적용하지 못하는 문제를 해결했습니다. 이전 UI에서 만든 활동이 보기별 타깃팅을 지원하지만, 새 UI는 보기 전환 컨트롤이 비활성화되어 표시된 상태에서 해당 보기에 대한 편집을 감지하거나 허용하지 못했습니다. (TGT-52556)
...
* [!UICONTROL 시각적 경험 작성기]에서 경험에 대한 수정 사항이 표시되지 않거나 UI에 일관되지 않게 표시되는 문제가 수정되었습니다. (TGT-TGT-53381)
* 업데이트된 VEC에서 [!UICONTROL 콘텐츠 관리] 섹션이 경험 썸네일에 대한 대체 텍스트를 표시하지 못하는 문제를 해결했습니다. 이 문제로 인해 사용자가 문서를 식별하는 데 어려움을 겪었습니다. 특히 파일 이름이 길거나 잘린 경우 더욱 그렇습니다. (TGT-52291)
* VEC 활동에서 [!UICONTROL 페이지 배달] 규칙을 구성할 때 고객이 잘못된 유효성 검사 오류를 발생하는 오류를 수정했습니다. 특히, 텍스트 값을 입력할 때 텍스트가 지원되어야 하지만 &quot;다음 중 1개 이상의 항목과 같음&quot; 및 &quot;다음 중 같은 항목 없음&quot;과 같은 연산자는 &quot;연산자 유형에 대한 잘못된 입력&quot;을 트리거했습니다. (TGT-52629)
* &quot;오퍼 선택&quot; 단추를 사용하여 오퍼를 선택할 때 업데이트된 UI의 [!UICONTROL 수정 사항] 패널에서 일관되지 않은 동작을 초래하는 몇 가지 문제를 해결했습니다. 기존 오퍼를 바꾸는 대신 UI에서 중복을 추가하고 두 오퍼 중 하나와 상호 작용하려고 시도하면 `selectorNotFound`과(와) 같은 콘솔 오류가 발생했습니다. 또한 일부 오퍼에는 &quot;오퍼 선택&quot; 버튼이 표시되지 않고 편집 가능한 속성만 표시됩니다. (TGT-53321)
...
* 업데이트된 [!DNL Target] UI에서 작업 영역 간에 활동을 복사할 때 여러 문제가 해결되었습니다. 사용자가 원본 및 대상 작업 영역 모두에서 &quot;[!UICONTROL 승인자]&quot; 역할을 가지고 있더라도 고객 액세스, 특히 라이브 활동 및 잘못된 권한 유효성 검사와 관련된 오류가 발생했습니다. (TGT-53002)
...
* [!UICONTROL 가격 규칙 선택] 드롭다운 목록에서 &quot;다음 값 사이&quot; 옵션을 선택할 때 문자열 &quot;to&quot;가 [!UICONTROL 포함 규칙] 섹션에서 현지화되지 않은 [!UICONTROL 기준 만들기] 모달의 현지화 문제를 해결했습니다. (TGT-49754)
* 피드 만들기 마법사의 [!UICONTROL 환경] 드롭다운 목록에 있는 문자열 &quot;[!UICONTROL 모든 호스트 그룹]&quot;이(가) 올바르게 현지화되지 않는 현지화 문제를 해결했습니다. (TGT-46737)
...
* QA 환경에서 활동을 만들 수 없는 문제를 해결했습니다. 프로세스가 완료되지 않고 [!UICONTROL 활동] 페이지로 리디렉션되었습니다. (TGT-53328)
...
* 업데이트된 UI에서 [!UICONTROL 카탈로그 검색]의 필터 제안이 부정확하던 문제를 해결했습니다. (TGT-52007)
...
* 사용자가 AP(Automated Personalization) 활동을 편집하는 동안 [!UICONTROL 콘텐츠 관리]를 클릭한 다음 [!UICONTROL 완료]를 클릭하면 페이지가 비어 있고 응답하지 않는 문제를 해결했습니다. (TGT-53047 및 TGT-52993)
* [!UICONTROL 목표 및 설정]에서 [!UICONTROL mbox 확인함] 전환 지표를 선택하면 페이지가 충돌하는 문제가 해결되었습니다. (TGT-53346, TGT-53343 및 TGT-53348)
* [!UICONTROL URL로 리디렉션] 기능이 예상대로 작동하지 않는 문제가 해결되었습니다. 올바른 URL이 있어도 리디렉션이 발생하지 않습니다. (TGT-53307)
...
* 작업 영역이 &quot;[!UICONTROL 모든 작업 영역]&quot;(으)로 설정되어 있을 때 기본 작업 영역에 이미 있는 활동을 복사하면 잘못된 오류가 발생하는 문제를 해결했습니다.
...
* [!UICONTROL Automated Personalization]&#x200B;(AP) 활동에서 삭제된 오퍼가 원래 이름 대신 `Deleted option with ID: X`(예: 기존 UI에 표시된 `Offer Name [Deleted]`)으로 표시되는 업데이트된 [!DNL Target] UI의 문제를 해결했습니다. 이 수정 사항은 삭제된 오퍼에 대해 의미 있는 레이블을 복원하여 명확성을 개선하고 보다 정확하고 사용자 친화적인 보고를 만듭니다. (TGT-52921)
...
* 수정 내용을 [!DNL Page Load]에서 [!UICONTROL 보기]&#x200B;(으)로 이동하면 수정 내용이 중복되어 [!UICONTROL 보기]에도 표시되면서 [!UICONTROL 페이지 로드]에 남아 있는 문제가 해결되었습니다. 또한 [!UICONTROL 보기]에서 수정 사항을 제거하면 [!UICONTROL 페이지 로드]에서도 수정 사항이 잘못 제거됩니다. (TGT-53270)
...
* [!UICONTROL Automated Personalization]&#x200B;(AP) 활동을 만들거나 편집할 때 **[!UICONTROL 콘텐츠 관리]** 아이콘(![콘텐츠 관리 아이콘](/help/main/assets/icons/Experience.svg))을 클릭한 후 편집기가 충돌하는 [!UICONTROL 양식 기반 경험 작성기]의 문제를 해결했습니다. (TGT-53047)
...
* 목록의 맨 아래로 스크롤할 때 [!UICONTROL 카탈로그 검색]에서 추가 결과를 로드할 수 없도록 하는 문제를 해결했습니다. 이전 UI와 일치하는 동작을 복원합니다. (TGT-53088)
* [!UICONTROL 기준 세부 정보] 대화 상자에서 항목 삭제를 차단하는 문제를 해결했습니다. (TGT-53245)
* 이름이 없는 제품을 열거나 상호 작용할 수 없는 문제를 해결했습니다. 이 문제는 명명되지 않은 결과를 반환하는 환경을 선택할 때 발생하여 제품 세부 정보에 대한 액세스를 방해했습니다. (TGT-53007)
* 특정 제품을 선택할 때 [!UICONTROL 카탈로그 검색] 페이지가 충돌하고 빈 화면이 표시되는 문제를 해결했습니다. (TGT-53087)
* 사용자가 [!DNL Target] UI에서 site_cart_z1 [!DNL Recommendation] 활동을 편집할 수 없는 문제가 해결되었습니다. 활동을 열려고 하면 [!UICONTROL 개요] 페이지에서 오류가 발생하여 편집기에 대한 액세스가 차단됩니다. (TGT-53221)
...
* VEC에서 이미지 오퍼를 구성할 때 [!UICONTROL 다음 항목 앞에 삽입] 및 [!UICONTROL 다음 항목 뒤에 삽입] 옵션에 대한 [!UICONTROL 실행 취소] 기능 문제를 해결했습니다.

  이전에는 이미지 오퍼에서 [!UICONTROL 다음 항목 앞에 삽입] 또는 [!UICONTROL 다음 항목 뒤에 삽입] 동작을 실행 취소하면 일관되지 않은 동작이 발생하거나, 특히 이전 [!DNL Target] UI에서 만든 활동에서 수정 사항을 제대로 되돌리지 못했습니다. 이 문제는 실행 취소 작업이 이러한 수정 사항에 대해 안정적으로 작동하도록 하기 위해 해결되었습니다. (TGT-52809)
...
* [!UICONTROL 목표 및 설정]의 [!UICONTROL 우선 순위] 슬라이더에 레거시 기능을 복원하여 고객이 레거시 UI에서 지원되는 대로 숫자 값을 직접 입력할 수 있도록 했습니다. (TGT-53185 및 TGT-53219)
...
* 고객이 [!UICONTROL 목표 및 설정] 페이지에서 특정 활동에 대한 보고서를 볼 때 [!UICONTROL 분석에서 보기] 링크가 프로덕션 환경이 아닌 QA 환경을 잘못 가리키는 문제가 해결되었습니다. (TGT-53163)

+++

**[!UICONTROL 경험] 및 [!UICONTROL 오퍼]**
...
* 활동 [!UICONTROL 개요] 페이지에서 지표 이름이 누락되고 올바른 지표 이름 대신 &#39;오퍼&#39;만 표시되는 문제가 해결되었습니다. (TGT-53054)
...
* 활동이 저장되지 않고 오류 메시지를 트리거하는 [!UICONTROL 양식 기반 경험 작성기]의 문제를 해결했습니다. &quot;정의되지 않은 속성을 읽을 수 없습니다(&#39;맵&#39; 읽기)&quot;. (TGT-53145)
...
* [!UICONTROL 카탈로그 검색]에서 제품을 클릭하면 &#39;제품 세부 정보를 검색하지 못했습니다&#39;라는 오류가 표시되고 닫기 옵션 없이 모달이 열리는 문제가 해결되었습니다. (TGT-53082)
* 컬렉션이나 프로모션을 변경할 때 [!UICONTROL A/B 테스트] 활동의 [오퍼로서의 권장 사항](/help/main/c-recommendations/recommendations-as-an-offer.md)이 올바르게 업데이트되지 않는 문제를 해결했습니다. (TGT-52884)
...
* [!UICONTROL 목표 및 설정] 페이지에서 여러 경험에 사용된 선택기가 선택된 상태로 일관되게 강조 표시되지 않던 문제를 해결했습니다. (TGT-53062)
...
* 작업 영역 간 속성을 변경할 때 발생하는 문제를 해결했습니다.
  ...
  * [!UICONTROL 속성] 목록에 경고가 표시되고(일부 속성이 호환되지 않을 수 있음을 나타낼 수 있음) 고객이 [!UICONTROL 추가] 또는 [!UICONTROL 제거]를 클릭한 다음 [!UICONTROL 저장]을 클릭하면 대상 작업 영역에 없는 모든 속성이 제거됩니다. 고객이 [!UICONTROL 취소]를 클릭하면 대상 작업 영역에 없는 경우에도 모든 속성이 유지됩니다. (TGT-47094)
  * 동일한 작업공간에 있거나 기본이 아닌 작업공간에서 기본 또는 다른 작업공간으로 전환하는 경우 모든 것이 그대로 유지됩니다. (TGT-53078)
* 활동의 원래 작업 영역 컨텍스트를 준수하도록 엔티티 유효성 검사 논리를 업데이트했습니다. [!UICONTROL 경험 조각]&#x200B;(XF)과 같은 엔터티는 이제 활동을 처음 만든 작업 영역을 기반으로 유효성이 검사됩니다. 예를 들어, 기본 작업공간에 XF가 존재하고 활동이 작업공간 X에서 작업공간 Y로 복사되는 경우 원본(기본) 작업공간에서 XF가 유효한 한 유효성 검사가 계속 진행됩니다. (TGT-53196)
...
* [!UICONTROL 활동 QA] URL에 불필요한 쿼리 매개 변수가 포함된 문제가 해결되었습니다. `at_preview_evaluate_as_true_audience_ids`. (TGT-52907)
* 미리보기 URL이 사용자가 명시적으로 입력한 대상 이외의 추가 대상을 잘못 포함하던 문제를 수정했습니다. QA 또는 미리 보기 링크를 생성할 때 지정된 대상만 적용되도록 이 동작이 수정되었습니다. (TGT-52912)
* 트래픽 할당을 설정하는 동안 [!UICONTROL 자동 할당]&#x200B;(AA)을 먼저 선택한 경우 사용자가 [!UICONTROL 자동 타겟]&#x200B;(AT) 활동을 만들 수 없는 문제를 해결했습니다. 이 문제로 인해 백엔드 유효성 검사 오류가 발생하고 활동이 저장되지 않습니다. (TGT-53096)
...
* [!UICONTROL 승인자] 역할을 가진 사용자가 활동 전용 대상 세분화를 추가하거나 저장할 수 없는 문제를 해결했습니다. 사용자에게 활동을 승인하고 관리할 권한이 충분함에도 불구하고 &quot;[editor]&quot; 권한이 필요함을 알리는 403 금지된 오류가 발생했습니다. (TGT-52984)
* [!UICONTROL 대상 개선 제거] 옵션을 사용하여 활동별 대상을 제거할 때 동일한 활동 내에서 다시 선택할 대상 목록에 대상이 더 이상 표시되지 않는 문제가 해결되었습니다. 이 비헤이비어는 사용자가 동일한 대상자를 처음부터 다시 만들지 않는 한 다시 추가하지 못하도록 했습니다. (TGT-52979)
...
* [!UICONTROL 모든 방문자] 이외의 대상을 활동에 할당하려고 할 때 발생하는 문제를 해결했습니다. 저장하면 다음과 같은 오류 메시지가 표시됩니다. &quot;요청을 완료할 수 없습니다. 문제가 지속되면 [!UICONTROL Adobe Client Care]에 문의하십시오.&quot; (TGT-53008)
...
* 모든 콘텐츠 옵션이 제거된 후 [!UICONTROL 콘텐츠 관리] 기능이 위치 상태를 제대로 확인하지 못하는 문제를 해결했습니다. 이 문제로 인해 활동 구성을 저장하거나 진행하려고 할 때 일관되지 않은 동작이나 오류가 발생할 수 있습니다. (TGT-52801)
...
* 새 [!DNL Recommendations] 피드 [상태](/help/main/c-recommendations/c-products/feeds.md#status)를 추가했습니다. [!UICONTROL 부분 가져오기 실패]. (KB-2215)
* [!UICONTROL 프로모션]을(를) 사용하여 [!DNL Recommendations]을(를) 추가할 때 활동 만들기 워크플로에 영향을 주는 문제를 해결했습니다. 사용자가 &quot;[!UICONTROL 속성별 승격]&quot;을(를) 선택하고 필터링 규칙을 추가한 경우(예: [!UICONTROL 매개 변수 일치]) 활동을 저장하고 다시 편집한 후 선택한 규칙 유형 및 피연산자 값이 유지되지 않았습니다. 다시 열면 필터링 규칙 유형이 예기치 않게 변경되고 피연산자 값이 누락됩니다. (TGT-53059)
* 단일 규칙으로 만든 프로모션이 규칙의 논리에 관계없이 &quot;항목 목록&quot; 프로모션 유형으로 잘못 해석되어 표시되는 [!DNL Recommendations] UI의 문제가 해결되었습니다. (TGT-53063)
* 업데이트된 [!UICONTROL 개요]UI를 사용할 때 [!DNL Recommendations]이(가) 포함된 [!UICONTROL 경험 타깃팅]&#x200B;(XT) 활동에 대해 &quot;[!UICONTROL 권장 사항 데이터 다운로드]&quot; 단추가 누락되는 문제를 해결했습니다. (TGT-52730 및 TGT-52756)
...
* 추천이 있는 양식 기반 A/B 활동에서 &quot;[!UICONTROL 특성별 프로모션]&quot; 프로모션을 구성할 때 고객이 필터링 규칙을 저장할 수 없는 문제를 해결했습니다. 활동을 저장하고 다시 연 후 필터링 규칙이 누락되어 활동을 저장할 수 없습니다. (TGT-53057)
...
* [!UICONTROL 보고서] 페이지에서 &quot;[!UICONTROL 주문 세부 정보를 CSV로 내보내기]&quot;를 선택하면 다운로드되는 빈 파일이 발생하는 문제가 해결되었습니다. 이 문제는 활동에 유효한 주문 데이터가 있는 경우에도 발생했습니다. (TGT-52225)
...
* 사용자 지정 코드를 편집하고 저장하면 [!UICONTROL 수정 사항] 패널이 응답하지 않는 문제를 해결했습니다. (TGT-53075)
* 변형 경험에서 사용자 지정 코드에 대한 수정 사항이 실수로 [!UICONTROL 컨트롤] 경험에 반영되는 문제가 해결되었습니다. 이로 인해 게재 동작이 의도하지 않게 변경되었습니다. [!UICONTROL 컨트롤] 경험은 이제 다른 경험에 대한 사용자 지정 코드 편집에서 격리된 상태로 유지됩니다. (TGT-52413)
...
* 활동 만들기 [!UICONTROL 수정] 단계의 변경 사항이 일관되게 저장되지 않던 문제를 수정했습니다. 경우에 따라 모든 단계를 완료하고 [!UICONTROL 저장]을 클릭하면 저장 프로세스 중에 표시되는 오류가 없더라도 [!UICONTROL 수정] 섹션에 추가된 사용자 지정 스크립트가 라이브 사이트에 반영되지 않습니다. (TGT-52661)
...
* 사용자가 [!UICONTROL 찾아보기 모드]에 있는 동안 다른 URL을 찾아볼 수 없는 문제가 해결되었습니다. 이렇게 하면 테스터와 편집자가 동일한 활동 세션 내에서 대체 페이지를 확인하거나 미리 볼 수 없습니다. (TGT-53052)
* 활동을 만드는 동안 여러 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC) 인스턴스가 동시에 열리는 문제를 해결했습니다. 이 문제는 사용자가 [!UICONTROL EEC(고급 경험 작성기])를 사용하지 않도록 설정하고 [!UICONTROL 페이지 전달] 단계에서 웹 사이트 URL의 뒤쪽 슬래시를 제거하는 동안 발생했습니다. (TGT-52782)
* 사용자가 다른 지표를 선택한 후에도 [!UICONTROL 목표 및 설정] 단계의 [!UICONTROL 매출] 지표 드롭다운이 [!UICONTROL 방문당 매출]&#x200B;(RPVISIT)로 잘못 설정되는 문제를 해결했습니다.  지표 구성 패널을 축소하고 다시 확장할 때 문제가 발생하여 이전에 선택한 값이 재설정되었습니다. (TGT-52811 및 TGT-52878)
* AP([!UICONTROL Automated Personalization]) 및 MVT([!UICONTROL Multivariate Testing]) 활동의 오퍼 이름 지정 및 컨텐츠 번역과 관련된 활동 만들기 워크플로의 몇 가지 문제를 해결했습니다.

  해결된 주요 문제:

  * 이름이 같은 여러 HTML 오퍼를 만들면(예: &quot;경험&quot;) &quot;중복된 오퍼 이름은 허용되지 않습니다&quot; 오류가 발생했지만 UI에서 충돌을 일으키는 오퍼를 명확하게 표시하지 않았습니다.
  * 오른쪽 패널을 통해 오퍼의 이름을 바꾸면 UI에서 이름이 업데이트되었지만 변경 내용이 [!UICONTROL 콘텐츠 관리] 탭 또는 [!UICONTROL 오퍼] 탭에 반영되지 않아 지속적인 유효성 검사 오류가 발생했습니다.
...
* [!UICONTROL 다시 정렬] 옵션을 업데이트된 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC) UI에 추가하여 기존 VEC에서 사용할 수 있는 기능에 맞춥니다. (TGT-46957 및 TGT-52876)
* [!UICONTROL A/B 테스트] 활동에서 변형 경험(예: 경험 B)에 대한 수정 사항이 유지되지 않는 문제를 해결했습니다. 경험 간에 전환하면 변형에 대한 변경 사항이 사라집니다. 이 문제는 제어 경험에 영향을 주지 않았습니다. (TGT-52664)
* 특정 고객은 활동을 만들거나 저장할 수 없지만 다른 고객은 문제 없이 동일한 작업을 수행할 수 있는 문제를 해결했습니다. 여러 계정에서 문제가 일관되지 않았습니다.(TGT-52842)
* 업데이트된 VEC에서 사용자가 기존 UI에 있던 기능인 [!UICONTROL 페이지 로드 이벤트]에 대한 수정 사항을 이동할 수 없던 문제를 해결했습니다. (TGT-52617)
* 업데이트된 UI에서 변경 내용을 만들 때 [!DNL Target]에 [!UICONTROL 페이지 로드] 이벤트가 표시되지 않는 문제가 해결되었습니다. 업데이트는 보기에만 적용됩니다. (TGT-52604)
* 일부 활동 수정 사항이 업데이트된 VEC에 제대로 표시되지 않는 문제를 해결했습니다. (TGT-52818)
* AP([!UICONTROL Automated Personalization]) 활동에 대한 보고 데이터를 가져올 때 발생하는 null 포인터 예외를 해결했습니다. (TGT-52362)
* [!UICONTROL Automated Personalization]&#x200B;(AP) 활동에 대한 .CSV 파일에 오퍼 수준 세부 정보가 표시되지 않는 문제를 해결했습니다. (TGT-52675)
* 업데이트된 VEC에서 수정 사항을 적용할 때 예상된 [!UICONTROL 경험 조각]을 포함하여 변경 사항이 처음에 올바르게 표시되는 문제를 해결했습니다. 그러나 경험을 전환하거나 추가로 편집할 때 선택기 문제로 인해 일부 수정 사항이 적용되지 않습니다. (TGT-52679)
* 기존 활동을 복제하여 새 활동을 만들 때 복제된 활동의 QA 링크가 원래 활동의 페이지 URL을 잘못 유지하는 문제를 해결했습니다. (TGT-52775)
* 업데이트된 VEC에서 의도하지 않게 [!UICONTROL 온디바이스 의사 결정]을 사용할 수 없는 문제를 해결했습니다. (TGT-52371)
* 제품 [!DNL Recommendations] 활동을 편집할 수 없는 문제를 해결했습니다. Target UI를 통해 VEC에 액세스하려고 할 때 [!UICONTROL 개요] 페이지에 오류가 발생하여 편집할 수 없습니다. (TGT-52823)
...
* [!UICONTROL 편집기] 역할을 가진 사용자가 [!DNL Recommendations] 활동을 편집할 수 없는 문제가 해결되었습니다. 사용자가 관련 작업 영역에서 이미 해당 역할을 가지고 있더라도 디자인을 변경하고 활동을 저장하려고 하면 &quot;[editor]&quot; 권한이 필요함을 알리는 403 금지된 오류가 발생했습니다. (TGT-52836)
...
* 특정 활동에 대해 [!UICONTROL 자동화된 세그먼트] 및 [!UICONTROL 중요 특성] 보고서가 생성되지 않는 문제가 해결되었습니다. (TGT-52904)
* 업데이트된 VEC에서 AP([!UICONTROL Automated Personalization]) 활동의 기본 콘텐츠 처리가 레거시 UI와 일치하지 않는 문제를 해결했습니다. 이제 명시적으로 추가된 그룹이 없을 때 시스템은 `optionGroupLocalId = 0`을(를) 가진 &quot;기본 콘텐츠&quot;라는 기본 `optionGroup`을(를) 자동으로 추가합니다. 이 그룹에는 기본 옵션(예: `optionLocalId: 0`)이 포함되어 있습니다. 기본 콘텐츠가 제거되면 해당 옵션 그룹도 제거됩니다. (TGT-52651)
* 이전에 제거한 경험에서 `experienceLocalId`을(를) 다시 사용할 수 없도록 잘못 설정된 [!UICONTROL 다변량 테스트]&#x200B;(MVT) 활동의 문제를 해결했습니다. (TGT-52672)
...
* 요청 페이로드의 인식할 수 없는 속성으로 인해 실시간 [!UICONTROL 권장 사항] 활동을 업데이트할 때 발생하는 오류를 수정했습니다. 이제 시스템에서 &quot;잘못된 JSON&quot;을 올바르게 처리합니다. 인식할 수 없는 속성 이름 오류. (TGT-52723)
* [!DNL Recommendations] 디자인을 만들 수 없는 문제를 해결했습니다. [!UICONTROL 만들기]를 클릭하면 &quot;스크립트 내에 하나 이상의 엔터티 변수가 사용되어야 합니다.&quot;라는 메시지가 트리거되었습니다. (TGT-52395 및 TGT-52899)
* 수정 없이 [!DNL Recommendations] 디자인을 다시 저장하는 작업이 차단되는 문제를 해결했습니다. (TGT-52879)
* [!UICONTROL 권장 사항] 활동을 저장할 때 &quot;400 잘못된 요청&quot; 오류가 발생하는 백엔드 유효성 검사 오류를 해결했습니다. (TGT-52716)
* [!UICONTROL 양식 기반 경험 작성기]에서 [!UICONTROL 위치] 드롭다운에서 특수 문자가 있는 mbox를 마우스로 가리키면 편집기가 비어 있고 &quot;요소&quot;에서 &quot;querySelector&quot;를 실행하지 못했습니다&quot;라는 문제가 해결되었습니다. 라는 오류가 표시됩니다. (TGT-52717)
...
* 업데이트된 [!DNL Target] UI 및 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)에 대한 일반적인 질문을 해결하기 위해 [새 FAQ 문서](/help/main/c-intro/updated-ui-faq.md)을 추가했습니다.
* [!UICONTROL 페이지 게재]의 &quot;[!UICONTROL URL - 포함하지 않음]&quot; 규칙이 작동하지 않아 콘텐츠를 차단해야 하는 경우에도 표시할 수 있는 문제가 해결되었습니다. (TGT-52754)
* [!UICONTROL 페이지 게재]에 오류 메시지가 잘못 표시되는 문제가 해결되었습니다. &quot;중복된 페이지 URL은 허용되지 않습니다. (TGT-52765)
* 경험 조각이 포함된 [!UICONTROL 페이지 게재] URL의 대상이 # 잘못 추가된 상태로 만들어지는 문제가 해결되었습니다. (TGT-52786)
* [!UICONTROL 목표 및 설정] 페이지에서 활동을 복사하고 설정을 편집하면 [!DNL Target] UI가 응답하지 않는 문제를 해결했습니다. (TGT-52797)
* 업데이트된 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)에서 [!UICONTROL A/B 테스트] 활동의 추가 페이지를 동일한 URL로 잘못 리디렉션하는 것을 허용하는 문제를 해결했습니다. (TGT-51838)
* 활동을 편집할 때 [!UICONTROL 목표 및 설정] 페이지의 지표 변경 사항이 저장되지 않던 문제를 수정했습니다. (TGT-52799)
...
* 업데이트된 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)에서 `triggerView()` 호출이 검색되지 않는 문제를 해결했습니다. (TGT-52575)
* 업데이트된 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)에서 사용자가 [!UICONTROL 단일 페이지 애플리케이션]&#x200B;(SPA) 보기에 수정 사항을 추가하지 못하는 문제를 해결했습니다. (TGT-52556)
* 업데이트된 [!DNL Target] UI에서 고객이 오퍼 세부 정보를 볼 수 없는 문제를 해결했습니다. (TGT-52607)
* [!UICONTROL 오퍼 라이브러리]의 오퍼에 대한 업데이트가 업데이트된 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)에 반영되지 않는 문제를 해결했습니다. (TGT-52637)
...
* [!UICONTROL 활동 QA] 단추가 없는 활동에 빈 옵션 선택기가 표시되는 문제를 해결했습니다. (TGT-52733)
* QA 링크가 콘텐츠를 제대로 렌더링하지 못하는 문제를 해결했습니다. (TGT-52718)
* 요소를 경험 조각으로 바꾸면 QA 환경에서 변경 사항이 올바르게 반영되지 않는 문제를 해결했습니다. (TGT-52762)
* 사용자가 경험 조각을 추가하려고 할 때 &quot;잘못된 입력&quot; 오류가 발생하는 업데이트된 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)의 문제를 해결했습니다. (TGT-52701)
* 업데이트된 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)에서 대상 타깃팅을 편집할 때 &quot;대상 편집&quot; 모달이 비어 있는 것으로 표시되는 문제가 수정되었습니다. (TGT-52749)
* 선택한 작업 영역에서 엔티티에 액세스할 수 없는 경우 사용자에게 알리는 메시지가 추가되었습니다. (TGT-52767)
* UI에서 조건에 환경 ID를 수동으로 할당할 수 없었던 문제가 해결되었습니다. 대신 기본적으로 [!UICONTROL 제품 카탈로그 검색] 호스트 그룹의 ID가 사용됩니다. 이 수정 사항은 이제 기본값뿐만 아니라 모든 환경에 기준 변경 사항이 적용되도록 합니다. (TGT-52817)
* 권장 사항이 있는 [!UICONTROL 경험 타깃팅]&#x200B;(XT) 활동에 대해 &quot;[!UICONTROL 권장 사항 데이터 다운로드]&quot; 옵션이 누락되는 문제를 해결했습니다. (TGT-52730 및 TGT-52756)
...
* 내부 웹 페이지에 대해 페이지를 로드하지 못했을 때 [!UICONTROL VEC(시각적 경험 작성기])에서 수정 사항에 액세스할 수 없는 문제를 해결했습니다. (TGT-52488 &amp;TGT-52470)
* VEC의 작은 화면 크기에서 [!UICONTROL 수정 사항] 패널이 표시되지 않는 문제를 해결했습니다. (TGT-52470)
* 업데이트된 VEC에서 [!UICONTROL 찾아보기] 모드에서 [!UICONTROL 디자인] 모드로 다시 전환하면 콘솔 오류가 발생하여 더 이상 상호 작용하지 못하는 문제가 해결되었습니다. (TGT-52532)
...
* 활동의 [!UICONTROL 개요] 페이지에 [!UICONTROL 활동 위치]에 대한 잘못된 URL이 표시되는 문제를 해결했습니다. (TGT-52695)
...
* [!UICONTROL 경험 조각] 또는 HTML 오퍼를 활동에 추가할 때 잘못된 페이로드 오류가 발생하는 문제를 해결했습니다. (TGT-52779 및 TGT-52773)
* 잘못된 입력 오류로 인해 E[!UICONTROL 경험 조각]이(가) 올바르게 표시되지 않는 업데이트된 [!DNL Target] UI의 문제를 해결했습니다. (TGT-52701)
* 잘못된 사용자 오류로 인해 고객이 [!UICONTROL 양식 기반 경험 작성기]에서 활동을 편집할 수 없는 문제를 해결했습니다. (TGT-52470)
...
* 기존 [!DNL Target] UI의 기능에 맞추기 위해 [!UICONTROL 보고서] > [!UICONTROL 보고서 설정]&#x200B;( ![보고서 설정 아이콘](/help/main/assets/icons/Setting.svg)) 아래에 QA 모드 트래픽 설정을 추가했습니다. (TGT-52228 및 TGT-52329)
...
* 업데이트된 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)가 `at_property` 값을 자동으로 검색하지 못하는 문제가 해결되었습니다. (TGT-52347)
* 양식 요소와 상호 작용할 때 VEC에서 [!UICONTROL 찾아보기]와 [!UICONTROL 디자인] 모드 간을 전환한 후 하나만 예상될 때 두 개의 수정 사항이 기록되는 문제를 해결했습니다. (TGT-52455)
* 선택기가 잘못되었거나, 이미 사용되었거나, 표시되지 않는다는 오류 때문에 업데이트된 VEC에서 [!UICONTROL 요소 클릭] 설정을 선택할 수 없는 문제를 해결했습니다. (TGT-52467)
* 업데이트된 VEC에 [!UICONTROL 추천 오퍼] 상자를 추가하면 중복(고스트) 상자가 표시되는 문제가 해결되었습니다. 경험 A와 경험 B 간을 전환하면 더 많은 고스트 상자가 반복적으로 추가되었습니다. (TGT-52505 및 TGT-52519)
* 업데이트된 [!DNL Target] UI에서 [!UICONTROL 오퍼] 메뉴를 통해 변경된 HTML 오퍼가 관련 활동에 반영되지 않거나 그 반대의 경우 문제가 해결되었습니다. 이제 이 동작은 [!UICONTROL 오퍼] 메뉴와 활동 간에 업데이트가 올바르게 동기화되는 레거시 UI와 일치합니다. (TGT-52540 및 TGT-52541)
* [!UICONTROL 오퍼 라이브러리]에 있는 [!UICONTROL 경험 조각]에 대한 최근 업데이트가 활동 내에서 사용하려고 할 때 반영되지 않는 문제를 해결했습니다. (TGT-52659)
...
* [!UICONTROL 활동] 목록의 이름별 검색 기능이 다중 단어 쿼리에서 제대로 작동하지 않는 문제가 해결되었습니다. (TGT-52529)
* [!UICONTROL Automated Personalization]&#x200B;(AP) 활동에서 경험을 제외하지 못하는 문제를 해결했습니다. (TGT-52383)
* AP 활동에서 콘텐츠를 관리할 때 [!UICONTROL 필터 규칙]에서 &quot;[!UICONTROL 포함]&quot; 옵션이 누락되는 문제를 해결했습니다. (TGT-52384)
...
* [!UICONTROL 승인자] 권한이 있는 사용자가 라이브 활동을 편집할 수 없도록 잘못 차단되어 &quot;액세스 거부됨&quot; 오류 메시지가 표시되는 문제를 해결했습니다. (TGT-52416)
...
* [!DNL Recommendations] 활동에 대한 [!UICONTROL VEC(시각적 경험 작성기)에서 시퀀스 기준이 올바르게 표시되지 않는 문제가 수정되었습니다. ]&#x200B;(TGT-52435)
...
* [!UICONTROL 제품 관리자] 및 [!UICONTROL 시스템 관리자] 권한이 있는 [!DNL Target] 사용자는 이제 [!DNL Target]의 역할에 관계없이 [!UICONTROL 관리] 페이지에서 모든 설정을 편집할 수 있습니다. 이러한 권한이 없는 사용자는 이러한 설정에 대해 읽기 전용 액세스 권한을 갖습니다. 이 업데이트는 [관리 설정](/help/main/administrating-target/administrating-target.md)에 대한 액세스 제어를 강화합니다. (TGT-48179)
...
* 고객이 VEC에서 사이트를 로드한 후 [!UICONTROL 사이트 환경 설정] 섹션에서 ID 및 클래스별 선택을 활성화할 수 없는 문제를 해결했습니다. [!UICONTROL 사이트 환경 설정] 설정을 사용하도록 설정한 후에도 사용하지 않도록 자동으로 되돌렸습니다. (TGT-52207)
* [페이지 배달](/help/main/c-experiences/c-visual-experience-composer/viztarget-options.md#settings) URL이 슬래시(/)로 끝났을 때 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)가 올바른 페이지를 표시하지 못하는 문제를 해결했습니다. (TGT-52237)
...
* [!UICONTROL 개요] 활동 페이지에서 [!DNL Customer Journey Analytics]이(가) 올바르게 표시되지 않도록 차단하는 문제를 해결했습니다. (TGT-52359)
...
* 기본 오퍼가 선택되었지만 다른 오퍼 콘텐츠가 [!UICONTROL AP(Automated Personalization]) 및 [!UICONTROL MVT(다변량 테스트]) 활동에 표시되는 문제를 해결했습니다. (TGT-52372)
* 전체 조직 액세스와 특정 조직 + 사용자 액세스 사이에서 OR로 확인하는 GET 권한 논리를 수정했습니다. (TGT-52374)
* [!UICONTROL 선택한 항목만 표시]를 활성화했지만 [!UICONTROL 관리 콘텐츠] 및 [!UICONTROL 보고 대상]에 대한 대상을 선택한 후 대상 이름이 표시되지 않는 문제를 해결했습니다. (TGT-52393)
...
* [!UICONTROL 활동] 설정 페이지와 [!UICONTROL 보고] 개요 페이지 간에 대상 목록이 일치하지 않는 문제를 해결했습니다. (TGT-52203)
...
* 활동의 [!UICONTROL 개요] 페이지에서 위치가 올바르지 않은 문제를 해결했습니다. (TGT-52182)
...
* 페이지를 추가한 후 [!UICONTROL 경험] 탭으로 다시 이동한 후 수정 사항이 사라지는 문제를 해결했습니다. (TGT-52264)
* 고객이 [!UICONTROL 경험 타깃팅]&#x200B;(XT) 활동에서 대상을 변경할 수 없도록 차단하는 문제가 해결되었습니다. (TGT-52191)
* 지원되지 않는 UI 규칙으로 인해 XT 활동을 편집할 수 없는 오류가 수정되었습니다. (TGT-52273)
* 업데이트된 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)에서 이동 경로가 편집기 하단에 항상 표시되지 않아 요소를 정확하게 선택할 수 없는 문제를 해결했습니다. (TGT-52169)
* 페이지 매김으로 인해 [!UICONTROL 대상] 드롭다운 목록에 모든 대상을 표시하지 못하는 문제가 해결되었습니다. (TGT-52204)
* AP([!UICONTROL Automated Personalization]) 활동에서 새 오퍼를 추가할 때 잘못된 사용자 입력 메시지가 발생하는 문제를 해결했습니다. (TGT-52210)
* 고객이 A4T에 액세스할 수 없어도 [!UICONTROL Analytics for Target]&#x200B;(A4T)이 보고 소스로 잘못 선택되던 문제를 해결했습니다. (TGT-52226)
* [!UICONTROL 페이지 보기] URL 지표로 활동을 저장할 수 없는 문제를 해결했습니다. (TGT-52260)
...
2025년 4월 22일부터 [!DNL Target] 작업 영역의 역할에 관계없이 [!UICONTROL 제품] 및 [!UICONTROL 솔루션] 관리자만 [!UICONTROL 관리] 섹션의 설정을 업데이트할 수 있습니다. 이 권한이 없는 사용자는 [!UICONTROL 관리] 섹션에 대한 읽기 전용 액세스 권한을 갖게 됩니다.
...
* AP([!UICONTROL Automated Personalization]) 활동에서 오퍼 수준 타깃팅을 편집할 때 대상 정의가 표시되지 않던 문제를 수정했습니다. (TGT-52148)
* [!UICONTROL 편집기] 권한이 있는 고객이 활동을 저장할 수 없는 문제를 해결했습니다. (TGT-52227)
...
* 고객이 특정 [!UICONTROL 경험 타깃팅]&#x200B;(XT) 활동에 대한 대상 정보 팝업을 열 수 없도록 하는 오류가 수정되었습니다. (TGT-52049)
* [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)에서 변경한 후 대상 설정이 &quot;[!UICONTROL 모든 방문자]&quot;(으)로 되돌아가는 문제가 해결되었습니다. (TGT-52132)
* 특정 활동에 대해 대상 세분화가 표시되지 않던 문제를 수정했습니다(TGT-52057).
* 고객이 기본 작업 영역에서 [!UICONTROL 경험 조각]을(를) 삽입할 수 없는 문제를 해결했습니다. (TGT-52073)
* 오퍼가 &quot;콘텐츠를 찾을 수 없음&quot;으로 표시되고 [!UICONTROL Automated Personalization]&#x200B;(AP) 활동에 대한 [!UICONTROL 오퍼] 페이지에 표시되지 않는 문제가 해결되었습니다. (TGT-52150)
* 활동 내에 중복 대상을 허용하는 기능이 추가되었습니다. (TGT-51200)
* 편집 후 XT 활동에 대한 [!UICONTROL 목표 및 설정] 페이지에 잘못된 mbox 이름이 표시되는 문제를 해결했습니다. (TGT-52026)
...
* 편집 후 고객이 [!UICONTROL 목표 및 설정] 페이지의 [!UICONTROL 보고 설정]에서 [!UICONTROL 최적화 목표]를 다시 구성해야 하는 문제를 해결했습니다. (TGT-52071)
* 페이지 전달 규칙이 없는 활동에서 [!UICONTROL 개요] 페이지에 여러 규칙을 표시하는 문제를 해결했습니다. (TGT-52084)
...
* 편집하는 동안 업데이트된 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)에 ClickTrack 지표가 표시되지 않던 문제를 수정했습니다. (TGT-52152)
* 쿼리 매개 변수를 활동 위치로 사용하는 URL에 활동의 [!UICONTROL 개요] 페이지에 쿼리 매개 변수가 표시되지 않던 문제를 해결했습니다. (TGT-51635)
* 전체 경험 URL이 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC) 내의 [!UICONTROL 찾아보기 모드]에서 표시되지 않는 문제를 해결했습니다. (TGT-52101)
* 활동을 편집하면 페이지 게재가 URL 끝에 &quot;/&quot;를 추가하여 유효하지 않게 되는 문제를 해결했습니다. (TGT-52114)
* [!UICONTROL 양식 기반 경험 작성기]의 [!UICONTROL 활동 QA] 링크가 [!DNL Adobe Experience Cloud] 홈 페이지로 잘못 리디렉션되는 문제를 해결했습니다. (TGT-52055)
* 저장하고 다시 연 후 [!UICONTROL A/B 테스트] 활동에 추가된 추가 페이지가 유지되지 않는 문제를 해결했습니다. (TGT-51994)
* 고객이 인라인 스타일 섹션에서 스타일을 삭제할 수 없는 문제를 해결했습니다. (TGT-52070)
* 기존 UI와 유사한 [!UICONTROL 활동 QA] 대화 상자에서 [대상 정의 카드](/help/main/c-target/c-audiences/audiences.md#section_11B9C4A777E14D36BA1E925021945780)에 대한 액세스를 복원했습니다. (TGT-52056)
...
* 고객이 [!UICONTROL 경험 타깃팅]&#x200B;(XT) 활동에서 우선순위 순서로 경험을 다시 정렬할 수 없는 문제가 해결되었습니다. (TGT-52054)
...
* [!UICONTROL ClickTrack]을(를) 취소할 때 [!DNL Target]에서 선택기를 잘못 저장하는 문제가 해결되었습니다. (TGT-51937)
* 변경하지 않고 [!UICONTROL 목표 및 설정] 페이지에서 mbox 선택기를 열고 닫은 후 잘못된 이름 오류를 트리거하는 문제를 해결했습니다. (TGT-51983)
...
* 탐색 모음 앞에 콘텐츠를 삽입할 때 [!UICONTROL 다음 항목 앞에 삽입] 옵션을 사용할 수 없는 문제를 해결했습니다. (TGT-52031)
...
* [!UICONTROL 활동] 페이지가 느리게 로드되는 문제를 해결했습니다. (TGT-51151)
...
* 활동을 만들거나 편집하는 동안 대상을 &quot;[!UICONTROL 모든 방문자]&quot;(으)로 바꾸면 &quot;중복 대상은 허용되지 않습니다&quot; 오류가 발생하는 문제가 해결되었습니다. (TGT-51978)
* [!UICONTROL A/B 테스트] 활동을 저장할 때 &quot;잘못된 사용자 입력&quot; 오류가 발생하는 문제를 해결했습니다. (TGT-51976)
* [!UICONTROL 목표 및 설정] 페이지에서 계산된 지표가 올바르게 표시되지 않는 문제를 해결했습니다. (TGT-51975)
...
* 페이지 대상을 제거하면 [!UICONTROL ClickTrack] 선택기도 제거되던 문제를 해결했습니다. (TGT-51935)
* [!UICONTROL 개요] 페이지를 연 후 활동을 편집할 수 없도록 하는 문제를 해결했습니다. (TGT-51931)
...
* [!UICONTROL 양식 기반 경험 작성기]에서 타깃팅된 대상이 올바르게 업데이트되지 않는 문제를 해결했습니다. (TGT-51845)
* 활동 탐색 중에 [!UICONTROL 시각적 경험 작성기]의 URL이 올바르게 업데이트되지 않는 문제를 해결했습니다. (TGT-51832)
* 활동을 만들고 오퍼를 추가할 때 오퍼가 올바르게 표시되더라도 오퍼가 [!UICONTROL 오퍼] UI에 표시되지 않는 문제를 해결했습니다. (TGT-51805)
* 개인화되거나 타겟팅된 콘텐츠를 전달할 수 없을 때 일부 활동에 기본 콘텐츠를 표시하는 대체 화면이 부족했던 문제를 해결했습니다. (TGT-51638)
* [!UICONTROL 오퍼] UI에서 라이브 오퍼 및 특정 폴더가 올바르게 표시되지 않는 문제를 해결했습니다. (TGT-51628)
* 일부 URL 문자열 및 goURL이 올바르게 현지화되지 않는 문제를 해결했습니다. (TGT-35741)
* 역할([!UICONTROL 승인자], [!UICONTROL 편집기] 및 [!UICONTROL 관찰자])이 [!DNL Target] UI에서 올바르게 현지화되지 않는 문제를 해결했습니다. (TGT-29925)

### [!DNL Target Standard/Premium] 25.3.6(2025년 3월 14일)

이번 릴리스에는 다음과 같은 수정 사항 및 업데이트가 포함됩니다.

* 동일한 [!UICONTROL ClickTrack] 선택기를 여러 번 사용할 때 [!UICONTROL 클릭 추적]이 활성화된 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC) 활동에서 &quot;잘못된 사용자 입력&quot; 오류가 해결되었습니다. (TGT-51921)
...
* 사용자가 [!UICONTROL 수정 사항] 패널에서 오퍼를 변경할 수 없는 문제를 해결했습니다. (TGT-51800)
* [!UICONTROL ClickTrack] 모드를 포함한 경험 및 대상의 왼쪽 패널에 작업이 잘못 표시되는 문제가 해결되었습니다. (TGT-51895)
...
* 활동 전용 대상이 [!UICONTROL 대상] 패널에 표시되지 않아서 편집 또는 재사용이 불가능한 문제가 해결되었습니다. (TGT-51860)
* [!DNL Target Standard] 고객이 A4T([!UICONTROL Analytics for Target]) 보고를 사용하여 활동을 만들 수 없도록 차단하는 문제를 해결했습니다. (TGT-51854)
...
* 활동 전용 대상이 있는 [!UICONTROL 경험 타깃팅]&#x200B;(XT) 활동을 편집할 수 없는 문제가 해결되었습니다. (TGT-51846)
* [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)가 첫 번째 편집 시 경험에 수정 사항을 올바르게 적용하지 못하던 문제를 해결했습니다. (TGT-51843)
* VEC 내에서 특정 요소를 클릭할 때 &#39;ID&#39; 오류를 트리거하는 문제를 해결했습니다. (TGT-51814)
* 활동을 만드는 동안 VEC에서 오류 처리가 업데이트되었습니다. (TGT-51759)
* 활동을 저장할 때 [!UICONTROL 수정 사항] 패널에서 보기가 누락되어 &#39;잘못된 사용자 입력&#39; 오류가 발생하는 문제를 해결했습니다. (TGT-51827)
...
* 결합된 대상은 하위 그룹을 포함할 수 있으며 각 그룹에는 여러 대상이 포함됩니다. 이 릴리스에서는 하위 그룹 대상이 [!UICONTROL 규칙] 대화 상자에 표시되지 않는 문제를 해결했습니다. (TGT-51813)
* 이전 활동을 열 때 일부 경험 대상이 [!UICONTROL 모든 방문자]&#x200B;(으)로 바뀌는 문제가 해결되었습니다. (TGT-51812)
...
* 활동을 만드는 [!UICONTROL 타깃팅] 단계 동안 대상 제외 규칙이 대상의 정보 패널에 표시되지 않는 문제를 해결했습니다. (TGT-51579)
...
* 활동 만들기 프로세스를 취소([!UICONTROL 대상 추가] 대신 [!UICONTROL 취소] 선택)할 때 모든 상태 대상 변경 내용이 제거되던 문제를 해결했습니다. (TGT-51769 및 TGT-51770)
* 특히 사용자 지정 코드를 사용할 때 일부 활동에 대해 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)를 로드하지 못하던 문제를 해결했습니다.  문제로 인해 VEC에 빈 화면이 표시되거나 [!DNL Target] UI가 이전 버전으로 되돌아갔습니다. (TGT-51758)
* 대상에 대한 페이지 전달을 편집한 후 수정 사항이 삭제되는 문제를 해결했습니다. (TGT-51756)
* [!UICONTROL 목표 및 설정] 페이지에서 지표 유형을 변경할 때 모든 비지표 대상(페이지 및 경험 대상)이 활동에서 제거되던 문제를 해결했습니다. (TGT-51753)
* 활동을 편집하는 동안 [!UICONTROL 취소]를 클릭하면 Target UI가 [!UICONTROL 활동 세부 정보] 페이지 대신 [!UICONTROL 활동 목록]으로 이동하는 문제가 해결되었습니다. (TGT-51731)
* 고객이 [!UICONTROL CSV로 보고서 내보내기] 옵션을 통해 보고서를 다운로드할 수 없는 문제를 해결했습니다. (TGT-51708)
* [!DNL Target Standard] 고객이 [!DNL Target Premium] 기능인 [!UICONTROL 속성]을(를) 사용하는 것으로 잘못 표시되는 양식 기반 경험 작성기의 문제를 해결했습니다. (TGT-51678)
* 새 오퍼를 만들 때 [!DNL Adobe Experience Platform] 특성이 표시되지 않도록 차단하는 문제를 해결했습니다. (TGT-51665)
* [!DNL Recommendations] 인벤토리에 대한 모든 활성 필터를 빠른 검색으로 이동하여 UI를 [!UICONTROL 필터] 레일 대신 [!UICONTROL 카탈로그 검색]과(와) 맞췄습니다. (TGT-50723)
...
* [!UICONTROL 활동] 사용자 인터페이스 업데이트
* [!DNL Recommendations] 사용자 인터페이스 업데이트

#### [!UICONTROL 활동] 사용자 인터페이스 업데이트

[!DNL Adobe Target] UI 현대화 작업이 계속됨에 따라 업데이트된 [!UICONTROL 활동] 사용자 인터페이스의 일반 가용성을 알려드립니다.

>[!NOTE]
>
>2월 17일부터 고객은 점진적으로 새로운 [!UICONTROL 활동] UI에 액세스할 수 있습니다. 모든 고객을 위한 원활한 롤아웃을 보장하기 위해 이 릴리스는 제어된 단계로 배포됩니다. 첫 번째 단계에서는 [!DNL Target] 고객의 초기 그룹을 새 [!UICONTROL 활동] UI로 업그레이드합니다. 이후 단계에서는 나머지 고객을 업그레이드합니다.
...
* [[!UICONTROL 변경 로그]](/help/main/c-activities/change-log.md) 페이지를 업데이트했습니다. 이제 실시간 인사이트를 위해 [[!DNL Audit Query API]](https://experienceleague.adobe.com/en/docs/experience-platform/landing/governance-privacy-security/audit-logs/audit-api/overview){target=_blank}에서 정보를 가져옵니다.
...
* 브라우저 공급자의 최신 보안 업데이트 및 최신 사용자 인터페이스를 지원하여 [다시 빌드된 [!UICONTROL 시각적 편집 작성기]](/help/main/c-experiences/c-visual-experience-composer/visual-experience-composer.md).
...
>[!NOTE]
>
>2월 17일부터 고객은 점진적으로 새로운 [!UICONTROL 권장 사항] UI에 액세스할 수 있습니다. 모든 고객을 위한 원활한 롤아웃을 보장하기 위해 이 릴리스는 제어된 단계로 배포됩니다. 첫 번째 단계에서는 [!DNL Target] 고객의 초기 그룹을 새 [!UICONTROL 활동] UI로 업그레이드합니다. 이후 단계에서는 나머지 고객을 업그레이드합니다.

최신 [!DNL Adobe Spectrum] 디자인 시스템을 기반으로 업데이트는 다음과 같은 새로운 개선 사항을 추가하면서 이전에 일관되지 않은 디자인 패턴을 표준화합니다.

* 이제 [제품 카탈로그 검색](/help/main/c-recommendations/c-products/catalog-search.md)에 제품의 실시간 동기화를 허용하는 업데이트된 데이터베이스가 있습니다.
* [!UICONTROL API를 통해 만든 [권장 사항] 개체([!UICONTROL 기준], [!UICONTROL 디자인], [!UICONTROL 컬렉션], [!UICONTROL 제외])를 이제 UI에서 사용할 수 있습니다](/help/main/c-recommendations/c-recommendations-faq/recommendations-faq.md).
* [권장 사항 설정](/help/main/administrating-target/recommendations-settings.md)이(가) [!UICONTROL 관리] 섹션에 통합되었습니다.
...
#### [!UICONTROL 오퍼 라이브러리] 사용자 인터페이스 업데이트

[!DNL Adobe Target] 사용자의 사용자 환경을 개선하기 위해 이 릴리스는 [!UICONTROL 오퍼 라이브러리] 사용자 인터페이스를 업데이트합니다.
...
* **[!UICONTROL 코드 편집기] 업그레이드**: 구문 강조 표시 및 줄 번호 매기기를 사용하여 HTML 및 JSON 편집기를 새로 고쳤습니다.
...
수동 제안 렌더링의 경우 이 최적화를 활용하려면 [[!DNL Platform Web SDK implementation]](https://experienceleague.adobe.com/en/docs/target-dev/developer/client-side/aep/aep-web-sdk-overview){target=_blank}을(를) 검토하여 경험을 수동으로 렌더링한 후 또는 `applyPropositions` 메서드(또는 해당 [!DNL Launch] 작업을 도우미로 사용)를 사용하여 경험을 렌더링할 때 알림을 보내고 있는지 확인하십시오.

경험을 수동으로 렌더링할 때 가장 일반적인 시나리오는 다음과 같습니다.

* JSON 오퍼 사용
* [[!UICONTROL 양식 기반 경험 작성기]](/help/main/c-experiences/form-experience-composer.md)에서 만든 활동에서 사용자 지정 결정 범위 사용
* 전역 `__view__` 범위를 사용하는 [!UICONTROL 양식 기반 경험 작성기]를 사용하여 만든 활동을 가져올 때 `renderDecisions: true`을(를) 사용하지 않음
...
* **개인화 및 측정을 위한 단일 호출입니다.**
  ...
  * 한 방울도 튀었다.
  * A4T와 [!UICONTROL 페이지 보기] 히트가 함께 결합되지 않으므로 [!DNL Analytics] eVar 및 이벤트를 사용하여 A4T 보고서의 특정 분류 및 상관 관계를 수행하기 어렵습니다.
...
* [!UICONTROL VEC(시각적 경험 작성기]) 또는 [!UICONTROL 양식 기반 경험 작성기]에서 리디렉션 오퍼를 사용하여 [!DNL Target]이(가) 올바르게 작동하지 않는 문제를 해결했습니다.
...
### [!UICONTROL 시각적 경험 작성기] Helper 확장 프로그램(2024년 4월 23일)

매니페스트 V2를 사용하여 레거시 [!DNL Target] 시각적 경험 작성기 Helper 확장이 만들어졌습니다. [!DNL Google]이(가) 2024년 6월부터 Manifest V2를 사용하여 만든 확장을 더 이상 허용하지 않는다고 발표했습니다. 자세한 내용은 [[!UICONTROL 시각적 경험 작성기] Helper 확장 기능](/help/main/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/vec-helper-browser-extension.md)을 참조하십시오.
...
### [!UICONTROL 브라우저] 대상 특성의 `Browser:iPad` 및 `Browser:iPhone` 업데이트(2024년 4월 30일)

| 업데이트 | 세부 사항 |
|--- |--- |
| 대상을 만들 때 사용되는 [브라우저 특성](/help/main/c-target/c-audiences/c-target-rules/browser.md)에서 [!UICONTROL 브라우저:iPad] 및 [!UICONTROL 브라우저:iPhone]이(가) 업데이트되었습니다. | [!DNL Adobe Target]을(를) 사용하면 페이지를 방문할 때 특정 [브라우저 또는 브라우저 옵션](/help/main/c-target/c-audiences/c-target-rules/browser.md)을 사용하는 방문자를 포함하여 [여러 범주 특성 중 하나를 타깃팅할 수 있습니다](/help/main/c-target/c-audiences/c-target-rules/target-rules.md).<P>[!DNL Target] Standard/Premium 24.3.1(2024년 3월 4~6일)부터 Target UI를 사용하여 만든 기본 제공 대상(예: `Browser:iPad` 및 `Browser:iPhone`)이 `profile.mobile.deviceVendor`, `profile.mobile.isMobilePhone` 및 `profile.mobile.isTablet`을(를) 사용하여 [!DNL iPad] 및 [!DNL iPhone]에 대한 적절한 타깃팅을 수행하도록 업데이트됩니다.<P>이 업데이트에는 고객 측에서 작업을 수행할 필요가 없습니다.<p><B>중요</b>: 고객이 프로필 스크립트(및 JavaScript 세그먼트)에서 [!DNL iPad] 및 [!DNL iPhone]에 대한 적절한 타깃팅을 수행하려면 **2024년 4월 30일**&#x200B;까지 고객이 수동으로 변경해야 합니다. 수동으로 변경해야 하는 대체 설정의 예는 [!UICONTROL 브라우저]대상 특성](/help/main/c-target/c-audiences/c-target-rules/browser.md#updates)에서 [및 [!DNL iPad] 및 [!DNL iPhone] 에 대한 업데이트를 참조하십시오. |

### [!UICONTROL Visual Editing Helper] 확장 기능(2024년 3월 14일)
...
* VEC([!UICONTROL 시각적 경험 작성기])에서 작성을 수행하는 동안 확장 프로그램이 쿠키를 복제하는 문제를 해결했습니다.
...
* [!UICONTROL Analytics for Target]&#x200B;(A4T) 보고로 구성된 [!UICONTROL MVT(다변량]) 활동이 제대로 표시되지 않는 문제를 해결했습니다. (TGT-47490)
...
* 매출 목표 지표가 있는 [!UICONTROL Analytics for Target]&#x200B;(A4T) 활동에서 &quot;매출&quot;이 열 이름으로 표시되지 않았고 매출 지표가 보고에 ($) 형식으로 표시되지 않았습니다. 이는 이미 해결된 표시용 문제였습니다. (TGT-46995)
* 보고 일자 간격이 올바르게 작동하지 않는 문제를 수정했습니다. (TGT-47396)
* 고객이 [!UICONTROL 추가 작업] 아이콘을 사용하여 활동을 활성화하거나 비활성화한 후 [!UICONTROL 모든 활동] 페이지에 잘못된 상태가 표시되는 문제를 해결했습니다. (TGT-47367)
* 단일 고객에 대해 [!UICONTROL 중요 특성] 보고서가 표시되지 않는 문제를 해결했습니다. (TGT-47272)
...
* 제어 경험에 트래픽이 할당되지 않을 경우 활동 보고서에 사용 가능한 데이터가 없을 수 있는 이유를 고객이 이해할 수 있도록 [!DNL Target] UI에 툴팁이 추가되었습니다. 도구 설명에 추가 정보에 대한 링크가 포함되어 있습니다. [내 활동의 보고서에 사용할 수 있는 데이터가 없는 이유는 무엇입니까?](/help/main/c-reports/reporting-frequently-asked-questions.md#section_E4722F6445884130951DF79981C8289B). (TGT-46610)
* 일부 고객의 [!UICONTROL 활동] 페이지에서 활동이 제대로 표시되지 않는 문제를 해결했습니다. (TGT-46830)
* [[!UICONTROL Analytics for Target]](/help/main/c-integrating-target-with-mac/a4t/a4t.md)(A4T)을 보고 소스로 사용하는 활동에 영향을 주는 다음 문제를 해결했습니다.
  * 일부 고객이 보고 데이터를 조회할 수 없는 문제가 해결되었습니다. (TGT-46557)
  * 활동 보고 페이지의 [!UICONTROL Analytics에서 보기] 링크가 제대로 작동하지 않는 문제가 해결되었습니다. (TGT-46731)
  * [!UICONTROL 상승도] 및 [!UICONTROL 신뢰도]에 대한 데이터가 [!DNL Target] UI에서 제대로 표시되지 않는 문제를 해결했습니다. (TGT-46592, TGT-46554 및 TGT-46586)

### [!UICONTROL 활동] 페이지 사용자 인터페이스 새로 고침(2023년 10월 25일)

[!DNL Target] 사용자의 사용자 경험을 개선하기 위한 [!DNL Adobe Target] 팀의 지속적인 노력의 일환으로 이 릴리스는 [!DNL Target] UI의 [!UICONTROL 활동] 페이지를 새로 고칩니다. 이번 업데이트를 통해 새로운 개선 사항이 추가되었으며 이전에 일관되지 않았던 디자인 패턴이 통합되고 표준화되었습니다.
...
* 새 활동을 만들 때 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)가 `selectorCriteria`의 기본 설정으로 열리도록 새 [!UICONTROL 활동] UI가 개선되었습니다. (TGT-46586)
* VEC를 사용할 때 일부 고객이 [!UICONTROL 작성기] 모드에서 요소를 편집할 수 없는 문제를 해결했습니다. (TGT-46470)
* 사용자 정의 속성을 사용할 때 일반적으로 많이 사용되는 선택기를 지정하는 기능이 추가되었습니다. (TGT-46545)
* 보고서가 [!DNL Adobe Analysis Workspace]에 올바르게 표시되더라도 [!UICONTROL Analytics for Target]&#x200B;(A4T)을 사용하는 [!UICONTROL 자동 타겟] 보고서가 [!DNL Target] UI에 표시되지 않는 문제를 해결했습니다. (TGT-46494)
...
* 동적 프레임워크에 대한 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC) 개선 사항이 추가되었습니다. (TGT-44064)
...
* Lightning Web Components(Light DOM)를 지원하도록 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)를 개선했습니다. (TGT-45422)
* VEC 액션이 잘못된 순서로 적용되는 문제를 수정했습니다. 경우에 따라 VEC가 일부 수정 사항을 비동기적으로 적용하고 요소에 추가 수정 사항을 추가하면 [!UICONTROL 삽입] 작업 후에 해당 요소가 표시되는 경우 오류가 발생합니다. 또한 앵커 링크를 클릭할 때 업데이트되는 VEC URL도 수정했습니다. (TGT-45983)
* 이제 그림자 DOM에서 요소를 지원하는 VEC [!UICONTROL 오버레이] 기능 문제를 해결했습니다. (TGT-45202 및 TGT-45262)
* VEC에서 SPA(단일 페이지 애플리케이션) 페이지를 연 다음 [!UICONTROL 찾아보기] 모드로 이동하면 뒤로 및 앞으로 화살표가 올바르게 작동하지 않는 문제가 해결되었습니다. (TGT-45956)
...
* [!DNL Target] 백엔드에서 활동을 적시에 동기화하고 미리 보기 링크에서 예상되는 경험을 전달하는 등 일부 고객의 [!UICONTROL Automated Personalization]&#x200B;(AP) 활동에 영향을 미치는 문제가 해결되었습니다. (TGT-46202)

### [!DNL Target] Standard/Premium 23.9.1 (2023년 9월 6~11일)

이번 릴리스에는 다음과 같은 개선 및 수정 사항이 포함되어 있습니다.

* A4T([!UICONTROL Analytics for Target])를 보고 소스로 사용하는 [!UICONTROL 자동 할당] 활동에 대한 [!DNL Target] UI 및 [!DNL Adobe Analytics] UI에서 보고 데이터가 일치하지 않는 문제를 해결했습니다. (TGT-46112)
...
자세한 내용은 *Adobe Target 개발자 안내서*&#x200B;의 [Target 에지 노드](https://experienceleague.adobe.com/docs/target-dev/developer/implementation/privacy/allowlist-edges.html){target=_blank}를 참조하십시오.

### [!DNL Target] Standard/Premium 23.8.1 (2023년 8월 9일)

이번 릴리스에는 다음과 같은 개선 및 수정 사항이 포함되어 있습니다.

* [!UICONTROL 활동] 목록 페이지의 &quot;[!UICONTROL 상태]&quot; 열에 표시된 대로 활동이 제대로 동기화되지 않는 문제가 해결되었습니다. (TGT-46010 및 TGT-44831)
* A4T([!UICONTROL Analytics for Target])를 보고 소스로 사용하는 활동의 [!UICONTROL 보고서] 페이지에 &quot;[!UICONTROL Analytics에서 보기]&quot; 링크가 표시되지 않는 문제가 해결되었습니다. (TGT-45808)
* 소수 자릿수가 포함 숫자 대신 백분율로 표시되도록 테이블의 값 표시가 조정되었습니다. 예를 들어 .08대신 8%가 표시됩니다. (TGT-45548)
* 고객이 [!UICONTROL 경험 타기팅]&#x200B;(XT) 활동에 대한 [!UICONTROL 목표 및 설정] 페이지에서 다음 요소로 이동할 때 키보드 포커스를 사용할 수 없는 문제를 해결했습니다. (TGT-44526)
* 활동을 만드는 동안 &quot;[!UICONTROL 대상자 추가]&quot; 대화 상자를 연 후 키보드 포커스가 상실되는 문제를 해결했습니다. (TGT-44525)

### [!DNL Target] Standard/Premium 23.7.1 (7월 24~26일)

이번 릴리스에는 다음과 같은 개선 및 수정 사항이 포함되어 있습니다.

* 그림자 DOM 요소를 포함하도록 [VEC([!UICONTROL 시각적 경험 작성기])에서 DOM 경로를 사용하여 요소 탐색](/help/main/c-experiences/c-visual-experience-composer/viztarget-options.md#dom-path)할 때 검색이 개선되었습니다. (TGT-45262)
...
| 기능 | 세부 사항 |
|--- |--- |
| [!UICONTROL Automated Personalization] 활동에 대한 [!UICONTROL QA 모드] | 이제 [!DNL Adobe Target] [!UICONTROL QA 모드]를 [!UICONTROL Automated Personalization] 활동에 사용할 수 있습니다. [!UICONTROL 미리 보기 링크] 기능을 바꿉니다.<P>자세한 내용은 [활동 QA](/help/main/c-activities/c-activity-qa/activity-qa.md)를 참조하십시오. |
...
* 이미지 이름에 GB 18030 문자가 포함된 경우 [!UICONTROL 디자인 만들기] 패널에서 이미지가 표시되지 않는 문제를 해결했습니다. (TGT-44614)
* 경험의 텍스트/HTML에서 일부 GB 18030 기호 문자가 잘못 이스케이프되는 문제가 해결되었습니다. (TGT-44600)
* 분석 중에 [!UICONTROL 자동 Personalization] 활동에 대한 보고서가 중지되는 문제를 해결했습니다. (TGT-44820)
* 활동 이름에 대괄호([또는])가 포함된 경우 [!UICONTROL 활동] 페이지에서 활동을 검색할 수 없는 문제를 해결했습니다. (TGT-44777)
...
* URL에 쿼리 매개 변수가 추가되어 페이지를 [!UICONTROL VEC(시각적 경험 작성기])에서 로드할 수 없는 문제가 해결되었습니다. (TGT-44873)
* [!DNL Target] UI 전반에 걸쳐 다양한 현지화 수정을 수행했습니다.

### [!DNL Target] [!UICONTROL Real-Time CDP 프로필 특성]과(와) 공유된 Real-Time CDP 프로필 특성(2023년 6월 13일)

이번 릴리스에는 다음과 같은 개선 사항이 포함됩니다.

| 기능 | 세부 사항 |
|--- |--- |
| [!DNL Target]과 공유되는 Real-Time CDP 프로필 속성 | [!UICONTROL Real-Time CDP 프로필 특성]은(는) HTML 및 JSON 오퍼에서 사용할 수 있도록 [!DNL Target]과(와) 공유할 수 있습니다.<P>자세한 내용은 [ [!DNL Target]](/help/main/c-integrating-target-with-mac/integrating-with-rtcdp.md#rtcdp-profile-attributes)과 Real-Time CDP 프로필 속성 공유를 참조하십시오. |
...
| 기능 | 세부 사항 |
|--- |--- |
| Headless 개인화 및 실험을 위한 AEM [!UICONTROL 콘텐츠 조각] | [!DNL Target] 활동에서 [!DNL Adobe Experience Manager]&#x200B;(AEM) [!UICONTROL 콘텐츠 조각]을(를) 사용합니다. AEM의 편의성과 기능을 [!DNL Target]의 강력한 AI(인공 지능) 및 ML(머신 러닝) 기능과 결합하여 headless 개인화와 실험을 지원할 수 있습니다.<P>자세한 내용은 [AEM [!UICONTROL 콘텐츠 조각]](/help/main/c-integrating-target-with-mac/aem/content-fragments-aem.md)을 참조하세요. |
| [*Adobe Target 개발자 안내서*](https://experienceleague.adobe.com/docs/target-dev/developer/overview.html){target=_blank} | *Adobe Target 개발자 안내서*&#x200B;가 *[!UICONTROL Adobe Experience League]*(으)로 재배치되었습니다. *[!UICONTROL Experience League]*(으)로 이동하면 추가 언어로 된 텍스트의 현지화가 지원되며, *Experience League* 내의 검색을 통합하여 *[!UICONTROL Adobe Target 비즈니스 실무자 안내서]* 및 *[!UICONTROL Adobe Target 개발자 안내서]*&#x200B;의 검색 결과를 확장하고 제공하며, 추가 이점을 제공합니다.<P>이전 위치에서 *[!UICONTROL Experience League]*(으)로 자동으로 리디렉션됩니다. 필요에 따라 책갈피를 업데이트하십시오. |
...
| 기능 | 세부 사항 |
|--- |--- |
| [!UICONTROL 자동 할당] 및 [!UICONTROL 자동 타겟]에 최적화된 A4T 지표<p>(릴리스 일자: 2023년 3월 30일) | [!DNL Target]을(를) 사용하면 [!UICONTROL 자동 할당] 및 [!UICONTROL 자동 타겟] 활동에 [!UICONTROL A4T]을(를) 사용할 때 이항 이벤트를 기반으로 하는 지표 또는 연속 이벤트를 기반으로 하는 지표를 선택할 수 있습니다.<P>다음은 유의해야 할 지원되는 지표에서의 변경 내용입니다.<ul><li>[!DNL Target]은 2023년 9월 9일까지의 기존 활동에 대한 이전 동작을 유지했습니다. 이 날짜 이후에는 기존 활동을 새 동작으로 강제 마이그레이션하기 위해 지원되지 않는 지표를 사용하는 활동이 중단됩니다.</li></ul>자세한 내용은 [!UICONTROL 자동 할당] 및 [!UICONTROL 자동 타겟] 활동](/help/main/c-integrating-target-with-mac/a4t/a4t-at-aa.md#supported)에 대한 [A4T 지원의 &quot;지원되는 목표 지표&quot;를 참조하십시오.<br>이 기능과 함께 다음 튜토리얼이 업데이트되었습니다.<ul><li>[A4T 보고서를 설정하는 중 [!DNL Analysis Workspace] [!UICONTROL 자동 할당] 활동](https://experienceleague.adobe.com/docs/target-learn/tutorials/integrations/set-up-a4t-reports-in-analysis-workspace-for-auto-allocate-activities.html?lang=ko-KR){target=_blank}</li><li>[A4T 보고서를 설정하는 중 [!DNL Analysis Workspace] [!UICONTROL 자동 타겟] 활동](https://experienceleague.adobe.com/docs/target-learn/tutorials/integrations/set-up-a4t-reports-in-analysis-workspace-for-auto-target-activities.html?lang=ko-KR){target=_blank}</li></ul> |
...
* 사용자가 [!UICONTROL 관리] > [!UICONTROL 시각적 경험 작성기] > [!UICONTROL 기본 URL]에서 [!UICONTROL 기본 URL]을(를) 제거할 수 있도록 UI가 개선되었습니다. 이 변경을 통해 고객은 기본 URL을 빈 문자열로 다시 변경할 수 있게 되었습니다(이전에는 초기 구성 이후 변경할 수 없었음). (TGT-44577)
* 고객이 기본 제공 대상자(예약된 이름이 있는 대상자)을 편집하거나 삭제할 수 없도록 하는 제한이 제거되었습니다. (TGT-44655)
* [결합된 대상](/help/main/c-target/combining-multiple-audiences.md)을(를) 만들 때 [!DNL Target] UI에 표시되는 분할자를 로드하는 동안 &quot;[!UICONTROL 완료]&quot; 옵션을 비활성화했습니다. (TGT-44079)
* [!UICONTROL 대상자] 페이지 하단에 있는 [!UICONTROL 언어] 링크를 수정하여 &quot;[!UICONTROL 계정 통신 환경 설정]&quot; 페이지로 올바르게 연결했습니다. (TGT-43562)
* [!UICONTROL 관리] > [!UICONTROL 보고] > [!UICONTROL Reporting Experience Cloud 솔루션]에서 [!UICONTROL Adobe Analytics] 옵션을 선택한 후 고객이 [!UICONTROL A/B 테스트] 활동을 만들 수 없는 문제를 해결했습니다. (TGT-44844)
* 고객이 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC) 내에서 많은 경험을 사용하는 [!UICONTROL 다변량 테스트] 활동에서 마지막 경험을 볼 수 없는 문제를 해결했습니다. 때때로 VEC 하단의 [DOM 경로](/help/main/c-experiences/c-visual-experience-composer/viztarget-options.md#dom-path)로 인해 고객이 마지막 경험을 보지 못하는 경우가 있었습니다. (TGT-44578)
* 페이지에 인증이 필요하거나 페이지에서 리디렉션을 호출하는 경우 VEC의 검색 URL이 일반 브라우저 세션에 표시되는 현재 페이지를 반영하지 않는 문제가 해결되었습니다. (TGT-44350)
* 고객이 [!UICONTROL 권장 사항] > [!UICONTROL 설정]에서 [!UICONTROL 호환되지 않는 기준 필터링] 설정을 변경할 수 없는 문제를 해결했습니다. (TGT-44398)
* 이름에 점이 있는 보고서 세트와 함께 [!UICONTROL Analytics 분류]을(를) 사용할 때 POST 요청에서 [!DNL Recommendations] 피드를 만들지 못하는 문제가 해결되었습니다. (TGT-44598)
...
* [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)를 사용하여 사용자 지정 웹 구성 요소 작성을 위한 업데이트:
...
| 기능 | 세부 사항 |
| --- | --- |
| Automated Personalization(AP)에서의 [JSON 오퍼](/help/main/c-experiences/c-manage-content/create-json-offer.md) 지원 | 양식 기반 경험 작성기를 사용하여 [!UICONTROL Automated Personalization]&#x200B;(AP) 활동에서 JSON 오퍼에 대한 지원을 추가했습니다. (TGT-41460) |
...
* 권장 사항이 포함된 [!UICONTROL A/B 테스트] 및 [!UICONTROL 경험 타깃팅]&#x200B;(XT) 활동에서 &quot;500 오류&quot;가 발생하는 문제를 해결했습니다. 이 문제는 [!DNL Target]이 더 이상 사용되지 않는 [!DNL Target] UI 및 [!DNL Recommendations] 백엔드에서 기준 오브젝트를 제대로 삭제하지 못했을 때 발생했습니다. (TGT-44383)
...
* AP 및 [!DNL Target] UI의 [!UICONTROL 자동 타겟] [!UICONTROL Personalization 인사이트] 및 [!UICONTROL 중요 특성] 보고서에서 45일 및 90일 달력 옵션이 제거되었습니다. 사용 패턴과 성능 향상을 위해 이들 날짜 범위는 더 이상 사용되지 않습니다. 현재 허용되는 범위인 15일, 30일 및 60일을 반영하도록 UI가 업데이트되었습니다. (TGT-39357)
* 활동이 라이브 상태가 된 후 [!UICONTROL 목표 및 설정] 페이지에서 [!UICONTROL 최적화 목표와 같음] 설정을 변경할 수 없습니다. (TGT-43923)
...
* 지원되는 모든 SDK(Node.js, Java, .NET 및 Python)에 대해 온디바이스 결정을 사용하는 방법을 설명하는 페이지를 가리키도록 &quot;온디바이스 의사 결정을 사용하는 구현 방법&quot;에 대한 [!UICONTROL 구현] 페이지([!UICONTROL 관리] > [!UICONTROL 구현])의 링크를 변경했습니다. 자세한 내용은 [Adobe Target 개발자 안내서](https://experienceleague.adobe.com/docs/target-dev/developer/overview.html){target=_blank}에서 [Target SDK 시작하기](https://experienceleague.adobe.com/docs/target-dev/developer/server-side/getting-started.html){target=_blank}를 참조하십시오.
...
사용자가 [!UICONTROL AP(Automated Personalization]) 및 [!UICONTROL AT(자동 타겟]) 활동에 대한 머신 러닝 모델에 사용되는 기능 목록을 관리할 수 있도록 차단 목록에 추가하다 API라고도 하는 새로운 [!DNL Adobe Target] 모델 API를 제공합니다.
...
* 고객이 A4T를 사용하는 [!UICONTROL 자동 타겟] 활동을 만들거나 편집하는 동안 최적화 기준을 선택할 수 있도록 [!DNL Target] UI에 툴팁이 추가되었습니다.
...
| Google Chrome용 새 [!UICONTROL 시각적 경험 작성기] 확장 | Chrome용 새 [!DNL Adobe Target] [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC) 확장 프로그램을 Chrome 웹 스토어에서 사용할 수 있습니다.<br>2023년 1월부터 현재 [!DNL Target] VEC Helper 확장 프로그램이 Google Chrome에서 작동하지 않습니다. Google에서는 Manifest V2를 사용하는 확장 프로그램이 허용되지 않기 때문입니다. 새해부터는 [!DNL Target]에서 웹 사이트를 계속 시각화하려면 새 확장 버전을 다운로드하십시오.<br>다음 링크에는 Chrome 웹 스토어의 두 가지 확장 기능이 표시됩니다.<ul><li>[새 확장](https://chrome.google.com/webstore/detail/adobe-experience-cloud-vi/kgmjjkfjacffaebgpkpcllakjifppnca){target=_blank}</li><li>[이전 확장](https://chrome.google.com/webstore/detail/adobe-target-vec-helper/ggjpideecfnbipkacplkhhaflkdjagak){target=_blank}</li></ul>추가 정보는 [Visual Editing Helper 확장 기능](/help/main/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/visual-editing-helper-extension.md)을 참조하십시오. |

* [!UICONTROL 대상 세분화] 정보 창에서 대상 규칙 정보가 제대로 표시되지 않는 문제를 해결했습니다. (TGT-43917)
...
* [!UICONTROL 작성]에서 [!UICONTROL 찾아보기] 모드로 전환한 후 VEC에서 활동을 만들거나 편집할 때 일부 구성 요소가 [!UICONTROL 경험] 페이지의 [!UICONTROL 수정] 패널에 제대로 표시되지 않는 문제를 해결했습니다. (TGT-43300)
* 일부 고객이 [!UICONTROL 자동 타겟]을(를) 사용하는 [!UICONTROL A/B 테스트] 활동을 보관할 수 없는 문제를 해결했습니다. (TGT-40978)
...
* .js 2.10.0 이상 버전에서 다운로드할 때 서드파티 쿠키의 설정을 허용하거나 비활성화하는 [!UICONTROL 도메인 간] 옵션을 추가했습니다. (TGT-43674)
* [!DNL Recommendations] 피드 가져오기가 실패할 경우 고객에게 알리도록 [!DNL Target] UI의 알림을 업데이트했습니다. (TGT-35811)
* [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)에서 [!UICONTROL 의사 결정 제안]이(가) 제대로 작동하지 않는 문제를 해결했습니다. (TGT-43866)
* [!UICONTROL Multivariate Testing]&#x200B;(MVT) 활동을 만드는 동안 [!UICONTROL 요소 클릭] 전환 목표를 선택할 때 오류 메시지가 표시되는 문제를 해결했습니다. (TGT-43842)
* [!UICONTROL Automated Personalization]&#x200B;(AP) 활동에 대해 다운로드한 CSV 보고서 파일에 [!UICONTROL 노출 횟수] 열이 표시되지 않는 문제를 해결했습니다. (TGT-43780)
...
* 권장 사항이 포함된 [!UICONTROL A/B 테스트] 및 [!UICONTROL Experience Targeting]&#x200B;(XT) 활동에서 고객이 [!DNL Recommendations]개의 개체(디자인, 기준, 컬렉션 등)를 올바르게 표시하고 더 이상 사용하지 않는 기준 개체를 [!DNL Target] UI 및 [!DNL Recommendations] 백엔드에서 삭제할 수 있도록 문제를 해결했습니다. (TGT-42331)
...
| *Adobe Target 개발자 안내서* | 다음 *Adobe Target 개발자 안내서* 모두 통합 [!DNL Target] 개발자 콘텐츠를 하나의 편리한 안내서에 추가했습니다. 안내서에는 [!DNL Target] 및 [!DNL Recommendations], [!DNL Target]개의 SDK 및 [!DNL Target]개의 API 구현에 대한 정보가 포함되어 있습니다.<br>자세한 내용은 [Adobe Target 개발자 안내서](https://experienceleague.adobe.com/docs/target-dev/developer/overview.html){target=_blank}를 참조하십시오. |

* [!UICONTROL 편집기] 역할이 있는 사용자는 더 이상 라이브 활동에서 대상을 편집할 수 없습니다. (TGT-43582)
...
* 새 [!UICONTROL 대상] UI가 배포되기 전에 세분화 및 대상이 만들어진 경우 한 고객이 해당 활동에 대한 경험 수준 세분화 및 대상을 편집하지 못하도록 하는 문제가 해결되었습니다. (TGT-43433)
...
* 고객이 [!UICONTROL 양식 기반 경험 작성기]에서 만든 활동에서 임시 오퍼가 있는 위치를 삭제할 수 없는 문제를 해결했습니다. (TGT-43315)
...
* 이번 릴리스에서는 [!UICONTROL 자동 Personalization]&#x200B;(AP) 및 [!UICONTROL 자동 타겟]&#x200B;(AT) 활동(이전에는 [!DNL Target]에서 반환하지 않음)에 대한 콘텐츠를 미리 가져올 수 있습니다. AP/AT 활동이 게재 경로에 있고 컨텐츠 전달에 동일한 위치를 사용하는 다른 AB/XT 활동보다 우선순위가 높은 경우 이 경우 미리 가져오기 호출의 경우(&quot;실행&quot; 흐름에 대한 변경 사항 없음) 최종 사용자가 볼 수 있는 경험이 변경될 수 있습니다.
...
* 모든 [!DNL Target Standard] 고객에 대해 새 [!UICONTROL 대상] UI가 활성화됩니다.

### Target Standard/Premium 고객 엔지니어링 수정 사항(2022년 3월 22일)

이번 유지 관리 릴리스에는 다음과 같은 개선 사항이 포함됩니다.

* [!UICONTROL Analytics를 보고 소스로 사용]&#x200B;(A4T)하는 활동과 함께 [!UICONTROL 배달 API]를 사용할 때 `prefetch` 보기 및 `pageLoad` 클릭 지표에 대한 [!DNL Analytics] 페이로드 데이터를 반환하는 기능이 추가되었습니다. (TNT-43198)
* 일본에서 일반적으로 사용되는 브라우저 유형을 허용하도록 보트 필터링 사용자 에이전트 목록을 업데이트했습니다. (TNT-43867)

### Target Standard/Premium 22.2.1 (2022년 2월 1일)

이번 유지 관리 릴리스에는 Target Standard/Premium 22.1.2 릴리스에서 발표된 새로운 [!UICONTROL 대상] UI에 대한 다음과 같은 수정 사항 및 개선 사항이 포함되어 있으며 향후 6주 동안 모든 지역의 고객에게 출시될 예정입니다. 이들 수정 사항은 [!DNL Adobe Target Standard/Premium]에서 생성된 대상자에 대한 기능을 조정합니다.
...
* [!DNL Adobe Experience Platform], [!DNL Adobe Experience Cloud] 및 [!DNL Adobe Target Classic]에서 가져온 대상의 [!UICONTROL 대상] 목록에 [!UICONTROL 삭제] 옵션이 추가되었습니다. 또한 일괄 삭제 기능이 추가되었습니다. (TGT-42914)

### at.js 버전 2.8.1 (2022년 1월 28일)

* `pageLoad`이(가) [!UICONTROL On Device Decisioning]&#x200B;(ODD) 하이브리드 실행 모드에서 target-global-mbox에 매핑되지 않는 문제를 해결했습니다.
...
| [!UICONTROL 대상] UI 새로 고침 | [!DNL Target] 사용자의 사용자 경험을 개선하기 위한 [!DNL Adobe Target] 팀의 지속적인 노력의 일환으로, 이 릴리스는 [!DNL Target] UI의 [!UICONTROL 대상] 및 [!UICONTROL 프로필 스크립트] 페이지를 새로 고칩니다. 이 업데이트는 다음과 같은 새로운 개선 사항을 추가하면서 이전에 일관되지 않고 디자인 패턴을 통합하고 표준화합니다.<ul><li>여러 대상자를 동시 선택하고 삭제할 수 있는 기능</li><li>새로 단장된 [대상자 빌더 디자인](/help/main/c-target/c-audiences/create-audience.md)</li><li>[!UICONTROL 대상] 라이브러리 규칙 빌더의 제외 규칙 지원</li><li>신속한 대상 검색을 위한 새로운 &quot;대상 Source&quot; 필터</li><li>세션 영구 검색 및 필터 옵션</li><li>[!DNL Target Premium] 고객을 위해 작업 영역 간에 대상자를 이동할 수 있습니다.</li></ul>자세한 내용은 [대상](/help/main/c-target/target.md).<br>**참고**&#x200B;을 참조하세요. 이 기능은 앞으로 8주 이내에 다른 지역의 고객에게도 배포됩니다. |
| [!UICONTROL 프로필 스크립트] UI 새로 고침 | [!UICONTROL 프로필 스크립트] 라이브러리도 업데이트되었으며, 새로 고침된 인터페이스와 몇 가지 생산성 업데이트가 포함되어 있습니다.<ul><li>여러 프로필 스크립트를 동시 선택하고 삭제할 수 있는 기능</li><li>프로필 스크립트용 새로운 편집기 코드</li><li>코드 편집기 내 구문 강조 표시 및 오류 검사</li><li>키보드 단축키를 통한 자동 완성 토큰(mbox 또는 프로필) 매개 변수</li></ul>자세한 내용은 [방문자 프로필](/help/main/c-target/c-visitor-profile/visitor-profile.md).<br>**참고**&#x200B;을 참조하세요. 이 기능은 앞으로 8주 이내에 다른 지역의 고객에게도 배포됩니다. |
...
* 활동을 편집할 때 조합된 대상에 대해 [!UICONTROL 포함] 및 [!UICONTROL 제외] 옵션이 비활성화되도록 하는 문제가 해결되었습니다. (TGT-43422)
* 활동 편집 시 일부 고객이 사용 가능한 대상자 목록을 볼 수 없도록 하는 문제가 해결되었습니다. (TGT-43404)
* 일부 고객이 [!UICONTROL 관리] > [!UICONTROL 보고]의 &quot;[!UICONTROL IPs에서 [!DNL Target] 보고 데이터]&quot; 목록에서 제외할 IP 주소를 삭제하지 못하는 문제를 해결했습니다. (TGT-43384)
* 변수가 “다음보다 큼“인지, “다음보다 크거나 같음“인지, “다음보다 작음” 인지, 또는 “다음보다 작거나 같음”인지 확인하는 대상자 기준에 음수를 사용할 수 없도록 하는 문제가 해결되었습니다. (TGT-43367)
* 조합된 대상 생성 시 고객이 [!UICONTROL 대상 세부 정보] 카드를 볼 수 없도록 하는 문제가 해결되었습니다. (TGT-43303)
...
* 고객이 [!DNL Target] 활동 보고에서 [!UICONTROL Analytics에서 보기] 단추를 클릭하여 [!DNL Analysis Workspace]에서 [!UICONTROL A4T] 패널을 열지 못하는 문제가 해결되었습니다. (TGT-42099, TGT-42100)
* [!UICONTROL 양식 기반 경험 작성기]를 사용하여 [!UICONTROL A/B 테스트] 및 [!UICONTROL 경험 타깃팅]&#x200B;(XT) 활동을 편집하는 동안 [!UICONTROL 디자인 편집] 단추가 표시되지 않는 문제를 해결했습니다. (TGT-41980)
* 새 [!UICONTROL 권장 사항] 활동을 만드는 동안 [!UICONTROL 호환] 확인란이 기준 선택에 표시되지 않는 문제를 해결했습니다. (TGT-42053)
...
[!DNL Adobe Experience Platform Web SDK]과(와) 함께 [!DNL Target] [!UICONTROL 대상]을(를) 사용할 때 다음과 같은 개선 사항이 추가되었습니다.
...
* [!DNL Target] UI의 다양한 위치에 경고 아이콘, 팝오버 및 메시지를 추가하여 소스에서 대상자가 삭제되었고 [!DNL Target] 활동에서 더 이상 사용할 수 없음을 표시할 수 있습니다.
  ...
  * 활동 만들기 워크플로의 [!UICONTROL 경험] 단계:
    ...
    ![[!UICONTROL 경험] 페이지의 원본 메시지에서 삭제된 대상](assets/deleted-at-source-experiences.png)

  * 활동 만들기 워크플로의 [!UICONTROL 타깃팅] 단계:

    ![[!UICONTROL 타깃팅] 페이지의 원본 메시지에서 삭제된 대상](assets/deleted-at-source-targeting.png)

  * 활동 만들기 워크플로의 [!UICONTROL 목표 및 설정] 단계:

    ![[!UICONTROL 목표 및 설정] 페이지의 원본 메시지에서 삭제된 대상](assets/deleted-at-source-goals-settings.png)

  * 대상 세분화([!UICONTROL 활동 만들기 워크플로의 [!UICONTROL 타깃팅] 단계에서 대상 대체]):

* Combine Audiences 기능을 사용하려고 하고 소스에서 대상 중 하나가 삭제되면 [!UICONTROL 저장]이(가) 비활성화됩니다.
...
| 기능 | 세부 사항 |
| --- | --- |
| [!UICONTROL 대상] UI 새로 고침 | [!DNL Target] 사용자의 사용자 경험을 개선하기 위한 [!DNL Adobe Target] 팀의 지속적인 노력의 일환으로, 이 릴리스는 [!DNL Target] UI의 [!UICONTROL 대상] 및 [!UICONTROL 프로필 스크립트] 페이지를 새로 고칩니다. 이 업데이트는 다음과 같은 새로운 개선 사항을 추가하면서 이전에 일관되지 않고 디자인 패턴을 통합하고 표준화합니다.<ul><li>여러 대상자를 동시 선택하고 삭제할 수 있는 기능</li><li>새로 단장된 [대상자 빌더 디자인](/help/main/c-target/c-audiences/create-audience.md)</li><li>[!UICONTROL 대상] 라이브러리 규칙 빌더의 제외 규칙 지원</li><li>신속한 대상 검색을 위한 새로운 &quot;대상 Source&quot; 필터</li><li>세션 영구 검색 및 필터 옵션</li></ul>자세한 내용은 [대상자](/help/main/c-target/target.md)를 참조하십시오. |
| [!UICONTROL 프로필 스크립트] UI 새로 고침 | [!UICONTROL 프로필 스크립트] 라이브러리도 업데이트되었으며, 새로 고침된 인터페이스와 몇 가지 생산성 업데이트가 포함되어 있습니다.<ul><li>여러 프로필 스크립트를 동시 선택하고 삭제할 수 있는 기능</li><li>프로필 스크립트용 새로운 편집기 코드</li><li>코드 편집기 내 구문 강조 표시 및 오류 검사</li><li>키보드 단축키를 통한 자동 완성 토큰(mbox 또는 프로필) 매개 변수</li></ul>자세한 내용은 [방문자 프로필](/help/main/c-target/c-visitor-profile/visitor-profile.md)을 참조하십시오. |
| [!BADGE Premium]{type=Positive url="/help/main/c-intro/intro.md#premium newtab=true" tooltip="Target Premium에 포함된 내용을 확인합니다."} 권장 사항 기준 만들기 및 편집 | 목표 달성에 적합한 추천 항목 알고리즘 및 설정 선택을 단순화하기 위해 [!UICONTROL 추천 항목 기준] 만들기 및 편집 워크플로가 간소화되었습니다.<br>자세한 내용은 [기준 만들기](/help/main/c-recommendations/c-algorithms/create-new-algorithm.md)를 참조하십시오. |
...
* VEC의 [!DNL Recommendations] 활동에 대한 [!UICONTROL 경험] 페이지에서 &quot;기준 편집&quot; 단추가 제대로 표시되지 않는 문제를 해결했습니다. (TGT-39512)
* 테스트 작업 영역에 복제 및 복사하는 경우 활동을 동기화할 수 없는 문제가 해결되었습니다. (TGT-40686)
* VEC에서 &quot;[!UICONTROL 다음 항목 뒤에 삽입]&quot;을(를) 사용할 때 [경험 조각](/help/main/c-experiences/c-manage-content/aem-experience-fragments.md)을(를) 사용하여 선택기를 수정할 수 없는 문제를 해결했습니다. (TGT-41802)
* 오퍼의 빈 JSON 콘텐츠를 백엔드로 전송할 수 없는 문제가 해결되었습니다. 비어있더라도 [!DNL Target] 에서 JSON 오브젝트를 보냅니다. (TGT-41555)
* 보고서를 보는 동안 고객이 &quot;[!UICONTROL Analytics에서 보기]&quot;를 클릭할 때 [!DNL Analysis Workspace] 대신 레거시 [!DNL Analytics] 보고서가 열리는 문제가 해결되었습니다. (TGT-41867)
* 고객이 [!UICONTROL Automated Personalization] 활동에 대한 보고 소스(A4T)로 [!DNL Analytics]을(를) 선택하려고 할 때 표시된 UI 메시지에 추가 설명이 추가되었습니다. 메시지에 &quot;[!DNL Target]이(가) [!UICONTROL Automated Personalization] 활동에 대한 유일한 지원 소스입니다&quot;라는 내용이 있습니다. (TGT-41954)
* 고객이 쉼표 대신 “새 줄”로 호스트 구분을 시도하는 경우 오류 메시지에 추가 설명이 추가되었습니다. (TGT-40671)
* 일부 활동의 &quot;[!UICONTROL 마지막 업데이트]&quot; 날짜가 스페인어 및 일본어 고객용 영어 UI와 다른 문제가 해결되었습니다(스페인어 및 일본어로 UI를 조회하는 경우). (TGT-38980)
...
* [!UICONTROL 양식 기반 경험 작성기]에서 만든 [!UICONTROL 자동 Personalization] 활동에 대한 보고서가 보고서에서 삭제된 오퍼를 참조하도록 하는 문제를 해결했습니다. 이로 인해 “이 보고서에 대한 데이터를 검색하는 데 문제가 있습니다. 문제가 지속되면 Adobe 클라이언트 지원 센터에 문의하십시오.”라는 오류 메시지가 표시됩니다. (TGT-41028)
...
| 기능 | 세부 사항 |
| --- | --- |
| [!UICONTROL Analytics for Target] (A4T) | [!DNL Analytics]을(를) 보고 소스로 사용(A4T)하는 활동에서 [!UICONTROL 보고서] 페이지의 &quot;[!UICONTROL Analytics에서 보기]&quot; 링크를 클릭하면 [!DNL Analysis Workspace]이(가) 열립니다. 이전에는 링크로 [!DNL Analytics] 보고서를 열 수 있었습니다. (TGT-36959) |
...
* [!UICONTROL 대상] 페이지를 새로 고칠 때 기본 작업 영역이 다른 작업 영역으로 변경되는 문제를 해결했습니다. (TGT-38871)
...
| 기능 | 세부 사항 |
| --- | --- |
| [!UICONTROL Analytics for Target]&#x200B;(A4T)을 사용하여 리디렉션 지원 | 이제 Platform Web SDK에서 [A4T](/help/main/c-integrating-target-with-mac/a4t/a4t.md)를 사용할 때 [!DNL Target] 리디렉션을 지원합니다.<br>자세한 내용은 [Analytics for [!DNL Target] 구현](/help/main/c-integrating-target-with-mac/a4t/a4timplementation.md)을 참조하십시오. |
...
* 대상을 [!UICONTROL 모든 방문자]&#x200B;(으)로 변경한 후 활동을 동기화할 수 없는 문제를 해결했습니다. (TGT-40259)
* [!UICONTROL 복제 허용] 옵션이 활성화되어 있더라도 [!UICONTROL Automated Personalization] 활동의 다른 위치에서 사용하는 경우 오퍼가 중복되지 않는 문제를 해결했습니다. (TGT-39567)
...
* [!UICONTROL 자동 타겟]&#x200B;(AT) 및 [!UICONTROL Personalization]&#x200B;(AP) 활동에 대한 [!UICONTROL Automated Personalization 통찰력] 보고서가 이제 매일 생성됩니다. 지난 15일, 30일 및 60일 동안 [!UICONTROL 자동화된 세그먼트] 또는 [!UICONTROL 중요 특성]을 제공하는 보고서를 선택할 수 있습니다. 다른 전환 확인 기간 설정을 매일 실행할 수 있도록 45일 및 90일 옵션이 제거되었습니다. (TGT-39472)
* 고객이 활동의 [!UICONTROL 목표 및 설정] 페이지에서 [!UICONTROL 종속성 편집]을 클릭할 때 현재 종속성이 표시되지 않는 문제를 해결했습니다. (TGT-39340)
* 작업 영역의 [!UICONTROL 대상 라이브러리]를 새로 고칠 때 발생하는 문제를 해결했습니다. 새로 고치기 전에 현재 선택한 작업 영역의 대상자가 표시되었습니다. 새로 고친 후에는 [!UICONTROL 기본 Workspace] 및 대상이 표시되었습니다. 이제 새로 고친 후에도 현재 작업 영역과 해당 대상자가 유지됩니다. (TGT-38871)
...
* [!UICONTROL 자동 타겟] 활동에서 [!UICONTROL Analytics를 보고 소스로 사용]&#x200B;(A4T)할 때 [!DNL Adobe Analytics] 지표를 선택할 때 경고가 추가되었습니다. [!UICONTROL 자동 타겟] 모델은 이진(전환 기반) 지표로 작동하도록 최적화되었습니다. 매출과 같은 연속적인 지표를 선택하면 최적의 결과가 없을 수 있으며 [!UICONTROL Personalization 인사이트] 보고서가 정확하지 않을 수 있습니다. (TGT-38926)
...
* A4T 및 [!DNL Analytics] 전환 지표를 사용하는 [!UICONTROL 자동 타겟] 활동에 대한 [!UICONTROL 자동 세그먼트] 및 [!UICONTROL 중요 특성] 보고서가 생성되며 보고 소스로 [!DNL Target]을(를) 사용할 때와 동일하게 표시됩니다. (TGT-38931)
* [!UICONTROL 권장 사항] [!UICONTROL 컬렉션] 목록에 환경 필터링 옵션이 추가되었습니다. (TGT-38353)
* [!UICONTROL 권장 사항] 컬렉션에 잘못된 제품 수가 표시되도록 하는 문제를 해결했습니다. (TGT-39162)
* [!UICONTROL 권장 사항] [!UICONTROL 카탈로그 검색]에 [!UICONTROL 마지막으로 업데이트됨] 필터를 추가했습니다. (TGT-38340)
* 수직 산업을 변경한 후 [!UICONTROL 시퀀스 만들기] 페이지가 중단되는 [!UICONTROL 권장 사항]의 문제를 해결했습니다. (TGT-38160)
...
* 일부 고객이 [!UICONTROL 기본 Workspace]의 활동 목록을 볼 수 없도록 하는 문제를 해결했습니다. (TGT-38526)
...
* [!UICONTROL 합계] 행에 대한 [!DNL Auto-Target] 보고에서 [!UICONTROL 평균 상승도 신뢰 구간] 및 [!UICONTROL 신뢰도]이(가) 표시되지 않는 문제를 해결했습니다. 모든 개별 경험에 대해 측정이 올바르게 표시됩니다. (TGT-37301)
* 9월 15일 오후 2시 30분(PDT)부터 10월 6일 오전 9시 25분(PDT)까지 [!DNL Adobe Target Premium] 사용자의 [!UICONTROL 자동 타겟] 보고에 영향을 미치는 문제를 해결했습니다. 영향을 받는 전환 지표에 대한 보고서(&quot;[!UICONTROL 페이지 확인함]&quot; 또는 &quot;[!UICONTROL mbox를 클릭함]&quot; 옵션을 사용하여 구성됨)를 볼 때 전환 속도가 잘못 보고됩니다. 현재 알려진 전달 문제는 없습니다.
* [!UICONTROL 카탈로그 검색] 표에 선택 가능한 [!UICONTROL 마지막 업데이트 날짜] 열과 [!UICONTROL 마지막 업데이트 날짜] 필터를 추가했습니다. 이렇게 하면 각 개별 항목을 열어 마지막으로 업데이트한 시기를 확인할 필요가 없고 항목이 마지막으로 업데이트된 날짜로 필터링할 수 있기 때문에 시간과 노력이 절약됩니다.
...
| 기능 | 세부 사항 |
| --- | --- |
| ![Premium 배지](/help/main/assets/premium.png) A4T(Analytics for Target)에서 자동 타겟 활동을 지원 | [!UICONTROL 자동 타겟] 활동은 이제 [Analytics for Target](/help/main/c-integrating-target-with-mac/a4t/a4t.md)을 지원합니다.<br>이 통합을 통해 [!UICONTROL 자동 타겟] 앙상블 머신 러닝 알고리즘을 사용하여 각 방문자의 프로필, 동작 및 컨텍스트를 기반으로 최상의 경험을 선택할 수 있습니다.<br>A/B 테스트 및 경험 타깃팅 활동과 함께 사용할 수 있도록 [A4T를 구현](/help/main/c-integrating-target-with-mac/a4t/a4timplementation.md)했다면 모두 완료되었습니다!<br>자세한 내용은 [자동 할당 및 자동 타겟 활동에 대한 A4T 지원](/help/main/c-integrating-target-with-mac/a4t/a4t-at-aa.md)을 참조하십시오. |
...
* 조직을 전환한 후 새 [!UICONTROL 관리] 페이지를 로드할 때 오류가 발생하던 문제를 해결했습니다. (TGT-37730)
* [!UICONTROL 관리 > 구현] 페이지에 잘못된 클라이언트 코드가 표시되는 문제를 해결했습니다. (TGT-37849)
...
* 사용자가 조직을 전환한 후 경우에 따라 [!UICONTROL 관리 > 구현] 페이지에서 at.js를 다운로드할 수 없는 문제를 해결했습니다. (TGT-37668)
...
* 작업 영역 이름([!UICONTROL Enterprise용 Adobe Admin Console]에 지정됨)에 아포스트로피가 포함된 경우 사용자가 [!UICONTROL 활동] 페이지를 표시할 수 없는 문제를 해결했습니다. (TGT-37709)
* 보고서 세트가 이미 지정되었지만 최적화 및 전환 지표를 선택하는 동안 [!UICONTROL 자동 할당] 활동에서 사용자에게 보고서 세트를 선택하도록 잘못 알리는 오류 메시지가 있는 문제를 해결했습니다. (TGT-37689)
* [!UICONTROL 타깃팅] 페이지로 이동한 다음 뒤로 이동하면 [!UICONTROL 목표 및 설정] 페이지의 지표가 비어 있는 문제가 해결되었습니다. (TGT-37691)
...
당사는 향상된 성능을 제공하고, 새로운 기능을 출시할 때 필요한 유지 관리 시간을 줄이고, 제품 전반에 걸쳐 사용자 경험을 개선할 수 있도록 새로운 기술 스택을 사용하여 전체 [!DNL Target] UI를 점차적으로 다시 작성하고 있습니다. 새로 고친 첫 번째 섹션은 [!UICONTROL 관리]&#x200B;(으)로 이름이 변경된 [!UICONTROL 설치] 섹션입니다.
...
* at.js 설정을 사용자 지정하고 변경 내용을 쉽게 검토할 수 있습니다(**[!UICONTROL 관리]** > **[!UICONTROL 구현]**).
* 기본 통화 및 시간대, 보고에서 제외할 IP 등 향상된 보고 설정을 수정합니다(**[!UICONTROL 관리]** > **[!UICONTROL 보고]**).
...
* 확장 가능한 벡터 그래픽(SVG) 이미지를 사용하여 [!UICONTROL 다음 항목 뒤에 삽입] > [!UICONTROL 이미지]가 제대로 작동하지 않는 문제를 해결했습니다. (TGT-37242)
* 초안 활동의 삭제를 방해하는 [!UICONTROL 게시자] 역할이 있는 사용자의 문제를 해결했습니다. (TGT-37358)
* [!UICONTROL 모든 내 작업 영역]을(를) 선택할 때 사용자가 활동을 편집할 수 없도록 하는 문제를 해결했습니다. (TGT-37276)

### Target Standard/Premium 20.5.1(2020년 6월 17일)

| 기능/향상 | 설명 |
| --- | --- |
| [!UICONTROL 자동 할당] 활동에 대한 Analytics for Target(A4T) 지원 | [!UICONTROL 자동 할당] 활동은 이제 [Analytics for Target](/help/main/c-integrating-target-with-mac/a4t/a4t.md)을 지원합니다.<br>이 통합을 통해 [!UICONTROL 자동 할당] multi-armed bandit 기능을 사용하여 트래픽을 승리 경험으로 유도하고, [!UICONTROL Adobe Analytics] 목표 지표 및/또는 [!UICONTROL Adobe Analytics] 보고 및 분석 기능을 사용할 수 있습니다.<br>A/B 테스트 및 경험 타깃팅 활동과 함께 사용할 수 있도록 [A4T를 구현](/help/main/c-integrating-target-with-mac/a4t/a4timplementation.md)했다면 모두 완료되었습니다!<br>자세한 내용은 [자동 할당 및 자동 타겟 활동에 대한 A4T 지원](/help/main/c-integrating-target-with-mac/a4t/a4t-at-aa.md)을 참조하십시오. |
...
| A4T는 [!DNL Analysis Workspace]<br>2020년 6월 25일에 지원 | [!UICONTROL Analytics for Target]&#x200B;(A4T)이 이제 [!DNL Analysis Workspace]에서 지원됩니다. [!UICONTROL Analytics for Target(A4T) 패널]을 사용하면 [!DNL Analysis Workspace]에서 [!DNL Adobe Target] 활동 및 경험을 분석할 수 있습니다.<br>자세한 내용은 *A4T 보고*&#x200B;의 [Analytics의 보고서](/help/main/c-integrating-target-with-mac/a4t/reporting.md) 및 *Analytics 도구 안내서*&#x200B;의 [Analytics for Target(A4T) 패널](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/panels/a4t-panel.html?lang=ko-KR)을 참조하십시오. |

**개선 사항, 수정 사항 및 변경 사항**

* 방문자 지표가 &quot;UniqueVisitors&quot; 대신 활동의 정의에 저장되도록 한 문제를 해결했습니다. (TGT-37098)
* [!UICONTROL 대상] 페이지에서 세로 스크롤 막대가 올바르게 작동하지 않는 [!DNL Target] UI의 문제를 해결했습니다. (TGT-36968)
...
* 다음 지표는 더 이상 사용되지 않으므로 새 A4T 활동을 생성할 때 기본 목표 지표로 더 이상 선택할 수 없습니다.
  ...
  | 평균 방문 깊이 | 해당 사항 없음 기본 목표 지표로 제안되지 않음 |
  | 보트 | 해당 사항 없음 기본 목표 지표로 제안되지 않음 |
  | 모바일 충돌률, 모바일 평균 이전 세션 길이, 모바일 앱 스토어 평균 순위, 모바일 앱 성능 충돌률, 모바일 앱 스토어 평균 등급 | 해당 사항 없음 기본 목표 지표로 제안되지 않음 |
...
| 기능/향상 | 설명 |
| --- | --- |
| 시각적 경험 작성기(VEC) | **새 VEC 메뉴 옵션**: VEC에서 페이지 요소를 클릭하면 메뉴에 해당 요소 유형에 사용할 수 있는 옵션이 표시됩니다.<ul><li>이제 [!UICONTROL 스타일 > 배경] 옵션을 사용하여 선택한 요소의 배경 이미지와 색상을 변경할 수 있습니다. (TGT-15001)</li></ul>[시각적 경험 옵션](/help/main/c-experiences/c-visual-experience-composer/viztarget-options.md#styles)의 *스타일*&#x200B;을(를) 참조하십시오.<br>**클릭 추적 개선 사항**: VEC 및 SPA(단일 페이지 애플리케이션) VEC 내에서 클릭 추적을 구성하는 프로세스를 개선했습니다.<ul><li>클릭 추적에서 사용할 요소를 선택할 때 사용 가능한 모든 요소의 이름이 오른쪽의 수정 패널에 표시되므로 원하는 요소를 빠르고 쉽게 선택할 수 있습니다.</li><li>세 부분으로 구성된 안내 활동 워크플로의 [!UICONTROL 목표 및 설정] 페이지에 클릭 추적에 대해 선택한 요소의 수를 나타내는 숫자가 표시됩니다. 이 숫자를 마우스로 가리키면 선택한 모든 요소의 이름이 표시됩니다. (TGT-33878)</li></ul>다음 [클릭 추적](/help/main/c-activities/r-success-metrics/click-tracking.md)을 참조하십시오. |
| SPA VEC(Single Page App Visual Experience Composer) | **안내 워크플로**: 새로운 안내 워크플로를 통해 페이지 전달 규칙 설정을 실행하도록 구성하는 방법을 이해하고 단일 페이지 앱에 대한 활동을 성공적으로 실행할 수 있습니다. (TGT-33718)<br> [SPA(단일 페이지 앱) 시각적 경험 작성기](/help/main/c-experiences/spa-visual-experience-composer.md#page-delivery-settings)를 참조하십시오.<br>**복제 수정**: 이제 SPA VEC를 사용하여 수정 내용을 정의한 다음 단일 페이지 앱의 다른 보기에서 사용하기 위해 해당 수정 내용을 복제할 수 있습니다. (TGT-33882)<br>. [SPA(단일 페이지 앱) 시각적 경험 작성기](/help/main/c-experiences/spa-visual-experience-composer.md)를 참조하십시오. |
| ![프리미엄 배지](/help/main/assets/premium.png) AP (Automated Personalization) 및 자동 타겟 | **특정 환경을 제어로 사용**: AP 또는 자동 타겟 활동을 작성하는 동안 컨트롤로 사용할 환경을 선택할 수 있습니다. 이 기능을 사용하면 활동에 구성된 트래픽 할당 비율에 따라 전체 제어 트래픽을 특정 환경으로 라우팅할 수 있습니다. 그런 다음 해당 경험의 제어 트래픽에 대해 개인화된 트래픽의 성능 보고서를 평가할 수 있습니다. 현재 제어 옵션(임의로 제공된 경험)은 계속 사용할 수 있습니다. (TGT-32801, TGT-26572, TGT-26571)<br>Automated Personalization 또는 자동 타겟 활동에 대한 제어 선택](/help/main/c-activities/t-automated-personalization/experience-as-control.md)을 참조하십시오.<br>**Personalization 통찰력 보고서**: 방문자가 특정 위치에서 특정 콘텐츠를 볼 때 마케터에게 친숙한 속성 이름 지정은 보다 의미 있는 정보를 제공합니다. [(TGT-33421 및 TGT-34957)<br>. [Target의 개인화 알고리즘을 위한 데이터 수집](/help/main/c-activities/t-automated-personalization/ap-data.md)을 참조하십시오. |
...
| 클라이언트측 분석 로깅 | 분석 데이터를 클라이언트측이든 아니면 서버측이든 간에 Adobe Analytics에 전송하는 방법을 고객이 완벽하게 제어할 수 있도록 합니다.<br>자세한 내용은 *구현하기 전에*&#x200B;의 [클라이언트측 분석 로깅](/help/main/c-integrating-target-with-mac/a4t/before-implement.md#client-side)을 참조하십시오. |
| 알림 보내기 | 경험이 `applyOffer()` 또는 `applyOffers()`을(를) 사용하는 대신 코드로 렌더링될 때 개발자가 알림을 전송할 수 있습니다.<br>자세한 내용은 [adobe.target.sendNotifications(options)](https://experienceleague.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/functions-overview/adobe-target-sendnotifications-atjs-21.html){target=_blank}를 참조하십시오. |
...
| 기능/향상 | 설명 |
| --- | --- |
| [!UICONTROL 시각적 경험 작성기] | VEC([!UICONTROL 시각적 경험 작성기])에는 작업을 보다 빠르고 효율적으로 수행할 수 있도록 다음과 같은 개선 사항이 포함되어 있습니다.<ul><li>이제 DOM 경로 기능은 클릭 추적을 설정할 때 사용할 수 있습니다.<br>자세한 내용은 [클릭 추적](/help/main/c-activities/r-success-metrics/click-tracking.md#considerations)을 참조하십시오.</li><li>스타일 패널을 사용하여 선택한 요소의 기존 스타일 값을 보거나 편집할 수 있습니다. 스타일을 추가할 수도 있습니다.<br>스타일 패널에 액세스하려면 VEC 내에서 페이지 요소를 클릭한 다음 [!UICONTROL 편집] > [!UICONTROL 스타일]을 클릭합니다.<br>스타일 패널이 VEC 오른쪽에 표시됩니다. 이 패널에는 선택한 요소를 편집하거나 선택한 요소에 추가할 수 있는 스타일 목록이 포함되어 있습니다. CSS(Cascading Style Sheet)를 사용하는 데 익숙하거나 개발자로부터 코드를 받은 경우 실시간 CSS 편집기를 사용하면 변경 사항을 보고 스타일을 추가할 수 있습니다.<br>자세한 내용은 [시각적 경험 작성기](/help/main/c-experiences/c-visual-experience-composer/viztarget-options.md#styles) 선택 사항의 *스타일*&#x200B;을 참조하십시오.</li><li>이제 서식 있는 텍스트 편집기에서 중첩된 HTML5 요소를 지원합니다.<br>HTML5 사양에 따라 중첩할 태그를 새로 조합할 수 있습니다. 이전 버전의 서식 있는 텍스트 편집기에서는 HTML5 사양에 따라 허용되는 태그의 새로운 중첩을 지원하지 않았습니다. 따라서 VEC에서 선택한 중첩된 요소가 제대로 처리되지 않아 HTML이 원치 않게 변경되었습니다. (TGT-33618)<br>자세한 내용은 [시각적 경험 작성기](/help/main/c-experiences/c-visual-experience-composer/viztarget-options.md#edit-text-html) 선택 사항의 *텍스트/HTML 편집*&#x200B;을 참조하십시오.</li> |

#### 개선 사항, 수정 및 변경 사항

* VEC를 사용하여 에셋을 삭제할 때 워크플로를 개선했습니다. 삭제된 자산은 이제 [!UICONTROL 오퍼 라이브러리] 및 [!DNL Scene7]에서 제거됩니다(해당하는 경우). 삭제된 에셋은 더 이상 검색 결과에 표시되지 않습니다. (TGT-31981)
...
* 이제 컬렉션 선택기에서 [!UICONTROL 권장 사항] 컬렉션을 선택한 후에는 [!UICONTROL 저장] 단추를 클릭해야 합니다. 이 워크플로는 [!DNL Target] 내의 다른 워크플로와 일치합니다. (TGT-33205)
...
>[!NOTE]
>
>GDPR(일반 데이터 보호 규정)에 대한 [!DNL Adobe] 옵트인 지원이 필요한 경우 at.js 1.7.1을 구현해야 합니다. 옵트인 지원은 현재 at.js 2.*x*&#x200B;에서 지원되지 않습니다.
...
| ![Premium 배지](/help/main/assets/premium.png)<br>[!UICONTROL A/B 테스트] 및 [!UICONTROL 경험 타깃팅] 활동의 권장 사항 | 이제 [!UICONTROL A/B 테스트]&#x200B;([!UICONTROL 자동 할당] 및 [!UICONTROL 자동 타겟] 포함)와 [!UICONTROL 경험 타깃팅]&#x200B;(XT) 활동 내에 권장 사항을 포함할 수 있습니다. 이에 따라 다음과 같이 완전히 새로운 기능을 사용할 수 있게 됩니다.<ul><li>동일한 활동에서 권장 사항 및 비권장 사항 콘텐츠를 테스트하고 타기팅할 수 있습니다.</li><li>권장 사항들의 순서를 포함하여 페이지에서의 권장 사항 배치를 쉽게 실험할 수 있습니다.</li><li>[!UICONTROL 자동 할당]을 사용하여 트래픽을 가장 성과가 가장 좋은 권장 사항 경험에 자동으로 푸시합니다.</li><li>[!UICONTROL 자동 타겟]을(를) 사용하여 방문자를 개별 프로필에 따라 맞춤 권장 사항 경험에 동적으로 지정할 수 있습니다.</li></ul>시작하려면 VEC를 사용하여 [!UICONTROL A/B 테스트] 또는 [!UICONTROL 경험 타깃팅] 활동을 만들고, [!UICONTROL 다음 항목 앞에 삽입], [!UICONTROL 다음 항목 뒤에 삽입] 또는 [!UICONTROL 다음으로 바꾸기] 작업을 사용하여 권장 사항을 경험에 추가하십시오. (RECS-6166)<br>자세한 내용은 [오퍼로서의 추천](/help/main/c-recommendations/recommendations-as-an-offer.md)를 참조하십시오. |
...
| 프로필 스크립트<br>2019년 1월 17일 | 성능상의 이유로 256자를 넘지 않는 반환 값이 좋습니다.<br>문자열 반환 값의 경우 반환 값의 크기가 2048자를 초과하는 경우 시스템에 의해 스크립트가 비활성화됩니다.<br>배열 반환 값의 경우, 연결된 배열 값의 크기가 2048자를 초과하는 경우 시스템에 의해 스크립트가 비활성화됩니다.<br>문자 제한 및 기타 제한(오퍼 크기, 대상, 프로필, 값, 매개 변수 등)에 대한 자세한 정보 [제한](/help/main/r-troubleshooting-target/target-limits.md)을 참조하세요. |
...
| 기능/향상 | 설명 |
| --- | --- |
| [!DNL Target] API에서 ![Target Premium 배지](/help/main/assets/premium.png)<br/>[!UICONTROL 엔터프라이즈 권한] 지원 | 이제 [Adobe Target 관리 API](https://developers.adobetarget.com/api/#admin-apis) 는 Target UI에 있는 것과 동일한 엔터프라이즈 권한 기능을 최대한 활용합니다. **2019년 2월 21일**&#x200B;부터 시스템 관리자는 프로그래밍 방식으로 보고서 데이터에 액세스하고 작업 영역에서 활동, 오퍼 및 대상자를 만들고 관리할 수 있습니다. 이러한 작업은 이전에는 기본 작업 영역으로만 제한되었습니다. Automated Personalization (AP) 활동에 대한 지원은 차후 릴리스에서 제공될 예정입니다. |
| ![Target Premium 배지](/help/main/assets/premium.png)<br/>[!UICONTROL 권장 사항]: 환경(호스트 그룹)별로 컬렉션 및 제외 필터링 | 이제 선택한 환경(호스트 그룹)에 대한 [!UICONTROL 권장 사항] 컬렉션 및 제외의 내용을 미리 볼 수 있습니다.<br/>이전에는 컬렉션이나 제외를 볼 때 포함된 항목이 기본 호스트 그룹([!UICONTROL 권장 사항 > 설정 > 기본 호스트 그룹]에 지정됨)에 대한 결과였습니다.<br/>이제 컬렉션이나 제외를 만들거나 업데이트할 때 [!UICONTROL 환경] 선택기를 사용하여 결과를 미리 볼 환경을 선택할 수 있습니다. 새 [!UICONTROL 환경] 필터를 사용하면 컬렉션과 제외를 만들거나 편집하기 전에 적절한 기본 호스트 그룹을 선택하기 위해 더 이상 [!UICONTROL 설정] 페이지로 이동할 필요가 없으므로 시간과 노력을 절약할 수 있습니다.<br/>**참고:** 선택한 환경을 변경한 후 [!UICONTROL 검색]을 클릭하여 반환된 결과를 업데이트해야 합니다.<br/>새 [!UICONTROL 환경] 필터는 [!DNL Target] UI의 다음 위치에서 사용할 수 있습니다.<ul><li>[!UICONTROL 카탈로그 검색]&#x200B;([!UICONTROL 권장 사항 > 카탈로그 검색])</li><li>[!UICONTROL 컬렉션 만들기] 대화 상자([!UICONTROL 권장 사항 > 컬렉션 > 새로 만들기])</li><li>[!UICONTROL 컬렉션 업데이트] 대화 상자([!UICONTROL 권장 사항 > 컬렉션 > 편집])</li><li>[!UICONTROL 제외 만들기] 대화 상자([!UICONTROL 권장 사항 > 제외 > 새로 만들기])</li><li>[!UICONTROL 제외 업데이트] 대화 상자([!UICONTROL 권장 사항 > 제외 > 편집])</li></ul><br>자세한 내용은 다음 주제를 참조하십시오.<uL><li>[컬렉션](/help/main/c-recommendations/c-products/collections.md)</li><li>[제외](/help/main/c-recommendations/c-products/exclusions.md)</li><li>[카탈로그 검색](/help/main/c-recommendations/c-products/catalog-search.md)</li><li>[설정](https://experienceleague.adobe.com/docs/target-dev/developer/recommendations.html){target=_blank}</li><li>[권장 사항: 환경(호스트 그룹)별로 컬렉션 및 제외 필터링](/help/main/administrating-target/hosts.md)</li></ul>(TGT-20622)</ul> |
...
<table id="table_EF529199D1C741F7BDBC9C41A37B7D26"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1" class="premium"> <p>개인화 인사이트 보고서 </p> <p> <p>참고: 2018년 11월 14일부터 이용 가능합니다. </p> </p> </td> 
...
* Adobe Analytics을 [!UICONTROL 관리] 페이지에서 보고 소스로 선택한 경우 특정 상황에서 사용자가 활동을 만들 수 없는 문제를 해결했습니다. 사용자에게 보고서 세트를 선택하는 옵션을 제공하지 않아도 &quot;보고서 세트를 선택하십시오&quot;라는 메시지가 표시됩니다. (TGT-31968)
...
<table id="table_4785030753B24AA1A973E1DF790B83DD"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1" class="premium"> <p>개인화 인사이트 보고서 </p> </td> 
...
<table id="table_5A60FFE5E86148F4BDC6A7031D03D6BA"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>시각적 경험 작성기(VEC) </p> </td> 
   <td colname="col2"> <p>[수정 사항] 패널에서 작업을 클릭하면 VEC에서는 자동으로 웹 페이지를 화면을 스크롤하고 해당 요소가 강조 표시됩니다. 더 이상 수정 사항의 영향을 받는 HTML 요소를 찾기 위해 직접 아래로 스크롤할 필요가 없습니다. </p> <p> <img src="assets/modifications_panel.png" id="image_6E01280636E34ADDA9527AD18A34310B" /> </p> <p>(TGT-30441) </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>지원되는 브라우저 </p> </td> 
   <td colname="col2"> <p>Target UI 및 콘텐츠 배송에 대한 Microsoft Edge 지원이 추가되었습니다. </p> <p>자세한 내용은 를 참조하십시오. <a href="https://experienceleague.adobe.com/docs/target-dev/developer/implementation/supported-browsers.html" format="dita" scope="local"> 지원되는 브라우저 </a>(TGT-14102) </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" class="premium"> <p>권장 사항 </p> </td> 
...
<table id="table_6D99C48B72D24728BF623608053931D3"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Target 활동에 AEM에서 만든 경험 조각을 사용하면 AEM의 편의성과 기능을 Target의 강력한 AI(Automated Intelligence) 및 기계 학습(ML) 기능을 결합하여 경험을 다양한 규모로 테스트 및 개인화할 수 있습니다.&amp;nbsp; </p> <p>AEM에서는 모든 콘텐츠 및 에셋을 중앙 위치에 가져와서 개인화 전략을 실행합니다. AEM을 사용하면 코드를 작성하지 않고도 한 위치에서 데스크탑, 태블릿 및 휴대 디바이스의 콘텐츠를 쉽게 만들 수 있습니다. 모든 장치를 위해 페이지를 만들 필요가 없이, 콘텐츠를 사용하여 각 경험이 자동으로 조정됩니다. </p> <p> Target을 사용하면 행동 변수, 컨텍스트 변수 및 오프라인 변수를 통합하는 규칙 기반 및 AI 기반 머신 러닝 접근 방식의 조합을 기반으로 다양한 규모로 개인화된 경험을 제공할 수 있습니다.&amp;nbsp; Target을 사용하면 A/B 및 다변량 활동을 쉽게 설정 및 실행하여 최상의 오퍼, 콘텐츠 및 경험을 결정할 수 있습니다. </p> <p>경험 조각은 콘텐츠/경험 작성자 및 관리자를 Target을 사용하여 비즈니스 결과를 이끄는 최적화 및 개인화 전문가에게 연결하기 위한 매우 큰 단계를 나타냅니다. </p> <p>자세한 내용은 <a href="/help/main/c-experiences/c-manage-content/aem-experience-fragments.md#topic_1E1E4EA01F074349B2CF8785387B5FE8" format="dita" scope="local"> AEM 경험 구성 요소 </a>를 참조하십시오. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>보고서 </p> </td> 
   <td colname="col2"> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_C595EEF916494342AD99FF0FDF999927"> 
      ...
      <li id="li_21B31F91685C46CAA47688FDE5735312"> <p>이제 Target은 보고서에서 통계적으로 중요한 경우 상승도 한계를 표시합니다(TGT-27301, TGT-27794 및 TGT-26387). </p> </li> 
...
<table id="table_701D8D53D1DF4F28ADAC6EC221B0208A"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>경험 타겟팅(XT) </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 이제 <span class="filepath"> at.js </span> 버전 0.9.6을 사용할 수 있습니다. 자세한 내용은 <a href="https://experienceleague.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/deploy-at-js/implement-target-without-a-tag-manager.html" format="dita" scope="local"> at.js 다운로드 </a>를 참조하십시오. </p> <p>다음 개선 사항 및 수정 사항이 <span class="filepath"> at.js </span> 버전 0.9.6에 포함되어 있습니다. </p> <p> 
     <ul id="ul_108DF85393614C69988E299485D338FD"> 
      ...
      <li id="li_3B1F618DEC744056B5BB172C4DBB359A"> <p>쿠키를 저장할 때 사용해야 하는 최상위 도메인을 추출하는 알고리즘이 <span class="codeph"> at.js </span> 버전 0.9.6에서 변경되었습니다. 이러한 변경으로 인해 쿠키는 IP를 사용하는 주소에 저장할 수 없습니다. 대부분의 경우 IP 주소는 테스트 용도로 사용되지만, 해결 방법으로 DNS 항목을 사용하거나, 로컬 상자에서 호스트 파일을 조정할 수 있습니다. </p> </li> 
...
<table id="table_4BA8DA701BC64427957355E144570EFE"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1" class="premium"> <p>추천 </p> </td> 
...
* [!UICONTROL Analytics for Target]&#x200B;(A4T)을 보고 소스로 사용하는 활동에서 리디렉션 오퍼를 지원하도록 [!DNL Target] 사용자 인터페이스가 업데이트되었습니다. 이 기능을 사용하려면 곧 출시될 예정인 [!DNL at.js] 0.9.6이 필요합니다.
* [!DNL Target] 사용자 인터페이스가 다음을 비롯한 일부 위치에서 업데이트되었습니다.

  * 보고서 및 활동의 일부 옵션([!UICONTROL 편집], [!UICONTROL 피드에 공유], [!UICONTROL 경험 URL 보기] 등)은 [!UICONTROL 추가 옵션] 아이콘(![icon_more_options 이미지](assets/icon_more_options.png))을 클릭하여 액세스할 수 있습니다.
...
* 이제 [!DNL Target]에서 [!UICONTROL Automated Personalization] 활동에 대한 환경(호스트 그룹) 전환을 지원합니다.
...
>[!NOTE]
>
>FP-11577을 사용하는 [!DNL Adobe Experience Manager] 6.2(또는 이상)에서는 이제 [!UICONTROL Adobe Target Cloud Services] 통합을 통해 [!DNL at.js] 구현을 지원합니다. 자세한 [내용은](https://experienceleague.adobe.com/docs/) [Adobe Experience Manager 6.2](https://experienceleague.adobe.com/docs/) 설명서에서 *기능 팩 및 Adobe Target과 통합을* 참조하십시오.
...
* 대상자를 삭제하면 [!DNL Target] 에는 해당 대상자를 참조하는 활동 목록이 표시됩니다. 목록의 각 활동을 클릭하여 해당 [!UICONTROL 개요] 페이지를 표시할 수 있습니다. (TGT-17997)
...
* 활동 페이지에 at.js(버전 0.9.1 이상)가 로드된 경우 추적 서버가 필요하지 않음을 사용자에게 알리는 [!UICONTROL Analytics for Target]&#x200B;(A4T) 보고를 사용하여 모든 활동의 [!UICONTROL 목표 및 설정] 페이지에 도구 설명이 추가되었습니다. (TGT-22607)
...
* 리디렉션이 적용된 경험에 대한 경험 미리 보기 URL에 문제가 있습니다. 이 문제를 해결하려면 경험 작성기에서 **[!UICONTROL 구성]**&#x200B;을 클릭하고 **[!UICONTROL 다중 대상]**&#x200B;을 선택한 후 유일한 대상으로 **[!UICONTROL 모든 방문자]**&#x200B;를 추가합니다. 계속해서 활동을 저장합니다. 활동의 전달은 변경되지 않지만 미리보기가 제대로 작동합니다. 이 문제는 Adobe Target의 7월 릴리스에서 수정될 예정입니다.
...
<table id="table_DDC5356FD6B8443EAA6EB81C03ADF73A"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>이제 CSV 다운로드에는 엔티티 권장 사항이 없는 환경을 포함하여 모든 환경에 대한 줄이 있습니다(예: 
     <code>
       # environment: 1724 
     </code>). </p> </td> 
  </tr> 
...
<table id="table_162CC5A0DB324B38A8A4252A18976686"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>이전에는 고객 특성을 <span class="codeph"> crs.get('&lt; <span class="varname"> 데이터 소스 이름 </span>&gt;.&lt; <span class="varname"> 특성 이름 </span>&gt;') </span>(으)로 형식이 지정된 프로필 스크립트에서 참조할 수 있었습니다. </p> <p>이제 이러한 속성은 프로필 스크립트에서 토큰으로 사용되거나 프로필 스크립트가 없어도 오퍼에서 직접 토큰으로 사용될 수 있습니다. 토큰은 <span class="codeph"> $crs. <span class="varname"> datasourceName </span>. <span class="varname"> attributeName </span></span>형식이어야 합니다. </p> <p><a href="/help/main/c-target/c-visitor-profile/variables-profiles-parameters-methods.md#section_62B4821EB6564FF4A14159A837AD4EDB" format="dita" scope="local"> CRS 토큰 </a>을 참조하십시오. </p> </td> 
  </tr> 
  <tr> 
...
* Chrome 버전 48 업데이트는 Visual Experience Composer가 Chrome에서 제대로 작동할 수 없게 하는 문제를 야기합니다. Google을 사용하면 문제가 해결됩니다. 자세한 내용은 [https://code.google.com/p/chromium/issues/detail?id=582603](https://code.google.com/p/chromium/issues/detail?id=582603)을 참조하십시오. 이 문제를 해결하려면 다음을 수행하십시오.
  ...
  * **[!UICONTROL 관리]** > **[!UICONTROL 시각적 경험 작성기]** 탭에서 구성할 수 있는 고급 경험 작성기를 사용하도록 설정합니다.
...
<table id="table_EE13D9B959DA4FB0AD6BC03FBF78AEF6"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1" class="premium"> <p class="Premium">추천 </p> <p class="Premium">이전 구매 제외 </p> </td> 
  ...
  <tr> 
   <td colname="col1" class="premium"> <p class="Premium">추천 </p> <p> 속성 가중치 </p> </td> 
  ...
  <tr> 
   <td colname="col1" class="premium"> <p class="Premium">추천 </p> <p>피드 처리 시간 설정 </p> </td> 
  ...
  <tr> 
   <td colname="col1" class="premium"> <p class="Premium">추천 </p> <p>피드 목록을 사용하여 피드가 절대 실행되지 않도록 설정 </p> </td> 
  ...
  <tr> 
   <td colname="col1" class="premium"> <p class="Premium">추천 </p> <p>콘텐츠 유사성을 기준으로 새로운 기준 유형 설정 </p> </td> 
  ...
  <tr> 
   <td colname="col1" class="premium"> <p class="Premium">추천 </p> <p>향상된 기능: 업계 관련 기준 구성 </p> </td> 
   <td colname="col2"> <p>설정 중에 부적절한 옵션이 제거되었습니다. 과거, 일부 업계 수직 부문(예: 미디어)에 대한 몇 가지 설정 옵션은 관련성이 없는 경우도 있었습니다. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" class="premium"> <p class="Premium">추천 </p> <p>새로운 기본 기준 </p> </td> 
   <td colname="col2"> <p> 
...
<table id="table_907A952F54084C2A9C61F10E2B7A7BFF"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1" class="premium"> <p class="Premium">추천 </p> <p class="Premium">양식 기반 권장 사항 </p> </td> 
  ...
  <tr> 
   <td colname="col1" class="premium"> <p class="Premium">추천 </p> <p> 디자인에 키에 대한 정보 표시 </p> </td> 
...
<table id="table_5A2F2058ACFB455E9F69484CA0C8D3DE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>CRM(고객 관계 관리) 데이터베이스에서 기업 고객 데이터를 캡처하는 Analytics 사용자는 이 데이터를 Experience Cloud에 업로드할 수 있습니다. </p> <p>데이터가 Experience Cloud에 업로드되면 세그먼트 정의에 사용자 속성을 포함하는 대상자 세그먼트를 Analytics에서 생성하여 Target으로 해당 대상자를 공유하는 등의 작업을 할 수 있습니다. </p> <p> <p>참고: Target에서는 아직 원시 고객 속성을 직접 사용할 수 없습니다. </p> </p></td> 
  </tr> 
 </tbody> 
</table>
...
* 사용자가 [!UICONTROL 목표 및 설정] 페이지에서 **[!UICONTROL 링크 선택]**&#x200B;을 클릭했을 때 선택한 링크가 선택된 링크로 표시되지 않는 문제가 해결되었습니다.
