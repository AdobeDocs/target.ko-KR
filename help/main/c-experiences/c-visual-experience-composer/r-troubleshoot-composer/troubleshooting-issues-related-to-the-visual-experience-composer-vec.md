...
## [!UICONTROL 시각적 경험 작성기]에서 웹 사이트를 열면 [!DNL Target] 라이브러리가 로드되지 않습니다. (VEC만 해당) {#section_8A7D3F4AD2CC4C3B823EE9432B97E06F}

+++세부 사항
[!DNL Target]이(가) [!UICONTROL 시각적 경험 작성기]에서 웹 사이트를 여는 동안 두 개의 매개 변수(`mboxEdit=1` 및 `mboxDisable=1`)를 추가합니다.
...
[!UICONTROL 향상된 경험 작성기]에 문제가 발생하면 [!UICONTROL 향상된 경험 작성기]를 끄고 대신 [!UICONTROL 시각적 경험 작성기]를 사용하십시오.

[!UICONTROL 향상된 경험 작성기]를 사용하지 않으려면 **[!UICONTROL 관리]** > **[!UICONTROL 시각적 경험 작성기]**&#x200B;로 이동하여 **[!UICONTROL 향상된 경험 작성기 사용]** 옵션을 끕니다.
...
[!UICONTROL 시각적 경험 작성기]와 [!UICONTROL 향상된 경험 작성기]가 모두 작동하지 않는 경우, 사이트의 X-Frame 헤더 옵션을 덮어쓰고 iFrame에 로드하도록 허용하는 [!DNL Requestly]&#x200B;([!DNL Chrome] 또는 [!DNL Firefox])과 같은 브라우저 확장 기능이나 응답 헤더 수정(Firefox)을 사용하여 VEC를 활성화하십시오. 브라우저 확장을 사용할 수 없는 경우 [양식 기반 경험 작성기](/help/main/c-experiences/form-experience-composer.md)를 사용하십시오.

>[!NOTE]
>
>다음 정보 외에 [!DNL Google Chrome]에 대해 [[!DNL Adobe Target] [!UICONTROL Visual Editing Helper] 확장 기능](/help/main/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/visual-editing-helper-extension.md)을 사용할 수 있습니다.
...
1. **[!UICONTROL 저장]**&#x200B;을 클릭합니다.
   ...
   이제 [!UICONTROL 시각적 경험 작성기]를 사용하여 페이지를 빠르게 로드할 수 있습니다.

**[!UICONTROL Firefox]에서 [!DNL Modify Response Headers] 확장을 사용하려면:**

1. [!DNL Firefox]에 [!UICONTROL 응답 헤더 수정]을(를) 설치하고 브라우저를 다시 시작합니다.
1. [!DNL Firefox] 확장에서 응답 헤더 수정 확장을 선택합니다.
1. **[!UICONTROL 기본 설정]**&#x200B;을 클릭합니다.
1. [!UICONTROL 작업] 드롭다운에서 **[!UICONTROL 필터]**&#x200B;을(를) 선택합니다.
1. [!UICONTROL 헤더 이름] 필드에 **[!UICONTROL X-Frame-Options]**&#x200B;을(를) 입력하십시오.
1. 4~5단계를 반복하고 **[!UICONTROL X-Frame-Options]**&#x200B;를 사용하여 필터를 추가합니다.
...
확장을 설정한 후 [!DNL Target]을(를) 엽니다. [!UICONTROL 향상된 경험 작성기]가 비활성화되어 있더라도 이제 페이지가 [!UICONTROL 시각적 경험 작성기]에 로드됩니다.
...
+++세부 사항
* VEC와의 최상의 호환성은 최신 버전의 확장 프로그램에서 보장됩니다. [[!DNL Adobe Experience Cloud] [!UICONTROL Visual Editing Helper 확장 프로그램]](/help/main/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/visual-editing-helper-extension.md).

  최신 버전을 사용 중인지 확인하려면 [!UICONTROL 확장] > [!UICONTROL 확장 관리]로 이동한 다음 [!UICONTROL 세부 정보]를 클릭합니다.

* [!UICONTROL 시각적 경험 작성기]에서 웹 페이지를 수정하려면 라이브러리를 작성해야 합니다. 이러한 라이브러리는 at.js 라이브러리에 포함되어 있으며 VEC를 사용할 때마다 [!DNL Adobe] 서버에서 확장을 통해 다운로드됩니다.

  확장 프로그램은 at.js 또는 [!DNL Adobe Experience Platform Web SDK]이(가) 페이지에 이미 포함되어 있는지 여부에 관계없이 at.js 라이브러리를 다운로드합니다.

  [!UICONTROL 관리] > [!UICONTROL 구현] 섹션에 구성된 at.js 헤더에 잘못된 변경 사항이 추가되지 않았는지 확인하십시오.
...
* 브라우저가 보안 사이트에서 비보안 페이지를 차단하고 있습니다.
  ...
  브라우저 주소 표시줄에서 URL 왼쪽에 있는 아이콘을 클릭하고 **[!UICONTROL 이 페이지에서 보호 비활성화]**&#x200B;를 클릭합니다.
...
## [!UICONTROL 시각적 경험 작성기]에서 CSS 충돌로 인해 발생하는 문제
