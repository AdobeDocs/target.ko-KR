...
1. **[!UICONTROL Chrome에 추가 > 확장 추가]**&#x200B;를 클릭합니다.
...
1. (조건부) 웹 페이지에 아직 [!DNL Target] at.js JavaScript 라이브러리가 포함되어 있지 않은 경우 **[!UICONTROL Target 라이브러리 삽입]** 토글을 &quot;켜짐&quot; 위치로 밉니다.
...
1. (조건부) **[!UICONTROL 쿠키]** 토글을 &quot;켜짐&quot; 위치로 밀어 `SameSite=None` 특성 브라우저 수정 사항을 자동으로 추가합니다.
