...
description: Adobe Target에서 VEC(시각적 경험 작성기)를 사용할 때 경험이 예상대로 작동하도록 하는 우수 사례를 알아봅니다.
title: 시각적 경험 작성기 우수 사례 및 제한 사항이란 무엇입니까?
...
다음 우수 사례는 경험이 예상대로 작동하도록 하는 데 도움이 될 수 있습니다. 또한 의 VEC(시각적 경험 작성기)를 사용할 때 알고 있어야 하는 다른 팁과 제한 사항이 있습니다 [!DNL Adobe Target].

이 우수 사례를 따르면 디자인하는 경험에 예기치 않은 문제점이 발생할 가능성이 줄어듭니다.

## 우수 사례 {#section_86CF28C99CFF40329E4CBAFE4DD78BB4}

**at.js 참조를 `<head>` 섹션에 자세히 설명되어 있습니다.**

방문자 API 서비스를 사용하는 경우 at.js 위에 방문자 API 스크립트를 배치하십시오.

**계정 수준(계정에서 만들어진 모든 활동에 대해 활성화됨)이나 개별 활동 수준에서 향상된 경험 작성기를 활성화할 수 있습니다.**

계정 수준에서 향상된 경험 작성기를 활성화하려면 [!UICONTROL 관리 > 시각적 경험 작성기]그런 다음 스위치를 켜짐 위치로 전환합니다.

시각적 경험 작성기에서 활동을 만드는 동안 활동 수준에서 향상된 경험 작성기를 활성화하려면 [!UICONTROL 구성 > URL]을 클릭한 다음, 스위치를 켜짐 위치로 전환하십시오.

**향상된 시각적 경험 작성기가 사이트의 보안 페이지에서 로드되지 않는 허용 목록에 추가하다 경우 특정 IP 주소를 테스트할 수 있습니다.**

다음 IP 주소를 허용 목록에 추가 하여 향상된 시각적 경험 작성기 로드 문제를 해결할 수 있습니다. 이 IP 주소는 향상된 경험 작성기 프록시에 사용되는 Adobe의 서버용이며, 활동 편집에만 필요합니다. 사이트 방문자는 이러한 IP 주소를 허용 목록에추가된으로 사용할 필요가 없습니다.
