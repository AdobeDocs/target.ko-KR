...
description: Adobe Target에서 시각적 경험 작성기(VEC)를 사용할 때 경험이 예상대로 작동하도록 하는 모범 사례에 대해 알아봅니다.
title: 시각적 경험 작성기 모범 사례 및 제한 사항이란 무엇입니까?
...
# 시각적 경험 작성기 모범 사례 및 제한 사항

다음 우수 사례는 경험이 예상대로 작동하도록 하는 데 도움이 될 수 있습니다. [!DNL Adobe Target]에서 VEC(시각적 경험 작성기)를 사용할 때 알고 있어야 하는 다른 팁과 제한 사항도 있습니다.
...
방문자 API 서비스를 사용하는 경우 at.js 위에 방문자 API 스크립트를 배치하십시오.

**계정 수준(계정에서 만들어진 모든 활동에 대해 활성화됨)이나 개별 활동 수준에서 향상된 경험 작성기를 활성화할 수 있습니다.**

계정 수준에서 향상된 경험 작성기를 활성화하려면 [!UICONTROL Administration > Visual Experience Composer]을(를) 클릭한 다음, 스위치를 [켜짐] 위치로 전환하십시오.

시각적 경험 작성기에서 활동을 만드는 동안 활동 수준에서 향상된 경험 작성기를 활성화하려면 [!UICONTROL Configure > URL]을(를) 클릭한 다음, 스위치를 [켜짐] 위치로 전환하십시오.

허용 목록에 추가하다 **Enhanced Visual Experience Composer가 사이트의 보안 페이지에서 로드되지 않는 경우 특정 IP 주소를 검색할 수 있습니다.**

다음 IP 주소를 허용 목록에 추가 하여 향상된 시각적 경험 작성기를 로드하는 동안 문제가 해결될 수 있습니다. 이 IP 주소는 향상된 경험 작성기 프록시에 사용되는 Adobe의 서버용이며, 활동 편집에만 필요합니다. 사이트 방문자는 이러한 IP 주소를 허용 목록에추가된으로 사용할 필요가 없습니다.
...
[시각적 경험 작성기에 사용된 요소 선택기](/help/main/c-experiences/c-visual-experience-composer/vec-selectors.md#concept_4EB7663E255F439B8D24079D23479337)를 참조하십시오.
...
**여러 페이지를 추가할 때에는 경험 레일과 페이지 레일이 모두 동시에 열립니다. 결국 최적화할 사이트를 표시하기 위해 시각적 경험 작성기의 너비가 줄어듭니다. 따라서 리플로우 가능한 사이트가 줄어든 공간에서 예상과 다르게 나타날 수 있습니다.**
...
클래스 편집 및 다시 정렬 같은 작업은 mbox 내에서 허용되지 않습니다.
