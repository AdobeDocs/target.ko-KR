...
### 계정 수준(계정에서 만든 모든 활동에 대해 활성화됨)이나 개별 활동 수준에서 향상된 경험 작성기를 활성화할 수 있습니다.
...
### 향상된 시각적 경험 작성기가 사이트의 보안 페이지를 로드하지 않는 경우 특정 IP 주소를 허용 목록 할 수 있습니다.
...
VEC는 링크를 업데이트한 프록시 서버를 사용하여 백그라운드에서 웹 사이트를 조작합니다. base 태그를 추가하는 경우, 프록시 서버에서 사용하는 URL은 브라우저에서 다시 확인되어 깨진 것처럼 표시됩니다.
...
### VEC의 customCode 작업은 Internet Explorer 8에서 작동하지 않습니다.
