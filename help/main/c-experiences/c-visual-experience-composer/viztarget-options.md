...
>[!IMPORTANT]
>
>업데이트된 [!UICONTROL 시각적 편집 작성기]에는 [!DNL Chrome Web Store]에서 사용할 수 있는 [!DNL Adobe Experience Cloud] [[!UICONTROL 시각적 편집 도우미] 확장](/help/main/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/visual-editing-helper-extension.md)이 필요합니다.
...
다음 섹션에서는 [!UICONTROL A/B 테스트] 활동에 대해 업데이트된 VEC에서 사용할 수 있는 옵션에 대해 설명합니다. 옵션은 활동 유형에 따라 다릅니다.

### [!UICONTROL 경험] 레일

[!UICONTROL 경험] 레일은 VEC의 왼쪽 레일에 표시됩니다.

![경험 레일](/help/main/c-experiences/c-visual-experience-composer/assets/experiences-panel.png)

[!UICONTROL 경험] 레일을 사용하여 경험을 보거나, 만들거나, 이름을 바꾸거나, 제거할 수 있습니다.

[!UICONTROL 경험] 레일에서 다음 옵션을 사용할 수 있습니다.

* **경험 보기**: 경험을 보려면 원하는 경험을 클릭하여 [!UICONTROL 디자인] 캔버스에 표시하십시오.
* **경험 추가**: **[!UICONTROL 추가]** 아이콘(![추가 아이콘](/help/main/assets/icons/Add.svg) )을 클릭하여 새 경험을 추가합니다. 원하는 대로 새 경험을 구성합니다.
* **경험 이름 바꾸기**: **[!UICONTROL 이름 바꾸기]** 아이콘( ![이름 바꾸기 아이콘](/help/main/assets/icons/Rename.svg))을 클릭하여 [!UICONTROL 경험 이름 바꾸기] 대화 상자를 표시합니다. 새 이름을 지정한 다음 **[!UICONTROL 저장]**&#x200B;을 클릭합니다.
* **경험을 복제, 삭제 또는 리디렉션합니다**: **[!UICONTROL 추가 작업]** 아이콘(![추가 작업 아이콘](/help/main/assets/icons/MoreSmall.svg))을 클릭한 다음 **[!UICONTROL 복제]**, **[!UICONTROL 삭제]** 또는 **[!UICONTROL URL로 리디렉션]**&#x200B;을 선택합니다.

### 활동 설정/구성 {#settings}

[!UICONTROL 디자인] 캔버스 위에 표시된 [!UICONTROL 구성] 아이콘(![구성 아이콘](/help/main/assets/icons/Setting.svg))을 클릭하여 활동 속성 메뉴를 표시합니다.
...
### [!UICONTROL 디자인]/[!UICONTROL 찾아보기] 모드

디자인 캔버스 위에 표시되는 [!UICONTROL 디자인]/[!UICONTROL 찾아보기] 전환을 사용하여 디자인과 찾아보기 모드를 전환하십시오.

![디자인 및 찾아보기 전환](/help/main/c-experiences/c-visual-experience-composer/assets/design-browse-mode.png)

[!UICONTROL 찾아보기] 모드를 사용하여 사이트를 탐색하고 업데이트할 보기 또는 페이지를 선택하십시오. 변경 내용을 추가하거나 편집하려면 [!UICONTROL 디자인] 모드로 다시 전환하십시오.

### [!UICONTROL 실행 취소]/[!UICONTROL 다시 실행]

[!UICONTROL 실행 취소] 아이콘(![실행 취소 아이콘](/help/main/assets/icons/Undo.svg))을 클릭하여 변경 내용을 실행 취소할 수 있습니다.

![VEC의 실행 취소 아이콘](/help/main/c-experiences/c-visual-experience-composer/assets/undo.png)

작업을 다시 실행하려면 실행 취소/[!UICONTROL 다시 실행] 단추 그룹을 확장하고 [!UICONTROL 다시 실행]을 선택하세요.

### [!UICONTROL 구성 요소] 레일

새 [!UICONTROL 구성 요소] 레일을 사용하여 웹 페이지에 여러 구성 요소를 추가하고 필요에 따라 편집할 수 있습니다.

![구성 요소 레일](/help/main/c-experiences/c-visual-experience-composer/assets/components-panel.png)

>[!NOTE]
>
>이 영역에 [!UICONTROL 구성 요소] 레일 대신 [!UICONTROL 수정 사항] 레일이 표시되면 **[!UICONTROL 구성 요소 표시]** 아이콘(![구성 요소 표시 아이콘](/help/main/assets/icons/Add.svg))을 클릭합니다. [!UICONTROL 구성 요소 표시] 아이콘( ![구성 요소 표시 아이콘](/help/main/assets/icons/Add.svg))과 [!UICONTROL 수정 사항 표시] 아이콘( ![수정 사항 표시 레일](/help/main/assets/icons/History.svg))은 적절한 옵션을 표시하도록 전환합니다.
>
>[!UICONTROL 구성 요소] 레일이 열려 있는 동안 [!UICONTROL 구성 요소] 레일을 축소하고 [!UICONTROL 디자인] 캔버스를 확대하려면 (![구성 요소 표시 아이콘](/help/main/assets/icons/Add.svg)) 아이콘을 클릭합니다.
...
[!UICONTROL 수정 사항] 레일을 열려면 [!UICONTROL 구성 요소] 레일에서 [!UICONTROL 수정 사항 표시] 아이콘(![수정 사항 표시 레일](/help/main/assets/icons/History.svg))을 클릭합니다.

![수정 레일](/help/main/c-experiences/c-visual-experience-composer/assets/modifications-panel.png)

>[!NOTE]
>
>[!UICONTROL 구성 요소 표시] 아이콘( ![구성 요소 표시 아이콘](/help/main/assets/icons/Add.svg))과 [!UICONTROL 수정 사항 표시] 아이콘( ![수정 사항 표시 레일](/help/main/assets/icons/History.svg))은 적절한 옵션을 표시하도록 전환합니다.
>
>[!UICONTROL 수정 사항] 레일이 열려 있는 동안 [!UICONTROL 수정 사항] 레일을 축소하고 [!UICONTROL 디자인] 캔버스를 확대하려면 [!UICONTROL 수정 사항 표시] 아이콘(![수정 사항 레일 표시](/help/main/assets/icons/History.svg) ) 아이콘을 클릭합니다.

[!UICONTROL 수정 사항] 레일에는 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)에서 페이지에 적용된 모든 변경 사항이 표시되며 추가 변경을 수행할 수 있습니다(예: CSS 선택기, Mbox, 사용자 지정 코드).

수정 사항을 추가하거나, 모든 수정 사항을 삭제하거나, 모든 잘못된 수정 사항을 삭제하려면 레일 헤더의 **[!UICONTROL 추가 옵션]** 아이콘(![추가 작업 아이콘](/help/main/assets/icons/MoreSmall.svg))을 클릭하십시오. 일괄 작업을 수행하려면 [!UICONTROL 선택]을 클릭하세요. [!UICONTROL 모든 페이지에 적용] 또는 [!UICONTROL 삭제].

각 수정 사항 옆에 있는 **[!UICONTROL 추가 옵션]** 아이콘(![추가 작업 아이콘](/help/main/assets/icons/MoreSmall.svg))을 클릭하여 해당 정보를 보거나, 수정 사항을 삭제하거나, 수정 사항을 더 많은 보기에 적용합니다.

### [!UICONTROL 디자인] 캔버스

[!UICONTROL 디자인] 캔버스를 사용하면 화면 맞춤, [!UICONTROL 데스크톱], [!UICONTROL 태블릿], [!UICONTROL 모바일 가로] 및 [!UICONTROL 모바일 세로]를 포함한 뷰포트를 선택할 수 있습니다. 기본적으로 캔버스는 [관리](/help/main/administrating-target/visual-experience-composer-set-up.md) 섹션에 정의된 뷰포트와 함께 페이지에 맞게 화면에 표시됩니다.
...
[!UICONTROL 디자인] 캔버스에서 페이지 요소를 클릭하면 메뉴에 해당 요소 유형에 사용할 수 있는 옵션이 표시됩니다. 또한 페이지 구조를 쉽게 탐색할 수 있는 DOM 경로가 페이지 하단에 표시됩니다.
...
[!UICONTROL 속성] 레일을 사용하면 해당 요소가 HTML 요소인지 [!DNL Target]과(와) 관련된 개체인지 여부와 관계없이 페이지에서 선택한 요소의 속성을 변경할 수 있습니다(예: 권장 사항 또는 오퍼).

![속성 레일](/help/main/c-experiences/c-visual-experience-composer/assets/properties-panel.png)

레일 상단의 아이콘을 클릭하여 HTML 코드를 편집하거나 요소를 삭제, 복제 또는 숨깁니다. 변경 사항이 [!UICONTROL 수정 사항] 레일에 표시됩니다.

디자인 캔버스를 숨기고 디자인 캔버스를 확대할 수 있도록 오른쪽 레일에서 [!UICONTROL 속성] 레일을 접을 수 있습니다. [!UICONTROL 속성] 레일을 축소하거나 표시하려면 레일의 오른쪽에 있는 [!UICONTROL 속성 표시/숨기기] 아이콘(![속성 아이콘](/help/main/assets/icons/Propertie.svg))을 클릭하십시오.

## [!UICONTROL 디자인] 캔버스를 사용하여 요소 편집 {#design}

다음 단원에서는 [!UICONTROL 디자인] 캔버스에서 이미지와 텍스트를 편집하는 방법을 보여 줍니다. 구성 요소, 수정 사항 및 속성 레일과 함께 디자인 캔버스에서는 활동을 위한 경험을 쉽게 만들 수 있는 강력한 도구를 제공합니다.

### 이미지 옵션

[!UICONTROL A/B 테스트] 활동에서 이미지를 클릭하면 VEC가 다음 그림과 비슷하게 보입니다.

이미지가 선택된 ![VEC](/help/main/c-experiences/c-visual-experience-composer/assets/vec-image.png)

다음 요소를 삽입하려면 왼쪽의 [!UICONTROL 구성 요소] 프레임에서 구성 요소를 선택하십시오.
...
오른쪽의 [!UICONTROL 속성] 창을 사용하면 이미지의 속성을 추가로 구성할 수 있습니다.
...
* 링크 URL을 편집합니다.
* 이미지의 크기(높이 및 너비)를 구성합니다. 이미지의 최소 및 최대 크기, 너비, 높이, 오버플로 및 개체 맞춤을 구성하려면 [!UICONTROL 고급 옵션 표시]를 클릭하십시오.
* 페이지에서 이미지의 위치(절대, 고정, 상대, 정적 또는 고정)를 구성합니다.
* 여백 및 패딩을 포함하여 요소의 간격을 구성합니다.
* 요소의 효과(불투명도)를 구성합니다. 이미지의 세피아, 회색 음영, 대비, 밝기 및 흐림 값을 구성하려면 [!UICONTROL 고급 옵션 표시]를 클릭합니다. 이미지를 반전하거나 회전할 수도 있습니다.
* 이미지의 인라인 스타일을 구성합니다.

### 텍스트 옵션

[!UICONTROL A/B 테스트] 활동에서 텍스트를 클릭하는 경우 VEC는 다음 그림과 유사합니다.
...
[!UICONTROL 수정 사항 표시] 아이콘( ![수정 사항 표시 아이콘](/help/main/assets/icons/History.svg) )을 클릭하여 환경에 대한 수정 사항을 표시합니다.
...
오른쪽의 [!UICONTROL 속성] 레일을 사용하면 텍스트의 속성을 추가로 구성할 수 있습니다.
...
* 테두리 색상을 선택합니다.
* 텍스트 상자의 크기(높이 및 너비)를 구성합니다. [!UICONTROL 고급 옵션 표시]를 클릭하여 텍스트 상자의 최소 및 최대 크기, 너비, 높이, 오버플로 및 개체 맞춤을 구성합니다.
* 페이지에서 텍스트 상자의 위치(절대, 고정, 상대, 정적 또는 고정)를 구성하고 위쪽, 오른쪽, 아래쪽 및 왼쪽에서 픽셀 수를 설정합니다.
* 여백 및 패딩을 포함하여 요소의 간격을 구성합니다.
* 요소의 효과(불투명도)를 구성합니다. 이미지의 세피아, 회색 음영, 대비, 밝기 및 흐림 값을 구성하려면 [!UICONTROL 고급 옵션 표시]를 클릭합니다. 텍스트를 반전하거나 회전할 수도 있습니다.
* 인라인 스타일을 구성합니다.
...
[!UICONTROL A/B] 및 [!UICONTROL 경험 타깃팅] 활동에 대한 텍스트 및 HTML을 편집할 때 여러 가지 서식 있는 텍스트 서식 옵션을 사용할 수 있습니다. 글꼴을 선택하고, 글꼴 스타일을 선택하고, 텍스트 정렬을 변경하고, 기타 표준 텍스트 서식 옵션을 사용할 수 있습니다. HTML을 수정할 때 HTML의 코드 보기와 리치 편집 보기 간에 전환할 수 있습니다.
...
DOM 경로가 표시되지 않으면 [!UICONTROL DOM 표시] 아이콘(![DOM 표시 아이콘](/help/main/assets/icons/LayersBringToFront.svg))을 클릭합니다.
...
* [[!DNL Target Standard/Premium] 25.2.1(2025년 2월 17일) 릴리스 정보](/help/main/r-release-notes/release-notes-for-previous-releases.md#ui-update-2): [!UICONTROL 활동], [!UICONTROL 권장 사항] 및 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)에 대한 [!DNL Target]의 주요 UI 변경 사항에 대한 요약을 제공합니다.

* [[!DNL Target Standard/Premium] 25.1.1(2025년 1월 9일) 릴리스 정보](/help/main/r-release-notes/release-notes-for-previous-releases.md#ui-update-1): [!UICONTROL 오퍼 라이브러리]에 대한 [!DNL Target]의 주요 UI 변경 사항에 대한 요약을 제공합니다.
...
* [[!UICONTROL 시각적 경험 작성기] 변경 사항](/help/main/c-experiences/c-visual-experience-composer/vec-changes.md): [!DNL Adobe Target Standard/Premium] 25.2.1 릴리스(2015년 2월 17일)에서는 업데이트된 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)를 도입했습니다. 이 문서에서는 VEC의 기존 버전과 업데이트된 버전의 차이점에 대해 설명합니다.

* [[!UICONTROL 시각적 경험 작성기] 옵션](/help/main/c-experiences/c-visual-experience-composer/viztarget-options.md): 이 문서에서는 업데이트된 VEC UI 및 해당 옵션에 대해 설명합니다.

* [[!DNL Target] UI 업데이트 FAQ](/help/main/c-intro/updated-ui-faq.md): 이 FAQ는 탐색 변경, 기능 위치 및 임시 UI 버전 전환 중단 등 새 [!DNL Target] UI 및 [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC)에 대한 일반적인 질문을 해결합니다. 마케터, 개발자 또는 관리자이든, 이 FAQ는 원활하게 전환하고 업데이트된 UI를 최대한 활용하는 데 도움이 됩니다.
