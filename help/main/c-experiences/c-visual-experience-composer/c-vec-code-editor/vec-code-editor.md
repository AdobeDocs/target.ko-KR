...
페이지에 대한 수정 사항을 보고 추가 수정 사항(CSS 선택기, Mbox 및 사용자 지정 코드)을 추가할 수 있는 [!UICONTROL Modifications]의 [!DNL Adobe Target] 페이지에 대한 정보입니다.
...
1. 수정 사항을 추가하려면 다음을 수행하십시오.
   ...
   * 경험에 대한 이전 수정 사항이 작성되지 않은 경우 오른쪽의 **[!UICONTROL Add Modification]** 패널 하단에 있는 [!UICONTROL Modifications] 단추를 클릭하십시오.
...
**을(를) 사용할 때 `triggerView`사용자 지정 코드가 실행되지 않습니다.**
