...
1. at.js 2.x의 최신 함수 구현: [triggerView()](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/functions-overview/adobe-target-triggerview-atjs-2.html){target=_blank} 을 클릭합니다.
...
| [고객 속성](https://experienceleague.corp.adobe.com/docs/target-dev/developer/implementation/methods/customer-attributes.html){target=_blank} | 예 |
...
위의 예를 염두에 두고 을 구성할 때는 어떻게 됩니까? [!UICONTROL 페이지 전달] 포함할 설정: [https://target.enablementadobe.com/react/demo/#/](https://target.enablementadobe.com/react/demo/#/) SPA at.js 2.*x*&#x200B;를 사용하는 SPA에서)하면 어떻게 될까요.
...
* 사용자가 로 직접 이동합니다. [https://target.enablementadobe.com/react/demo/#/](https://target.enablementadobe.com/react/demo/#/).
...
참고: 로 이동하는 사용자 [https://target.enablementadobe.com/react/demo/#/products](https://target.enablementadobe.com/react/demo/#/products) 이(가) 페이지 로드를 트리거하지 않았습니다.

**사용자 여정 2**

* 사용자가 로 직접 이동합니다. [https://target.enablementadobe.com/react/demo/#/products](https://target.enablementadobe.com/react/demo/#/products).
...
* 에 적합한 활동이 없습니다. [https://target.enablementadobe.com/react/demo/#/products](https://target.enablementadobe.com/react/demo/#/products).
