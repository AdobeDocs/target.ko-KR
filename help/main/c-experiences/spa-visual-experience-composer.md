...
위의 예를 염두에 두고, 구성 시 발생하는 작업 [!UICONTROL 페이지 전달] 다음과 같은 경우에만 포함할 수 있습니다. [https://target.enablementadobe.com/react/demo/#/](https://target.enablementadobe.com/react/demo/#/) at.js 2.*x*&#x200B;를 사용하는 SPA에서)하면 어떻게 될까요.
...
참고: 로 이동하는 사용자 [https://target.enablementadobe.com/react/demo/#/products](https://target.enablementadobe.com/react/demo/#/products) 페이지 로드를 트리거하지 않았습니다.
