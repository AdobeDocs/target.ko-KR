...
1. at.js 2.x의 최신 함수인 [triggerView()](https://experienceleague.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/functions-overview/adobe-target-triggerview-atjs-2.html?lang=ko){target=_blank}을(를) 사이트에 구현합니다.
