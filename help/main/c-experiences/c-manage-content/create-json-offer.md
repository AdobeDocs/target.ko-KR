...
* 브라우저에서 at.js 1.2.3(또는 이상)을 통해서만, [ 작업을 사용하여 작업을 필터링함으로써 ](https://experienceleague.adobe.com/en/docs/target-dev/developer/client-side/at-js-implementation/functions-overview/adobe-target-getoffer){target=_blank}getOffer()`setJson`을(를) 사용하여 JSON 오퍼를 검색할 수 있습니다.
