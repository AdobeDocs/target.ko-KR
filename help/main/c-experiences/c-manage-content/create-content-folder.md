...
description: '[!UICONTROL 오퍼] 라이브러리에서 폴더를 만들려면 어떻게 해야 합니까?'
...
1. (선택 사항) **[!UICONTROL 개인]**&#x200B;을(를) 선택하여 폴더와 해당 컨텐츠만 볼 수 있도록 개인 폴더로 지정합니다.
1. (선택 사항) **[!UICONTROL 목록 보기에서 순서 변경 가능]**&#x200B;을 선택하여 나와 다른 사용자가 [!UICONTROL 목록 보기]에서 폴더 위치를 다시 정렬할 수 있도록 지정합니다.
