...
1. 만들려는 디자인에 대한 카드 위로 마우스를 가져간 다음 **[!UICONTROL 복사]** 아이콘을 클릭합니다.
...
1. **[!UICONTROL 정보]** 패널에서 디자인 카드에 표시할 **[!UICONTROL 콘텐츠 이름]**&#x200B;과 선택적 미리 보기 이미지를 추가하십시오.
...
1. **[!UICONTROL 디자인 만들기]**&#x200B;를 클릭합니다.
   ...
   기존 디자인을 기준으로 새 사용자 지정 디자인을 만들려면 원하는 디자인 위로 마우스를 가져간 다음 [!UICONTROL 복사] 아이콘을 클릭합니다. 그런 다음 사본을 편집하여 새 사용자 정의 디자인을 만들 수 있습니다.
...
[!UICONTROL 디자인] 라이브러리에서 원하는 디자인 위로 마우스를 가져간 다음 편집, 복사 또는 삭제 아이콘을 클릭합니다.
...
1. 디자인 라이브러리 또는 양식 기반 워크플로에서 디자인을 만듭니다. [!UICONTROL 시각적 경험 작성기]&#x200B;(VEC) 워크플로 내에서 디자인을 만들려고 하면 클릭 추적을 위해 `<div>`에 래핑된 HTML 디자인 이외의 다른 디자인을 만들 수 없습니다.
