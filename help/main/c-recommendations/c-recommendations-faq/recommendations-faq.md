...
현재, 고객이 특성 유형을 변경할 수 있는 기능이 없습니다. 변경하려면 문자열에서 숫자로 유형을 변경해야 하는 특성을 참조하는 [고객 문제를 여십시오](/help/main/cmp-resources-and-contact-information.md#reference_ACA3391A00EF467B87930A450050077C).
...
## 권장 사항에 반영되는 사용자의 동작(예: 제품 A 클릭 및 제품 B 구매)에 걸리는 시간은 어떻게 됩니까 *그게* 사용자가 수신합니까?

* 현재 보는/구매하는 제품/콘텐츠는 사용자가 같은 페이지뷰/[!DNL Target] 콘텐츠 요청에서 받는 Recommendations에 영향을 미칩니다.
* &quot;마지막으로 본 제품&quot;, &quot;가장 많이 본 제품&quot; 및 전체 보기/구매 내역과 같은 내역 사용자 동작은 해당 요청으로 업데이트되며, 사용자가 다음 페이지 보기에서 받은 권장 사항에 영향을 줍니다./[!DNL Target] 콘텐츠 요청. 예를 들어, &quot;최근에 본 항목&quot; 및 &quot;사용자에게 권장&quot; 알고리즘은 각 제품 보기/구매로 업데이트되고 후속 컨텐츠 요청에 반영됩니다.

## 권장 사항에 반영되는 사용자의 동작(예: 제품 A 클릭 및 제품 B 구매)에 걸리는 시간은 어떻게 됩니까 *기타* 사용자가 받습니까?
...
* 색인이 최신 상태입니까? 로 이동 [!DNL /target/products.html#productSearch] 색인이 몇 시간 경과되었는지 확인합니다(예를 들어, &quot;색인화된 후 3시간 경과&quot;). 필요에 따라 색인을 새로 고칠 수 있습니다.
...
* [!DNL Target] 은 게재(고객의 페이지/앱에서)에 대한 업데이트를 가능한 한 빨리 수행하는 데 최선을 다합니다. 그러나, [!DNL Target]은 마케터를 위해 UI에 일부 표시를 제공해야 합니다. [!DNL Target]은 UI 업데이트가 동기화되는 것을 기다리기 위해 게재 업데이트를 지연하지 않습니다. [mboxTrace](/help/main/c-activities/c-troubleshooting-activities/content-trouble.md) 를 사용하여 요청이 들어올 당시 시스템의 내용을 확인할 수 있습니다.
...
이 유형의 가중치는 보다 동적이며, 현재 &quot;권장 사항 키&quot;(현재 표시된 항목)를 기반으로 합니다. 다음 예(브랜드 x 16)에서 방문자가 Nike 운동화를 보고 있다면 경쟁자의 운동화보다 다른 Nike 제품(운동화일 필요는 없음)을 추천할 수 있습니다. 방문자가 Adidas 스니커즈를 보고 있다면 이 방문자는 Adidas 제품을 추천받을 가능성이 더 큽니다.

![content_유사성_example 이미지](assets/content_similarity_example.png)
...
### 사용 시 알려진 몇 가지 문제는 무엇입니까 [!DNL Recommendations] 활동?
