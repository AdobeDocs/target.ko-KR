...
아니오. [!DNL Recommendations] UI에서 만들어진 시각적 오퍼가 있는 [!DNL Target] 활동은 [!DNL Target] API를 사용하여 관리할 수 없습니다. 이러한 활동은 [!UICONTROL Activities] 목록에 표시되지만, 읽거나 업데이트할 수 없습니다(GET/PUT 사용).
