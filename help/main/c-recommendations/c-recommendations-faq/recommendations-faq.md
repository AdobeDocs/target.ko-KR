...
## [!DNL Recommendations] 활동에서 내 [!UICONTROL Download data] 작업이 실패한 이유는 무엇입니까? {#download-data-error}

[!DNL Recommendations] 활동의 [!UICONTROL Activity Overview] 페이지에서 **[!UICONTROL Download data]**&#x200B;을(를) 클릭하면 [!DNL Target] 사용자 인터페이스에 `Error while fetching recommendation data file.` 오류가 표시될 수 있습니다
