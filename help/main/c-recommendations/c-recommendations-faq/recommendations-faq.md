...
[!DNL Target]은(는) 알고리즘 선택기의 지능적 필터링을 제어하기 위해 [호환되지 않는 기준 필터링](https://experienceleague.adobe.com/docs/target-dev/developer/recommendations.html?lang=ko){target=_blank} 설정을 사용합니다.
