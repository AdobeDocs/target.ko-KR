...
* [!UICONTROL 프로필 특성별 가장 많이 본 항목] 및 [!UICONTROL 프로필 특성별 최상위 판매자] 또한 집계 보기 또는 구매 횟수별로 항목의 등급을 매기지만, 그룹화 키는 항목 속성 대신 국가, 지역 또는 멤버십 계층과 같은 방문자 프로필 특성입니다. 각 세션의 수는 상호 작용 시 방문자가 보유한 프로필 값에 영향을 미치며, 항목의 속성에는 영향을 미치지 않습니다. 그 결과, 해당 프로필 속성의 고유한 값에 의해 입력된 추천 목록 세트가 됩니다.
