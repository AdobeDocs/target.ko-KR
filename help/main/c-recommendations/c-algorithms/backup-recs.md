...
>[!NOTE]
>
>추가 정보는 [!UICONTROL 부분 디자인 렌더링] 및 [!UICONTROL 백업 권장 사항 표시] 옵션을 함께 사용하거나 별도로 사용할 때 관찰할 결과를 설명하는 행렬을 포함하여 만들기 기준](/help/main/c-recommendations/c-algorithms/create-new-algorithm.md#content) 주제의 [콘텐츠 섹션에 포함되어 있습니다.
