...
>[!NOTE]
>
>기준 시퀀스를 2016년 10월 릴리스([!DNL Target Premium]) 이전에 만든 [!UICONTROL 권장 사항] 활동에는 사용할 수 없습니다.
...
* [!UICONTROL 권장 사항] 활동을 편집하는 경우 페이지에서 [!UICONTROL 권장 사항 위치] 상자를 클릭한 다음 **[!UICONTROL 기준 변경]**&#x200B;을 선택합니다. [!UICONTROL 기준 선택] 화면에서 **[!UICONTROL 새로 만들기]** > **[!UICONTROL 기준 시퀀스 만들기]**&#x200B;를 클릭합니다. 다른 [!UICONTROL 권장 사항] 활동과 함께 사용할 새 기준을 저장하는 옵션이 있습니다.

다음 단계에서는 첫 번째 메서드를 사용하여 [!UICONTROL 기준 시퀀스 만들기] 화면에 액세스한다고 가정합니다. **[!UICONTROL 권장 사항]** > **[!UICONTROL 기준]** 라이브러리 화면.
...
1. **[!UICONTROL 기준 시퀀스]** 섹션에서 더하기(+) 기호를 클릭하여 하나 이상의 기준 시퀀스를 추가합니다.

   시퀀스 순서는 디자인이 채워지는 순서를 정의합니다. 기준 1에 디자인을 채울 권장 사항이 충분하지 않으면 나머지 슬롯이 기준 2로 채워집니다.

1. [!UICONTROL 기준 선택] 화면에서 기준을 선택한 다음 **[!UICONTROL 저장]**&#x200B;을 클릭합니다.

   [!UICONTROL 검색] 상자와 필터 옵션을 사용하여 원하는 기준을 찾을 수 있습니다.

1. (선택 사항) **[!UICONTROL 반환되는 항목 수 제한]** 토글을 &quot;켜짐&quot; 위치로 밀고 항목 수(1에서 50 사이)를 지정합니다.

   [!UICONTROL 반환되는 항목 수 제한] 옵션(&quot;슬롯 수준 제어&quot;라고도 함)의 값을 이해하는 데 도움이 되도록 다음 사용 사례를 고려하십시오.
...
1. **[!UICONTROL 만들기]**&#x200B;를 클릭합니다.
   ...
   기준 시퀀스가 [!UICONTROL 기준] 목록에 표시됩니다.
