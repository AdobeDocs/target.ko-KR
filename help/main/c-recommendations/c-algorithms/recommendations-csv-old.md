...
1. [기본 정보](/help/main/c-recommendations/c-algorithms/create-new-algorithm.md#info) 섹션에 정보를 입력하십시오.
   ...
   1. **[!UICONTROL 알고리즘]** 드롭다운 목록에서 **[!UICONTROL 사용자 지정 알고리즘]**&#x200B;을 선택합니다.
      ...
      >[!NOTE]
      >
      >위의 단계를 수행하면 [!UICONTROL CSV 업로드] 섹션이 [!UICONTROL 새 기준 만들기] 대화 상자의 아래쪽에 표시됩니다.
...
* 사용자 지정 기준 피드는 24시간마다 한 번씩 업데이트됩니다.
  ...
  [!UICONTROL 권장 사항] > [!UICONTROL 기준] 페이지에서 각 기준 카드의 맨 아래에 사용자 지정 기준 업로드의 업로드 및 동기화 상태를 볼 수 있습니다. 사용자 지정 기준을 편집할 때 [!UICONTROL 편집] 대화 상자에서도 상태를 확인할 수 있습니다.
