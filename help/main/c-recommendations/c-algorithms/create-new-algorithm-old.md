...
1. 표시할 권장 사항을 결정할 때 사용할 사용 가능한 내역 사용자 동작 데이터의 시간 범위를 결정하려면 **[!UICONTROL Lookback Window]**&#x200B;을(를) 설정하십시오. 이 옵션은 유사한 속성 및 사용자 지정 알고리즘이 있는 항목을 제외한 모든 알고리즘에 대해 사용할 수 있습니다.
