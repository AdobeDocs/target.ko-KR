...
1. 표시할 권장 사항을 결정할 때 사용할 사용 가능한 내역 사용자 동작 데이터의 시간 범위를 결정하려면 **[!UICONTROL 전환 확인 기간]**&#x200B;을 설정하십시오. 이 옵션은 유사한 속성 및 사용자 지정 알고리즘이 있는 항목을 제외한 모든 알고리즘에 대해 사용할 수 있습니다.
...
>[!NOTE]
>
>알고리즘 유형 및 알고리즘으로 **[!UICONTROL 비슷한 특성을 가진 항목 기반]**/ **[!UICONTROL 미디어]**&#x200B;를 선택한 경우 콘텐츠 유사성 규칙을 설정할 수 있는 옵션이 있습니다.
