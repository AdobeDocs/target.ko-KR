...
테스트에 2개 이상의 경험(&quot;A/Bn 테스트&quot;)이 있는 경우 **ANOVA**(두 개 이상의 변형으로 t 테스트를 일반화)와 같은 보다 복잡한 메서드를 적용할 수 있습니다. 하지만, ANOVA는 일반적인 A/Bn 테스트에서는 _특정 변형_&#x200B;이 가장 적합한 경우에 관심이 더 많은 &quot;모든 변형이 동일한 평균을 가지고 있는지&quot; 질문에 대답합니다. 따라서 [!DNL Target]에서는 여러 비교를 위해 Bonferroni 교정을 사용하여 각 변형을 컨트롤에 비교하는 정규 t-테스트를 적용합니다.
