...
seo-title: Adobe Target의 사용자 지정 매개 변수
solution: Target
title: 사용자 지정 매개 변수
topic: Standard
...
* 대상 및 활동은 특정 mbox에 대해 평가됩니다. 예를 들어 글로벌 mbox가 특정 매개 변수를 전달하지만 지역 mbox가 전달하지 않는 경우 해당 매개 변수가 지역 mbox에 대해 자격을 부여하지 않습니다.
