...
description: 네트워크 세부 사항을 기반으로 [!DNL Adobe Target] 에서 대상을 만드는 방법을 알아봅니다.
...
ISP, 도메인 이름 및 연결 속도와 같은 네트워크 세부 사항을 기반으로 하여 [!DNL Adobe Target]에서 대상을 만들 수 있습니다.
...
1. **[!UICONTROL 선택]**&#x200B;을 클릭한 후, 다음 선택 사항 중 하나를 선택합니다.
   ...
   * **도메인 이름:** 이 이름은 방문자 IP 주소의 도메인 이름입니다. 이 이름은 [!DNL Target]에 사용하는 웹 사이트의 도메인 이름이 아닙니다. 이 도메인 이름은 방문자의 IP 주소와 관련되며 때로는 호스트 이름이라고도 합니다. ISP 이름과 비슷합니다. 호스트 이름이 도메인 이름이 아니라, ISP 이름을 새로이 브랜딩한 회사의 이전 이름을 참조하는 경우도 있습니다.
