---
description: 페이지를 방문할 때 특정 브라우저나 특정 브라우저 선택 사항을 사용하는 사용자를 타깃팅할 수 있습니다.
keywords: 브라우저 선택 사항;유형;브라우저 유형;브라우저 언어;언어;버전;브라우저 버전
seo-description: 페이지를 방문할 때 특정 브라우저나 특정 브라우저 선택 사항을 사용하는 사용자를 타깃팅할 수 있습니다.
seo-title: 브라우저
solution: Target
subtopic: 다변량 테스트
title: 브라우저
...
## 브라우저 {#concept_925EAD7A8A42431395F9792AC7C3F76B}
