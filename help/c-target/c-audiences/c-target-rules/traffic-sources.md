...
description: Adobe [!DNL Target] 에서 대상을 만들어 사이트를 안내하는 검색 엔진 또는 랜딩 페이지에 따라 방문자를 타깃팅하는 방법을 알아봅니다.
...
[!DNL Adobe Target]에서 사이트를 안내하는 검색 엔진 또는 랜딩 페이지에 따라 방문자를 타깃팅할 대상을 만듭니다.
