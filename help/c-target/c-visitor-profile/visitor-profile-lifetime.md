...
기본적으로 방문자 프로필은 해당 방문자에 대해 활동이 없는 후 14 일 후에 만료됩니다. 이 프로필 라이프타임은 연장할 수 있습니다.
...
하나의 클라이언트 코드 하에 두 개의 사이트가 있고 방문자가 두 사이트를 모두 방문하는 경우, 프로필은 어느 사이트든 마지막으로 방문한 사이트의 프로필 라이프타임으로 설정됩니다. 예를 들어 사이트 1에 84 일 프로필 라이프타임이 있고 사이트 2에 14 일 라이프타임이 있고 방문자가 사이트 1를 방문한 다음 사이트 2를 방문하는 경우 방문자의 프로필은 비활동 후 14 일 동안 만료됩니다. 방문자가 사이트 2를 방문한 후 사이트 1를 방문하는 경우 활동이 없는 후 프로필이 만료됩니다.
