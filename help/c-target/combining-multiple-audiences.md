...
description: 여러 대상(Adobe Experience Cloud 대상 및 [!DNL Target] 대상 포함)을 신속하게 결합하여 임시 대상을 만드는 방법을 알아봅니다.
...
여러 대상([!DNL Adobe Experience Cloud], [!DNL Adobe Experience Platform] 및 [!DNL Target] 대상 포함)을 동시에 조합하여 임시 대상을 만들 수 있습니다. 제외 규칙을 만들고 규칙에서 대상을 제외할 수도 있습니다.
...
다른 예로, 모든 충성도 고객을 타깃팅할 수 있습니다. 예를 들어, 충성도 상태에 대한 특정 [!DNL Audience Manager] 대상을 포함하고 현재 세션 동안 충성도 프로그램에 등록한 사람들로 구성된 [!DNL Target] 대상과 결합할 수 있습니다. 이러한 두 대상을 결합하는 것은 세 번째 영구 대상을 만드는 것보다 쉽습니다.
...
1. [!UICONTROL 대상 선택] 페이지에서, 결합된 대상을 위한 빌딩 블록으로 사용할 대상의 옆에 있는 확인란을 선택합니다.
   ...
   원하는 대상에 대한 검색 범위를 좁히려면 [!UICONTROL 필터] 단추를 클릭하십시오. 소스별로 대상을 필터링할 수 있습니다. ([!DNL Adobe Target], [!DNL Adobe Target Classic], [!DNL Experience Cloud], [!DNL Adobe Experience Platform] (베타)).

   ![단계 결과](assets/combine_multiple_audiences1.png)

1. 오른쪽 상단 모서리에서 **[!UICONTROL 대상 결합]**&#x200B;을 클릭합니다.

   ![단계 결과](assets/combine_multiple_audiences2.png)

1. (조건부) 결합된 새 대상을 원하는 대로 편집합니다.

   [!UICONTROL 대상 편집] 대화 상자에서는 왼쪽의 추가 대상 빌딩 블록을 새로운 결합된 대상으로 끌어다 놓을 수 있습니다. 제외 규칙을 추가하고 대상을 제외할 수도 있습니다.
...
1. 결합된 대상에 대해 수사적 이름을 지정한 다음 **[!UICONTROL 완료]**&#x200B;를 클릭합니다.
