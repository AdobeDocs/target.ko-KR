...
description: 특정 조건에서 Adobe [!DNL Target] EEC에서 발생하는 문제를 해결하는 방법을 알아봅니다.
...
특정 조건에서 [!DNL Adobe Target] [!UICONTROL 고급 경험 작성기] (EEC)에 문제가 발생하는 경우가 있습니다.
...
* **문제:**[!UICONTROL 웹 사이트 도메인(ISP)에서 고급 경험 작성기를 차단하고 있습니다].
   ...
   **해결 방법:** 위에 나열된 IP 주소를 허용 목록에 추가하다 게시합니다.

* **문제:** IP 주소는 허용 목록에추가된이지만 웹 사이트에서 TLS 버전 1.2를 지원하지 않습니다.  [!DNL Target] 현재 기본 구성 1.2를  [!DNL Target] 사용합니다.  [18.4.1(2018년 4월 25일) 이전에는 기본 구성이 TLS 1.0을 지원합니다. 자세한 내용은 ](/help/c-implementing-target/c-considerations-before-you-implement-target/tls-transport-layer-security-encryption.md#concept_CC1001E9D3AE4BABAF90B8311B0A6451)TLS(Transport Layer Security) 암호화 변경을 참조하십시오.
...
위에 설명된 오류 메시지가 &quot;The [!UICONTROL 고급 시각적 경험 작성기]가 내 사이트의 보안 페이지에 로드되지 않습니다.&quot;에 표시될 수 있습니다. 위의 IP 주소가 허용 목록에추가된이지만 웹 사이트에서 TLS 버전 1.2를 지원하지 않는 경우에는 [!DNL Target]에서 현재 1.2의 기본 구성을 사용합니다. [!DNL Target] 18.4.1(2018년 4월 25일) 이전에는 기본 구성이 TLS 1.0을 지원합니다. 자세한 내용은 [TLS(전송 계층 보안) 암호화 변경 사항](/help/c-implementing-target/c-considerations-before-you-implement-target/tls-transport-layer-security-encryption.md#concept_CC1001E9D3AE4BABAF90B8311B0A6451)을 참조하십시오.
