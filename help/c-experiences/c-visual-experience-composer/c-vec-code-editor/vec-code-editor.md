...
description: Adobe [!DNL Target] 의 수정 사항 패널을 사용하여 페이지 수정 사항을 보고 추가 수정(CSS 선택기, Mbox 및 사용자 지정 코드)를 추가하는 방법을 알아봅니다.
...
페이지 수정 사항을 보고 추가로 수정(CSS 선택기, Mbox 및 사용자 지정 코드)할 수 있는 [!DNL Adobe Target] 의 수정 사항 페이지에 대한 정보입니다.

수정 사항 페이지는 VEC(시각적 경험 작성기)에서 페이지에 수행된 모든 변경 사항을 표시하며, 페이지에서 각 요소를 클릭하고 작업](/help/c-experiences/c-visual-experience-composer/viztarget-options.md#reference_3BD1BEEAFA584A749ED2D08F14732E81)을 선택하여 추가 변경할 수 있습니다. [ 각 변경 사항은 [!UICONTROL 수정 사항] 목록에서 별도의 작업 또는 요소로 표시됩니다. CSS 선택기, Mbox 및 사용자 지정 코드 수정 유형을 포함하여 수정 사항을 추가할 수도 있습니다.
