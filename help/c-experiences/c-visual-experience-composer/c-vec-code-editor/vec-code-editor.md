...
수정 사항 페이지에는 VEC(시각적 경험 작성기)에서 페이지에 수행된 모든 변경 사항이 표시되며, 페이지의 각 요소를 클릭하여 추가 변경할 수 있습니다. [작업 선택](/help/c-experiences/c-visual-experience-composer/viztarget-options.md#reference_3BD1BEEAFA584A749ED2D08F14732E81). 각 변경 사항은 [!UICONTROL 수정 사항] 목록에서 별도의 작업 또는 요소로 표시됩니다. CSS 선택기, Mbox 및 사용자 지정 코드 수정 유형을 포함하여 수정 사항을 추가할 수도 있습니다.
