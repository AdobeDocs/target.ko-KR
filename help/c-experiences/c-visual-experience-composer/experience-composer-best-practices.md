...
다음 우수 사례는 경험이 예상대로 작동하도록 하는 데 도움이 될 수 있습니다. 또한 [!DNL Adobe Target]에서 VEC(시각적 경험 작성기)를 사용할 때 알고 있어야 하는 다른 팁과 제한 사항이 있습니다.
...
계정 수준에서 향상된 경험 작성기를 활성화하려면 [!UICONTROL 관리 > 시각적 경험 작성기] 를 클릭한 다음, 스위치를 켜짐 위치로 전환하십시오.
