...
다음 우수 사례는 경험이 예상대로 작동하도록 하는 데 도움이 될 수 있습니다. [!DNL Adobe Target]에서 VEC(Visual Experience Composer)를 사용할 때 알아야 하는 다른 팁과 제한 사항도 있습니다.
...
계정 수준에서 향상된 경험 작성기를 활성화하려면 [!UICONTROL 관리 > 시각적 경험 작성기]를 클릭한 다음 스위치를 설정 위치로 전환합니다.

시각적 경험 작성기에서 활동을 만드는 동안 활동 수준에서 향상된 경험 작성기를 활성화하려면 [!UICONTROL 구성 > URL]을 클릭한 다음, 스위치를 켜짐 위치로 전환하십시오.

**향상된 시각적 경험 작성기가 사이트의 보안 페이지에서 로드되지 않을 경우 허용 목록에 추가하다 특정 IP 주소를 표시할 수 있습니다.**

다음 IP 주소를 허용 목록에 추가에서 고급 시각적 경험 작성기를 로드하는 데 문제가 발생할 수 있습니다. 이 IP 주소는 향상된 경험 작성기 프록시에 사용되는 Adobe의 서버용이며, 활동 편집에만 필요합니다. 사이트 방문자에게 이러한 IP 주소가 필요하지 허용 목록에추가된 않습니다.
