...
작업을 클릭하면 이 작업이 적용될 사이트의 요소가 강조 표시됩니다. 보기 아래에 작성된 각 VEC 작업에는 아래에 표시된 대로 정보, 편집, &quot;페이지 로드&quot;로 이동 및 삭제, 이렇게 네 개 아이콘이 있습니다.

![수정 사항 패널](/help/c-experiences/assets/modifications.png)
...
| &quot;페이지 로드&quot;로 이동 | 작업을 페이지 로드 이벤트로 이동합니다. 이러한 작업은 일반적으로 머리글 및 바닥글 등 여러 페이지에 사용되는 SPA의 정적 HTML에 적용됩니다. |
| 삭제 | 작업을 삭제합니다. |
