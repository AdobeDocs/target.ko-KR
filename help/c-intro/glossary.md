...
대상 활동을 볼 수 있는 유사한 활동 참여자의 그룹입니다.
...
mbox에 표시되는 컨텐츠(또는 오퍼)를 정의합니다. 때때로 레서피라고도 합니다.
...
Target Standard에서 Target 지원 페이지의 조각을 시각적으로 식별하고 Target 애플리케이션을 사용하지 않고 페이지의 일부를 직접 수정하는 방법을 제공하는 페이지의 표현입니다.
