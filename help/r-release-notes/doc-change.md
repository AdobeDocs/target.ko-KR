...
| 21년 5월 | [Allowlist 대상 에지 노드](/help/c-implementing-target/c-considerations-before-you-implement-target/allowlist-edges.md) | 목록 `mboxedge30.tt.omtrdc.net` 에 추가되었습니다. |
...
| 14년 4월 | [Allowlist 타겟 에지 호스트](/help/c-implementing-target/c-considerations-before-you-implement-target/allowlist-edges.md) | 새 주제입니다.  |
