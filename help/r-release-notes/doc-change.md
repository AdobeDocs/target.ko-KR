...
| 날짜 | 주제 | 변경 사항 |
| --- | --- | --- |
| 2020년 2월 18일 | [릴리스 노트](/help/r-release-notes/release-notes.md) | 앞으로 있을 mbox.js 라이브러리 사용 중단에 대한 정보가 추가되었습니다. |
|  | [지역](/help/c-target/c-audiences/c-target-rules/geo.md) | mboxOverride.browserIp는 at.js 1에서만 지원된다는 참고가 추가되었습니다.*x*&#x200B;에는 사용할 수 없습니다. |
