...
|  | [활동 QA](/help/c-activities/c-activity-qa/activity-qa.md) | at.js 2.5.0(이상)가 있는 [!UICONTROL Automated Personalization](AP) 활동에 미리 보기 링크를 사용할 수 있음을 나타내기 위해 항목을 업데이트했습니다. |
|  | [지원되는 브라우저](/help/c-implementing-target/c-considerations-before-you-implement-target/supported-browsers.md) | at.js 2.5.0 릴리스에서는 Microsoft Internet Explorer 10, Internet Explorer 11 및 모든 이전 버전에 대한 지원이 제거되었음을 나타냅니다. Microsoft Edge는 at.js 2.5.0 이상에서 계속 지원됩니다. |
|  | [향상된 Experience Composer와 관련된  [!UICONTROL 문제 해결]](/help/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/troubleshooting-issues-related-to-the-enhanced-experience-composer-eec.md) | 에 대한 IP 주소 목록을 허용 목록에 추가하다 업데이트했습니다. |
...
|  | [온디바이스 의사 결정](/help/c-implementing-target/c-api-and-sdk-overview/on-device-decisioning.md) | Adobe 기술 블로그에서 다음 블로그 게시물에 링크를 추가했습니다.<ul><li>1부:에지 플랫폼에서 실험 및 개인화를 위해 Adobe Target NodeJS SDK 실행(Akamai Edge Workers)</li></ul> |
