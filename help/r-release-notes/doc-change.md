...
| 날짜 | 주제 | 변경 사항 |
| --- | --- | --- |
| 8월 4일 | [Target 공지 및 이벤트](/help/r-release-notes/target-announcements.md) | 8월 13일로 예정된 &quot;인공 지능과 Adobe Target을 사용한 개인화 전략&quot; 웨비나에 대한 등록 정보가 추가되었습니다. |
...
| 날짜 | 주제 | 변경 사항 |
| --- | --- | --- |
| 17년 7월 | [Target 공지 및 이벤트](/help/r-release-notes/target-announcements.md) | 7월 22일 Adobe Target 커피 휴가에 대한 정보가 추가되었습니다. |
