...
| 날짜 | 주제 | 변경 사항 |
| --- | --- | --- |
| 2019년 10월 3일 | [알려진 문제 및 해결된 문제](/help/r-release-notes/known-issues-resolved-issues.md) | at.js 2를 사용하여 수정 없이 경험을 만들 때 알려진 문제 및 해결 방법이 추가되었습니다.*x* 라이브러리. |
...
| 2019년 8월 20일 | [Target 릴리스 노트(사전 릴리스)](/help/r-release-notes/target-release-notes.md) | Postponed the Target/Premium 19.8.1 release (August 20, 2019). Content from this release will be rolled into the 19.9.1 release (September 24, 2019). |
