...
|  | [Enterprise 권한 구성](/help/administrating-target/c-user-management/property-channel/properties-overview.md) | 2단계에서 `targetPageParams`이 `targetPageParamsAll`(으)로 변경되었습니다. |
