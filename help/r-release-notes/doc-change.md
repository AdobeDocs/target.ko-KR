...
| 날짜 | 주제 | 변경 사항 |
| --- | --- | --- |
| 2019년 10월 25일 | [mbox3rdPartyID에 대한 실시간 프로필 동기화](/help/c-target/c-visitor-profile/3rd-party-id.md) | 인증된 사용자와 인증되지 않은 사용자 간의 차이를 구분하는 방법을 설명하는 참고가 추가되었습니다. |
...
| 날짜 | 주제 | 변경 사항 |
| --- | --- | --- |
| 2019년 9월 27일 | [A/B 테스트를 얼마 동안 실행해야 합니까?](/help/c-activities/t-test-ab/sample-size-determination.md) | 대상 샘플 크기 계산기에 대한 텍스트가 업데이트되었습니다. |
|  | [자동 할당](/help/c-activities/automated-traffic-allocation/automated-traffic-allocation.md) | 대상 샘플 크기 계산기에 대한 텍스트가 업데이트되었습니다. |
...
| 2019년 9월 9일 | [AEM 경험 구성요소](/help/c-experiences/c-manage-content/aem-experience-fragments.md#considerations) | "고려 사항" 섹션이 추가되었습니다. |
...
| 2019년 9월 6일 | [Target 릴리스 노트(사전 릴리스)](/help/r-release-notes/target-release-notes.md) | Target Standard/Premium 19.9.1(2019년 9월 10일) 릴리스에 대한 정보가 추가되었습니다. |
...
| 2019년 8월 23일 | [타겟 모바일 미리 보기](/help/c-target-mobile-app/target-mobile-preview.md) | `AndroidManifest.xml`의 코드 스니펫이 업데이트되었습니다. |
| 2019년 8월 22일 | [모바일 앱 시각적 경험 작성기](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer.md) | 모바일 앱 ID에서 금지된 문자를 사용하는 방법에 대한 정보가 삭제되었습니다. 더 이상 제한 사항이 없습니다. |
|  | [사용자 지정 매개 변수](/help/c-target/c-audiences/c-target-rules/custom-parameters.md#considerations) | 섹션: "고려 사항"이 새로 추가되었습니다. |
|  | [사용자 지정 기준 업로드](/help/c-recommendations/c-algorithms/recommendations-csv.md) | 문장: "사용자 지정 기준 업데이트는 기본적으로 "누적"입니다."이 새로 추가되었습니다. CSV 업로드 파일에 지정된 새 키-값 쌍이 기존 키-값 쌍을 덮어씁니다. CSV 업로드에 지정된 키가 없는 기존 키-값 쌍은 계속 제공할 수 있으며, CSV 파일의 일부로 마지막으로 업로드한 뒤 31일 후에 만료됩니다. |
| 2019년 8월 20일 | [Target 릴리스 노트(사전 릴리스)](/help/r-release-notes/target-release-notes.md) | Target/Premium 19.8.1 릴리스(2019년 8월 20일)를 연기했습니다. 이 릴리스의 콘텐츠는 19.9.1 릴리스(2019년 9월 24일)로 배포됩니다. |
|  | [디자인 FAQ](/help/c-recommendations/c-design-overview/template-faq.md) | FAQ: "권장 품목 가격이 소수점 오른쪽에 두 값을 모두 표시하지 않습니다. 어떻게 표시할 수 있습니까?"가 새로 추가되었습니다. |
| 2019년 8월 16일 | [mbox3rdPartyID에 대한 실시간 프로필 동기화](/help/c-target/c-visitor-profile/3rd-party-id.md) | 섹션: "고려 사항"이 새로 추가되었습니다. |
...
| 2019년 8월 14일 | [CNAME 및 Adobe Target](/help/c-implementing-target/c-considerations-before-you-implement-target/implement-cname-support-in-target.md) | 텍스트가 업데이트되고 교육 비디오 링크가 추가되었습니다. |
...
| 2019년 8월 12일 | [Android - 모바일 앱 설정](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer-android.md#sdk-library) | 종속성 및 아티팩트에 대한 정보가 업데이트되었습니다.<br>`AndroidManifest.XML` 파일에 대한 코드 샘플이 업데이트되었습니다. |
|  | [Target 릴리스 노트(현재)](/help/r-release-notes/release-notes.md) | 다음 "Target Mobile VEC SDK iOS 2.1.0 &amp; Android 1.1.1" 섹션의 개선 사항 및 수정 사항 목록을 업데이트했습니다. |
|  | [활동 편집 또는 초안으로 저장](/help/c-activities/edit-activity.md#classic) | 섹션: "Recommendations Classic에서 생성한 이전 활동과 작업"이 새로 추가되었습니다. |
...
|  | [모바일 앱에서 클릭 추적 설정](/help/c-target-mobile-app/c-mobile-visual-experience-composer/set-up-click-tracking-in-the-mobile-vec.md) | 클릭 추적용으로 설정한 요소를 보여주는 수정 패널에 대한 정보가 추가되었습니다. |
...
|  | [모바일 앱 시각적 경험 작성기](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer.md#ts) | 문자 제한 사항이 더 이상 앱 이름에 적용되지 않도록 문제 해결 섹션을 업데이트했습니다. 제한 사항은 ID에만 적용됩니다. |
...
| 2019년 5월 14일 | [모바일 앱 시각적 경험 작성기](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer.md),<br>[Android - 모바일 앱 설정](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer-android.md),<br>[iOS - 모바일 앱 설정](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer-ios.md) 및<br>[모바일 VEC에서 클릭 추적 설정](/help/c-target-mobile-app/c-mobile-visual-experience-composer/set-up-click-tracking-in-the-mobile-vec.md) | 새 주제입니다. |
...
|  | [알려진 문제 및 해결된 문제](/help/r-release-notes/known-issues-resolved-issues.md) | 제외 그룹에 대해 알려진 문제가 해결된 문제 표로 이동되었습니다. |
...
| 2019년 18월 3일 | [Target 릴리스 노트(사전 릴리스)](/help/r-release-notes/target-release-notes.md) 및 [at.js 버전 정보](/help/c-implementing-target/c-implementing-target-for-client-side-web/target-atjs-versions.md) | at.js 버전 2.0.1과 1.7.1에 대한 정보가 추가되었습니다. |
...
|  | [at.js 함수](/help/c-implementing-target/c-implementing-target-for-client-side-web/cmp-atjs-functions.md) | at.js 2.x의 도입에 변경 사항을 반영하도록 주제를 업데이트했습니다.<br>at.js 2.x에는 세 가지 새로운 함수가 있습니다.<ul><li>adobe.target.getOffers(options)</li><li>adobe.target.applyOffers(options)</li><li>adobe.target.triggerView (viewName, options)</li></ul> |
...
|  | [Adobe Experience Cloud Debugger를 사용하여 at.js 디버그](/help/c-implementing-target/c-implementing-target-for-client-side-web/c-target-debugging-atjs/target-debugging-atjs.md) | Adobe Experience Cloud Debugger 네트워크 요청 및 Mbox 추적 기능은 아직 at.js 2.x에 대해 지원되지 않는다는 참고 설명이 추가되었습니다. |
...
|  | [](/help/c-implementing-target/c-considerations-before-you-implement-target/c-privacy/cmp-privacy-and-general-data-protection-regulation.md)개인 정보 및 GDPR(일반 데이터 보호 규정) | 옵트인 기능 및 at.js 1.7.0과 at.js 2.x에 대한 정보가 약간 편집되었습니다. |
...
|  | [ Adobe Target(AT)용 보고 소스로서의 Adobe Analytics ](../c-integrating-target-with-mac/a4t/a4t.md) | A4T가 서버 측 배포를 지원함을 나타내는 표를 업데이트했습니다. |
