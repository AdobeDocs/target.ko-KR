...
* 사용자가 단일 경험에서 컨텐츠를 교체한 후 다른 Recommendations 오퍼 미리 보기에 편집된 컨텐츠가 표시되는 타겟 UI의 문제를 해결했습니다. (TGT-36053)
...
## 프로필 배치 상태 API v2 변경 사항(2020년 5월 4일)
