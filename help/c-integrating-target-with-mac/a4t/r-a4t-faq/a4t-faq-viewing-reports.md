...
해당 활동에 대해 분류가 수행되었고 보고서에 &quot;지정되지 않음&quot; 행이 여전히 표시되는 경우 보고서가 타깃이 아닌 지표를 사용하여 데이터를 표시하지 않도록 하십시오. 보고서에서 Target 특정 지표를 사용하지 않는 한, &quot;지정되지 않음&quot; 행은 Target과 연결되지 않은 호출에 대한 이벤트를 포함합니다.
각각 해당 행은 Target 관련 정보를 포함하지 않습니다(예: 방문자 수/방문 수/노출 횟수 없음).
