...
description: Analytics for [!DNL Target] (A4T), which lets you use Analytics reporting for [!DNL Target] 활동 프로비저닝에 대한 FAQ에 대한 답변을 찾습니다.
...
이 주제에서는 [!DNL Adobe Target](A4T)의 보고 소스로 [!DNL Adobe Analytics] 프로비저닝에 대해 자주 묻는 질문에 대한 답변을 제공합니다.
...
## 내 [!DNL Target] 계정에 A4T가 활성화되었는지 어떻게 알 수 있습니까? {#section_4437D284448F4313BF953D4B6EDBACA6}
...
Analytics 및 Target에 액세스할 수 있는 하나 이상의 Experience Cloud 그룹의 구성원이고 모든 보고서 세트에 대해 액세스 권한이 있으면 **[!UICONTROL 활동 만들기]** 아래에 Analytics를 사용하여 A/B 테스트를 만들 수 있는 옵션이 표시됩니다.
...
## [!DNL Target]에 있는 내 보고서가 비어 있는 이유는 무엇입니까? {#section_3837104757464CB488C5A83014A669A1}
