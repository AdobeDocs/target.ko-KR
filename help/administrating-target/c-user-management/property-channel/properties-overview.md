...
## 1단계. Add users (Optional) {#section_A92AF0F921B743FEB9E9033433BD816A}
...
작업 공간(제품 프로필)을 사용하면 조직은 특정 사용자 집합을 특정 속성 세트에 지정할 수 있습니다. 여러 가지 방식에서 작업 공간은 [!DNL Analytics]의 보고서 세트와 비슷합니다.
...
## 3단계. Create user groups (Optional) {#section_5F5CB9AA7A9F4D26953E22016DA59605}
...
### Target 작업 공간 구성 방법(6:55) ![자습서 배지](/help/assets/tutorial.png)
