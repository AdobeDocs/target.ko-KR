...
사용자를 추가하고 [!DNL Adobe Admin Console]에서 해당 권한을 관리합니다.
...
>
>* **[!DNL Target]표준 고객**: 사용자 탭(  관리 > 사용자)이 표시되고 속성 탭 **** 이 표시되지 않으면 조직에  [!DNL Target] Standard 라이센스가 있는 것입니다. [!DNL Target] Standard 고객은 이 문서의 지침에 따라 [!DNL Adobe Admin Console]에서 사용자를 추가하고 권한을 지정해야 합니다.
   >
   >
* **[!DNL Target]Premium 고객**: 사용자 탭   및 속성   탭([!UICONTROL 관리 > 속성])이 표시되면 조직에  [!DNL Target] Premium 라이센스가 있는 것입니다. [!DNL Target] Premium 고객은 [엔터프라이즈 사용자 권한](/help/administrating-target/c-user-management/property-channel/property-channel.md) 및 [엔터프라이즈 권한 구성](/help/administrating-target/c-user-management/property-channel/properties-overview.md)의 지침에 따라 [!DNL Adobe Admin Console]에서 사용자를 추가하고 권한을 지정해야 합니다.
>
>
사용자 및 권한을 관리하는 방법에 대한 자세한 내용은 *엔터프라이즈 및 팀 사용 안내서*&#x200B;에서 [제품 및 프로필 관리](https://helpx.adobe.com/enterprise/using/manage-products-and-profiles.html)를 참조하십시오.

[!DNL Adobe Target]을 시작하면 [!DNL Adobe Experience Cloud] 계정에 미리 채워져 있는 ID(Adobe.com으로 끝남)를 발견하게 됩니다. 이 ID는 [!DNL Adobe] 팀 구성원용으로서, 도움이 필요할 경우 새 계정과 [!DNL Adobe Target] 사용과 관련하여 여러분을 지원할 수 있습니다. 지원을 받으려면 일반적인 방법으로 Adobe 팀에 문의하십시오.

사용자가 [!DNL Adobe Experience Cloud] 계정을 사용하여 로그인한 다음, [!DNL Target Standard/Premium]에 로그인하기 전까지는 [!UICONTROL 사용자] 페이지에 새 사용자가 표시되지 않습니다.

기본적으로 모든 [!DNL Target] 사용자는 관찰자 권한으로 시작합니다.

관리자 사용자는 [!UICONTROL 사용자] 목록에서 식별됩니다. 액세스 수준을 변경해야 하는 경우 시스템 관리자 사용자에게 문의하십시오.
...
1. [Admin Console ](/help/administrating-target/c-user-management/c-user-management/user-management.md#section_79796E0227D048F59BAE0AB02E544EBE)에서  **[!UICONTROL 사용자]**  > 사용자 **** 를 클릭하여 새 사용자를 만들거나 기존 사용자를 편집합니다.
...
1. [Admin Console ](/help/administrating-target/c-user-management/c-user-management/user-management.md#section_79796E0227D048F59BAE0AB02E544EBE)에서  **[!UICONTROL 사용자]**  >  **[!UICONTROL 사용자 그룹]** 을 클릭하여 새 사용자 그룹을 만들거나 기존 그룹을 편집합니다.
1. *Enterprise 사용 안내서*&#x200B;의 [Experience Cloud에서 사용자 및 그룹 관리](https://helpx.adobe.com/enterprise/help/users.html)에 있는 지침을 따릅니다.
...
시스템 관리자 사용자는 시스템에 사용자를 추가해야 합니다. 사용자는 자동으로 추가되지 않습니다. [!DNL Experience Cloud]에서 이메일로 초대되며, 계정을 등록하기 전에 전자 메일 주소를 확인해야 합니다.
...
## 교육 비디오: Adobe Target 작업 공간을 구성하는 방법 ![자습서 배지](/help/assets/tutorial.png)
