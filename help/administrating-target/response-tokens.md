...
응답 토큰을 사용하면 활용할 변수를 선택한 다음, mbox 응답의 일부로 전송할 수 있습니다. 이렇게 하려면 스위치를 사용하여 변수를 활성화하십시오. 그러면 이 변수가 mbox 응답으로 전송되므로 네트워크 호출에서 유효성을 검사할 수 있습니다. Response tokens work in [!UICONTROL Preview] mode as well.
